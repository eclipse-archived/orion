...
define('orion/compare/compare',[/*'orion/serviceregistry',
		'orion/commands',*/
		'orion/Deferred',
...
/*
	...
	*/
    ...
    function compare(parentDivId, commandDivId, nameOnLeft, contentOnLeft, nameOnRight, contentOnRight, viewOptions){
		...
		var compareView = new mCompareView.toggleableCompareView(null, parentDivId, "twoWay", options); //$NON-NLS-0$
		compareView.startup();
    }
    return compare;
});
 define(['orion/compare/compare'], function(compare) {return compare;});