...
4)!==".css"&&(e+=".css"),/^\//.test(e)||/[a-zA-Z0-9]+:\/\//i.test(e)||!s.toUrl)this._createStyle(b,e,h,!0);else{var g=this;s(["text!"+e],function(a){g._createStyle(b,a,h,!1)})}else h()},setThemeClass:function(b,e){var h=this,g=h._themeClass;h._themeClass=b;this._load(b,e,function(){h.onThemeChanged({type:"ThemeChanged",oldValue:g,newValue:h.getThemeClass()})})},onThemeChanged:function(b){return this.dispatchEvent(b)}};p.EventTarget.addMixin(j.prototype);return{TextTheme:j}});
...
g.substring(g.length-4)===".css"&&(g=g.substring(0,g.length-4));c.setThemeClass(g,{href:a.theme});a.theme=c}var h;a.readonly||(e={createContentAssistMode:function(a){h=new n.ContentAssist(a.getTextView());a=new n.ContentAssistWidget(h);return new n.ContentAssistMode(h,a)}});e=new q.Editor({textViewFactory:function(){return new s.TextView({parent:b,model:new j.ProjectionTextModel(new p.TextModel("")),tabSize:a.tabSize?a.tabSize:4,readonly:a.readonly,fullSelection:a.fullSelection,tabMode:a.tabMode,
...
(c=y(b));c||(c="");e.installTextView();e.setLineNumberRulerVisible(a.showLinesRuler===void 0||a.showLinesRuler);e.setAnnotationRulerVisible(a.showAnnotationRuler===void 0||a.showFoldingRuler);e.setOverviewRulerVisible(a.showOverviewRuler===void 0||a.showOverviewRuler);e.setFoldingRulerVisible(a.showFoldingRuler===void 0||a.showFoldingRuler);e.setInput(a.title,null,c);({styler:null,highlight:function(b,c){if(this.styler)this.styler.destroy(),this.styler=null;if(b){var d=c.getTextView(),e=c.getAnnotationModel();
...
b.style.height=c+"px";return e}var G=this.orion?this.orion.editor:void 0;if(G)for(var C=0;C<arguments.length;C++)E(G,arguments[C]);return F});define(["orion/editor/edit"],function(s){return s});