...
f.annotationRuler,!0);h("ruler.lines",f.annotationRuler,!0);h("ruler.folding",f.annotationRuler,!0);h("ruler.overview",f.overviewRuler,!0);h("rulerLines",f.lineNumber,!1);h("rulerLines.even",f.lineNumberEven,!1);h("rulerLines.odd",f.lineNumberOdd,!1);h("annotationLine.currentLine",f.currentLine,!0);h("entity-name-tag",f.keyword,!1);h("entity-other-attribute-name",f.attribute,!1);h("string-quoted",f.string,!1);h("token_keyword",f.keyword,!1);h("token_string",f.string,!1);h("token_singleline_comment",
f.comment,!1);h("token_multiline_comment",f.comment,!1);h("token_doc_comment",f.comment,!1);h("token_doc_html_markup",f.comment,!1);return c.join("\n")},_createStyle:function(b,f,h,c){var a=this._document,b="orion-theme-"+b,g=a.getElementById(b);if(g){if(c||g.firstChild.data===f)return;g.removeChild(g.firstChild);g.appendChild(a.createTextNode(f))}else c?(g=m.createElement(a,"link"),g.rel="stylesheet",g.type="text/css",g.href=f,g.addEventListener("load",function(){h()})):(g=m.createElement(a,"style"),
g.appendChild(a.createTextNode(f))),g.id=b,(a.getElementsByTagName("head")[0]||a.documentElement).appendChild(g);c||h()},_load:function(b,f,h){if(b)if(typeof f==="string")this._createStyle(b,f,h);else if(f=f.href,f.substring(f.length-4)!==".css"&&(f+=".css"),/^\//.test(f)||/[a-zA-Z0-9]+:\/\//i.test(f)||!r.toUrl)this._createStyle(b,f,h,!0);else{var c=this;r(["text!"+f],function(a){c._createStyle(b,a,h,!1)})}else h()}};q.EventTarget.addMixin(i.prototype);return{TextTheme:i}});
...
e={type:"LineStyle",textView:u,lineIndex:l,lineText:a,lineStart:g};if(a.length<2E3)u.onLineStyle(e);k=j||b.createElement(d.ownerDocument,"div");if(!j||!c(j.viewStyle,e.style)){f(e.style,k,j);if(j)j._trim=null;k.viewStyle=e.style;k.setAttribute("role","presentation")}k.lineIndex=l;l=[];this._createRanges(e.ranges,a,0,a.length,g,{tabOffset:0,ranges:l});a=" ";!u._fullSelection&&b.isIE<9&&(a="\ufeff");b.isWebkit&&(a="\u200c");l.push({text:a,style:u._metrics.largestFontStyle,ignoreChars:1});var n,p,o,
h,s,a=u=0,i,t;if(j){if(p=j.modelChangedEvent)p.removedLineCount===0&&p.addedLineCount===0?(t=p.start-g,i=p.addedCharCount-p.removedCharCount):t=-1,j.modelChangedEvent=void 0;p=j.firstChild}for(g=0;g<l.length;g++){n=l[g];h=n.text;u+=h.length;e=n.style;if(p)if(s=p.firstChild.data,o=p.viewStyle,s===h&&c(e,o)){a+=s.length;p._rectsCache=void 0;n=p=p.nextSibling;continue}else for(;p;){if(t!==-1){o=u;o>=t&&(o-=i);s=(s=p.firstChild.data)?s.length:0;if(a+s>o)break;a+=s}o=p.nextSibling;k.removeChild(p);p=o}n=
this._createSpan(k,h,e,n.ignoreChars);p?k.insertBefore(n,p):k.appendChild(n);if(j)j.lineWidth=void 0}if(j)for(d=n?n.nextSibling:null;d;)o=d.nextSibling,j.removeChild(d),d=o;else d.appendChild(k);return k},_createRanges:function(d,j,l,u,k,a){if(!(l>=u)){if(d)for(var b=0;b<d.length;b++){var g=d[b];if(!(g.end<=k+l)){var f=Math.max(k+l,g.start)-k;if(f>=u)break;var e=Math.min(k+u,g.end)-k;if(f<e){f=Math.max(l,f);e=Math.min(u,e);for(l<f&&this._createRange(j,l,f,null,a);b+1<d.length&&d[b+1].start-k===e&&
...
e.top<=j&&j<e.bottom)break;if(d<e.left)d=e.left;d>e.right&&(d=e.right-1)}else d<0&&(d=0),d>k.right-k.left&&(d=k.right-k.left);var n=c.ownerDocument,p=n.defaultView||n.parentWindow,o=b.isIE?p.screen.logicalXDPI/p.screen.deviceXDPI:1,h=b.isIE?p.screen.logicalYDPI/p.screen.deviceYDPI:1,p=g,s=c.firstChild;a:for(;s;){var i=s.firstChild,c=i.length;s.ignoreChars&&(c-=s.ignoreChars);var t,m,q;f=this._getClientRects(s,k);for(var v=0;v<f.length;v++)if(e=f[v],e.left<=d&&d<e.right&&(!l._wrapMode||e.top<=j&&j<
e.bottom)){if(b.isIE||l._isRangeRects){for(var n=l._isRangeRects?n.createRange():n.body.createTextRange(),v=c,r=-1;v-r>1;){var B=Math.floor((v+r)/2);e=r+1;f=B===c-1&&s.ignoreChars?i.length:B+1;l._isRangeRects?(n.setStart(i,e),n.setEnd(i,f)):(n.moveToElementText(s),n.move("character",e),n.moveEnd("character",f-e));f=n.getClientRects();for(var H=!1,D=0;D<f.length;D++)if(e=f[D],t=e.left*o-k.left,q=e.right*o-k.left,m=e.top*h-k.top,e=e.bottom*h-k.top,t<=d&&d<q&&(!l._wrapMode||m<=j&&j<e)){H=!0;break}H?
v=B:r=B}p+=v;e=v;f=v===c-1&&s.ignoreChars?i.length:Math.min(v+1,i.length);l._isRangeRects?(n.setStart(i,e),n.setEnd(i,f)):(n.moveToElementText(s),n.move("character",e),n.moveEnd("character",f-e));e=n.getClientRects()[0];t=e.left*o-k.left;q=e.right*o-k.left;d>t+(q-t)/2&&p++}else{e=[];for(o=0;o<c;o++)e.push("<span>"),o===c-1?e.push(i.data.substring(o)):e.push(i.data.substring(o,o+1)),e.push("</span>");s.innerHTML=e.join("");for(o=s.firstChild;o;){e=o.getBoundingClientRect();t=e.left-k.left;q=e.right-
k.left;if(t<=d&&d<q){d>t+(q-t)/2&&p++;break}p++;o=o.nextSibling}if(!this._createdDiv)s.innerHTML="",s.appendChild(i),k=l._getSelection(),(p<=k.start&&k.start<p+c||p<=k.end&&k.end<p+c)&&l._updateDOMSelection()}break a}p+=c;s=s.nextSibling}return Math.min(a,Math.max(g,p))},getNextOffset:function(d,j,l){return j==="line"?(j=this.view._model,d=j.getLineAtOffset(d),l>0?j.getLineEnd(d):j.getLineStart(d)):j==="wordend"?this._getNextOffset_W3C(d,j,l):b.isIE?this._getNextOffset_IE(d,j,l):this._getNextOffset_W3C(d,
...
n.getBoundingClientRect(k);n.destroy();g.extend(k);d.select||g.collapse();this._setSelection(g,!0,!0,function(){a._columnX=p},l.top+c-e.top);return!0}if(c<f-1){var o=this._getLineHeight(),h=Math.min(f-c-1,Math.floor(l/o)),h=Math.max(1,h);p=this._columnX;if(p===-1||d.select&&b.isIE)n=this._getLine(c),p=n.getBoundingClientRect(k).left,n.destroy();n=this._getLine(c+h);g.extend(n.getOffset(p,0));n.destroy();d.select||g.collapse();d=f*o;k=e.y+h*o;k+l>d&&(k=d-l);this._setSelection(g,!0,!0,function(){a._columnX=
...
function(d){c.push(d)},function(){c.push(g)}),k=c.join(""),j&&j(k),k;if(b.isFirefox){this._ignoreFocus=!0;var e=this._clipboardDiv;e.innerHTML="<pre contenteditable=''></pre>";e.firstChild.focus();var p=this,n=function(){var d=p._getTextFromElement(e);e.innerHTML="";c=[];a(d,function(d){c.push(d)},function(){c.push(g)});return c.join("")},o=!1;this._ignorePaste=!0;if(!b.isLinux||this._lastMouseButton!==2)try{o=e.ownerDocument.execCommand("paste",!1,null)}catch(h){o=e.childNodes.length>1||e.firstChild&&
e.firstChild.childNodes.length>0}this._ignorePaste=!1;if(!o)return d?(f.setTimeout(function(){p.focus();(k=n())&&j&&j(k);p._ignoreFocus=!1},0),null):(this.focus(),this._ignoreFocus=!1,"");this.focus();this._ignoreFocus=!1;(k=n())&&j&&j(k);return k}return d&&d.clipboardData?(c=[],k=d.clipboardData.getData("text/plain"),a(k,function(d){c.push(d)},function(){c.push(g)}),(k=c.join(""))&&j&&j(k),k):""},_getDOMText:function(d,a){for(var g=d.firstChild,b="",k=0;g;){var c;if(g.ignoreChars){c=g.lastChild;
for(var f=0,e=[],p=-1;c;){for(var n=c.data,o=n.length-1;o>=0;o--){var h=n.substring(o,o+1);f<g.ignoreChars&&(h===" "||h==="\u200c"||h==="\ufeff")?f++:e.push(h==="\u00a0"?"\t":h)}if(a===c)p=e.length;c=c.previousSibling}e=e.reverse().join("");p!==-1&&(k=b.length+e.length-p);b+=e}else for(c=g.firstChild;c;){if(a===c)k=b.length;b+=c.data;c=c.nextSibling}g=g.nextSibling}return{text:b,offset:k}},_getTextFromElement:function(d){var a=d.ownerDocument,g=a.defaultView;if(!g.getSelection)return d.innerText||
...
this._theme.addEventListener("ThemeChanged",this._themeListener.onChanged);var a=this._handlers=[],g=this._clientDiv,c=this._viewDiv,k=this._rootDiv,f=this._overlayDiv||g,p=g.ownerDocument,n=this._getWindow(),o=b.isIE?p:n;a.push({target:n,type:"resize",handler:function(a){return d._handleResize(a?a:n.event)}});a.push({target:g,type:"blur",handler:function(a){return d._handleBlur(a?a:n.event)}});a.push({target:g,type:"focus",handler:function(a){return d._handleFocus(a?a:n.event)}});a.push({target:c,
...
handler:function(a){return d._handleMouseOver(a?a:n.event)}});a.push({target:g,type:"mouseout",handler:function(a){return d._handleMouseOut(a?a:n.event)}});a.push({target:o,type:"mouseup",handler:function(a){return d._handleMouseUp(a?a:n.event)}});a.push({target:o,type:"mousemove",handler:function(a){return d._handleMouseMove(a?a:n.event)}});a.push({target:k,type:"mousedown",handler:function(a){return d._handleRootMouseDown(a?a:n.event)}});a.push({target:k,type:"mouseup",handler:function(a){return d._handleRootMouseUp(a?
...
this._clientDiv.appendChild(e);var n=f.createRange();n.setStart(e.firstChild,0);n.setEndBefore(e.lastChild);var p=k.getSelection();p.rangeCount>0&&p.removeAllRanges();p.addRange(n);var o=this,n=function(){e&&e.parentNode===o._clientDiv&&o._clientDiv.removeChild(e);o._updateDOMSelection()},p=!1;this._ignoreCopy=!0;try{p=f.execCommand("copy",!1,null)}catch(h){}this._ignoreCopy=!1;if(!p&&g)return k.setTimeout(n,0),!1;n();return!0},_setDOMSelection:function(a,g,c,f){for(var k,e,n,p,o=0,h=a.firstChild,
s,i,t=this._model.getLine(a.lineIndex).length;h;){s=h.firstChild;i=s.length;h.ignoreChars&&(i-=h.ignoreChars);if(o+i>g||o+i>=t){k=s;e=g-o;h.ignoreChars&&i>0&&e===i&&(e+=h.ignoreChars);break}o+=i;h=h.nextSibling}for(var o=0,h=c.firstChild,w=this._model.getLine(c.lineIndex).length;h;){s=h.firstChild;i=s.length;h.ignoreChars&&(i-=h.ignoreChars);if(i+o>f||o+i>=w){n=s;p=f-o;h.ignoreChars&&i>0&&p===i&&(p+=h.ignoreChars);break}o+=i;h=h.nextSibling}this._setDOMFullSelection(a,g,t,c,f,w);if(this._hasFocus)if(g=
...
p=this._viewDiv.getBoundingClientRect(),c=p.left+e.left,o=n.right,e=p.top+e.top,h=n.bottom,p=n=0;this._clipDiv?(p=this._clipDiv.getBoundingClientRect(),n=p.left-this._clipDiv.scrollLeft):(p=this._rootDiv.getBoundingClientRect(),n=p.left);p=p.top;this._ignoreDOMSelection=!0;var a=(new s(this,a.lineIndex,a)).getBoundingClientRect(f.getLineStart(a.lineIndex)+g,!1),i=a.left,k=(new s(this,b.lineIndex,b)).getBoundingClientRect(f.getLineStart(b.lineIndex)+k,!1),g=k.left;this._ignoreDOMSelection=!1;var f=
this._selDiv1,i=Math.min(o,Math.max(c,i)),t=Math.min(h,Math.max(e,a.top)),w=o,b=Math.min(h,Math.max(e,a.bottom));f.style.left=i-n+"px";f.style.top=t-p+"px";f.style.width=Math.max(0,w-i)+"px";f.style.height=Math.max(0,b-t)+"px";if(a.top===k.top)w=Math.min(g,o),f.style.width=Math.max(0,w-i)+"px";else if(a=Math.min(h,Math.max(e,k.top)),g=Math.min(o,Math.max(c,g)),e=Math.min(h,Math.max(e,k.bottom)),h=this._selDiv3,h.style.left=c-n+"px",h.style.top=a-p+"px",h.style.width=Math.max(0,g-c)+"px",h.style.height=
Math.max(0,e-a)+"px",a-b>0)e=this._selDiv2,e.style.left=c-n+"px",e.style.top=b-p+"px",e.style.width=Math.max(0,o-c)+"px",e.style.height=Math.max(0,a-b)+"px"}},_setGrab:function(a){if(a!==this._grabControl)a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null)},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=a;if(b.isIE&&a)this._hadFocus=this._hasFocus;var g=this._clientDiv;g.contentEditable=
...
"break-word",b.style.overflowX="hidden",b.style.overflowY="scroll"):(c.style.whiteSpace="pre",c.style.wordWrap="normal",b.style.overflowX="auto",b.style.overflowY="auto");g||(this.redraw(),this._resetLineWidth());this._resetLineHeight()},_showCaret:function(a,g,c,b){if(this._clientDiv){var k=this._model,f=this._getSelection(),e=this._getScroll(),n=f.getCaret(),p=f.start,o=f.end,h=k.getLineAtOffset(o),s=Math.max(Math.max(p,k.getLineStart(h)),o-1),k=this._getClientWidth(),h=this._getClientHeight(),
i=k/4,t=this._getBoundsAtOffset(n===p?p:s),m=t.left,q=t.right,v=t.top,r=t.bottom;a&&!f.isEmpty()&&(t=this._getBoundsAtOffset(n===o?p:s),t.top===v?n===p?q=m+Math.min(t.right-m,k):m=q-Math.min(q-t.left,k):n===p?r=v+Math.min(t.bottom-v,h):v=r-Math.min(r-t.top,h));a=0;m<e.x&&(a=Math.min(m-e.x,-i));q>e.x+k&&(a=Math.max(q-e.x-k,i));f=0;v<e.y?f=v-e.y:r>e.y+h&&(f=r-e.y-h);b&&(b>0?f>0&&(f=Math.max(f,b)):f<0&&(f=Math.min(f,b)));return a!==0||f!==0?(f!==0&&typeof c==="number"&&(c<0&&(c=0),c>1&&(c=1),f+=Math.floor(f>
0?c*h:-c*h)),this._scrollViewAnimated(a,f,g),h!==this._getClientHeight()||k!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0):!1}},_startIME:function(){if(this._imeOffset===-1){var a=this._getSelection();a.isEmpty()||this._modifyContent({text:"",start:a.start,end:a.end},!0);this._imeOffset=a.start}},_unhookEvents:function(){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);
...
!1;var g=this._clientDiv;if(g){if(this._metrics.invalid)this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1;var c=this._model,f=this._getScroll(!1),k=this._getViewPadding(),e=c.getLineCount(),n=this._getLineHeight(),p=this._getClientWidth();if(this._wrapMode)g.style.width=p+"px";var o,h,i,t,m=0,w=0;if(this._lineHeight){for(;w<e;){i=this._getLineHeight(w);if(m+i>f.y)break;m+=i;w++}o=w;h=Math.max(0,o-1);i=c=f.y-m;o>0&&(c+=this._getLineHeight(o-1))}else t=Math.max(0,f.y)/n,o=Math.floor(t),
h=Math.max(0,o-1),c=Math.round((t-h)*n),i=Math.round((t-o)*n);this._topIndexY=i;t=this._parent;var q=t.clientWidth,v=t.clientHeight;t=this._getClientHeight();if(a){h=0;this._leftDiv&&(o=this._leftDiv.getBoundingClientRect(),h=o.right-o.left);o=p;for(this._wrapMode||(o=Math.max(this._maxLineWidth,o));w<e;)i=this._getLineHeight(w,!1),m+=i,w++;e=m}else{var p=this._viewDiv,n=Math.min(o+Math.floor((t+i)/n),e-1),f=Math.min(n+1,e-1),r;for(i=g.firstChild;i;){r=i.lineIndex;var x=i.nextSibling;if(!(h<=r&&r<=
f)||i.lineRemoved||i.lineIndex===-1)this._mouseWheelLine===i?(i.style.display="none",i.lineIndex=-1):g.removeChild(i);i=x}i=this._getLineNext();var x=p.ownerDocument,z=x.createDocumentFragment();for(r=h;r<=f;r++)if(!i||i.lineIndex>r)(new s(this,r)).create(z,null);else{z.firstChild&&(g.insertBefore(z,i),z=x.createDocumentFragment());if(i&&i.lineChanged)i=(new s(this,r)).create(z,i),i.lineChanged=!1;i=this._getLineNext(i)}z.firstChild&&g.insertBefore(z,i);if(b.isWebkit&&!this._wrapMode)g.style.width=
"0x7fffffffpx";i=this._getLineNext();r=t+c;for(z=!1;i;){h=i.lineWidth;if(h===void 0)x=i._line.getBoundingClientRect(),h=i.lineWidth=Math.ceil(x.right-x.left),this._lineHeight&&(this._lineHeight[i.lineIndex]=Math.ceil(x.bottom-x.top));if(this._lineHeight&&!z&&(r-=this._lineHeight[i.lineIndex],r<0))n=i.lineIndex,z=!0;if(!this._wrapMode){if(h>=this._maxLineWidth)this._maxLineWidth=h,this._maxLineIndex=i.lineIndex;if(this._checkMaxLineIndex===i.lineIndex)this._checkMaxLineIndex=-1}if(i.lineIndex===o)this._topChild=
i;if(i.lineIndex===n)this._bottomChild=i;i=this._getLineNext(i)}if(this._checkMaxLineIndex!==-1&&(r=this._checkMaxLineIndex,this._checkMaxLineIndex=-1,0<=r&&r<e)){i=new s(this,r);x=i.getBoundingClientRect();h=x.right-x.left;if(h>=this._maxLineWidth)this._maxLineWidth=h,this._maxLineIndex=r;i.destroy()}for(;w<e;)i=this._getLineHeight(w,w<=n),m+=i,w++;e=m;this._updateRuler(this._leftDiv,o,f,v);this._updateRuler(this._rightDiv,o,f,v);h=0;this._leftDiv&&(o=this._leftDiv.getBoundingClientRect(),h=o.right-
o.left);f=0;this._rightDiv&&(f=this._rightDiv.getBoundingClientRect(),f=f.right-f.left);p.style.left=h+"px";p.style.right=f+"px";f=this._scrollDiv;f.style.height=e+"px";m=p=this._getClientWidth();this._wrapMode||(m=Math.max(this._maxLineWidth,m));o=m;if((!b.isIE||b.isIE>=9)&&this._maxLineWidth>p)m+=k.right+k.left;f.style.width=m+"px";if(this._clipScrollDiv)this._clipScrollDiv.style.width=m+"px";f=this._getScroll(!1)}if(this._vScrollDiv)m=t-8,w=Math.max(15,Math.ceil(Math.min(1,m/(e+k.top+k.bottom))*
m)),this._vScrollDiv.style.left=h+p-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,f.y*m/e))+"px",this._vScrollDiv.style.height=w+"px";if(!this._wrapMode&&this._hScrollDiv)m=p-8,w=Math.max(15,Math.ceil(Math.min(1,m/(this._maxLineWidth+k.left+k.right))*m)),this._hScrollDiv.style.left=h+Math.floor(Math.max(0,Math.floor(f.x*m/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=t-9+"px",this._hScrollDiv.style.width=w+"px";r=f.x;i=this._clipDiv;m=this._overlayDiv;if(i){i.scrollLeft=r;w=h+k.left;
n=k.top;a=p;h=t;r=0;x=-c;if(f.x===0)w-=k.left,a+=k.left,r=k.left;f.x+p===o&&(a+=k.right);f.y===0&&(n-=k.top,h+=k.top,x+=k.top);f.y+t===e&&(h+=k.bottom);i.style.left=w+"px";i.style.top=n+"px";i.style.right=q-a-w+"px";i.style.bottom=v-h-n+"px";g.style.left=r+"px";g.style.top=x+"px";g.style.width=o+"px";g.style.height=t+c+"px";if(m)m.style.left=g.style.left,m.style.top=g.style.top,m.style.width=g.style.width,m.style.height=g.style.height}else{w=r;n=c;q=r+p;v=c+t;w===0&&(w-=k.left);n===0&&(n-=k.top);
q===o&&(q+=k.right);f.y+t===e&&(v+=k.bottom);g.style.clip="rect("+n+"px,"+q+"px,"+v+"px,"+w+"px)";g.style.left=-r+h+k.left+"px";g.style.width=(b.isWebkit?o:p+r)+"px";if(!a)g.style.top=-c+k.top+"px",g.style.height=t+c+"px";if(m&&(m.style.clip=g.style.clip,m.style.left=g.style.left,m.style.width=g.style.width,!a))m.style.top=g.style.top,m.style.height=g.style.height}this._updateDOMSelection();g=this._ensureCaretVisible;this._ensureCaretVisible=!1;t!==this._getClientHeight()&&(this._update(),g&&this._showCaret())}}},
_updateRuler:function(a,g,c,e){if(a)for(var k=this._parent.ownerDocument,n=this._getLineHeight(),p=this._getViewPadding(),a=a.firstChild;a;){var o=a._ruler,h=n,i=o.getOverview();i==="page"&&(h+=this._topIndexY);a.style.top=-h+"px";a.style.height=e+h+"px";a.rulerChanged&&f(o.getRulerStyle(),a);var s,t=a.firstChild;t?(s=t,t=t.nextSibling):(s=b.createElement(k,"div"),s.style.visibility="hidden",a.appendChild(s));var m;if(a.rulerChanged&&s){h=-1;if(m=o.getWidestAnnotation())if(f(m.style,s),m.html)s.innerHTML=
m.html;s.lineIndex=h;s.style.height=n+p.top+"px"}var q;if(i==="page"){for(o=o.getAnnotations(g,c+1);t;)h=t.lineIndex,m=t.nextSibling,(!(g<=h&&h<=c)||t.lineChanged)&&a.removeChild(t),t=m;t=a.firstChild.nextSibling;q=k.createDocumentFragment();for(h=g;h<=c;h++)if(!t||t.lineIndex>h){s=b.createElement(k,"div");if(m=o[h]){f(m.style,s);if(m.html)s.innerHTML=m.html;s.annotation=m}s.lineIndex=h;s.style.height=this._getLineHeight(h)+"px";q.appendChild(s)}else if(q.firstChild&&(a.insertBefore(q,t),q=k.createDocumentFragment()),
t)t=t.nextSibling;q.firstChild&&a.insertBefore(q,t)}else{m=this._getClientHeight();h=this._model.getLineCount();t=m+p.top+p.bottom-2*this._metrics.scrollWidth;i=n*h<t?n:t/h;if(a.rulerChanged){for(m=a.childNodes.length;m>1;)a.removeChild(a.lastChild),m--;o=o.getAnnotations(0,h);q=k.createDocumentFragment();for(var v in o)if(h=v>>>0,!(h<0)){s=b.createElement(k,"div");m=o[v];f(m.style,s);s.style.position="absolute";s.style.top=this._metrics.scrollWidth+n+Math.floor(h*i)+"px";if(m.html)s.innerHTML=m.html;
s.annotation=m;s.lineIndex=h;q.appendChild(s)}a.appendChild(q)}else if(a._oldTrackHeight!==t)for(s=a.firstChild?a.firstChild.nextSibling:null;s;)s.style.top=this._metrics.scrollWidth+n+Math.floor(s.lineIndex*i)+"px",s=s.nextSibling;a._oldTrackHeight=t}a.rulerChanged=!1;a=a.nextSibling}},_updateStyleSheet:function(){var a="";b.isWebkit&&this._metrics.scrollWidth>0&&(a+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");b.isFirefox&&b.isMac&&this._highlightRGB&&this._highlightRGB!=="Highlight"&&
...
define("orion/editor/rulers",["i18n!orion/editor/nls/messages","orion/editor/annotations","orion/editor/tooltip","orion/util"],function(r,q,m,i){function b(a,c,b,f){this._location=c||"left";this._overview=b||"page";this._rulerStyle=f;this._view=null;var e=this;this._listener={onTextModelChanged:function(a){e._onTextModelChanged(a)},onAnnotationModelChanged:function(a){e._onAnnotationModelChanged(a)}};this.setAnnotationModel(a)}function e(a,c,e,f,h){b.call(this,a,c,"page",e);this._oddStyle=f||{style:{backgroundColor:"white"}};
this._evenStyle=h||{style:{backgroundColor:"white"}};this._numOfDigits=0}function f(a,c,e){b.call(this,a,c,"page",e)}function h(a,c,e){b.call(this,a,c,"document",e)}function c(a,c,b){f.call(this,a,c,b)}b.prototype={getAnnotations:function(a,c){var b=this._annotationModel;if(!b)return[];var e=this._view.getModel(),f=e.getLineStart(a),h=e.getLineEnd(c-1),i=e;e.getBaseModel&&(i=e.getBaseModel(),f=e.mapOffset(f),h=e.mapOffset(h));for(var m=[],b=this.getAnnotationsByType(b,f,h),f=0;f<b.length;f++)for(var h=
b[f],d=i.getLineAtOffset(h.start),j=i.getLineAtOffset(Math.max(h.start,h.end-1)),l=d;l<=j;l++){var u=l;if(e!==i){u=i.getLineStart(l);u=e.mapOffset(u,!0);if(u===-1)continue;u=e.getLineAtOffset(u)}if(a<=u&&u<c){var k=this._mergeAnnotation(m[u],h,l-d,j-d+1);k&&(m[u]=k)}}if(!this._multiAnnotation&&this._multiAnnotationOverlay)for(var y in m)m[y]._multiple&&(m[y].html+=this._multiAnnotationOverlay.html);return m},getAnnotationModel:function(){return this._annotationModel},getLocation:function(){return this._location},
...
a},setView:function(a){this._onTextModelChanged&&this._view&&this._view.removeEventListener("ModelChanged",this._listener.onTextModelChanged);this._view=a;this._onTextModelChanged&&this._view&&this._view.addEventListener("ModelChanged",this._listener.onTextModelChanged)},onClick:function(a){if(a!==void 0){var c=this._view,b=c.getModel(),e=b,f=b.getLineStart(a),h=f,i=this._annotationModel;if(i){h=c.getSelection();c=Math.max(h.start,h.end);h=b.getLineEnd(a,!0);f<=c&&c<b.getLineEnd(a)&&(f=c+1);b.getBaseModel&&
(f=b.mapOffset(f),h=b.mapOffset(h),e=b.getBaseModel());for(var q,a=i.getAnnotations(f,h);!q&&a.hasNext();)h=a.next(),this.isAnnotationTypeVisible(h.type)&&(q=h);q&&e.getLineAtOffset(q.start)===e.getLineAtOffset(f)?(f=q.start,h=q.end):h=f;b.getBaseModel&&(f=b.mapOffset(f,!0),h=b.mapOffset(h,!0))}(b=m.Tooltip.getTooltip(this._view))&&b.setTarget(null);this._view.setSelection(h,f,1/3,function(){})}},onDblClick:function(){},onMouseMove:function(a,c){var b=m.Tooltip.getTooltip(this._view);if(b&&!(b.isVisible()&&
this._tooltipLineIndex===a)){this._tooltipLineIndex=a;var f=this;b.setTarget({y:c.clientY,getTooltipInfo:function(){return f._getTooltipInfo(f._tooltipLineIndex,this.y)}})}},onMouseOver:function(a,c){this.onMouseMove(a,c)},onMouseOut:function(){var a=m.Tooltip.getTooltip(this._view);a&&a.setTarget(null)},_getTooltipInfo:function(a,c){if(a!==void 0){var b=this._view,f=b.getModel(),e=this._annotationModel,h=[];if(e){var h=f.getLineStart(a),i=f.getLineEnd(a);f.getBaseModel&&(h=f.mapOffset(h),i=f.mapOffset(i));
h=this.getAnnotationsByType(e,h,i)}e=this._getTooltipContents(a,h);if(!e)return null;e={contents:e,anchor:this.getLocation()};h=b.getClientArea();h.y=this.getOverview()==="document"?b.convert({y:c},"view","document").y:b.getLocationAtOffset(f.getLineStart(a)).y;b.convert(h,"document","page");e.x=h.x;e.y=h.y;e.anchor==="right"&&(e.x+=h.width);return e}},_getTooltipContents:function(a,c){return c},_onAnnotationModelChanged:function(a){function c(a){for(var g=0;g<a.length;g++)if(f.isAnnotationTypeVisible(a[g].type)){var d=
a[g].start,j=a[g].end;e.getBaseModel&&(d=e.mapOffset(d,!0),j=e.mapOffset(j,!0));d!==-1&&j!==-1&&b.redrawLines(e.getLineAtOffset(d),e.getLineAtOffset(Math.max(d,j-1))+1,f)}}var b=this._view;if(b){var e=b.getModel(),f=this,h=e.getLineCount();a.textModelChangedEvent?(a=a.textModelChangedEvent.start,e.getBaseModel&&(a=e.mapOffset(a,!0)),a=e.getLineAtOffset(a),b.redrawLines(a,h,f)):(c(a.added),c(a.removed),c(a.changed))}},_mergeAnnotation:function(a,c,b){a||(a={});if(b===0)if(a.html&&c.html){if(c.html!==
...
(a.attributes[b]=c.attributes[b])}}return a}};q.AnnotationTypeList.addMixin(b.prototype);e.prototype=new b;e.prototype.getAnnotations=function(a,c){for(var e=b.prototype.getAnnotations.call(this,a,c),f=this._view.getModel(),h=a;h<c;h++){var i=h&1?this._oddStyle:this._evenStyle,t=h;f.getBaseModel&&(t=f.getLineStart(t),t=f.getBaseModel().getLineAtOffset(f.mapOffset(t)));e[h]||(e[h]={});e[h].html=t+1+"";if(!e[h].style)e[h].style=i}return e};e.prototype.getWidestAnnotation=function(){var a=this._view.getModel().getLineCount();
...
function(a,c){if(c.length===0){var e=this._view.getModel(),f=a;e.getBaseModel&&(f=e.getLineStart(f),f=e.getBaseModel().getLineAtOffset(e.mapOffset(f)));return i.formatMessage(r.line,f+1)}return b.prototype._getTooltipContents.call(this,a,c)};h.prototype._mergeAnnotation=function(a,c,b,e){if(b===0){if(!a)a={html:"&nbsp;",style:{style:{height:3*e+"px"}}},a.style=this._mergeStyle(a.style,c.overviewStyle);return a}};c.prototype=new f;c.prototype.onClick=function(a){if(a!==void 0){var c=this._annotationModel;
if(c){var b=this._view.getModel(),e=b.getLineStart(a),a=b.getLineEnd(a,!0);b.getBaseModel&&(e=b.mapOffset(e),a=b.mapOffset(a),b=b.getBaseModel());for(var f,c=c.getAnnotations(e,a);!f&&c.hasNext();)a=c.next(),this.isAnnotationTypeVisible(a.type)&&(f=a);f&&b.getLineAtOffset(f.start)===b.getLineAtOffset(e)&&((b=m.Tooltip.getTooltip(this._view))&&b.setTarget(null),f.expanded?f.collapse():f.expand(),this._annotationModel.modifyAnnotation(f))}}};c.prototype._getTooltipContents=function(a,c){return c.length===
...
setCaretOffset:function(c,a,b){var e=this._textView,f=e.getModel();f.getBaseModel&&(this._expandOffset(c),c=f.mapOffset(c,!0));e.setCaretOffset(c,a,b)},setText:function(c,a,b){var e=this._textView,f=e.getModel();f.getBaseModel&&(a!==void 0&&(this._expandOffset(a),a=f.mapOffset(a,!0)),b!==void 0&&(this._expandOffset(b),b=f.mapOffset(b,!0)));e.setText(c,a,b)},setFoldingEnabled:function(c){this.setFoldingRulerVisible(c)},setSelection:function(c,a,b,e){var f=this._textView,h=f.getModel();h.getBaseModel&&
(this._expandOffset(c),this._expandOffset(a),c=h.mapOffset(c,!0),a=h.mapOffset(a,!0));f.setSelection(c,a,b,e)},moveSelection:function(c,a,b,e){var f=this._textView;this.setSelection(c,a||c,1/3,function(){(e===void 0||e)&&f.focus();b&&b()})},checkDirty:function(){this.setDirty(!this._undoStack.isClean())},reportStatus:function(c,a,b){this._statusReporter&&this._statusReporter(c,a,b)},_getTooltipInfo:function(c,a){var b=this._textView,e=this.getAnnotationModel();if(!e)return null;var f=this._annotationStyler;
if(!f)return null;var h=b.getOffsetAtLocation(c,a);if(h===-1)return null;h=this.mapOffset(h);f=f.getAnnotationsByType(e,h,h+1);e=[];for(h=0;h<f.length;h++)f[h].rangeStyle&&e.push(f[h]);if(e.length===0)return null;b=b.convert({x:c,y:a},"document","page");return{contents:e,anchor:"left",x:b.x+10,y:b.y+20}},_highlightCurrentLine:function(c,a){var g=this._annotationModel;if(g){var e=this._textView.getModel(),f=a?e.getLineAtOffset(a.start):-1,h=e.getLineAtOffset(c.start),i=c.start===c.end,t=!a||a.start===
a.end,m=e.getLineStart(h),d=e.getLineEnd(h);e.getBaseModel&&(m=e.mapOffset(m),d=e.mapOffset(d));e=this._currentLineAnnotation;if(!(f===h&&t&&i&&e&&e.start===m&&e.end===d)){var f=e?[e]:null,j;i&&(e=b.AnnotationType.createAnnotation(b.AnnotationType.ANNOTATION_CURRENT_LINE,m,d),j=[e]);this._currentLineAnnotation=e;g.replaceAnnotations(f,j)}}},installTextView:function(){this._textView=this._textViewFactory();if(this._undoStackFactory)this._undoStack=this._undoStackFactory.createUndoStack(this);if(this._textDNDFactory)this._textDND=
this._textDNDFactory.createTextDND(this,this._undoStack);if(this._contentAssistFactory){var c=this._contentAssistFactory.createContentAssistMode(this);this._keyModes.push(c);this._contentAssist=c.getContentAssist()}var a=this,g=this._textView,e=this;this._listener={onModelChanged:function(){e.checkDirty()},onMouseOver:function(a){e._listener.onMouseMove(a)},onMouseMove:function(a){var c=i.Tooltip.getTooltip(g);if(c&&!(e._listener.lastMouseX===a.event.clientX&&e._listener.lastMouseY===a.event.clientY))e._listener.lastMouseX=
a.event.clientX,e._listener.lastMouseY=a.event.clientY,c.setTarget({x:a.x,y:a.y,getTooltipInfo:function(){return e._getTooltipInfo(this.x,this.y)}})},onMouseOut:function(a){var c=i.Tooltip.getTooltip(g);if(c&&!(e._listener.lastMouseX===a.event.clientX&&e._listener.lastMouseY===a.event.clientY))e._listener.lastMouseX=a.event.clientX,e._listener.lastMouseY=a.event.clientY,c.setTarget(null)},onScroll:function(){var a=i.Tooltip.getTooltip(g);a&&a.setTarget(null)},onSelection:function(a){e._updateCursorStatus();
...
return!1}.bind(this));g.setAction("enter",function(){for(var a=0;a<this._keyModes.length;a++)if(this._keyModes[a].isActive())return this._keyModes[a].enter();return!1}.bind(this));c=function(c){if(c!==void 0&&c!==-1){for(var g=this.getView().getModel(),e=this.getAnnotationModel(),d=a.mapOffset(g.getLineStart(c)),c=a.mapOffset(g.getLineEnd(c)),g=e.getAnnotations(d,c),f=null;g.hasNext();){var h=g.next();if(h.type===b.AnnotationType.ANNOTATION_BOOKMARK){f=h;break}}f?e.removeAnnotation(f):(f=b.AnnotationType.createAnnotation(b.AnnotationType.ANNOTATION_BOOKMARK,
d,c),f.title=void 0,e.addAnnotation(f))}};if(this._annotationFactory){var f=g.getModel();f.getBaseModel&&(f=f.getBaseModel());if(this._annotationModel=this._annotationFactory.createAnnotationModel(f))if(f=this._annotationStyler=this._annotationFactory.createAnnotationStyler(g,this._annotationModel))f.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_SEARCH),f.addAnnotationType(b.AnnotationType.ANNOTATION_MATCHING_SEARCH),f.addAnnotationType(b.AnnotationType.ANNOTATION_ERROR),f.addAnnotationType(b.AnnotationType.ANNOTATION_WARNING),
f.addAnnotationType(b.AnnotationType.ANNOTATION_MATCHING_BRACKET),f.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_BRACKET),f.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_LINE),f.addAnnotationType(b.AnnotationType.ANNOTATION_READ_OCCURRENCE),f.addAnnotationType(b.AnnotationType.ANNOTATION_WRITE_OCCURRENCE),f.addAnnotationType("orion.annotation.highlightError");g.annotationModel=this._annotationModel;var f=this._annotationFactory.createAnnotationRulers(this._annotationModel),h=this._annotationRuler=
f.annotationRuler;if(h)h.onDblClick=c,h.setMultiAnnotationOverlay({html:"<div class='annotationHTML overlay'></div>"}),h.addAnnotationType(b.AnnotationType.ANNOTATION_ERROR),h.addAnnotationType(b.AnnotationType.ANNOTATION_WARNING),h.addAnnotationType(b.AnnotationType.ANNOTATION_TASK),h.addAnnotationType(b.AnnotationType.ANNOTATION_BOOKMARK);this.setAnnotationRulerVisible(!0);if(h=this._overviewRuler=f.overviewRuler)h.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_SEARCH),h.addAnnotationType(b.AnnotationType.ANNOTATION_MATCHING_SEARCH),
...
c=c.getLineStart(b);a-=c;for(c=0;c<this._keyModes.length;c++){var f=this._keyModes[c];if(f.isActive()&&f.isStatusActive&&f.isStatusActive())return}this.reportStatus(e.formatMessage(r.lineColumn,b+1,a+1))},showProblems:function(c){var a=this._annotationModel;if(a){for(var g=[],e=[],f=a.getTextModel(),h=a.getAnnotations(0,f.getCharCount()),i;h.hasNext();)i=h.next(),(i.type===b.AnnotationType.ANNOTATION_ERROR||i.type===b.AnnotationType.ANNOTATION_WARNING)&&g.push(i);if(c)for(h=0;h<c.length;h++)if(i=
c[h]){var m=i.description.replace(/'/g,"&#39;").replace(/"/g,"&#34;"),q=f.getLineStart(i.line-1);i=b.AnnotationType.createAnnotation(i.severity==="error"?b.AnnotationType.ANNOTATION_ERROR:b.AnnotationType.ANNOTATION_WARNING,q+i.start-1,q+i.end,m);e.push(i)}a.replaceAnnotations(g,e)}},showOccurrences:function(c){var a=this._annotationModel;if(a){for(var g=[],e=[],f=a.getTextModel(),h=a.getAnnotations(0,f.getCharCount()),i;h.hasNext();)i=h.next(),(i.type===b.AnnotationType.ANNOTATION_READ_OCCURRENCE||
i.type===b.AnnotationType.ANNOTATION_WRITE_OCCURRENCE)&&g.push(i);if(c)for(h=0;h<c.length;h++)if(i=c[h]){var m=f.getLineStart(i.line-1);i=b.AnnotationType.createAnnotation(i.readAccess===!0?b.AnnotationType.ANNOTATION_READ_OCCURRENCE:b.AnnotationType.ANNOTATION_WRITE_OCCURRENCE,m+i.start-1,m+i.end,i.description);e.push(i)}a.replaceAnnotations(g,e)}},showSelection:function(c,a,b,e,f){typeof c==="number"?(typeof a!=="number"&&(a=c),this.moveSelection(c,a)):typeof b==="number"&&(c=this.getModel().getLineStart(b-
1),typeof e==="number"&&(c+=e),typeof f!=="number"&&(f=0),this.moveSelection(c,c+f))},setInput:function(c,a,b,e){this._title=c;this._textView&&(e?(this._undoStack.markClean(),this.checkDirty()):(a?this._textView.setText(a):b!==null&&b!==void 0&&(this._textView.setText(b),this._textView.getModel().setLineDelimiter("auto"),this._highlightCurrentLine(this._textView.getSelection())),this._undoStack.reset(),this.checkDirty(),this._textView.focus()));this.onInputChanged({type:"InputChanged",title:c,message:a,
contents:b,contentsSaved:e})},onInputChanged:function(c){return this.dispatchEvent(c)},onGotoLine:function(c,a,b){if(this._textView){var e=this.getModel(),f=e.getLineStart(c),h=0;b===void 0&&(b=0);typeof a==="string"?(c=e.getLine(c).indexOf(a),c!==-1&&(h=c,b=h+a.length)):(h=a,a=e.getLineEnd(c)-f,h=Math.min(h,a),b=Math.min(b,a));this.moveSelection(f+h,f+b)}},onDirtyChanged:function(c){return this.dispatchEvent(c)}};m.EventTarget.addMixin(f.prototype);if(!Function.prototype.bind)Function.prototype.bind=
...
return!0}.bind(this),{name:r.incrementalFindKey});d.setAction("deletePrevious",function(){return this._incrementalFind.backspace()}.bind(this));d.setAction("tab",function(){if(d.getOptions("readonly"))return!1;if(d.getOptions("tabMode")){var a=this.editor,c=a.getModel(),b=a.getSelection(),e=c.getLineAtOffset(b.start),g=c.getLineAtOffset(b.end>b.start?b.end-1:b.end);if(e!==g){var f=[];f.push("");for(var h=e;h<=g;h++)f.push(c.getLine(h,!0));var h=c.getLineStart(e),c=c.getLineEnd(g,!0),j=d.getOptions("tabSize",
"expandTab"),j=j.expandTab?Array(j.tabSize+1).join(" "):"\t";a.setText(f.join(j),h,c);a.setSelection(h===b.start?b.start:b.start+j.length,b.end+(g-e+1)*j.length);return!0}a=a.getKeyModes();for(b=0;b<a.length;b++)if(a[b].isActive())return a[b].tab();return!1}}.bind(this));d.setAction("shiftTab",function(){if(d.getOptions("readonly"))return!1;if(d.getOptions("tabMode")){for(var a=this.editor,c=a.getModel(),b=a.getSelection(),e=c.getLineAtOffset(b.start),g=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),
f=d.getOptions("tabSize"),h=Array(f+1).join(" "),j=[],i=0,n=0,o=e;o<=g;o++){var p=c.getLine(o,!0);if(c.getLineStart(o)!==c.getLineEnd(o))if(p.indexOf("\t")===0)p=p.substring(1),i++;else if(p.indexOf(h)===0)p=p.substring(f),i+=f;else return!0;o===e&&(n=i);j.push(p)}e=c.getLineStart(e);f=c.getLineEnd(g,!0);c=c.getLineStart(g);a.setText(j.join(""),e,f);j=e===b.start?b.start:b.start-n;b=Math.max(j,b.end-i+(b.end===c+1&&b.start!==b.end?1:0));a.setSelection(j,b);return!0}}.bind(this),{name:r.unindentLines});
d.setKeyBinding(new m.KeyBinding(38,!1,!1,!0),"moveLinesUp");d.setAction("moveLinesUp",function(){if(d.getOptions("readonly"))return!1;var a=this.editor,c=a.getModel(),b=a.getSelection(),e=c.getLineAtOffset(b.start);if(e===0)return!0;var f=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),g=c.getLineCount(),b=c.getLineStart(e-1),h=c.getLineStart(e),j=c.getLineEnd(f,!0),i=c.getText(h,j),n=0;f===g-1&&(f=c.getLineEnd(e-1),e=c.getLineEnd(e-1,!0),i+=c.getText(f,e),h=f,n=e-f);this.startUndo();a.setText("",
h,j);a.setText(i,b,b);a.setSelection(b,b+i.length-n);this.endUndo();return!0}.bind(this),{name:r.moveLinesUp});d.setKeyBinding(new m.KeyBinding(40,!1,!1,!0),"moveLinesDown");d.setAction("moveLinesDown",function(){if(d.getOptions("readonly"))return!1;var a=this.editor,c=a.getModel(),b=a.getSelection(),e=c.getLineAtOffset(b.start),f=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),g=c.getLineCount();if(f===g-1)return!0;var e=c.getLineStart(e),b=c.getLineEnd(f,!0),h=c.getLineEnd(f+1,!0)-(b-e),j=0;f!==
g-2?c=c.getText(e,b):(f=c.getLineEnd(f),c=c.getText(f,b)+c.getText(e,f),j+=b-f);this.startUndo();a.setText("",e,b);a.setText(c,h,h);a.setSelection(h+j,h+j+c.length);this.endUndo();return!0}.bind(this),{name:r.moveLinesDown});d.setKeyBinding(new m.KeyBinding(38,!0,!1,!0),"copyLinesUp");d.setAction("copyLinesUp",function(){if(d.getOptions("readonly"))return!1;var a=this.editor,c=a.getModel(),b=a.getSelection(),e=c.getLineAtOffset(b.start),b=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),e=c.getLineStart(e),
f=c.getLineEnd(b,!0),g=c.getLineCount(),h="",f=c.getText(e,f);b===g-1&&(f+=h=c.getLineDelimiter());a.setText(f,e,e);a.setSelection(e,e+f.length-h.length);return!0}.bind(this),{name:r.copyLinesUp});d.setKeyBinding(new m.KeyBinding(40,!0,!1,!0),"copyLinesDown");d.setAction("copyLinesDown",function(){if(d.getOptions("readonly"))return!1;var a=this.editor,c=a.getModel(),b=a.getSelection(),e=c.getLineAtOffset(b.start),b=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),f=c.getLineStart(e),e=c.getLineEnd(b,
!0),g=c.getLineCount(),h="",f=c.getText(f,e);b===g-1&&(f=(h=c.getLineDelimiter())+f);a.setText(f,e,e);a.setSelection(e+h.length,e+f.length);return!0}.bind(this),{name:r.copyLinesDown});d.setKeyBinding(new m.KeyBinding("d",!0,!1,!1),"deleteLines");d.setAction("deleteLines",function(){if(d.getOptions("readonly"))return!1;var a=this.editor,c=a.getSelection(),b=a.getModel(),e=b.getLineAtOffset(c.start),c=b.getLineAtOffset(c.end>c.start?c.end-1:c.end),e=b.getLineStart(e),b=b.getLineEnd(c,!0);a.setText("",
...
f=c.getCaretOffset(),g=e.getLineAtOffset(f),f=e.getLineStart(g),g=e.getLineEnd(g,!0);e.getBaseModel&&(f=e.mapOffset(f),g=e.mapOffset(g),e.getBaseModel());for(var h,e=d.getAnnotations(f,g);!h&&e.hasNext();)f=e.next(),f.type===b.AnnotationType.ANNOTATION_FOLDING&&(h=f);h&&a!==h.expanded&&(a?h.expand():(c.setCaretOffset(h.start),h.collapse()),d.modifyAnnotation(h));return!0},expandAnnotations:function(a){var c=this.editor,d=c.getTextView(),e=c.getAnnotationModel();if(!e)return!0;var c=c.getModel(),f=
e.getAnnotations(0,c.getCharCount());for(d.setRedraw(!1);f.hasNext();)c=f.next(),c.type===b.AnnotationType.ANNOTATION_FOLDING&&a!==c.expanded&&(a?c.expand():c.collapse(),e.modifyAnnotation(c));d.setRedraw(!0);return!0},startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()},cancel:function(){this._incrementalFind.setActive(!1)},isActive:function(){return this._incrementalFind.isActive()},isStatusActive:function(){return this._incrementalFind.isActive()},
lineUp:function(){return this._incrementalFind.find(!1)},lineDown:function(){return this._incrementalFind.find(!0)},enter:function(){return!1}};v.prototype={startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()},init:function(){function a(c,d,b){var e=c.getLineAtOffset(d),f=c.getLineAtOffset(b),g,h,j,i,n,l;for(g=e;g>=0;g--)if(h=c.getLine(g),j=g===e?d-c.getLineStart(e):h.length,i=h.lastIndexOf("/*",j),h=h.lastIndexOf("*/",
j),h>i)break;else if(i!==-1){n=c.getLineStart(g)+i;break}for(g=f;g<c.getLineCount();g++)if(h=c.getLine(g),j=g===f?b-c.getLineStart(f):0,i=h.indexOf("/*",j),h=h.indexOf("*/",j),i!==-1&&i<h)break;else if(h!==-1){l=c.getLineStart(g)+h;break}return{commentStart:n,commentEnd:l}}var d=this.editor.getTextView();d.setAction("lineStart",function(){for(var a=this.editor,c=a.getModel(),d=a.getCaretOffset(),b=c.getLineAtOffset(d),e=c.getLineStart(b),c=c.getLine(b),b=0;b<c.length;b++){var f=c.charCodeAt(b);if(!(f===
32||f===9))break}b+=e;return d!==b?(a.setSelection(b,b),!0):!1}.bind(this));d.setKeyBinding(new m.KeyBinding(191,!0),"toggleLineComment");d.setAction("toggleLineComment",function(){if(d.getOptions("readonly"))return!1;for(var a=this.editor,c=a.getModel(),b=a.getSelection(),e=c.getLineAtOffset(b.start),f=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),g=!0,h=[],j,i,n=e;n<=f;n++)if(j=c.getLine(n,!0),h.push(j),!g||(i=j.indexOf("//"))===-1)g=!1;else if(i!==0){var o;for(o=0;o<i;o++)if(g=j.charCodeAt(o),
!(g===32||g===9))break;g=o===i}n=c.getLineStart(e);o=c.getLineEnd(f,!0);if(g){for(g=0;g<h.length;g++)j=h[g],i=j.indexOf("//"),h[g]=j.substring(0,i)+j.substring(i+2);h=h.join("");j=c.getLineStart(f);c=n===b.start?b.start:b.start-2;b=b.end-2*(f-e+1)+(b.end===j+1?2:0)}else h.splice(0,0,""),h=h.join("//"),c=n===b.start?b.start:b.start+2,b=b.end+2*(f-e+1);a.setText(h,n,o);a.setSelection(c,b);return!0}.bind(this),{name:r.toggleLineComment});d.setKeyBinding(new m.KeyBinding(191,!0,!c.isMac,!1,c.isMac),"addBlockComment");
d.setAction("addBlockComment",function(){if(d.getOptions("readonly"))return!1;var c=this.editor,b=c.getModel(),e=c.getSelection(),f=RegExp("/\\*|\\*/","g"),g=a(b,e.start,e.end);if(g.commentStart!==void 0&&g.commentEnd!==void 0)return!0;b=b.getText(e.start,e.end);if(b.length===0)return!0;g=b.length;b=b.replace(f,"");f=b.length;c.setText("/*"+b+"*/",e.start,e.end);c.setSelection(e.start+2,e.end+2+(f-g));return!0}.bind(this),{name:r.addBlockComment});d.setKeyBinding(new m.KeyBinding(220,!0,!c.isMac,
!1,c.isMac),"removeBlockComment");d.setAction("removeBlockComment",function(){if(d.getOptions("readonly"))return!1;var c=this.editor,b=c.getModel(),e=c.getSelection(),f=b.getText(e.start,e.end),g,h,i;for(i=0;i<f.length;i++)if(f.substring(i,i+2)==="/*"){g=e.start+i;break}for(;i<f.length;i++)if(f.substring(i,i+2)==="*/"){h=e.start+i;break}if(g!==void 0&&h!==void 0)c.setText(b.getText(g+2,h),g,h+2),c.setSelection(g,h);else{f=a(b,e.start,e.end);if(f.commentStart===void 0||f.commentEnd===void 0)return!0;
b=b.getText(f.commentStart+2,f.commentEnd);c.setText(b,f.commentStart,f.commentEnd+2);c.setSelection(e.start-2,e.end-2)}return!0}.bind(this),{name:r.removeBlockComment})},contentAssistProposalApplied:function(a){a=a.data.proposal;if(a.positions&&this.linkedMode){for(var c=[],d=0;d<a.positions.length;++d)c[d]={positions:[{offset:a.positions[d].offset,length:a.positions[d].length}]};this.linkedMode.enterLinkedMode({groups:c,escapePosition:a.escapePosition})}else a.escapePosition&&this.editor.getTextView().setCaretOffset(a.escapePosition);
return!0},cancel:function(){return!1},isActive:function(){return!0},isStatusActive:function(){return!1},lineUp:function(){return!1},lineDown:function(){return!1},enter:function(){if(this.editor.getTextView().getOptions("readonly"))return!1;var a=this.editor,c=a.getSelection();if(c.start===c.end){for(var d=a.getModel(),b=d.getLineAtOffset(c.start),e=d.getLine(b,!0),f=d.getLineStart(b),b=0,f=c.start-f,g;b<f&&((g=e.charCodeAt(b))===32||g===9);)b++;if(b>0){for(var h=e.substring(0,b),b=f;b<e.length&&((g=
e.charCodeAt(b++))===32||g===9);)c.end++;a.setText(d.getLineDelimiter()+h,c.start,c.end);return!0}}return!1},tab:function(){return!1}};d.prototype={enterLinkedMode:function(a){if(!this.linkedModeActive){this.linkedModeActive=!0;this.linkedModePositions=[];for(var c=0;c<a.groups.length;++c){var d=a.groups[c];this.linkedModePositions[c]={offset:d.positions[0].offset,length:d.positions[0].length}}this.linkedModeEscapePosition=a.escapePosition;this.linkedModeCurrentPositionIndex=0;this.selectTextForLinkedModePosition(this.linkedModePositions[this.linkedModeCurrentPositionIndex]);
...
!1;var e=this.textView.getOptions("parent").ownerDocument;this.parentNode=typeof c==="string"?e.getElementById(c):c;if(!this.parentNode){this.parentNode=b.createElement(e,"div");this.parentNode.className="contentassist";var f=e.getElementsByTagName("body")[0];if(f)f.appendChild(this.parentNode);else throw Error("parentNode is required");}var g=this;this.textViewListener={onMouseDown:function(a){a.event.target.parentElement!==g.parentNode&&g.contentAssist.deactivate()}};this.contentAssist.addEventListener("ProposalsComputed",
...
null)},tab:function(){return this.widget?(this.widget.createAccessible(this),this.widget.parentNode.focus(),!0):!1}};g.prototype={onClick:function(a){this.contentAssist.apply(this.getProposal(a.target));this.textView.focus()},createDiv:function(a,c,e,f){var g=e.ownerDocument,d=b.createElement(g,"div");d.id="contentoption"+f;d.setAttribute("role","option");a.style==="hr"?a=b.createElement(g,"hr"):(d.className=this.calculateClasses(a.style,c),a=g.createTextNode(this.getDisplayString(a)),c&&this.parentNode.setAttribute("aria-activedescendant",
...
a:a.description&&typeof a.description==="string"?a.description:a.proposal},getProposal:function(a){for(var c=0,b=this.parentNode.firstChild;b!==null;b=b.nextSibling){if(b===a)return this.proposals[c]||null;c++}return null},setSelectedIndex:function(a){this.selectedIndex=a;this.selectNode(this.parentNode.childNodes[this.selectedIndex])},selectNode:function(a){for(var c=this.parentNode.childNodes,b=0;b<c.length;b++){var e=c[b],f=e.className.indexOf(p.selected);if(f>=0)e.className=e.className.substring(0,
f)+e.className.substring(f+p.selected.length);e===a&&(e.className+=p.selected,this.parentNode.setAttribute("aria-activedescendant",e.id),e.focus(),e.offsetTop<this.parentNode.scrollTop?e.scrollIntoView(!0):e.offsetTop+e.offsetHeight>this.parentNode.scrollTop+this.parentNode.clientHeight&&e.scrollIntoView(!1))}},setProposals:function(a){this.proposals=a},show:function(){if(this.proposals.length===0)this.hide();else{this.parentNode.innerHTML="";for(var a=0;a<this.proposals.length;a++)this.createDiv(this.proposals[a],
...
[],d=a.getBaseModel(),e=this.comments,f=0;f<e.length;f++){var g=e[f];(g=this._createFoldingAnnotation(a,d,g.start,g.end))&&c.push(g)}b.replaceAnnotations(null,c)}}}},_createFoldingAnnotation:function(a,b,c,d){var e=b.getLineAtOffset(c),b=b.getLineAtOffset(d);return e===b?null:new (r.AnnotationType.getType(r.AnnotationType.ANNOTATION_FOLDING))(c,d,a)},_computeTasks:function(a,b,c){if(this.detectTasks){var d=this.annotationModel;if(d){var e=this.view.getModel(),f=e;e.getBaseModel&&(f=e.getBaseModel());
for(var g=d.getAnnotations(b,c),e=[],h=r.AnnotationType.ANNOTATION_TASK;g.hasNext();){var i=g.next();i.type===h&&e.push(i)}g=[];i=this._commentScanner;i.setText(f.getText(b,c));for(var j;j=i.nextToken();){var l=i.getStartOffset()+b;j===14&&(j=f.getLineEnd(f.getLineAtOffset(l)),a!==6&&(j=Math.min(j,c-this.commentEnd.length)),g.push(r.AnnotationType.createAnnotation(h,l,j,f.getText(l,j))))}d.replaceAnnotations(e,g)}}},_getLineStyle:function(a){if(this.highlightCaretLine){var b=this.view,c=b.getModel(),
b=b.getSelection();if(b.start===b.end&&c.getLineAtOffset(b.start)===a)return u}return null},_getStyles:function(a,b,c){a.getBaseModel&&(c=a.mapOffset(c));for(var d=c+b.length,e=[],f=c,h=this.comments,i=this._binarySearch(h,c,!0);i<h.length;i++){if(h[i].start>=d)break;var j=h[i].start,l=h[i].end;f<j&&this._parse(b.substring(f-c,j-c),f,e);var n=h[i].type,m;switch(n){case 8:m=p;break;case 7:m=g;break;case 5:m=t}f=Math.max(f,j);j=Math.min(d,l);(n===8||n===7)&&(this.whitespacesVisible||this.detectHyperlinks)?
this._parseComment(b.substring(f-c,j-c),f,e,m,n):n===5&&this.whitespacesVisible?this._parseString(b.substring(f-c,j-c),f,e,t):e.push({start:f,end:j,style:m});f=l}f<d&&this._parse(b.substring(f-c,d-c),f,e);if(a.getBaseModel)for(b=0;b<e.length;b++)c=e[b].end-e[b].start,e[b].start=a.mapOffset(e[b].start,!0),e[b].end=e[b].start+c;return e},_parse:function(b,c,e){var f=this._scanner;for(f.setText(b);b=f.nextToken();){var h=f.getStartOffset()+c,i=null;switch(b){case 2:i=d;break;case 3:i=v;break;case 5:case 4:if(this.whitespacesVisible){this._parseString(f.getData(),
h,e,t);continue}else i=t;break;case 8:this._parseComment(f.getData(),h,e,p,b);continue;case 6:this._parseComment(f.getData(),h,e,a,b);continue;case 7:this._parseComment(f.getData(),h,e,g,b);continue;case 10:this.whitespacesVisible&&(i=l);break;case 11:this.whitespacesVisible&&(i=j)}e.push({start:h,end:f.getOffset()+c,style:i})}},_parseComment:function(a,b,c,d,e){var f=this._commentScanner;f.setText(a);for(f.setType(e);a=f.nextToken();){var e=f.getStartOffset()+b,g=d;switch(a){case 10:this.whitespacesVisible&&
(g=l);break;case 11:this.whitespacesVisible&&(g=j);break;case 12:g=n;break;case 13:g=s;break;case 14:g=o;break;default:this.detectHyperlinks&&(g=this._detectHyperlinks(f.getData(),e,c,g))}g&&c.push({start:e,end:f.getOffset()+b,style:g})}},_parseString:function(a,b,c,d){var e=this._whitespaceScanner;for(e.setText(a);a=e.nextToken();){var f=e.getStartOffset()+b,g=d;switch(a){case 10:this.whitespacesVisible&&(g=l);break;case 11:this.whitespacesVisible&&(g=j)}g&&c.push({start:f,end:e.getOffset()+b,style:g})}},
...
switch(b){case "js":case "java":case "css":this.styler=new k.TextStyler(d,b,e);c.setFoldingRulerVisible(a.showFoldingRuler===void 0||a.showFoldingRuler);break;case "html":this.styler=new l.TextMateStyler(d,new u.HtmlGrammar)}}}}).highlight(a.lang,d);if(g){var h=new s.CssContentAssistProvider,j=new v.JSTemplateContentAssistProvider;g.addEventListener("Activating",function(){/css$/.test(a.lang)?g.setProviders([h]):/js$/.test(a.lang)&&g.setProviders([j])})}if(J(b)<=50)c=d.getTextView().computeSize().height,
b.style.height=c+"px";return d}var G=this.orion?this.orion.editor:void 0;if(G)for(var C=0;C<arguments.length;C++)E(G,arguments[C]);return F});define(["orion/editor/edit"],function(r){return r});