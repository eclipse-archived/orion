/*
 ...
 IBM Corporation - initial API and implementation
*/
(function(){function k(b,d,i,e,f,a){d[b]&&(i.push(b),(d[b]===!0||d[b]===1)&&e.push(f+b+"/"+a))}function p(b,d,i,e,f){d=e+d+"/"+f;require._fileExists(b.toUrl(d+".js"))&&i.push(d)}function o(b,d,i){for(var e in d)d.hasOwnProperty(e)&&(!b.hasOwnProperty(e)||i)?b[e]=d[e]:typeof d[e]==="object"&&o(b[e],d[e],i)}var e=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(b){var d=b.config?b.config():{};return{version:"2.0.1+",load:function(b,j,f,a){a=a||{};if(a.locale)d.locale=a.locale;
var c=e.exec(b),h=c[1],m=c[4],l=c[5],n=m.split("-"),q=[],r={},t,u="";if(c[5])h=c[1],b=h+l;else{l=c[4];m=d.locale;if(!m)m=d.locale=typeof navigator==="undefined"?"root":(navigator.language||navigator.userLanguage||"root").toLowerCase();n=m.split("-")}if(a.isBuild){q.push(b);p(j,"root",q,h,l);for(t=0;t<n.length;t++)a=n[t],u+=(u?"-":"")+a,p(j,u,q,h,l);j(q,function(){f()})}else j([b],function(g){var s=[],a;k("root",g,s,q,h,l);for(t=0;t<n.length;t++)a=n[t],u+=(u?"-":"")+a,k(u,g,s,q,h,l);j(q,function(){var a,
c,d;for(a=s.length-1;a>-1&&s[a];a--){d=s[a];c=g[d];if(c===!0||c===1)c=j(h+d+"/"+l);o(r,c)}f(r)})})}}})})();define("orion/editor/i18n",{load:function(k,p,o){p.specified&&p.specified("orion/bootstrap")?p(["orion/i18n!"+k],function(e){o(e)}):o({})}});
...
o){var e=this._eventTypes?this._eventTypes[k]:null;if(e){var b=e.listeners;try{if(e.level++,b)for(var d=0,i=b.length;d<i;d++)if(b[d]){var j=b[d].listener;typeof j==="function"?j.call(this,o):j.handleEvent&&typeof j.handleEvent==="function"&&j.handleEvent(o)}}finally{if(e.level--,e.compact&&e.level===0){for(d=b.length-1;d>=0;d--)b[d]||b.splice(d,1);b.length===0&&delete this._eventTypes[k];e.compact=!1}}}},isListening:function(k){return!this._eventTypes?!1:this._eventTypes[k]!==void 0},removeEventListener:function(k,
o,e){if(this._eventTypes){var b=this._eventTypes[k];if(b){for(var d=b.listeners,i=0,j=d.length;i<j;i++){var f=d[i];if(f&&f.listener===o&&f.useCapture===e){b.level!==0?(d[i]=null,b.compact=!0):d.splice(i,1);break}}d.length===0&&delete this._eventTypes[k]}}}};return{EventTarget:k}});
define("orion/util",[],function(){var k=navigator.userAgent,p=parseFloat(k.split("MSIE")[1])||void 0,o=parseFloat(k.split("Firefox/")[1]||k.split("Minefield/")[1])||void 0,e=k.indexOf("Opera")!==-1,b=parseFloat(k.split("Chrome/")[1])||void 0,d=k.indexOf("Safari")!==-1&&!b,i=parseFloat(k.split("WebKit/")[1])||void 0,j=k.indexOf("Android")!==-1,f=k.indexOf("iPad")!==-1,k=k.indexOf("iPhone")!==-1,a=f||k,c=navigator.platform.indexOf("Mac")!==-1,h=navigator.platform.indexOf("Win")!==-1,m=navigator.platform.indexOf("Linux")!==
-1;return{formatMessage:function(a){var c=arguments;return a.replace(/\$\{([^\}]+)\}/g,function(a,d){return c[(d<<0)+1]})},createElement:function(a,c){return a.createElementNS?a.createElementNS("http://www.w3.org/1999/xhtml",c):a.createElement(c)},isIE:p,isFirefox:o,isOpera:e,isChrome:b,isSafari:d,isWebkit:i,isAndroid:j,isIPad:f,isIPhone:k,isIOS:a,isMac:c,isWindows:h,isLinux:m,platformDelimiter:h?"\r\n":"\n"}});
define("orion/editor/textModel",["orion/editor/eventTarget","orion/util"],function(k,p){function o(e,b){this._lastLineIndex=-1;this._text=[""];this._lineOffsets=[0];this.setText(e);this.setLineDelimiter(b)}o.prototype={find:function(e){if(this._text.length>1)this._text=[this._text.join("")];var b=e.string,d=b,i=e.caseInsensitive;!e.regex&&b&&(d=b.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&"),i&&(d=d.replace(/[iI\u0130\u0131]/g,"[Ii\u0130\u0131]")));var j=null,f;if(d){var b=e.reverse,a=e.wrap,c=e.wholeWord,
h=e.start||0,e=e.end,m=e!==null&&e!==void 0,l="";l.indexOf("g")===-1&&(l+="g");i&&l.indexOf("i")===-1&&(l+="i");c&&(d="\\b"+d+"\\b");var n=this._text[0],q,r,k=0;m&&(i=h<e?h:e,n=n.substring(i,h<e?e:h),k=i);var o=RegExp(d,l);if(b)f=function(){var g=null;for(o.lastIndex=0;;){r=o.lastIndex;q=o.exec(n);if(r===o.lastIndex)return null;if(q){if(!(q.index+k<h)){if(!a||g)break;h=n.length+k}g={start:q.index+k,end:o.lastIndex+k}}else break}if(g)h=g.start;return g};else{if(!m)o.lastIndex=h;f=function(){for(;;){r=
o.lastIndex;q=o.exec(n);if(r===o.lastIndex)break;if(q)return{start:q.index+k,end:o.lastIndex+k};if(!(r!==0&&a))break}return null}}j=f()}return{next:function(){var g=j;g&&(j=f());return g},hasNext:function(){return j!==null}}},getCharCount:function(){for(var e=0,b=0;b<this._text.length;b++)e+=this._text[b].length;return e},getLine:function(e,b){var d=this.getLineCount();if(!(0<=e&&e<d))return null;var i=this._lineOffsets[e];if(e+1<d){d=this.getText(i,this._lineOffsets[e+1]);if(b)return d;for(var i=
d.length,j;(j=d.charCodeAt(i-1))===10||j===13;)i--;return d.substring(0,i)}else return this.getText(i)},getLineAtOffset:function(e){var b=this.getCharCount();if(!(0<=e&&e<=b))return-1;var d=this.getLineCount();if(e===b)return d-1;var i,j,f=this._lastLineIndex;if(0<=f&&f<d&&(i=this._lineOffsets[f],j=f+1<d?this._lineOffsets[f+1]:b,i<=e&&e<j))return f;for(var a=d,c=-1;a-c>1;)if(f=Math.floor((a+c)/2),i=this._lineOffsets[f],j=f+1<d?this._lineOffsets[f+1]:b,e<=i)a=f;else if(e<j){a=f;break}else c=f;return this._lastLineIndex=
a},getLineCount:function(){return this._lineOffsets.length},getLineDelimiter:function(){return this._lineDelimiter},getLineEnd:function(e,b){var d=this.getLineCount();if(!(0<=e&&e<d))return-1;if(e+1<d){d=this._lineOffsets[e+1];if(b)return d;for(var i=this.getText(Math.max(this._lineOffsets[e],d-2),d),j=i.length,f;(f=i.charCodeAt(j-1))===10||f===13;)j--;return d-(i.length-j)}else return this.getCharCount()},getLineStart:function(e){return!(0<=e&&e<this.getLineCount())?-1:this._lineOffsets[e]},getText:function(e,
b){e===void 0&&(e=0);b===void 0&&(b=this.getCharCount());if(e===b)return"";for(var d=0,i=0,j;i<this._text.length;){j=this._text[i].length;if(e<=d+j)break;d+=j;i++}for(var f=d,a=i;i<this._text.length;){j=this._text[i].length;if(b<=d+j)break;d+=j;i++}if(a===i)return this._text[a].substring(e-f,b-d);f=this._text[a].substring(e-f);d=this._text[i].substring(0,b-d);return f+this._text.slice(a+1,i).join("")+d},onChanging:function(e){return this.dispatchEvent(e)},onChanged:function(e){return this.dispatchEvent(e)},
setLineDelimiter:function(e,b){e==="auto"&&(e=void 0,this.getLineCount()>1&&(e=this.getText(this.getLineEnd(0),this.getLineEnd(0,!0))));this._lineDelimiter=e?e:p.platformDelimiter;if(b){var d=this.getLineCount();if(d>1){for(var i=Array(d),j=0;j<d;j++)i[j]=this.getLine(j);this.setText(i.join(this._lineDelimiter))}}},setText:function(e,b,d){e===void 0&&(e="");b===void 0&&(b=0);d===void 0&&(d=this.getCharCount());if(!(b===d&&e==="")){for(var i=this.getLineAtOffset(b),j=this.getLineAtOffset(d),f=b,a=
d-b,c=j-i,h=e.length,m=0,l=this.getLineCount(),n=0,q=0,r=0,k=[];;){n!==-1&&n<=r&&(n=e.indexOf("\r",r));q!==-1&&q<=r&&(q=e.indexOf("\n",r));if(q===-1&&n===-1)break;r=n!==-1&&q!==-1?n+1===q?q+1:(n<q?n:q)+1:n!==-1?n+1:q+1;k.push(b+r);m++}this.onChanging({type:"Changing",text:e,start:f,removedCharCount:a,addedCharCount:h,removedLineCount:c,addedLineCount:m});k.length===0&&(r=this.getLineStart(i),j=j+1<l?this.getLineStart(j+1):this.getCharCount(),b!==r&&(e=this.getText(r,b)+e,b=r),d!==j&&(e+=this.getText(d,
j),d=j));r=h-a;for(j=i+c+1;j<l;j++)this._lineOffsets[j]+=r;if(k.length<5E4)i=[i+1,c].concat(k),Array.prototype.splice.apply(this._lineOffsets,i);else{r=i+1;this._lineOffsets.splice(r,c);for(l=0;l<k.length;l+=5E4)i=[r,0].concat(k.slice(l,Math.min(k.length,l+5E4))),Array.prototype.splice.apply(this._lineOffsets,i),r+=5E4}for(r=l=0;r<this._text.length;){j=this._text[r].length;if(b<=l+j)break;l+=j;r++}i=l;for(k=r;r<this._text.length;){j=this._text[r].length;if(d<=l+j)break;l+=j;r++}j=this._text[r];b=
this._text[k].substring(0,b-i);d=j.substring(d-l);k=[k,r-k+1];b&&k.push(b);e&&k.push(e);d&&k.push(d);Array.prototype.splice.apply(this._text,k);if(this._text.length===0)this._text=[""];this.onChanged({type:"Changed",start:f,removedCharCount:a,addedCharCount:h,removedLineCount:c,addedLineCount:m})}}};k.EventTarget.addMixin(o.prototype);return{TextModel:o}});
define("orion/keyBinding",["orion/util"],function(k){function p(e,b,d,i,j,f){this.type=f||"keydown";this.keyCode=typeof e==="string"&&this.type==="keydown"?e.toUpperCase().charCodeAt(0):e;this.mod1=b!==void 0&&b!==null?b:!1;this.mod2=d!==void 0&&d!==null?d:!1;this.mod3=i!==void 0&&i!==null?i:!1;this.mod4=j!==void 0&&j!==null?j:!1}function o(e){this.keys=e}p.prototype={getKeys:function(){return[this]},match:function(e,b){if(b!==void 0){if(b!==0)return!1}else if(e instanceof Array){if(e.length>1)return!1;
...
keyBinding:new k.KeyBinding("w",!0,!1,!0)});d.push({actionID:"toggleOverwriteMode",keyBinding:new k.KeyBinding(45)});if(!p.isFirefox){var i=p.isMac&&p.isChrome;d.push({actionID:"noop",keyBinding:new b("u",!i,!1,!1,i),predefined:!0});d.push({actionID:"noop",keyBinding:new b("i",!i,!1,!1,i),predefined:!0});d.push({actionID:"noop",keyBinding:new b("b",!i,!1,!1,i),predefined:!0})}p.isFirefox&&(d.push({actionID:"copy",keyBinding:new b(45,!0),predefined:!0}),d.push({actionID:"paste",keyBinding:new b(45,
...
define("orion/editor/textTheme",["require","orion/editor/eventTarget","orion/util"],function(k,p,o){function e(d){d=d||{};this._document=d.document||document}var b={};e.getTheme=function(d){var d=d||"default",i=b[d];i||(i=b[d]=new e);return i};e.prototype={getThemeClass:function(){return this._themeClass},setThemeClass:function(d,b){var e=this,f=e._themeClass;e._themeClass=d;this._load(d,b,function(){e.onThemeChanged({type:"ThemeChanged",oldValue:f,newValue:e.getThemeClass()})})},onThemeChanged:function(d){return this.dispatchEvent(d)},
...
define("orion/editor/textView","i18n!orion/editor/nls/messages,orion/editor/textModel,orion/editor/keyModes,orion/editor/eventTarget,orion/editor/textTheme,orion/util".split(","),function(k,p,o,e,b,d){function i(g,s,a,c){typeof g.addEventListener==="function"?g.addEventListener(s,a,c===!0):g.attachEvent("on"+s,a)}function j(g,s,a){if(a){s.className="";for(var a=s.attributes,c=a.length;c-- >0;)(!d.isIE||d.isIE>=9||d.isIE<9&&a[c].specified)&&s.removeAttribute(a[c].name)}if(g){if(g.styleClass)s.className=
g.styleClass;if(a=g.style)for(var b in a)a.hasOwnProperty(b)&&(s.style[b]=a[b]);if(g=g.attributes)for(var h in g)g.hasOwnProperty(h)&&s.setAttribute(h,g[h])}}function f(g){return g instanceof Array?g.slice(0):g}function a(g,s){if(!g)return s;if(!s)return g;for(var a in s)s.hasOwnProperty(a)&&(g.hasOwnProperty(a)||(g[a]=s[a]));return g}function c(g,s){if(g===s)return!0;if(g&&!s||!g&&s)return!1;if(g&&g.constructor===String||s&&s.constructor===String)return!1;if(g instanceof Array||s instanceof Array){if(!(g instanceof
Array&&s instanceof Array))return!1;if(g.length!==s.length)return!1;for(var a=0;a<g.length;a++)if(!c(g[a],s[a]))return!1;return!0}if(!(g instanceof Object)||!(s instanceof Object))return!1;for(a in g)if(g.hasOwnProperty(a)){if(!s.hasOwnProperty(a))return!1;if(!c(g[a],s[a]))return!1}for(a in s)if(!g.hasOwnProperty(a))return!1;return!0}function h(g,s,a){for(var c=0,d=0,b=0,h=g.length;b<h;){c!==-1&&c<=b&&(c=g.indexOf("\r",b));d!==-1&&d<=b&&(d=g.indexOf("\n",b));var f=b,m;if(d===-1&&c===-1){s(g.substring(b));
...
d=g.currentStyle.paddingBottom;return{left:parseInt(s,10)||0,top:parseInt(a,10)||0,right:parseInt(c,10)||0,bottom:parseInt(d,10)||0}}function l(g){var s,a,c,d,b=g._trim;if(!b){var b=m(g),h=g.ownerDocument.defaultView||g.ownerDocument.parentWindow;if(h.getComputedStyle)d=h.getComputedStyle(g,null),s=d.getPropertyValue("border-left-width"),a=d.getPropertyValue("border-top-width"),c=d.getPropertyValue("border-right-width"),d=d.getPropertyValue("border-bottom-width");else if(g.currentStyle)s=g.currentStyle.borderLeftWidth,
a=g.currentStyle.borderTopWidth,c=g.currentStyle.borderRightWidth,d=g.currentStyle.borderBottomWidth;s=parseInt(s,10)||0;a=parseInt(a,10)||0;c=parseInt(c,10)||0;d=parseInt(d,10)||0;b.left+=s;b.top+=a;b.right+=c;b.bottom+=d;g._trim=b}return b}function n(g,s,a){this.start=g;this.end=s;this.caret=a}function q(g){this.left=g.left;this.top=g.top;this.right=g.right;this.bottom=g.bottom}function r(g,s,a){this.view=g;this.lineIndex=s;this._lineDiv=a}function t(g){this._init(g||{})}var u=function(){function g(g){this.options=
g}g.prototype.play=function(){var g=typeof this.options.duration==="number"?this.options.duration:350,a=this.options.easing||this.defaultEasing,c=this.options.onAnimate||function(){},d=this.options.curve[0],b=this.options.curve[1],h=b-d,f=-1,m,l=this;this.interval=this.options.window.setInterval(function(){f=f===-1?(new Date).getTime():f;var n=((new Date).getTime()-f)/g;n<1?(n=a(n),m=d+n*h,c(m)):(c(b),l.stop())},typeof this.options.rate==="number"?this.options.rate:20)};g.prototype.stop=function(){this.options.window.clearInterval(this.interval);
(this.options.onEnd||function(){})()};g.prototype.defaultEasing=function(g){return Math.sin(g*(Math.PI/2))};return g}();n.prototype={clone:function(){return new n(this.start,this.end,this.caret)},collapse:function(){this.caret?this.end=this.start:this.start=this.end},extend:function(g){this.caret?this.start=g:this.end=g;if(this.start>this.end)g=this.start,this.start=this.end,this.end=g,this.caret=!this.caret},setCaret:function(g){this.end=this.start=g;this.caret=!1},getCaret:function(){return this.caret?
...
this;return c}},_createLine:function(g,a,b){var w=this.view,h=w._model,f=h.getLine(b),m=h.getLineStart(b),l={type:"LineStyle",textView:w,lineIndex:b,lineText:f,lineStart:m};if(f.length<2E3)w.onLineStyle(l);h=a||d.createElement(g.ownerDocument,"div");if(!a||!c(a.viewStyle,l.style)){j(l.style,h,a);if(a)a._trim=null;h.viewStyle=l.style;h.setAttribute("role","presentation")}h.lineIndex=b;b=[];this._createRanges(l.ranges,f,0,f.length,m,{tabOffset:0,ranges:b});f=" ";!w._fullSelection&&d.isIE<9&&(f="\ufeff");
d.isWebkit&&(f="\u200c");l={text:f,style:w._metrics.largestFontStyle,ignoreChars:1};b.length===0||!b[b.length-1].style||b[b.length-1].style.tagName!=="div"?b.push(l):b.splice(b.length-1,0,l);var n,e,i,q,r,f=w=0,k,o;if(a){if(e=a.modelChangedEvent)e.removedLineCount===0&&e.addedLineCount===0?(o=e.start-m,k=e.addedCharCount-e.removedCharCount):o=-1,a.modelChangedEvent=void 0;e=a.firstChild}for(m=0;m<b.length;m++){l=b[m];q=l.text;w+=q.length;n=l.style;if(e)if(r=e.firstChild.data,i=e.viewStyle,r===q&&
c(n,i)){f+=r.length;e._rectsCache=void 0;n=e=e.nextSibling;continue}else for(;e;){if(o!==-1){i=w;i>=o&&(i-=k);r=(r=e.firstChild.data)?r.length:0;if(f+r>i)break;f+=r}i=e.nextSibling;h.removeChild(e);e=i}n=this._createSpan(h,q,n,l.ignoreChars);e?h.insertBefore(n,e):h.appendChild(n);if(a)a.lineWidth=void 0}if(a)for(g=n?n.nextSibling:null;g;)i=g.nextSibling,a.removeChild(g),g=i;else g.appendChild(h);return h},_createRanges:function(g,a,d,w,b,h){if(!(d>w)){if(g)for(var f=0;f<g.length;f++){var m=g[f];if(!(m.end<
b+d)){var l=Math.max(b+d,m.start)-b;if(l>w)break;var n=Math.min(b+w,m.end)-b;if(l<=n){l=Math.max(d,l);n=Math.min(w,n);for(d<l&&this._createRange(a,d,l,null,h);f+1<g.length&&g[f+1].start-b===n&&c(m.style,g[f+1].style);)m=g[f+1],n=Math.min(b+w,m.end)-b,f++;this._createRange(a,l,n,m.style,h);d=n}}}d<w&&this._createRange(a,d,w,null,h)}},_createRange:function(g,a,c,d,b){if(!(a>c)){var h=this.view._customTabSize;if(h&&h!==8)for(var f=g.indexOf("\t",a);f!==-1;){a<f&&(a={text:g.substring(a,f),style:d},b.ranges.push(a),
b.tabOffset+=a.text.length);a=h-b.tabOffset%h;if(a>0){for(var m="\u00a0",l=1;l<a;l++)m+=" ";a={text:m,style:d,ignoreChars:a-1};b.ranges.push(a);b.tabOffset+=a.text.length}a=f+1;if(a===c)return;f=g.indexOf("\t",a)}a<=c&&(a={text:g.substring(a,c),style:d},b.ranges.push(a),b.tabOffset+=a.text.length)}},_createSpan:function(g,a,c,w){var b=this.view,h="span";c&&c.tagName&&(h=c.tagName.toLowerCase());var f=h==="a";if(f)g.hasLink=!0;f&&!b._linksVisible&&(h="span");f=g.ownerDocument;g=d.createElement(g.ownerDocument,
h);c&&c.html?(g.innerHTML=c.html,g.ignore=!0):c&&c.node?(g.appendChild(c.node),g.ignore=!0):g.appendChild(f.createTextNode(c&&c.text?c.text:a));j(c,g);if(h==="a"){var m=b._getWindow();i(g,"click",function(g){return b._handleLinkClick(g?g:m.event)},!1)}g.viewStyle=c;if(w)g.ignoreChars=w;return g},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(g,a){var c=this._ensureCreated(),w=this.view;if(g===void 0)return this._getLineBoundingClientRect(c,
!0);var b=w._model,h=c.ownerDocument,f=this.lineIndex,m=null;if(g<b.getLineEnd(f)){b=b.getLineStart(f);for(f=c.firstChild;f;){if(!f.ignore){var l=f.firstChild,n=l.length;f.ignoreChars&&(n-=f.ignoreChars);if(b+n>g){m=g-b;if(w._isRangeRects)h=h.createRange(),h.setStart(l,m),h.setEnd(l,m+1),m=new q(h.getBoundingClientRect());else if(d.isIE)h=h.body.createTextRange(),h.moveToElementText(f),h.collapse(),h.moveEnd("character",m+1),h.moveStart("character",m),m=new q(h.getBoundingClientRect());else{var e=
l.data;f.removeChild(l);f.appendChild(h.createTextNode(e.substring(0,m)));var i=d.createElement(h,"span");i.appendChild(h.createTextNode(e.substring(m,m+1)));f.appendChild(i);f.appendChild(h.createTextNode(e.substring(m+1)));m=new q(i.getBoundingClientRect());f.innerHTML="";f.appendChild(l);this._createdDiv||(h=w._getSelection(),(b<=h.start&&h.start<b+n||b<=h.end&&h.end<b+n)&&w._updateDOMSelection())}d.isIE&&(h=c.ownerDocument.defaultView||c.ownerDocument.parentWindow,c=h.screen.logicalXDPI/h.screen.deviceXDPI,
h=h.screen.logicalYDPI/h.screen.deviceYDPI,m.left*=c,m.right*=c,m.top*=h,m.bottom*=h);break}b+=n}f=f.nextSibling}}c=this.getBoundingClientRect();if(!m)w._wrapMode?(w=this.getClientRects(),m=w[w.length-1],m.left=m.right,m.left+=c.left,m.top+=c.top,m.right+=c.left,m.bottom+=c.top):(m=new q(c),m.left=m.right);if(a||a===void 0)m.left-=c.left,m.top-=c.top,m.right-=c.left,m.bottom-=c.top;return m},_getClientRects:function(g,a){var c,d,b,h;if(!g._rectsCache){c=g.getClientRects();d=Array(c.length);for(h=
0;h<c.length;h++)b=d[h]=new q(c[h]),b.left-=a.left,b.top-=a.top,b.right-=a.left,b.bottom-=a.top;g._rectsCache=d}c=g._rectsCache;d=[c.length];for(h=0;h<c.length;h++)d[h]=new q(c[h]);return d},getClientRects:function(g){if(!this.view._wrapMode)return[this.getBoundingClientRect()];for(var a=this._ensureCreated(),c=[],d=a.firstChild,b,h=a.getBoundingClientRect();d;){if(!d.ignore)for(var f=this._getClientRects(d,h),a=0;a<f.length;a++){var m=f[a],l;if(m.top!==m.bottom){var n=m.top+(m.bottom-m.top)/2;for(l=
0;l<c.length;l++)if(b=c[l],b.top<=n&&n<b.bottom)break;if(l===c.length)c.push(m);else{if(m.left<b.left)b.left=m.left;if(m.top<b.top)b.top=m.top;if(m.right>b.right)b.right=m.right;if(m.bottom>b.bottom)b.bottom=m.bottom}}}d=d.nextSibling}return g!==void 0?c[g]:c},_getLineBoundingClientRect:function(g,a){var c=new q(g.getBoundingClientRect());if(!this.view._wrapMode){c.right=c.left;for(var d=g.lastChild;d&&d.ignoreChars===d.firstChild.length;)d=d.previousSibling;if(d)d=d.getBoundingClientRect(),c.right=
d.right+l(g).right}a&&(d=l(g),c.left+=d.left,c.right-=d.right);return c},getLineCount:function(){return!this.view._wrapMode?1:this.getClientRects().length},getLineIndex:function(g){if(!this.view._wrapMode)return 0;for(var a=this.getClientRects(),g=this.getBoundingClientRect(g),g=g.top+(g.bottom-g.top)/2,c=0;c<a.length;c++)if(a[c].top<=g&&g<a[c].bottom)return c;return a.length-1},getLineStart:function(g){if(!this.view._wrapMode||g===0)return this.view._model.getLineStart(g);var a=this.getClientRects();
return this.getOffset(a[g].left+1,a[g].top+1)},getOffset:function(g,a){var c=this.view,b=c._model,h=this.lineIndex,f=b.getLineStart(h),m=b.getLineEnd(h);if(f===m)return f;var l=this._ensureCreated(),n=this.getBoundingClientRect(),e,i;if(c._wrapMode){e=this.getClientRects();if(a<e[0].top)a=e[0].top;for(var j=0;j<e.length;j++)if(i=e[j],i.top<=a&&a<i.bottom)break;if(g<i.left)g=i.left;g>i.right&&(g=i.right-1)}else g<0&&(g=0),g>n.right-n.left&&(g=n.right-n.left);var q=l.ownerDocument,j=q.defaultView||
q.parentWindow,r=d.isIE?j.screen.logicalXDPI/j.screen.deviceXDPI:1,k=d.isIE?j.screen.logicalYDPI/j.screen.deviceYDPI:1,j=f,o=l.firstChild;a:for(;o;){if(!o.ignore){var t=o.firstChild,l=t.length;o.ignoreChars&&(l-=o.ignoreChars);var p,u,x;e=this._getClientRects(o,n);for(var z=0;z<e.length;z++)if(i=e[z],i.left<=g&&g<i.right&&(!c._wrapMode||i.top<=a&&a<i.bottom)){if(d.isIE||c._isRangeRects){for(var q=c._isRangeRects?q.createRange():q.body.createTextRange(),z=l,D=-1;z-D>1;){var E=Math.floor((z+D)/2);e=
D+1;i=E===l-1&&o.ignoreChars?t.length:E+1;c._isRangeRects?(q.setStart(t,e),q.setEnd(t,i)):(q.moveToElementText(o),q.move("character",e),q.moveEnd("character",i-e));e=q.getClientRects();for(var J=!1,G=0;G<e.length;G++)if(i=e[G],p=i.left*r-n.left,x=i.right*r-n.left,u=i.top*k-n.top,i=i.bottom*k-n.top,p<=g&&g<x&&(!c._wrapMode||u<=a&&a<i)){J=!0;break}J?z=E:D=E}j+=z;e=z;i=z===l-1&&o.ignoreChars?t.length:Math.min(z+1,t.length);c._isRangeRects?(q.setStart(t,e),q.setEnd(t,i)):(q.moveToElementText(o),q.move("character",
e),q.moveEnd("character",i-e));i=q.getClientRects()[0];p=i.left*r-n.left;x=i.right*r-n.left;c=g>p+(x-p)/2;n=j-f;b=b.getLine(h);h=b.charCodeAt(n);55296<=h&&h<=56319&&c?n<b.length&&(h=b.charCodeAt(n+1),56320<=h&&h<=57343&&(j+=1)):56320<=h&&h<=57343&&!c&&n>0&&(h=b.charCodeAt(n-1),55296<=h&&h<=56319&&(j-=1));c&&j++}else{b=[];for(h=0;h<l;h++)b.push("<span>"),h===l-1?b.push(t.data.substring(h)):b.push(t.data.substring(h,h+1)),b.push("</span>");o.innerHTML=b.join("");for(b=o.firstChild;b;){i=b.getBoundingClientRect();
p=i.left-n.left;x=i.right-n.left;if(p<=g&&g<x){g>p+(x-p)/2&&j++;break}j++;b=b.nextSibling}if(!this._createdDiv)o.innerHTML="",o.appendChild(t),n=c._getSelection(),(j<=n.start&&n.start<j+l||j<=n.end&&n.end<j+l)&&c._updateDOMSelection()}break a}j+=l}o=o.nextSibling}return Math.min(m,Math.max(f,j))},getNextOffset:function(g,a){if(a.unit==="line"){var c=this.view._model,b=c.getLineAtOffset(g);if(a.count>0)return a.count--,c.getLineEnd(b);a.count++;return c.getLineStart(b)}return a.unit==="wordend"||a.unit===
"wordWS"||a.unit==="wordendWS"?this._getNextOffset_W3C(g,a):d.isIE?this._getNextOffset_IE(g,a):this._getNextOffset_W3C(g,a)},_getNextOffset_W3C:function(g,a){function c(g){return 33<=g&&g<=47||58<=g&&g<=64||91<=g&&g<=94||g===96||123<=g&&g<=126}function d(g){return g===32||g===9}var b=this.view._model,h=b.getLineAtOffset(g),f=b.getLine(h),m=b.getLineStart(h),b=b.getLineEnd(h),h=f.length,l=g-m,n,e=a.count<0?-1:1;if(a.unit==="word"||a.unit==="wordend"||a.unit==="wordWS"||a.unit==="wordendWS")for(var i,
j,q;a.count!==0;){if(a.count>0){if(l===h)return b;n=f.charCodeAt(l);i=c(n);j=!i&&!d(n);for(l++;l<h;){n=f.charCodeAt(l);if(a.unit!=="wordWS"&&a.unit!=="wordendWS"){q=c(n);if(a.unit==="wordend"){if(!q&&i)break}else if(q&&!i)break;n=!q&&!d(n)}else n=!d(n);if(a.unit==="wordend"||a.unit==="wordendWS"){if(!n&&j)break}else if(n&&!j)break;j=n;i=q;l++}}else{if(l===0)return m;l--;n=f.charCodeAt(l);i=c(n);for(j=!i&&!d(n);0<l;){n=f.charCodeAt(l-1);if(a.unit!=="wordWS"&&a.unit!=="wordendWS"){q=c(n);if(a.unit===
"wordend"){if(q&&!i)break}else if(!q&&i)break;n=!q&&!d(n)}else n=!d(n);if(a.unit==="wordend"||a.unit==="wordendWS"){if(n&&!j)break}else if(!n&&j)break;j=n;i=q;l--}}a.count-=e}else for(;a.count!==0&&0<=l+e&&l+e<=h;)l+=e,n=f.charCodeAt(l),56320<=n&&n<=57343&&l>0&&(n=f.charCodeAt(l-1),55296<=n&&n<=56319&&(l+=e)),a.count-=e;return m+l},_getNextOffset_IE:function(g,a){for(var c=this._ensureCreated(),d=this.view._model,b=this.lineIndex,h=0,f,m=d.getLineStart(b),l=c.ownerDocument,n=a.count<0?-1:1;a.count!==
0;){if(g===d.getLineEnd(b)){for(f=c.lastChild;f&&f.ignoreChars;)f=f.previousSibling;if(!f)return m;h=l.body.createTextRange();h.moveToElementText(f);f=h.text.length;h.moveEnd(a.unit,a.count);h=g+h.text.length-f}else if(g===m&&a.count<0)h=m;else for(f=c.firstChild;f;){var e=f.firstChild.length;f.ignoreChars&&(e-=f.ignoreChars);if(m+e>g){h=l.body.createTextRange();g===m&&a.count<0?h.moveToElementText(f.previousSibling):(h.moveToElementText(f),h.collapse(),h.moveEnd("character",g-m));f=h.text.length;
h.moveEnd(a.unit,a.count);h=g+h.text.length-f;break}m=e+m;f=f.nextSibling}a.count-=n}return h},destroy:function(){var g=this._createdDiv;if(g)g.parentNode.removeChild(g),this._createdDiv=null}};t.prototype={addKeyMode:function(g,a){var c=this._keyModes;a!==void 0?c.splice(a,0,g):c.push(g);g._modeAdded&&g._modeAdded()},addRuler:function(g,a){g.setView(this);var c=this._rulers;if(a!==void 0){var d,b;for(d=0,b=0;d<c.length&&b<a;d++)g.getLocation()===c[d].getLocation()&&b++;c.splice(b,0,g);a=b}else c.push(g);
this._createRuler(g,a);this._update()},computeSize:function(){var g=0,a=0,c=this._model,b=this._clientDiv;if(!b)return{width:g,height:a};var h=b.style.width;if(d.isWebkit)b.style.width="0x7fffffffpx";for(var c=c.getLineCount(),f=0;f<c;f++){var m=this._getLine(f),l=m.getBoundingClientRect(),g=Math.max(g,l.right-l.left);a+=l.bottom-l.top;m.destroy()}if(d.isWebkit)b.style.width=h;b=this._getViewPadding();g+=b.right+b.left+this._metrics.scrollWidth;a+=b.bottom+b.top+this._metrics.scrollWidth;return{width:g,
height:a}},convert:function(g,a,c){if(this._clientDiv){var b=this._getScroll(),d=this._getViewPadding(),h=this._viewDiv.getBoundingClientRect();a==="document"&&(g.x!==void 0&&(g.x+=-b.x+h.left+d.left),g.y!==void 0&&(g.y+=-b.y+h.top+d.top));c==="document"&&(g.x!==void 0&&(g.x+=b.x-h.left-d.left),g.y!==void 0&&(g.y+=b.y-h.top-d.top));return g}},destroy:function(){for(var g=0;g<this._rulers.length;g++)this._rulers[g].setView(null);this.rulers=null;this._destroyView();this.onDestroy({type:"Destroy"});
this._actions=this._keyModes=this._doubleClickSelection=this._selection=this._theme=this._model=this._parent=null},focus:function(){this._clientDiv&&(this._updateDOMSelection(),d.isOpera&&this._clientDiv.blur(),this._clientDiv.focus(),this._updateDOMSelection())},hasFocus:function(){return this._hasFocus},getActionDescription:function(g){if(g=this._actions[g])return g.actionDescription},getActions:function(g){var a=[],c=this._actions,b;for(b in c)c.hasOwnProperty(b)&&(g||!c[b].defaultHandler)&&a.push(b);
return a},getBottomIndex:function(g){return!this._clientDiv?0:this._getBottomIndex(g)},getBottomPixel:function(){return!this._clientDiv?0:this._getScroll().y+this._getClientHeight()},getCaretOffset:function(){return this._getSelection().getCaret()},getClientArea:function(){if(!this._clientDiv)return{x:0,y:0,width:0,height:0};var g=this._getScroll();return{x:g.x,y:g.y,width:this._getClientWidth(),height:this._getClientHeight()}},getHorizontalPixel:function(){return!this._clientDiv?0:this._getScroll().x},
getKeyBindings:function(g){for(var a=[],c=this._keyModes,b=0;b<c.length;b++)a=a.concat(c[b].getKeyBindings(g));return a},getKeyModes:function(){return this._keyModes.slice(0)},getLineHeight:function(g){return!this._clientDiv?0:this._getLineHeight(g)},getLineIndex:function(g){return!this._clientDiv?0:this._getLineIndex(g)},getLinePixel:function(g){return!this._clientDiv?0:this._getLinePixel(g)},getLocationAtOffset:function(g){if(!this._clientDiv)return{x:0,y:0};var a=this._model,g=Math.min(Math.max(0,
g),a.getCharCount()),a=a.getLineAtOffset(g),c=this._getLine(a),g=c.getBoundingClientRect(g);c.destroy();c=g.left;a=this._getLinePixel(a)+g.top;return{x:c,y:a}},getOptions:function(){var g;if(arguments.length===0)g=this._defaultOptions();else if(arguments.length===1){if(g=arguments[0],typeof g==="string")return f(this["_"+g])}else{g={};for(var a in arguments)arguments.hasOwnProperty(a)&&(g[arguments[a]]=void 0)}for(var c in g)g.hasOwnProperty(c)&&(g[c]=f(this["_"+c]));return g},getModel:function(){return this._model},
getOffsetAtLocation:function(g,a){if(!this._clientDiv)return 0;var c=this._getLineIndex(a),b=this._getLine(c),c=b.getOffset(g,a-this._getLinePixel(c));b.destroy();return c},getRulers:function(){return this._rulers.slice(0)},getSelection:function(){var g=this._getSelection();return{start:g.start,end:g.end}},getText:function(g,a){return this._model.getText(g,a)},getTopIndex:function(g){return!this._clientDiv?0:this._getTopIndex(g)},getTopPixel:function(){return!this._clientDiv?0:this._getScroll().y},
invokeAction:function(g,a,c){if(this._clientDiv){if(g=this._actions[g]){if(!a&&g.handler&&g.handler(c))return!0;if(g.defaultHandler)return typeof g.defaultHandler(c)==="boolean"}return!1}},isDestroyed:function(){return!this._clientDiv},onContextMenu:function(g){return this.dispatchEvent(g)},onDragStart:function(g){return this.dispatchEvent(g)},onDrag:function(g){return this.dispatchEvent(g)},onDragEnd:function(g){return this.dispatchEvent(g)},onDragEnter:function(g){return this.dispatchEvent(g)},
onDragOver:function(g){return this.dispatchEvent(g)},onDragLeave:function(g){return this.dispatchEvent(g)},onDrop:function(g){return this.dispatchEvent(g)},onDestroy:function(g){return this.dispatchEvent(g)},onLineStyle:function(g){return this.dispatchEvent(g)},onKeyDown:function(g){return this.dispatchEvent(g)},onKeyPress:function(g){return this.dispatchEvent(g)},onKeyUp:function(g){return this.dispatchEvent(g)},onModelChanged:function(g){return this.dispatchEvent(g)},onModelChanging:function(g){return this.dispatchEvent(g)},
onModify:function(g){return this.dispatchEvent(g)},onMouseDown:function(g){return this.dispatchEvent(g)},onMouseUp:function(g){return this.dispatchEvent(g)},onMouseMove:function(g){return this.dispatchEvent(g)},onMouseOver:function(g){return this.dispatchEvent(g)},onMouseOut:function(g){return this.dispatchEvent(g)},onSelection:function(g){return this.dispatchEvent(g)},onScroll:function(g){return this.dispatchEvent(g)},onVerify:function(g){return this.dispatchEvent(g)},onFocus:function(g){return this.dispatchEvent(g)},
onBlur:function(g){return this.dispatchEvent(g)},redraw:function(){if(!(this._redrawCount>0)){var g=this._model.getLineCount();this.redrawRulers(0,g);this.redrawLines(0,g)}},redrawRulers:function(g,a){if(!(this._redrawCount>0))for(var c=this.getRulers(),b=0;b<c.length;b++)this.redrawLines(g,a,c[b])},redrawLines:function(g,a,c){if(!(this._redrawCount>0)&&(g===void 0&&(g=0),a===void 0&&(a=this._model.getLineCount()),g!==a)){var b=this._clientDiv;if(b){if(c)for(b=(c.getLocation()==="left"?this._leftDiv:
this._rightDiv).firstChild;b;){if(b._ruler===c)break;b=b.nextSibling}c?b.rulerChanged=!0:this._lineHeight&&this._resetLineHeight(g,a);if(!c||c.getOverview()==="page")for(b=b.firstChild;b;){var d=b.lineIndex;if(g<=d&&d<a)b.lineChanged=!0;b=b.nextSibling}if(!c&&!this._wrapMode&&g<=this._maxLineIndex&&this._maxLineIndex<a)this._checkMaxLineIndex=this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0;this._queueUpdate()}}},redrawRange:function(g,a){if(!(this._redrawCount>0)){var c=this._model;
g===void 0&&(g=0);a===void 0&&(a=c.getCharCount());var b=c.getLineAtOffset(g),c=c.getLineAtOffset(Math.max(g,a-1))+1;this.redrawLines(b,c)}},removeKeyMode:function(g){for(var a=this._keyModes,c=0;c<a.length;c++)if(a[c]===g){a.splice(c,1);g._modeRemoved&&g._modeRemoved();break}},removeRuler:function(g){for(var a=this._rulers,c=0;c<a.length;c++)if(a[c]===g){a.splice(c,1);g.setView(null);this._destroyRuler(g);this._update();break}},resize:function(){this._clientDiv&&this._handleResize(null)},setAction:function(g,
a,c){if(g){var b=this._actions,d=b[g];d||(d=b[g]={});d.handler=a;if(c!==void 0)d.actionDescription=c}},setKeyBinding:function(g,a){this._keyModes[0].setKeyBinding(g,a)},setCaretOffset:function(g,a,c){var b=this._model.getCharCount(),g=Math.max(0,Math.min(g,b));this._setSelection(new n(g,g,!1),a===void 0||a,!0,c)},setHorizontalPixel:function(g){this._clientDiv&&(g=Math.max(0,g),this._scrollView(g-this._getScroll().x,0))},setRedraw:function(g){g?--this._redrawCount===0&&this.redraw():this._redrawCount++},
setModel:function(g){if(g&&g!==this._model){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);var a=this._model.getLineCount(),c=this._model.getCharCount(),b=g.getLineCount(),d=g.getCharCount(),h={type:"ModelChanging",text:g.getText(),start:0,removedCharCount:c,addedCharCount:d,removedLineCount:a,addedLineCount:b};this.onModelChanging(h);this._model=g;h={type:"ModelChanged",start:0,removedCharCount:c,
addedCharCount:d,removedLineCount:a,addedLineCount:b};this.onModelChanged(h);this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._reset();this._update()}},setOptions:function(g){var a=this._defaultOptions(),b;for(b in g)if(g.hasOwnProperty(b)){var d=g[b];if(!c(this["_"+b],d)){var h=a[b]?a[b].update:null;h?h.call(this,d):this["_"+b]=f(d)}}},setSelection:function(g,a,c,b){var d=g>a;if(d)var h=g,g=a,
a=h;h=this._model.getCharCount();g=Math.max(0,Math.min(g,h));a=Math.max(0,Math.min(a,h));this._setSelection(new n(g,a,d),c===void 0||c,!0,b)},setText:function(g,a,c){var b=a===void 0&&c===void 0;a===void 0&&(a=0);c===void 0&&(c=this._model.getCharCount());if(b)this._variableLineHeight=!1;this._modifyContent({text:g,start:a,end:c,_code:!0},!b);if(b)this._columnX=-1,this._setSelection(new n(0,0,!1),!0),d.isFirefox&&this._fixCaret()},setTopIndex:function(g){this._clientDiv&&this._scrollView(0,this._getLinePixel(Math.max(0,
g))-this._getScroll().y)},setTopPixel:function(g){this._clientDiv&&this._scrollView(0,Math.max(0,g)-this._getScroll().y)},showSelection:function(){return this._showCaret(!0)},update:function(g,a){this._clientDiv&&(g&&this._updateStyle(),a===void 0||a?this._update():this._queueUpdate())},_handleRootMouseDown:function(g){if(!this._ignoreEvent(g)){if(d.isFirefox&&g.which===1)this._clientDiv.contentEditable=!1,this._ignoreBlur=(this._overlayDiv||this._clientDiv).draggable=!0;var a=this._overlayDiv||this._clientDiv;
...
g))},_handleDrop:function(g){if(!this._ignoreEvent(g)){this._dropTarget=!1;if(this.isListening("Drop"))this.onDrop(this._createMouseEvent("Drop",g));g.preventDefault&&g.preventDefault();return!1}},_handleFocus:function(){this._hasFocus=!0;d.isIOS&&this._lastTouchOffset!==void 0?(this.setCaretOffset(this._lastTouchOffset,!0),this._lastTouchOffset=void 0):this._updateDOMSelection();if(this._cursorDiv)this._cursorDiv.style.display="block";if(this._selDiv1){var g=this._highlightRGB;this._selDiv1.style.background=
g;this._selDiv2.style.background=g;this._selDiv3.style.background=g}if(!this._ignoreFocus)this.onFocus({type:"Focus"})},_handleKeyDown:function(g){if(!this._ignoreEvent(g)){if(this.isListening("KeyDown")){var a=this._createKeyEvent("KeyDown",g);this.onKeyDown(a);if(a.defaultPrevented){if(d.isFirefox)this._keyDownPrevented=!0;g.preventDefault();return}}a=!1;switch(g.keyCode){case 16:case 17:case 18:case 91:a=!0;break;default:this._setLinksVisible(!1)}if(g.keyCode===229){if(this._readonly)return g.preventDefault&&
g.preventDefault(),!1;a=!0;if(d.isSafari&&d.isMac&&g.ctrlKey)a=!1,g.keyCode=129;a&&this._startIME()}else a||this._commitIME();if((d.isMac||d.isLinux)&&d.isFirefox<4||d.isOpera)return this._keyDownEvent=g,!0;if(this._doAction(g))return g.preventDefault?(g.preventDefault(),g.stopPropagation()):(g.cancelBubble=!0,g.returnValue=!1,g.keyCode=0),!1}},_handleKeyPress:function(g){if(!this._ignoreEvent(g))if(this._keyDownPrevented)g.preventDefault&&(g.preventDefault(),g.stopPropagation()),this._keyDownPrevented=
void 0;else{if(d.isMac&&d.isWebkit&&(63232<=g.keyCode&&g.keyCode<=63487||g.keyCode===13||g.keyCode===8))return g.preventDefault&&g.preventDefault(),!1;if(((d.isMac||d.isLinux)&&d.isFirefox<4||d.isOpera)&&this._doAction(this._keyDownEvent))return g.preventDefault&&g.preventDefault(),!1;var a=d.isMac?g.metaKey:g.ctrlKey;if(g.charCode!==void 0&&a)switch(g.charCode){case 99:case 118:case 120:return!0}if(this.isListening("KeyPress")&&(a=this._createKeyEvent("KeyPress",g),this.onKeyPress(a),a.defaultPrevented)){g.preventDefault();
return}if(this._doAction(g))return g.preventDefault?(g.preventDefault(),g.stopPropagation()):(g.cancelBubble=!0,g.returnValue=!1,g.keyCode=0),!1;a=!1;if(d.isMac){if(g.ctrlKey||g.metaKey)a=!0}else if(d.isFirefox){if(g.ctrlKey||g.altKey)a=!0}else g.ctrlKey^g.altKey&&(a=!0);if(!a&&(a=d.isOpera?g.which:g.charCode!==void 0?g.charCode:g.keyCode,a>31))return this._doContent(String.fromCharCode(a)),g.preventDefault&&g.preventDefault(),!1}},_handleKeyUp:function(g){if(!this._ignoreEvent(g)){if(this.isListening("KeyUp")){var a=
this._createKeyEvent("KeyUp",g);this.onKeyUp(a);if(a.defaultPrevented){g.preventDefault();return}}(d.isMac?g.metaKey:g.ctrlKey)||this._setLinksVisible(!1);g.keyCode===13&&this._commitIME()}},_handleLinkClick:function(g){if(!(d.isMac?g.metaKey:g.ctrlKey))return g.preventDefault&&g.preventDefault(),!1},_handleMouse:function(g){var a=this._getWindow(),c=!0,b=a;if(d.isIE||d.isFirefox&&!this._overlayDiv)b=this._clientDiv;if(this._overlayDiv){if(this._hasFocus)this._ignoreFocus=!0;var h=this;a.setTimeout(function(){h.focus();
h._ignoreFocus=!1},0)}this._clickCount===1?(c=this._setSelectionTo(g.clientX,g.clientY,g.shiftKey,!d.isOpera&&this._hasFocus&&this.isListening("DragStart")))&&this._setGrab(b):(this._isW3CEvents&&this._setGrab(b),this._doubleClickSelection=null,this._setSelectionTo(g.clientX,g.clientY,g.shiftKey),this._doubleClickSelection=this._getSelection());return c},_handleMouseDown:function(g){if(!this._ignoreEvent(g)){if(this._linksVisible)if((g.target||g.srcElement).tagName!=="A")this._setLinksVisible(!1);
else return;this._commitIME();var a=g.which;a||(g.button===4&&(a=2),g.button===2&&(a=3),g.button===1&&(a=1));var c=a!==2&&g.timeStamp?g.timeStamp:(new Date).getTime(),b=c-this._lastMouseTime,h=Math.abs(this._lastMouseX-g.clientX),f=Math.abs(this._lastMouseY-g.clientY),m=this._lastMouseButton===a;this._lastMouseX=g.clientX;this._lastMouseY=g.clientY;this._lastMouseTime=c;this._lastMouseButton=a;if(a===1)this._isMouseDown=!0,m&&b<=this._clickTime&&h<=this._clickDist&&f<=this._clickDist?this._clickCount++:
...
g.preventDefault&&g.preventDefault(),!1},_getModelOffset:function(g,a){if(g){var c;c=g.tagName==="DIV"?g:g.parentNode.parentNode;var b=0,d=c.lineIndex;if(g.tagName!=="DIV")for(c=c.firstChild;c;){var h=c.firstChild;if(h===g){c.ignoreChars&&(b-=c.ignoreChars);b+=a;break}c.ignoreChars&&(b-=c.ignoreChars);b+=h.data.length;c=c.nextSibling}return Math.max(0,b)+this._model.getLineStart(d)}},_updateSelectionFromDOM:function(){var g=this._getWindow().getSelection(),a=this._getModelOffset(g.anchorNode,g.anchorOffset),
g=this._getModelOffset(g.focusNode,g.focusOffset);a===void 0||g===void 0||this._setSelection(new n(a,g),!1,!1)},_handleSelectionChange:function(){if(this._imeOffset===-1)if(d.isAndroid){var g=this._getWindow();this._selTimer&&g.clearTimeout(this._selTimer);var a=this;this._selTimer=g.setTimeout(function(){if(a._clientDiv)a._selTimer=null,a._updateSelectionFromDOM()},250)}else this._updateSelectionFromDOM()},_handleTextInput:function(g){if(!this._ignoreEvent(g)){this._imeOffset=-1;if(d.isAndroid){for(var a=
this._getWindow().getSelection(),c=a.anchorNode;c;){if(c.lineIndex!==void 0)break;c=c.parentNode}if(c){var b=this._model,h=c.lineIndex,f=b.getLine(h),m=f,l=0,b=b.getLineStart(h);if(a.rangeCount>0)a.getRangeAt(0).deleteContents(),h=c.ownerDocument.createTextNode(g.data),a.getRangeAt(0).insertNode(h),l=this._getDOMText(c,h),m=l.text,l=l.offset,h.parentNode.removeChild(h);c.lineRemoved=!0;for(c=0;f.charCodeAt(c)===m.charCodeAt(c)&&c<l;)c++;a=f.length-1;for(h=m.length-f.length;f.charCodeAt(a)===m.charCodeAt(a+
h)&&a+h>=l+g.data.length;)a--;a++;f=m.substring(c,a+h);c+=b;a+=b;this._modifyContent({text:f,start:c,end:a,_ignoreDOMSelection:!0},!0)}}else this._doContent(g.data);g.preventDefault()}},_handleTouchStart:function(g){this._commitIME();var a=this._getWindow();if(this._touchScrollTimer)this._vScrollDiv.style.display="none",this._hScrollDiv.style.display="none",a.clearInterval(this._touchScrollTimer),this._touchScrollTimer=null;var c=g.touches;if(c.length===1){var c=c[0],b=c.clientX,h=c.clientY;this._touchStartX=
b;this._touchStartY=h;if(d.isAndroid&&(h<c.pageY-a.pageYOffset||b<c.pageX-a.pageXOffset))b=c.pageX-a.pageXOffset,h=c.pageY-a.pageYOffset;a=this.convert({x:b,y:h},"page","document");this._lastTouchOffset=this.getOffsetAtLocation(a.x,a.y);this._touchStartTime=g.timeStamp;this._touching=!0}},_handleTouchMove:function(g){var a=g.touches;if(a.length===1){a=a[0];this._touchCurrentX=a.clientX;this._touchCurrentY=a.clientY;if(!this._touchScrollTimer&&g.timeStamp-this._touchStartTime<200){this._vScrollDiv.style.display=
"block";if(!this._wrapMode)this._hScrollDiv.style.display="block";var c=this,b=this._getWindow();this._touchScrollTimer=b.setInterval(function(){var g=0,a=0;if(c._touching)g=c._touchStartX-c._touchCurrentX,a=c._touchStartY-c._touchCurrentY,c._touchSpeedX=g/10,c._touchSpeedY=a/10,c._touchStartX=c._touchCurrentX,c._touchStartY=c._touchCurrentY;else if(Math.abs(c._touchSpeedX)<0.1&&Math.abs(c._touchSpeedY)<0.1){c._vScrollDiv.style.display="none";c._hScrollDiv.style.display="none";b.clearInterval(c._touchScrollTimer);
c._touchScrollTimer=null;return}else g=c._touchSpeedX*10,a=c._touchSpeedY*10,c._touchSpeedX*=0.95,c._touchSpeedY*=0.95;c._scrollView(g,a)},10)}this._touchScrollTimer&&g.preventDefault()}},_handleTouchEnd:function(g){if(g.touches.length===0)this._touching=!1},_doAction:function(g){var a,c,b=this._keyModes;for(c=b.length-1;c>=0;c--)if(a=b[c],typeof a.match==="function"&&(a=a.match(g),a!==void 0))return this.invokeAction(a);return!1},_doMove:function(g,a){var c=this._model,b=a.getCaret(),d=c.getLineAtOffset(b);
if(!g.count)g.count=1;for(;g.count!==0;){var h=c.getLineStart(d);if(g.count<0&&b===h)if(d>0)g.unit==="character"&&g.count++,d--,a.extend(c.getLineEnd(d));else break;else if(g.count>0&&b===c.getLineEnd(d))if(d+1<c.getLineCount())g.unit==="character"&&g.count--,d++,a.extend(c.getLineStart(d));else break;else{var f=!1;g.expandTab&&g.unit==="character"&&(b-h)%this._tabSize===0&&(f=!/[^ ]/.test(c.getText(h,b)));f?(a.extend(b-this._tabSize),g.count+=g.count<0?1:-1):(h=this._getLine(d),a.extend(h.getNextOffset(b,
g)),h.destroy())}b=a.getCaret()}return a},_doBackspace:function(g){var a=this._getSelection();if(a.isEmpty()){if(!g.count)g.count=1;g.count*=-1;g.expandTab=this._expandTab;this._doMove(g,a)}this._modifyContent({text:"",start:a.start,end:a.end},!0);return!0},_doCase:function(g){var a=this._getSelection();this._doMove(g,a);var c=this.getText(a.start,a.end);this._setSelection(a,!0);switch(g.type){case "lower":c=c.toLowerCase();break;case "capitalize":c=c.replace(/(?:^|\s)\S/g,function(g){return g.toUpperCase()});
break;case "reverse":g="";for(a=0;a<c.length;a++){var b=c[a],d=b.toLowerCase(),b=d!==b?d:b.toUpperCase();g+=b}c=g;break;default:c=c.toUpperCase()}this._doContent(c);return!0},_doContent:function(g){var a=this._getSelection();if(this._overwriteMode&&a.isEmpty()){var c=this._model,b=c.getLineAtOffset(a.end);a.end<c.getLineEnd(b)&&(c=this._getLine(b),a.extend(c.getNextOffset(a.getCaret(),{unit:"character",count:1})),c.destroy())}this._modifyContent({text:g,start:a.start,end:a.end,_ignoreDOMSelection:!0},
!0)},_doCopy:function(g){var a=this._getSelection();return!a.isEmpty()?this._setClipboardText(this._getBaseText(a.start,a.end),g):!0},_doCursorNext:function(g){var a=this._getSelection();!a.isEmpty()&&!g.select?a.start=a.end:this._doMove(g,a);g.select||a.collapse();this._setSelection(a,!0);return!0},_doCursorPrevious:function(g){var a=this._getSelection();if(!a.isEmpty()&&!g.select)a.end=a.start;else{if(!g.count)g.count=1;g.count*=-1;this._doMove(g,a)}g.select||a.collapse();this._setSelection(a,!0);
return!0},_doCut:function(g){var a=this._getSelection();return!a.isEmpty()?(a=this._getBaseText(a.start,a.end),this._doContent(""),this._setClipboardText(a,g)):!0},_doDelete:function(g){var a=this._getSelection();a.isEmpty()&&this._doMove(g,a);this._modifyContent({text:"",start:a.start,end:a.end},!0);return!0},_doEnd:function(a){var c=this._getSelection(),b=this._model,d;if(a.ctrl)c.extend(b.getCharCount()),d=function(){};else{var h=c.getCaret(),f=b.getLineAtOffset(h);if(this._wrapMode){var m=this._getLine(f),
h=m.getLineIndex(h),h=h===m.getLineCount()-1?b.getLineEnd(f):m.getLineStart(h+1)-1;m.destroy()}else h=b.getLineEnd(f);c.extend(h)}a.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doEnter:function(a){var c=this._model,b=this._getSelection();this._doContent(c.getLineDelimiter());if(a&&a.noCursor)b.end=b.start,this._setSelection(b,!0);return!0},_doHome:function(a){var c=this._getSelection(),b=this._model,d;if(a.ctrl)c.extend(0),d=function(){};else{var h=c.getCaret(),f=b.getLineAtOffset(h);
this._wrapMode?(b=this._getLine(f),h=b.getLineIndex(h),h=b.getLineStart(h),b.destroy()):h=b.getLineStart(f);c.extend(h)}a.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doLineDown:function(a){var c=this._model,b=this._getSelection(),h=b.getCaret(),f=c.getLineAtOffset(h),m=this._getLine(f),l=this._columnX,n=1,e=!1;if(l===-1||a.wholeLine||a.select&&d.isIE)l=a.wholeLine?c.getLineEnd(f+1):h,l=m.getBoundingClientRect(l).left;(h=m.getLineIndex(h))<m.getLineCount()-1?n=m.getClientRects(h+
1).top+1:(h=c.getLineCount()-1,e=f===h,a.count&&a.count>0?f=Math.min(f+a.count,h):f++);h=!1;if(e){if(a.select||d.isMac||d.isLinux)b.extend(c.getCharCount()),h=!0}else m.lineIndex!==f&&(m.destroy(),m=this._getLine(f)),b.extend(m.getOffset(l,n)),h=!0;h&&(a.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=l;m.destroy();return!0},_doLineUp:function(a){var c=this._model,b=this._getSelection(),h=b.getCaret(),f=c.getLineAtOffset(h),m=this._getLine(f),l=this._columnX,n=!1,e;if(l===-1||a.wholeLine||
a.select&&d.isIE)l=a.wholeLine?c.getLineStart(f-1):h,l=m.getBoundingClientRect(l).left;(h=m.getLineIndex(h))>0?e=m.getClientRects(h-1).top+1:(n=f===0,n||(a.count&&a.count>0?f=Math.max(f-a.count,0):f--,e=this._getLineHeight(f)-1));h=!1;if(n){if(a.select||d.isMac||d.isLinux)b.extend(0),h=!0}else m.lineIndex!==f&&(m.destroy(),m=this._getLine(f)),b.extend(m.getOffset(l,e)),h=!0;h&&(a.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=l;m.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(a){var c=
this,b=this._model,h=this._getSelection(),f=h.getCaret(),m=b.getLineAtOffset(f),l=b.getLineCount(),n=this._getScroll(),b=this._getClientHeight(),e,i;if(this._lineHeight){e=this._columnX;n=this._getBoundsAtOffset(f);if(e===-1||a.select&&d.isIE)e=n.left;f=this._getLineIndex(n.top+b);i=this._getLine(f);m=this._getLinePixel(f);f=i.getOffset(e,n.top+b-m);b=i.getBoundingClientRect(f);i.destroy();h.extend(f);a.select||h.collapse();this._setSelection(h,!0,!0,function(){c._columnX=e},b.top+m-n.top);return!0}if(m<
l-1){var j=this._getLineHeight(),q=Math.min(l-m-1,Math.floor(b/j)),q=Math.max(1,q);e=this._columnX;if(e===-1||a.select&&d.isIE)i=this._getLine(m),e=i.getBoundingClientRect(f).left,i.destroy();i=this._getLine(m+q);h.extend(i.getOffset(e,0));i.destroy();a.select||h.collapse();a=l*j;f=n.y+q*j;f+b>a&&(f=a-b);this._setSelection(h,!0,!0,function(){c._columnX=e},f-n.y)}return!0},_doPageUp:function(a){var c=this,b=this._model,h=this._getSelection(),f=h.getCaret(),m=b.getLineAtOffset(f),l=this._getScroll(),
n=this._getClientHeight(),e;if(this._lineHeight){e=this._columnX;l=this._getBoundsAtOffset(f);if(e===-1||a.select&&d.isIE)e=l.left;f=this._getLineIndex(l.bottom-n);b=this._getLine(f);m=this._getLinePixel(f);f=b.getOffset(e,l.bottom-n-m);n=b.getBoundingClientRect(f);b.destroy();h.extend(f);a.select||h.collapse();this._setSelection(h,!0,!0,function(){c._columnX=e},n.top+m-l.top);return!0}if(m>0){var i=this._getLineHeight(),n=Math.max(1,Math.min(m,Math.floor(n/i)));e=this._columnX;if(e===-1||a.select&&
d.isIE)b=this._getLine(m),e=b.getBoundingClientRect(f).left,b.destroy();b=this._getLine(m-n);h.extend(b.getOffset(e,this._getLineHeight(m-n)-1));b.destroy();a.select||h.collapse();a=Math.max(0,l.y-n*i);this._setSelection(h,!0,!0,function(){c._columnX=e},a-l.y)}return!0},_doPaste:function(a){var c=this;return this._getClipboardText(a,function(a){a&&(d.isLinux&&c._lastMouseButton===2&&(new Date).getTime()-c._lastMouseTime<=c._clickTime&&c._setSelectionTo(c._lastMouseX,c._lastMouseY),c._doContent(a))})!==
null},_doScroll:function(a){var c=a.type,b=this._model,d=b.getLineCount(),a=this._getClientHeight(),h=this._getLineHeight();d*=h;var f=this._getScroll().y,m;switch(c){case "textStart":m=0;break;case "textEnd":m=d-a;break;case "pageDown":m=f+a;break;case "pageUp":m=f-a;break;case "lineDown":m=f+h;break;case "lineUp":m=f-h;break;case "centerLine":c=this._getSelection(),m=b.getLineAtOffset(c.start),b=(b.getLineAtOffset(c.end)-m+1)*h,m=m*h-a/2+b/2}m!==void 0&&(m=Math.min(Math.max(0,m),d-a),this._scrollViewAnimated(0,
m-f,function(){}));return!0},_doSelectAll:function(){var a=this._model,c=this._getSelection();c.setCaret(0);c.extend(a.getCharCount());this._setSelection(c,!1);return!0},_doTab:function(){if(this._tabMode&&!this._readonly){var a="\t";if(this._expandTab)var c=this._model,a=this._getSelection().getCaret(),b=c.getLineAtOffset(a),c=c.getLineStart(b),a=Array(this._tabSize-(a-c)%this._tabSize+1).join(" ");this._doContent(a);return!0}},_doShiftTab:function(){return!this._tabMode||this._readonly?void 0:!0},
_doOverwriteMode:function(){if(!this._readonly)return this.setOptions({overwriteMode:!this.getOptions("overwriteMode")}),!0},_doTabMode:function(){this._tabMode=!this._tabMode;return!0},_doWrapMode:function(){this.setOptions({wrapMode:!this.getOptions("wrapMode")});return!0},_autoScroll:function(){var a=this._model,c=this._getSelection(),b=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),h=c.getCaret(),f=a.getLineCount(),m=a.getLineAtOffset(h),l;if(this._autoScrollDir==="up"||
this._autoScrollDir==="down")h=this._autoScrollY/this._getLineHeight(),h=h<0?Math.floor(h):Math.ceil(h),l=Math.max(0,Math.min(f-1,m+h));else if(this._autoScrollDir==="left"||this._autoScrollDir==="right")l=this._getLineIndex(b.y),m=this._getLine(m),b.x+=m.getBoundingClientRect(h,!1).left,m.destroy();l===0&&(d.isMac||d.isLinux)?c.extend(0):l===f-1&&(d.isMac||d.isLinux)?c.extend(a.getCharCount()):(m=this._getLine(l),c.extend(m.getOffset(b.x,b.y-this._getLinePixel(l))),m.destroy());this._setSelection(c,
!0)},_autoScrollTimer:function(){this._autoScroll();var a=this;this._autoScrollTimerID=this._getWindow().setTimeout(function(){a._autoScrollTimer()},this._AUTO_SCROLL_RATE)},_calculateLineHeightTimer:function(a){if(this._lineHeight&&!this._calculateLHTimer){var c=this._model.getLineCount(),b=0;if(a){for(var a=0,h=(new Date).getTime(),d=0;b<c;)if(this._lineHeight[b]||(a++,d||(d=b),this._lineHeight[b]=this._calculateLineHeight(b)),b++,(new Date).getTime()-h>100)break;this.redrawRulers(0,c);this._queueUpdate()}a=
this._getWindow();if(b!==c){var f=this;this._calculateLHTimer=a.setTimeout(function(){f._calculateLHTimer=null;f._calculateLineHeightTimer(!0)},0)}else if(this._calculateLHTimer)a.clearTimeout(this._calculateLHTimer),this._calculateLHTimer=void 0}},_calculateLineHeight:function(a){var a=this._getLine(a),c=a.getBoundingClientRect();a.destroy();return Math.max(1,Math.ceil(c.bottom-c.top))},_calculateMetrics:function(){var a=this._clientDiv,c=a.ownerDocument,b=d.createElement(c,"div");b.style.lineHeight=
"normal";var h={type:"LineStyle",textView:this,0:0,lineText:this._model.getLine(0),lineStart:0};this.onLineStyle(h);j(h.style,b);b.style.position="fixed";b.style.left="-1000px";var f=d.createElement(c,"span");f.appendChild(c.createTextNode(" "));b.appendChild(f);var n=d.createElement(c,"span");n.style.fontStyle="italic";n.appendChild(c.createTextNode(" "));b.appendChild(n);var e=d.createElement(c,"span");e.style.fontWeight="bold";e.appendChild(c.createTextNode(" "));b.appendChild(e);h=d.createElement(c,
"span");h.style.fontWeight="bold";h.style.fontStyle="italic";h.appendChild(c.createTextNode(" "));b.appendChild(h);a.appendChild(b);var i=b.getBoundingClientRect(),f=f.getBoundingClientRect(),n=n.getBoundingClientRect(),e=e.getBoundingClientRect(),h=h.getBoundingClientRect(),f=f.bottom-f.top,n=n.bottom-n.top,e=e.bottom-e.top,q=h.bottom-h.top,B=0,h=i.bottom-i.top<=0,i=Math.max(1,i.bottom-i.top);n>f&&(B=1);e>n&&(B=2);q>e&&(B=3);var r;if(B!==0){r={style:{}};if((B&1)!==0)r.style.fontStyle="italic";if((B&
2)!==0)r.style.fontWeight="bold"}f=l(b);a.removeChild(b);n=m(this._viewDiv);b=d.createElement(c,"div");b.style.position="fixed";b.style.left="-1000px";b.style.paddingLeft=n.left+"px";b.style.paddingTop=n.top+"px";b.style.paddingRight=n.right+"px";b.style.paddingBottom=n.bottom+"px";b.style.width="100px";b.style.height="100px";e=d.createElement(c,"div");e.style.width="100%";e.style.height="100%";b.appendChild(e);a.appendChild(b);c=b.getBoundingClientRect();n=e.getBoundingClientRect();b.style.overflow=
"hidden";e.style.height="200px";e=b.clientWidth;b.style.overflow="scroll";q=b.clientWidth;a.removeChild(b);n={left:n.left-c.left,top:n.top-c.top,right:c.right-n.right,bottom:c.bottom-n.bottom};return{lineHeight:i,largestFontStyle:r,lineTrim:f,viewPadding:n,scrollWidth:e-q,invalid:h}},_cancelAnimation:function(){if(this._animation)this._animation.stop(),this._animation=null},_clearSelection:function(a){var c=this._getSelection();if(c.isEmpty())return!1;a==="next"?c.start=c.end:c.end=c.start;this._setSelection(c,
!0);return!0},_commitIME:function(){if(this._imeOffset!==-1){this._scrollDiv.focus();this._clientDiv.focus();var a=this._model,c=a.getLineAtOffset(this._imeOffset),b=a.getLineStart(c),h=this._getDOMText(this._getLineNode(c)).text,a=a.getLine(c),b=this._imeOffset-b,a=b+h.length-a.length;b!==a&&this._doContent(h.substring(b,a));this._imeOffset=-1}},_createActions:function(){this.addKeyMode(new o.DefaultKeyMode(this));var g=this;this._actions={noop:{defaultHandler:function(){return g._doNoop()}},lineUp:{defaultHandler:function(c){return g._doLineUp(a(c,
{select:!1}))},actionDescription:{name:k.lineUp}},lineDown:{defaultHandler:function(c){return g._doLineDown(a(c,{select:!1}))},actionDescription:{name:k.lineDown}},lineStart:{defaultHandler:function(c){return g._doHome(a(c,{select:!1,ctrl:!1}))},actionDescription:{name:k.lineStart}},lineEnd:{defaultHandler:function(c){return g._doEnd(a(c,{select:!1,ctrl:!1}))},actionDescription:{name:k.lineEnd}},charPrevious:{defaultHandler:function(c){return g._doCursorPrevious(a(c,{select:!1,unit:"character"}))},
actionDescription:{name:k.charPrevious}},charNext:{defaultHandler:function(c){return g._doCursorNext(a(c,{select:!1,unit:"character"}))},actionDescription:{name:k.charNext}},pageUp:{defaultHandler:function(c){return g._doPageUp(a(c,{select:!1}))},actionDescription:{name:k.pageUp}},pageDown:{defaultHandler:function(c){return g._doPageDown(a(c,{select:!1}))},actionDescription:{name:k.pageDown}},scrollPageUp:{defaultHandler:function(c){return g._doScroll(a(c,{type:"pageUp"}))},actionDescription:{name:k.scrollPageUp}},
scrollPageDown:{defaultHandler:function(c){return g._doScroll(a(c,{type:"pageDown"}))},actionDescription:{name:k.scrollPageDown}},scrollLineUp:{defaultHandler:function(c){return g._doScroll(a(c,{type:"lineUp"}))},actionDescription:{name:k.scrollLineUp}},scrollLineDown:{defaultHandler:function(c){return g._doScroll(a(c,{type:"lineDown"}))},actionDescription:{name:k.scrollLineDown}},wordPrevious:{defaultHandler:function(c){return g._doCursorPrevious(a(c,{select:!1,unit:"word"}))},actionDescription:{name:k.wordPrevious}},
wordNext:{defaultHandler:function(c){return g._doCursorNext(a(c,{select:!1,unit:"word"}))},actionDescription:{name:k.wordNext}},textStart:{defaultHandler:function(c){return g._doHome(a(c,{select:!1,ctrl:!0}))},actionDescription:{name:k.textStart}},textEnd:{defaultHandler:function(c){return g._doEnd(a(c,{select:!1,ctrl:!0}))},actionDescription:{name:k.textEnd}},scrollTextStart:{defaultHandler:function(c){return g._doScroll(a(c,{type:"textStart"}))},actionDescription:{name:k.scrollTextStart}},scrollTextEnd:{defaultHandler:function(c){return g._doScroll(a(c,
{type:"textEnd"}))},actionDescription:{name:k.scrollTextEnd}},centerLine:{defaultHandler:function(c){return g._doScroll(a(c,{type:"centerLine"}))},actionDescription:{name:k.centerLine}},selectLineUp:{defaultHandler:function(c){return g._doLineUp(a(c,{select:!0}))},actionDescription:{name:k.selectLineUp}},selectLineDown:{defaultHandler:function(c){return g._doLineDown(a(c,{select:!0}))},actionDescription:{name:k.selectLineDown}},selectWholeLineUp:{defaultHandler:function(c){return g._doLineUp(a(c,
{select:!0,wholeLine:!0}))},actionDescription:{name:k.selectWholeLineUp}},selectWholeLineDown:{defaultHandler:function(c){return g._doLineDown(a(c,{select:!0,wholeLine:!0}))},actionDescription:{name:k.selectWholeLineDown}},selectLineStart:{defaultHandler:function(c){return g._doHome(a(c,{select:!0,ctrl:!1}))},actionDescription:{name:k.selectLineStart}},selectLineEnd:{defaultHandler:function(c){return g._doEnd(a(c,{select:!0,ctrl:!1}))},actionDescription:{name:k.selectLineEnd}},selectCharPrevious:{defaultHandler:function(c){return g._doCursorPrevious(a(c,
{select:!0,unit:"character"}))},actionDescription:{name:k.selectCharPrevious}},selectCharNext:{defaultHandler:function(c){return g._doCursorNext(a(c,{select:!0,unit:"character"}))},actionDescription:{name:k.selectCharNext}},selectPageUp:{defaultHandler:function(c){return g._doPageUp(a(c,{select:!0}))},actionDescription:{name:k.selectPageUp}},selectPageDown:{defaultHandler:function(c){return g._doPageDown(a(c,{select:!0}))},actionDescription:{name:k.selectPageDown}},selectWordPrevious:{defaultHandler:function(c){return g._doCursorPrevious(a(c,
{select:!0,unit:"word"}))},actionDescription:{name:k.selectWordPrevious}},selectWordNext:{defaultHandler:function(c){return g._doCursorNext(a(c,{select:!0,unit:"word"}))},actionDescription:{name:k.selectWordNext}},selectTextStart:{defaultHandler:function(c){return g._doHome(a(c,{select:!0,ctrl:!0}))},actionDescription:{name:k.selectTextStart}},selectTextEnd:{defaultHandler:function(c){return g._doEnd(a(c,{select:!0,ctrl:!0}))},actionDescription:{name:k.selectTextEnd}},deletePrevious:{defaultHandler:function(c){return g._doBackspace(a(c,
{unit:"character"}))},actionDescription:{name:k.deletePrevious}},deleteNext:{defaultHandler:function(c){return g._doDelete(a(c,{unit:"character"}))},actionDescription:{name:k.deleteNext}},deleteWordPrevious:{defaultHandler:function(c){return g._doBackspace(a(c,{unit:"word"}))},actionDescription:{name:k.deleteWordPrevious}},deleteWordNext:{defaultHandler:function(c){return g._doDelete(a(c,{unit:"word"}))},actionDescription:{name:k.deleteWordNext}},deleteLineStart:{defaultHandler:function(c){return g._doBackspace(a(c,
...
{noCursor:!0}))},actionDescription:{name:k.enterNoCursor}},selectAll:{defaultHandler:function(){return g._doSelectAll()},actionDescription:{name:k.selectAll}},copy:{defaultHandler:function(){return g._doCopy()},actionDescription:{name:k.copy}},cut:{defaultHandler:function(){return g._doCut()},actionDescription:{name:k.cut}},paste:{defaultHandler:function(){return g._doPaste()},actionDescription:{name:k.paste}},uppercase:{defaultHandler:function(c){return g._doCase(a(c,{type:"upper"}))},actionDescription:{name:k.uppercase}},
lowercase:{defaultHandler:function(c){return g._doCase(a(c,{type:"lower"}))},actionDescription:{name:k.lowercase}},capitalize:{defaultHandler:function(c){return g._doCase(a(c,{unit:"word",type:"capitalize"}))},actionDescription:{name:k.capitalize}},reversecase:{defaultHandler:function(c){return g._doCase(a(c,{type:"reverse"}))},actionDescription:{name:k.reverse}},toggleOverwriteMode:{defaultHandler:function(){return g._doOverwriteMode()},actionDescription:{name:k.toggleOverwriteMode}},toggleTabMode:{defaultHandler:function(){return g._doTabMode()},
actionDescription:{name:k.toggleTabMode}},toggleWrapMode:{defaultHandler:function(){return g._doWrapMode()},actionDescription:{name:k.toggleWrapMode}}}},_createRuler:function(a,c){if(this._clientDiv){var b=a.getLocation()==="left"?this._leftDiv:this._rightDiv;b.style.display="block";var h=d.createElement(b.ownerDocument,"div");h._ruler=a;h.rulerChanged=!0;h.style.position="relative";h.style.cssFloat="left";h.style.styleFloat="left";h.style.borderWidth="0px";h.style.margin="0px";h.style.padding="0px";
h.style.outline="none";if(c===void 0||c<0||c>=b.children.length)b.appendChild(h);else{for(var f=b.firstChild;f&&--c>0;)f=f.nextSibling;b.insertBefore(h,f)}}},_createView:function(){if(!this._clientDiv){for(var a=this._parent;a.hasChildNodes();)a.removeChild(a.lastChild);var c=a.ownerDocument,b=d.createElement(c,"div");this._rootDiv=b;b.tabIndex=-1;b.style.position="relative";b.style.overflow="hidden";b.style.width="100%";b.style.height="100%";b.style.overflow="hidden";b.style.WebkitTextSizeAdjust=
"100%";b.setAttribute("role","application");a.appendChild(b);a=d.createElement(c,"div");a.className="textviewLeftRuler";this._leftDiv=a;a.tabIndex=-1;a.style.overflow="hidden";a.style.MozUserSelect="none";a.style.WebkitUserSelect="none";a.style.position="absolute";a.style.top="0px";a.style.bottom="0px";a.style.cursor="default";a.style.display="none";a.setAttribute("aria-hidden","true");b.appendChild(a);a=d.createElement(c,"div");a.className="textviewScroll";this._viewDiv=a;a.tabIndex=-1;a.style.overflow=
"auto";a.style.position="absolute";a.style.top="0px";a.style.bottom="0px";a.style.borderWidth="0px";a.style.margin="0px";a.style.outline="none";a.style.background="transparent";if(d.isMac&&d.isWebkit)a.style.pointerEvents="none",a.style.zIndex="2";b.appendChild(a);var h=d.createElement(c,"div");h.className="textviewRightRuler";this._rightDiv=h;h.tabIndex=-1;h.style.display="none";h.style.overflow="hidden";h.style.MozUserSelect="none";h.style.WebkitUserSelect="none";h.style.position="absolute";h.style.top=
"0px";h.style.bottom="0px";h.style.cursor="default";h.style.right="0px";h.setAttribute("aria-hidden","true");b.appendChild(h);this._scrollDiv=h=d.createElement(c,"div");h.style.margin="0px";h.style.borderWidth="0px";h.style.padding="0px";a.appendChild(h);if(d.isFirefox)this._clipboardDiv=a=d.createElement(c,"div"),a.style.position="fixed",a.style.whiteSpace="pre",a.style.left="-1000px",b.appendChild(a);if(!d.isIE&&!d.isIOS)this._clipDiv=a=d.createElement(c,"div"),a.style.position="absolute",a.style.overflow=
"hidden",a.style.margin="0px",a.style.borderWidth="0px",a.style.padding="0px",a.style.background="transparent",b.appendChild(a),this._clipScrollDiv=h=d.createElement(c,"div"),h.style.position="absolute",h.style.height="1px",h.style.top="-1000px",h.style.background="transparent",a.appendChild(h);this._setFullSelection(this._fullSelection,!0);a=d.createElement(c,"div");a.className="textviewContent";this._clientDiv=a;a.style.position="absolute";a.style.borderWidth="0px";a.style.margin="0px";a.style.padding=
"0px";a.style.outline="none";a.style.zIndex="1";a.style.WebkitUserSelect="text";a.setAttribute("spellcheck","false");if(d.isIOS||d.isAndroid)a.style.WebkitTapHighlightColor="transparent";(this._clipDiv||b).appendChild(a);if(d.isIOS||d.isAndroid)this._vScrollDiv=h=d.createElement(c,"div"),h.style.position="absolute",h.style.borderWidth="1px",h.style.borderColor="white",h.style.borderStyle="solid",h.style.borderRadius="4px",h.style.backgroundColor="black",h.style.opacity="0.5",h.style.margin="0px",
h.style.padding="0px",h.style.outline="none",h.style.zIndex="3",h.style.width="8px",h.style.display="none",b.appendChild(h),this._hScrollDiv=h=d.createElement(c,"div"),h.style.position="absolute",h.style.borderWidth="1px",h.style.borderColor="white",h.style.borderStyle="solid",h.style.borderRadius="4px",h.style.backgroundColor="black",h.style.opacity="0.5",h.style.margin="0px",h.style.padding="0px",h.style.outline="none",h.style.zIndex="3",h.style.height="8px",h.style.display="none",b.appendChild(h);
...
!0);this._hookEvents();b=this._rulers;for(c=0;c<b.length;c++)this._createRuler(b[c]);this._update()}},_defaultOptions:function(){return{parent:{value:void 0,update:null},model:{value:void 0,update:this.setModel},scrollAnimation:{value:0,update:null},readonly:{value:!1,update:this._setReadOnly},fullSelection:{value:!0,update:this._setFullSelection},tabMode:{value:!0,update:null},tabSize:{value:8,update:this._setTabSize},expandTab:{value:!1,update:null},overwriteMode:{value:!1,update:this._setOverwriteMode},
blockCursorVisible:{value:!1,update:this._setBlockCursor},wrapMode:{value:!1,update:this._setWrapMode},wrappable:{value:!1,update:null},theme:{value:b.TextTheme.getTheme(),update:this._setTheme},themeClass:{value:void 0,update:this._setThemeClass}}},_destroyRuler:function(a){var c=a.getLocation()==="left"?this._leftDiv:this._rightDiv;if(c)for(var b=c.firstChild;b;){if(b._ruler===a){b._ruler=void 0;c.removeChild(b);if(c.children.length===0)c.style.display="none";break}b=b.nextSibling}},_destroyView:function(){if(this._clientDiv){this._setGrab(null);
this._unhookEvents();var a=this._getWindow();if(this._autoScrollTimerID)a.clearTimeout(this._autoScrollTimerID),this._autoScrollTimerID=null;if(this._updateTimer)a.clearTimeout(this._updateTimer),this._updateTimer=null;a=this._rootDiv;a.parentNode.removeChild(a);this._hScrollDiv=this._vScrollDiv=this._rightDiv=this._leftDiv=this._overlayDiv=this._clientDiv=this._clipScrollDiv=this._clipDiv=this._viewDiv=this._scrollDiv=this._rootDiv=this._clipboardDiv=this._selDiv3=this._selDiv2=this._selDiv1=null}},
_doAutoScroll:function(a,c,b){this._autoScrollDir=a;this._autoScrollX=c;this._autoScrollY=b;this._autoScrollTimerID||this._autoScrollTimer()},_endAutoScroll:function(){this._autoScrollTimerID&&this._getWindow().clearTimeout(this._autoScrollTimerID);this._autoScrollTimerID=this._autoScrollDir=void 0},_fixCaret:function(){var a=this._clientDiv;if(a){var c=this._hasFocus;this._ignoreFocus=!0;c&&a.blur();a.contentEditable=!1;a.contentEditable=!0;c&&a.focus();this._ignoreFocus=!1}},_getBaseText:function(a,
c){var b=this._model;b.getBaseModel&&(a=b.mapOffset(a),c=b.mapOffset(c),b=b.getBaseModel());return b.getText(a,c)},_getBottomIndex:function(a){var c=this._bottomChild;if(a&&this._getClientHeight()>this._getLineHeight()){var a=c.getBoundingClientRect(),b=this._clientDiv.getBoundingClientRect();a.bottom>b.bottom&&(c=this._getLinePrevious(c)||c)}return c.lineIndex},_getBoundsAtOffset:function(a){var c=this._getLine(this._model.getLineAtOffset(a)),a=c.getBoundingClientRect(a),b=this._getLinePixel(c.lineIndex);
a.top+=b;a.bottom+=b;c.destroy();return a},_getClientHeight:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientHeight-a.top-a.bottom)},_getClientWidth:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientWidth-a.left-a.right)},_getClipboardText:function(a,c){var b=this._model.getLineDelimiter(),f,m,l=this._getWindow();if(l.clipboardData)return f=[],m=l.clipboardData.getData("Text"),h(m,function(a){f.push(a)},function(){f.push(b)}),m=f.join(""),c&&
c(m),m;if(d.isFirefox){this._ignoreFocus=!0;var n=this._clipboardDiv;n.innerHTML="<pre contenteditable=''></pre>";n.firstChild.focus();var e=this,i=function(){var a=e._getTextFromElement(n);n.innerHTML="";f=[];h(a,function(a){f.push(a)},function(){f.push(b)});return f.join("")},j=!1;this._ignorePaste=!0;if(!d.isLinux||this._lastMouseButton!==2)try{j=n.ownerDocument.execCommand("paste",!1,null)}catch(q){j=n.childNodes.length>1||n.firstChild&&n.firstChild.childNodes.length>0}this._ignorePaste=!1;if(!j)return a?
(l.setTimeout(function(){e.focus();(m=i())&&c&&c(m);e._ignoreFocus=!1},0),null):(this.focus(),this._ignoreFocus=!1,"");this.focus();this._ignoreFocus=!1;(m=i())&&c&&c(m);return m}return a&&a.clipboardData?(f=[],m=a.clipboardData.getData("text/plain"),h(m,function(a){f.push(a)},function(){f.push(b)}),(m=f.join(""))&&c&&c(m),m):""},_getDOMText:function(a,c){for(var b=a.firstChild,h="",d=0;b;){var f;if(!b.ignore)if(b.ignoreChars){f=b.lastChild;for(var m=0,n=[],l=-1;f;){for(var e=f.data,i=e.length-1;i>=
0;i--){var j=e.substring(i,i+1);m<b.ignoreChars&&(j===" "||j==="\u200c"||j==="\ufeff")?m++:n.push(j==="\u00a0"?"\t":j)}if(c===f)l=n.length;f=f.previousSibling}n=n.reverse().join("");l!==-1&&(d=h.length+n.length-l);h+=n}else for(f=b.firstChild;f;){if(c===f)d=h.length;h+=f.data;f=f.nextSibling}b=b.nextSibling}return{text:h,offset:d}},_getTextFromElement:function(a){var c=a.ownerDocument,b=c.defaultView;if(!b.getSelection)return a.innerText||a.textContent;c=c.createRange();c.selectNode(a);var a=b.getSelection(),
b=[],h;for(h=0;h<a.rangeCount;h++)b.push(a.getRangeAt(h));this._ignoreSelect=!0;a.removeAllRanges();a.addRange(c);c=a.toString();a.removeAllRanges();for(h=0;h<b.length;h++)a.addRange(b[h]);this._ignoreSelect=!1;return c},_getViewPadding:function(){return this._metrics.viewPadding},_getLine:function(a){var c=this._getLineNode(a);return c&&!c.lineChanged&&!c.lineRemoved?c._line:new r(this,a)},_getLineHeight:function(a,c){if(a!==void 0&&this._lineHeight){var b=this._lineHeight[a];if(b)return b;if(c||
c===void 0)return this._lineHeight[a]=this._calculateLineHeight(a)}return this._metrics.lineHeight},_getLineNode:function(a){for(var c=this._clientDiv.firstChild;c;){if(a===c.lineIndex)return c;c=c.nextSibling}},_getLineNext:function(a){for(a=a?a.nextSibling:this._clientDiv.firstChild;a&&a.lineIndex===-1;)a=a.nextSibling;return a},_getLinePrevious:function(a){for(a=a?a.previousSibling:this._clientDiv.lastChild;a&&a.lineIndex===-1;)a=a.previousSibling;return a},_getLinePixel:function(a){a=Math.min(Math.max(0,
a),this._model.getLineCount());if(this._lineHeight){var c=this._getTopIndex(),b=-this._topIndexY+this._getScroll().y;if(a>c)for(;c<a;c++)b+=this._getLineHeight(c);else for(c-=1;c>=a;c--)b-=this._getLineHeight(c);return b}return this._getLineHeight()*a},_getLineIndex:function(a){var c,b=0,h=this._model.getLineCount();if(this._lineHeight){var b=this._getTopIndex(),d=-this._topIndexY+this._getScroll().y;if(a!==d)if(a<d)for(;a<d&&b>0;)a+=this._getLineHeight(--b);else for(c=this._getLineHeight(b);a-c>=
d&&b<h-1;)a-=c,c=this._getLineHeight(++b)}else c=this._getLineHeight(),b=Math.floor(a/c);return Math.max(0,Math.min(h-1,b))},_getScroll:function(a){(a===void 0||a)&&this._cancelAnimation();a=this._viewDiv;return{x:a.scrollLeft,y:a.scrollTop}},_getSelection:function(){return this._selection.clone()},_getTopIndex:function(a){var c=this._topChild;if(a&&this._getClientHeight()>this._getLineHeight()){var a=c.getBoundingClientRect(),b=this._getViewPadding(),h=this._viewDiv.getBoundingClientRect();a.top<
h.top+b.top&&(c=this._getLineNext(c)||c)}return c.lineIndex},_hookEvents:function(){var a=this;this._modelListener={onChanging:function(c){a._onModelChanging(c)},onChanged:function(c){a._onModelChanged(c)}};this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._themeListener={onChanged:function(){a._setThemeClass(a._themeClass)}};this._theme.addEventListener("ThemeChanged",this._themeListener.onChanged);
var c=this._handlers=[],b=this._clientDiv,h=this._viewDiv,f=this._rootDiv,m=this._overlayDiv||b,n=b.ownerDocument,l=this._getWindow(),e=d.isIE?n:l;c.push({target:l,type:"resize",handler:function(c){return a._handleResize(c?c:l.event)}});c.push({target:b,type:"blur",handler:function(c){return a._handleBlur(c?c:l.event)}});c.push({target:b,type:"focus",handler:function(c){return a._handleFocus(c?c:l.event)}});c.push({target:h,type:"focus",handler:function(){b.focus()}});c.push({target:h,type:"scroll",
handler:function(c){return a._handleScroll(c?c:l.event)}});c.push({target:b,type:"textInput",handler:function(c){return a._handleTextInput(c?c:l.event)}});c.push({target:b,type:"keydown",handler:function(c){return a._handleKeyDown(c?c:l.event)}});c.push({target:b,type:"keypress",handler:function(c){return a._handleKeyPress(c?c:l.event)}});c.push({target:b,type:"keyup",handler:function(c){return a._handleKeyUp(c?c:l.event)}});c.push({target:b,type:"contextmenu",handler:function(c){return a._handleContextMenu(c?
c:l.event)}});c.push({target:b,type:"copy",handler:function(c){return a._handleCopy(c?c:l.event)}});c.push({target:b,type:"cut",handler:function(c){return a._handleCut(c?c:l.event)}});c.push({target:b,type:"paste",handler:function(c){return a._handlePaste(c?c:l.event)}});if(d.isIOS||d.isAndroid)c.push({target:n,type:"selectionchange",handler:function(c){return a._handleSelectionChange(c?c:l.event)}}),c.push({target:b,type:"touchstart",handler:function(c){return a._handleTouchStart(c?c:l.event)}}),
c.push({target:b,type:"touchmove",handler:function(c){return a._handleTouchMove(c?c:l.event)}}),c.push({target:b,type:"touchend",handler:function(c){return a._handleTouchEnd(c?c:l.event)}});else{c.push({target:b,type:"selectstart",handler:function(c){return a._handleSelectStart(c?c:l.event)}});c.push({target:b,type:"mousedown",handler:function(c){return a._handleMouseDown(c?c:l.event)}});c.push({target:b,type:"mouseover",handler:function(c){return a._handleMouseOver(c?c:l.event)}});c.push({target:b,
type:"mouseout",handler:function(c){return a._handleMouseOut(c?c:l.event)}});c.push({target:e,type:"mouseup",handler:function(c){return a._handleMouseUp(c?c:l.event)}});c.push({target:e,type:"mousemove",handler:function(c){return a._handleMouseMove(c?c:l.event)}});c.push({target:f,type:"mousedown",handler:function(c){return a._handleRootMouseDown(c?c:l.event)}});c.push({target:f,type:"mouseup",handler:function(c){return a._handleRootMouseUp(c?c:l.event)}});c.push({target:m,type:"dragstart",handler:function(c){return a._handleDragStart(c?
c:l.event)}});c.push({target:m,type:"drag",handler:function(c){return a._handleDrag(c?c:l.event)}});c.push({target:m,type:"dragend",handler:function(c){return a._handleDragEnd(c?c:l.event)}});c.push({target:m,type:"dragenter",handler:function(c){return a._handleDragEnter(c?c:l.event)}});c.push({target:m,type:"dragover",handler:function(c){return a._handleDragOver(c?c:l.event)}});c.push({target:m,type:"dragleave",handler:function(c){return a._handleDragLeave(c?c:l.event)}});c.push({target:m,type:"drop",
handler:function(c){return a._handleDrop(c?c:l.event)}});c.push({target:this._clientDiv,type:d.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(c){return a._handleMouseWheel(c?c:l.event)}});if(d.isFirefox&&(!d.isWindows||d.isFirefox>=15))(h=l.MutationObserver||l.MozMutationObserver)?(this._mutationObserver=new h(function(c){a._handleDataModified(c)}),this._mutationObserver.observe(b,{subtree:!0,characterData:!0})):c.push({target:this._clientDiv,type:"DOMCharacterDataModified",handler:function(c){return a._handleDataModified(c?
c:l.event)}});this._overlayDiv&&(c.push({target:this._overlayDiv,type:"mousedown",handler:function(c){return a._handleMouseDown(c?c:l.event)}}),c.push({target:this._overlayDiv,type:"mouseover",handler:function(c){return a._handleMouseOver(c?c:l.event)}}),c.push({target:this._overlayDiv,type:"mouseout",handler:function(c){return a._handleMouseOut(c?c:l.event)}}),c.push({target:this._overlayDiv,type:"contextmenu",handler:function(c){return a._handleContextMenu(c?c:l.event)}}));this._isW3CEvents||c.push({target:this._clientDiv,
type:"dblclick",handler:function(c){return a._handleDblclick(c?c:l.event)}})}h=this._leftDiv;f=this._rightDiv;d.isIE&&c.push({target:h,type:"selectstart",handler:function(){return!1}});c.push({target:h,type:d.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(c){return a._handleMouseWheel(c?c:l.event)}});c.push({target:h,type:"click",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:h,type:"dblclick",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:h,
type:"mousemove",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:h,type:"mouseover",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:h,type:"mouseout",handler:function(c){a._handleRulerEvent(c?c:l.event)}});d.isIE&&c.push({target:f,type:"selectstart",handler:function(){return!1}});c.push({target:f,type:d.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(c){return a._handleMouseWheel(c?c:l.event)}});c.push({target:f,type:"click",handler:function(c){a._handleRulerEvent(c?
c:l.event)}});c.push({target:f,type:"dblclick",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:f,type:"mousemove",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:f,type:"mouseover",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:f,type:"mouseout",handler:function(c){a._handleRulerEvent(c?c:l.event)}});for(h=0;h<c.length;h++)f=c[h],i(f.target,f.type,f.handler,f.capture)},_getWindow:function(){return this._parent.ownerDocument.defaultView||
this._parent.ownerDocument.parentWindow},_ignoreEvent:function(a){for(a=a.target;a&&a!==this._clientDiv;){if(a.ignore)return!0;a=a.parentNode}return!1},_init:function(a){var c=a.parent;typeof c==="string"&&(c=(a.document||document).getElementById(c));if(!c)throw"no parent";a.parent=c;a.model=a.model||new p.TextModel;var b=this._defaultOptions(),h;for(h in b)b.hasOwnProperty(h)&&(this["_"+h]=a[h]!==void 0?a[h]:b[h].value);this._keyModes=[];this._rulers=[];this._selection=new n(0,0,!1);this._linksVisible=
!1;this._maxLineWidth=this._redrawCount=0;this._maxLineIndex=-1;this._ignoreSelect=!0;this._hasFocus=this._ignoreFocus=!1;this._dragOffset=this._columnX=-1;this._isRangeRects=(!d.isIE||d.isIE>=9)&&typeof c.ownerDocument.createRange().getBoundingClientRect==="function";this._isW3CEvents=c.addEventListener;this._autoScrollTimerID=this._autoScrollY=this._autoScrollX=null;this._AUTO_SCROLL_RATE=50;this._mouseUpClosure=this._moseMoveClosure=this._grabControl=null;this._clickCount=this._lastMouseTime=this._lastMouseY=
...
this._getSelection(),b.setCaret(a.start+a.text.length),this._setSelection(b,!0));this.onModify({type:"Modify"})}},_onModelChanged:function(a){a.type="ModelChanged";this.onModelChanged(a);a.type="Changed";var c=a.start,b=a.addedCharCount,h=a.removedCharCount,d=a.addedLineCount,f=a.removedLineCount,m=this._getSelection();m.end>c&&(m.end>c&&m.start<c+h?m.setCaret(c+b):(m.start+=b-h,m.end+=b-h),this._setSelection(m,!1,!1));c=this._model.getLineAtOffset(c);for(b=this._getLineNext();b;){h=b.lineIndex;if(c<=
h&&h<=c+f)c===h&&!b.modelChangedEvent&&!b.lineRemoved?(b.modelChangedEvent=a,b.lineChanged=!0):(b.lineRemoved=!0,b.lineChanged=!1,b.modelChangedEvent=null);if(h>c+f)b.lineIndex=h+d-f,b._line.lineIndex=b.lineIndex;b=this._getLineNext(b)}this._lineHeight&&(a=[c,f].concat(Array(d)),Array.prototype.splice.apply(this._lineHeight,a));if(!this._wrapMode&&c<=this._maxLineIndex&&this._maxLineIndex<=c+f)this._checkMaxLineIndex=this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0;this._update()},_onModelChanging:function(a){a.type=
...
!1,(c=this._hasFocus)&&a.blur(),a.contentEditable=!1,a.contentEditable=!0,c&&a.focus(),this._ignoreFocus=!1}},_scrollViewAnimated:function(a,c,b){if(b&&this._scrollAnimation){var h=this;this._animation=new u({window:this._getWindow(),duration:this._scrollAnimation,curve:[c,0],onAnimate:function(a){a=c-Math.floor(a);h._scrollView(0,a);c-=a},onEnd:function(){h._animation=null;h._scrollView(a,c);b&&b()}});this._animation.play()}else this._scrollView(a,c),b&&b()},_scrollView:function(a,c){this._ensureCaretVisible=
!1;var b=this._viewDiv;a&&(b.scrollLeft+=a);c&&(b.scrollTop+=c)},_setClipboardText:function(a,c){var b,f=this._parent.ownerDocument,m=this._getWindow();if(m.clipboardData)return b=[],h(a,function(a){b.push(a)},function(){b.push(d.platformDelimiter)}),m.clipboardData.setData("Text",b.join(""));if(c&&c.clipboardData&&(b=[],h(a,function(a){b.push(a)},function(){b.push(d.platformDelimiter)}),c.clipboardData.setData("text/plain",b.join(""))))return!0;var l=d.createElement(f,"pre");l.style.position="fixed";
l.style.left="-1000px";h(a,function(a){l.appendChild(f.createTextNode(a))},function(){l.appendChild(d.createElement(f,"br"))});l.appendChild(f.createTextNode(" "));this._clientDiv.appendChild(l);var n=f.createRange();n.setStart(l.firstChild,0);n.setEndBefore(l.lastChild);var e=m.getSelection();e.rangeCount>0&&e.removeAllRanges();e.addRange(n);var i=this,n=function(){l&&l.parentNode===i._clientDiv&&i._clientDiv.removeChild(l);i._updateDOMSelection()},e=!1;this._ignoreCopy=!0;try{e=f.execCommand("copy",
!1,null)}catch(j){}this._ignoreCopy=!1;if(!e&&c)return m.setTimeout(n,0),!1;n();return!0},_setDOMSelection:function(a,c,b,h,f){for(var m,l,n,e,i=0,j=a.firstChild,q,r,k=this._model.getLine(a.lineIndex).length;j;){if(!j.ignore){q=j.firstChild;r=q.length;j.ignoreChars&&(r-=j.ignoreChars);if(i+r>c||i+r>=k){m=q;l=c-i;j.ignoreChars&&r>0&&l===r&&(l+=j.ignoreChars);break}i+=r}j=j.nextSibling}for(var i=0,j=b.firstChild,o=this._model.getLine(b.lineIndex).length;j;){if(!j.ignore){q=j.firstChild;r=q.length;j.ignoreChars&&
(r-=j.ignoreChars);if(r+i>h||i+r>=o){n=q;e=h-i;j.ignoreChars&&r>0&&e===r&&(e+=j.ignoreChars);break}i+=r}j=j.nextSibling}this._setDOMFullSelection(a,c,k,b,h,o);c=this._getWindow();a=this._parent.ownerDocument;if(c.getSelection){c=c.getSelection();a=a.createRange();a.setStart(m,l);a.setEnd(n,e);if(this._hasFocus&&(c.anchorNode!==m||c.anchorOffset!==l||c.focusNode!==n||c.focusOffset!==e||c.anchorNode!==n||c.anchorOffset!==e||c.focusNode!==m||c.focusOffset!==l))this._ignoreSelect=!1,c.rangeCount>0&&c.removeAllRanges(),
c.addRange(a),this._ignoreSelect=!0;if(this._cursorDiv)f?a.setEnd(m,l):a.setStart(n,e),n=a.getClientRects()[0],e=this._cursorDiv.parentNode,m=e.getBoundingClientRect(),this._cursorDiv.style.top=n.top-m.top+e.scrollTop+"px",this._cursorDiv.style.left=n.left-m.left+e.scrollLeft+"px"}else if(a.selection&&this._hasFocus)f=a.body,a=d.createElement(a,"div"),f.appendChild(a),f.removeChild(a),a=f.createTextRange(),a.moveToElementText(m.parentNode),a.moveStart("character",l),m=f.createTextRange(),m.moveToElementText(n.parentNode),
m.moveStart("character",e),a.setEndPoint("EndToStart",m),this._ignoreSelect=!1,a.select(),this._ignoreSelect=!0},_setDOMFullSelection:function(a,c,b,h,d){if(this._selDiv1&&(b=this._selDiv1,b.style.width="0px",b.style.height="0px",b=this._selDiv2,b.style.width="0px",b.style.height="0px",b=this._selDiv3,b.style.width="0px",b.style.height="0px",!(a===h&&c===d))){var f=this._model,m=this._getViewPadding(),l=this._clientDiv.getBoundingClientRect(),n=this._viewDiv.getBoundingClientRect(),b=n.left+m.left,
e=l.right,m=n.top+m.top,i=l.bottom,n=l=0;this._clipDiv?(n=this._clipDiv.getBoundingClientRect(),l=n.left-this._clipDiv.scrollLeft):(n=this._rootDiv.getBoundingClientRect(),l=n.left);n=n.top;this._ignoreDOMSelection=!0;var a=(new r(this,a.lineIndex,a)).getBoundingClientRect(f.getLineStart(a.lineIndex)+c,!1),j=a.left,d=(new r(this,h.lineIndex,h)).getBoundingClientRect(f.getLineStart(h.lineIndex)+d,!1),c=d.left;this._ignoreDOMSelection=!1;var f=this._selDiv1,j=Math.min(e,Math.max(b,j)),q=Math.min(i,
Math.max(m,a.top)),k=e,h=Math.min(i,Math.max(m,a.bottom));f.style.left=j-l+"px";f.style.top=q-n+"px";f.style.width=Math.max(0,k-j)+"px";f.style.height=Math.max(0,h-q)+"px";if(a.top===d.top)k=Math.min(c,e),f.style.width=Math.max(0,k-j)+"px";else if(a=Math.min(i,Math.max(m,d.top)),c=Math.min(e,Math.max(b,c)),m=Math.min(i,Math.max(m,d.bottom)),i=this._selDiv3,i.style.left=b-l+"px",i.style.top=a-n+"px",i.style.width=Math.max(0,c-b)+"px",i.style.height=Math.max(0,m-a)+"px",a-h>0)m=this._selDiv2,m.style.left=
b-l+"px",m.style.top=h-n+"px",m.style.width=Math.max(0,e-b)+"px",m.style.height=Math.max(0,a-h)+"px"}},_setGrab:function(a){if(a!==this._grabControl)a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null)},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=a;if(d.isIE&&a)this._hadFocus=this._hasFocus;var c=this._clientDiv;c.contentEditable=!a;this._hadFocus&&!a&&c.focus();if(this._overlayDiv)this._overlayDiv.style.zIndex=
a?"-1":"1";for(a=this._getLineNext();a;){if(a.hasLink)for(c=a.firstChild;c;)if(c.ignore)c=c.nextSibling;else{var b=c.nextSibling,h=c.viewStyle;h&&h.tagName&&h.tagName.toLowerCase()==="a"&&a.replaceChild(a._line._createSpan(a,c.firstChild.data,h),c);c=b}a=this._getLineNext(a)}this._updateDOMSelection()}},_setSelection:function(a,c,b,h,d){if(a){this._columnX=-1;b===void 0&&(b=!0);var f=this._selection;this._selection=a;c!==!1&&this._showCaret(!1,h,c,d);b&&this._updateDOMSelection();if(!f.equals(a))this.onSelection({type:"Selection",
oldValue:{start:f.start,end:f.end},newValue:{start:a.start,end:a.end}})}},_setSelectionTo:function(a,c,b,h){var d=this._model,f=this._getSelection(),c=this.convert({x:a,y:c},"page","document"),a=this._getLineIndex(c.y);if(this._clickCount===1){d=this._getLine(a);a=d.getOffset(c.x,c.y-this._getLinePixel(a));d.destroy();if(h&&!b&&f.start<=a&&a<f.end)return this._dragOffset=a,!1;f.extend(a);b||f.collapse()}else(this._clickCount&1)===0?(d=this._getLine(a),a=d.getOffset(c.x,c.y-this._getLinePixel(a)),
this._doubleClickSelection?a>=this._doubleClickSelection.start?(b=this._doubleClickSelection.start,h=d.getNextOffset(a,{unit:"wordend",count:1})):(b=d.getNextOffset(a,{unit:"word",count:-1}),h=this._doubleClickSelection.end):(b=d.getNextOffset(a,{unit:"word",count:-1}),h=d.getNextOffset(b,{unit:"wordend",count:1})),d.destroy()):this._doubleClickSelection?(h=d.getLineAtOffset(this._doubleClickSelection.start),a>=h?(b=d.getLineStart(h),h=d.getLineEnd(a)):(b=d.getLineStart(a),h=d.getLineEnd(h))):(b=
d.getLineStart(a),h=d.getLineEnd(a)),f.setCaret(b),f.extend(h);this._setSelection(f,!0,!0);return!0},_setFullSelection:function(a,c){this._fullSelection=a;if(d.isWebkit)this._fullSelection=!0;var b=this._clipDiv||this._rootDiv;if(b)if(this._fullSelection){if(!this._selDiv1&&this._fullSelection&&!d.isIOS){var h=b.ownerDocument;this._highlightRGB=d.isWebkit?"transparent":"Highlight";var f=d.createElement(h,"div");this._selDiv1=f;f.style.position="absolute";f.style.borderWidth="0px";f.style.margin="0px";
f.style.padding="0px";f.style.outline="none";f.style.background=this._highlightRGB;f.style.width="0px";f.style.height="0px";f.style.zIndex="0";b.appendChild(f);var m=d.createElement(h,"div");this._selDiv2=m;m.style.position="absolute";m.style.borderWidth="0px";m.style.margin="0px";m.style.padding="0px";m.style.outline="none";m.style.background=this._highlightRGB;m.style.width="0px";m.style.height="0px";m.style.zIndex="0";b.appendChild(m);this._selDiv3=h=d.createElement(h,"div");h.style.position="absolute";
h.style.borderWidth="0px";h.style.margin="0px";h.style.padding="0px";h.style.outline="none";h.style.background=this._highlightRGB;h.style.width="0px";h.style.height="0px";h.style.zIndex="0";b.appendChild(h);if(d.isFirefox&&d.isMac){b=this._getWindow().getComputedStyle(h,null).getPropertyValue("background-color");switch(b){case "rgb(119, 141, 168)":b="rgb(199, 208, 218)";break;case "rgb(127, 127, 127)":b="rgb(198, 198, 198)";break;case "rgb(255, 193, 31)":b="rgb(250, 236, 115)";break;case "rgb(243, 70, 72)":b=
...
4){if(b)b.style.MozTabSize=this._tabSize+""}else if(this._tabSize!==8)this._customTabSize=this._tabSize;c||(this.redrawLines(),this._resetLineWidth())},_setTheme:function(a){this._theme&&this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);(this._theme=a)&&this._theme.addEventListener("ThemeChanged",this._themeListener.onChanged);this._setThemeClass(this._themeClass)},_setThemeClass:function(a,c){this._themeClass=a;var b="textview",h=this._theme.getThemeClass();h&&(b+=" "+
h);this._themeClass&&h!==this._themeClass&&(b+=" "+this._themeClass);this._rootDiv.className=b;this._updateStyle(c)},_setWrapMode:function(a,c){this._wrapMode=a&&this._wrappable;var b=this._clientDiv,h=this._viewDiv;a?(b.style.whiteSpace="pre-wrap",b.style.wordWrap="break-word",h.style.overflowX="hidden",h.style.overflowY="scroll"):(b.style.whiteSpace="pre",b.style.wordWrap="normal",h.style.overflowX="auto",h.style.overflowY="auto");c||(this.redraw(),this._resetLineWidth());this._resetLineHeight()},
_showCaret:function(a,c,b,h){if(this._clientDiv){var d=this._model,f=this._getSelection(),m=this._getScroll(),l=f.getCaret(),n=f.start,e=f.end,i=d.getLineAtOffset(e),j=Math.max(Math.max(n,d.getLineStart(i)),e-1),d=this._getClientWidth(),i=this._getClientHeight(),q=d/4,r=this._getBoundsAtOffset(l===n?n:j),k=r.left,o=r.right,t=r.top,p=r.bottom;a&&!f.isEmpty()&&(r=this._getBoundsAtOffset(l===e?n:j),r.top===t?l===n?o=k+Math.min(r.right-k,d):k=o-Math.min(o-r.left,d):l===n?p=t+Math.min(r.bottom-t,i):t=
p-Math.min(p-r.top,i));a=0;k<m.x&&(a=Math.min(k-m.x,-q));o>m.x+d&&(a=Math.max(o-m.x-d,q));f=0;t<m.y?f=t-m.y:p>m.y+i&&(f=p-m.y-i);h&&(h>0?f>0&&(f=Math.max(f,h)):f<0&&(f=Math.min(f,h)));if(a!==0||f!==0)return f!==0&&typeof b==="number"&&(b<0&&(b=0),b>1&&(b=1),f+=Math.floor(f>0?b*i:-b*i)),this._scrollViewAnimated(a,f,c),i!==this._getClientHeight()||d!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0;else c&&c();return!1}},_startIME:function(){if(this._imeOffset===-1){var a=this._getSelection();
a.isEmpty()||this._modifyContent({text:"",start:a.start,end:a.end},!0);this._imeOffset=a.start}},_unhookEvents:function(){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);this._modelListener=null;for(var a=0;a<this._handlers.length;a++){var c=this._handlers[a],b=c.target,h=c.type,c=c.handler;typeof b.removeEventListener===
"function"?b.removeEventListener(h,c,!1):b.detachEvent("on"+h,c)}this._handlers=null;if(this._mutationObserver)this._mutationObserver.disconnect(),this._mutationObserver=null},_updateDOMSelection:function(){if(!this._ignoreDOMSelection&&this._clientDiv){var a=this._getSelection(),c=this._model,b=c.getLineAtOffset(a.start),h=c.getLineAtOffset(a.end),d=this._getLineNext();if(d){var f=this._getLinePrevious(),m;b<d.lineIndex?(m=d,b=0):b>f.lineIndex?(m=f,b=0):(m=this._getLineNode(b),b=a.start-c.getLineStart(b));
h<d.lineIndex?c=0:h>f.lineIndex?(d=f,c=0):(d=this._getLineNode(h),c=a.end-c.getLineStart(h));this._setDOMSelection(m,b,d,c,a.caret)}}},_update:function(a){if(!(this._redrawCount>0)){if(this._updateTimer)this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,a=!1;var c=this._clientDiv;if(c){if(this._metrics.invalid)this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1;var b=this._model,h=this._getScroll(!1),f=this._getViewPadding(),m=b.getLineCount(),l=this._getLineHeight(),
n=this._getClientWidth();if(this._wrapMode)c.style.width=n+"px";var e,i,j,q,k=0,o=0;if(this._lineHeight){for(;o<m;){i=this._getLineHeight(o);if(k+i>h.y)break;k+=i;o++}e=o;i=Math.max(0,e-1);j=b=h.y-k;e>0&&(b+=this._getLineHeight(e-1))}else q=Math.max(0,h.y)/l,e=Math.floor(q),i=Math.max(0,e-1),b=Math.round((q-i)*l),j=Math.round((q-e)*l);this._topIndexY=j;q=this._parent;var t=q.clientWidth,p=q.clientHeight;q=this._getClientHeight();if(a){l=0;this._leftDiv&&(e=this._leftDiv.getBoundingClientRect(),l=
e.right-e.left);e=n;for(this._wrapMode||(e=Math.max(this._maxLineWidth,e));o<m;)i=this._getLineHeight(o,!1),k+=i,o++;m=k}else{n=this._viewDiv;j=Math.min(e+Math.floor((q+j)/l),m-1);for(var h=Math.min(j+1,m-1),u,v=c.firstChild;v;){u=v.lineIndex;var y=v.nextSibling;if(!(i<=u&&u<=h)||v.lineRemoved||v.lineIndex===-1)this._mouseWheelLine===v?(v.style.display="none",v.lineIndex=-1):c.removeChild(v);v=y}var v=this._getLineNext(),y=n.ownerDocument,x=y.createDocumentFragment();for(u=i;u<=h;u++)if(!v||v.lineIndex>
u)(new r(this,u)).create(x,null);else{x.firstChild&&(c.insertBefore(x,v),x=y.createDocumentFragment());if(v&&v.lineChanged)v=(new r(this,u)).create(x,v),v.lineChanged=!1;v=this._getLineNext(v)}x.firstChild&&c.insertBefore(x,v);if(d.isWebkit&&!this._wrapMode)c.style.width="0x7fffffffpx";v=this._getLineNext();u=q+b;for(x=!1;v;){i=v.lineWidth;if(i===void 0)if(y=v._line.getBoundingClientRect(),i=v.lineWidth=Math.ceil(y.right-y.left),y=y.bottom-y.top,this._lineHeight)this._lineHeight[v.lineIndex]=Math.ceil(y);
else if(l!==0&&y!==0&&l!==y)this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[v.lineIndex]=Math.ceil(y);if(this._lineHeight&&!x&&(u-=this._lineHeight[v.lineIndex],u<0))j=v.lineIndex,x=!0;if(!this._wrapMode){if(i>=this._maxLineWidth)this._maxLineWidth=i,this._maxLineIndex=v.lineIndex;if(this._checkMaxLineIndex===v.lineIndex)this._checkMaxLineIndex=-1}if(v.lineIndex===e)this._topChild=v;if(v.lineIndex===j)this._bottomChild=v;v=this._getLineNext(v)}if(this._checkMaxLineIndex!==-1&&(u=
this._checkMaxLineIndex,this._checkMaxLineIndex=-1,0<=u&&u<m)){l=new r(this,u);y=l.getBoundingClientRect();i=y.right-y.left;if(i>=this._maxLineWidth)this._maxLineWidth=i,this._maxLineIndex=u;l.destroy()}for(;o<m;)i=this._getLineHeight(o,o<=j),k+=i,o++;m=k;this._updateRuler(this._leftDiv,e,h,p);this._updateRuler(this._rightDiv,e,h,p);l=0;this._leftDiv&&(e=this._leftDiv.getBoundingClientRect(),l=e.right-e.left);h=0;this._rightDiv&&(h=this._rightDiv.getBoundingClientRect(),h=h.right-h.left);n.style.left=
l+"px";n.style.right=h+"px";h=this._scrollDiv;h.style.height=m+"px";k=n=this._getClientWidth();this._wrapMode||(k=Math.max(this._maxLineWidth,k));e=k;if((!d.isIE||d.isIE>=9)&&this._maxLineWidth>n)k+=f.right+f.left;h.style.width=k+"px";if(this._clipScrollDiv)this._clipScrollDiv.style.width=k+"px";h=this._getScroll(!1)}if(this._vScrollDiv)k=q-8,o=Math.max(15,Math.ceil(Math.min(1,k/(m+f.top+f.bottom))*k)),this._vScrollDiv.style.left=l+n-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,h.y*k/m))+
"px",this._vScrollDiv.style.height=o+"px";if(!this._wrapMode&&this._hScrollDiv)k=n-8,o=Math.max(15,Math.ceil(Math.min(1,k/(this._maxLineWidth+f.left+f.right))*k)),this._hScrollDiv.style.left=l+Math.floor(Math.max(0,Math.floor(h.x*k/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=q-9+"px",this._hScrollDiv.style.width=o+"px";v=h.x;i=this._clipDiv;k=this._overlayDiv;if(i){i.scrollLeft=v;o=l+f.left;j=f.top;a=n;l=q;v=0;u=-b;if(h.x===0)o-=f.left,a+=f.left,v=f.left;h.x+n===e&&(a+=f.right);h.y===0&&
(j-=f.top,l+=f.top,u+=f.top);h.y+q===m&&(l+=f.bottom);i.style.left=o+"px";i.style.top=j+"px";i.style.right=t-a-o+"px";i.style.bottom=p-l-j+"px";c.style.left=v+"px";c.style.top=u+"px";c.style.width=e+"px";c.style.height=q+b+"px";if(k)k.style.left=c.style.left,k.style.top=c.style.top,k.style.width=c.style.width,k.style.height=c.style.height}else{o=v;j=b;t=v+n;p=b+q;o===0&&(o-=f.left);j===0&&(j-=f.top);t===e&&(t+=f.right);h.y+q===m&&(p+=f.bottom);c.style.clip="rect("+j+"px,"+t+"px,"+p+"px,"+o+"px)";
c.style.left=-v+l+f.left+"px";c.style.width=(d.isWebkit?e:n+v)+"px";if(!a)c.style.top=-b+f.top+"px",c.style.height=q+b+"px";if(k&&(k.style.clip=c.style.clip,k.style.left=c.style.left,k.style.width=c.style.width,!a))k.style.top=c.style.top,k.style.height=c.style.height}this._updateDOMSelection();c=this._ensureCaretVisible;this._ensureCaretVisible=!1;q!==this._getClientHeight()&&(this._update(),c&&this._showCaret())}}},_updateRuler:function(a,c,b,h){if(a)for(var f=this._parent.ownerDocument,m=this._getLineHeight(),
l=this._getViewPadding(),a=a.firstChild;a;){var n=a._ruler,e=m,i=n.getOverview();i==="page"&&(e+=this._topIndexY);a.style.top=-e+"px";a.style.height=h+e+"px";a.rulerChanged&&j(n.getRulerStyle(),a);var q,r=a.firstChild;r?(q=r,r=r.nextSibling):(q=d.createElement(f,"div"),q.style.visibility="hidden",a.appendChild(q));var k;if(a.rulerChanged&&q){e=-1;if(k=n.getWidestAnnotation())if(j(k.style,q),k.html)q.innerHTML=k.html;q.lineIndex=e;q.style.height=m+l.top+"px"}var o;if(i==="page"){for(n=n.getAnnotations(c,
b+1);r;)e=r.lineIndex,k=r.nextSibling,(!(c<=e&&e<=b)||r.lineChanged)&&a.removeChild(r),r=k;r=a.firstChild.nextSibling;o=f.createDocumentFragment();for(e=c;e<=b;e++)if(!r||r.lineIndex>e){q=d.createElement(f,"div");if(k=n[e]){j(k.style,q);if(k.html)q.innerHTML=k.html;q.annotation=k}q.lineIndex=e;q.style.height=this._getLineHeight(e)+"px";o.appendChild(q)}else if(o.firstChild&&(a.insertBefore(o,r),o=f.createDocumentFragment()),r)r=r.nextSibling;o.firstChild&&a.insertBefore(o,r)}else{k=this._getClientHeight();
e=this._model.getLineCount();r=k+l.top+l.bottom-2*this._metrics.scrollWidth;i=m*e<r?m:r/e;if(a.rulerChanged){for(k=a.childNodes.length;k>1;)a.removeChild(a.lastChild),k--;n=n.getAnnotations(0,e);o=f.createDocumentFragment();for(var t in n)if(e=t>>>0,!(e<0)){q=d.createElement(f,"div");k=n[t];j(k.style,q);q.style.position="absolute";q.style.top=this._metrics.scrollWidth+m+Math.floor(e*i)+"px";if(k.html)q.innerHTML=k.html;q.annotation=k;q.lineIndex=e;o.appendChild(q)}a.appendChild(o)}else if(a._oldTrackHeight!==
r)for(q=a.firstChild?a.firstChild.nextSibling:null;q;)q.style.top=this._metrics.scrollWidth+m+Math.floor(q.lineIndex*i)+"px",q=q.nextSibling;a._oldTrackHeight=r}a.rulerChanged=!1;a=a.nextSibling}},_updateStyleSheet:function(){var a="";d.isWebkit&&this._metrics.scrollWidth>0&&(a+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");d.isFirefox&&d.isMac&&this._highlightRGB&&this._highlightRGB!=="Highlight"&&(a+="\n.textview ::-moz-selection {background: "+this._highlightRGB+";}");if(a){var c=
document.getElementById("_textviewStyle");if(c)c.removeChild(c.firstChild),c.appendChild(document.createTextNode(a));else{c=d.createElement(document,"style");c.id="_textviewStyle";var b=document.getElementsByTagName("head")[0]||document.documentElement;c.appendChild(document.createTextNode(a));b.insertBefore(c,b.firstChild)}}},_updateStyle:function(a){if(!a&&d.isIE)this._rootDiv.style.lineHeight="normal";var c=this._metrics=this._calculateMetrics();this._rootDiv.style.lineHeight=d.isIE?c.lineHeight-
(c.lineTrim.top+c.lineTrim.bottom)+"px":"normal";this._updateStyleSheet();a||(this.redraw(),this._resetLineWidth())}};e.EventTarget.addMixin(t.prototype);return{TextView:t}});
define("orion/editor/projectionTextModel",["orion/editor/textModel","orion/editor/eventTarget"],function(k,p){function o(e){this._model=e;this._projections=[]}o.prototype={addProjection:function(e){if(e){var b=this._model,d=this._projections;e._lineIndex=b.getLineAtOffset(e.start);e._lineCount=b.getLineAtOffset(e.end)-e._lineIndex;var i=e.text;i||(i="");e._model=typeof i==="string"?new k.TextModel(i,b.getLineDelimiter()):i;var b=this.mapOffset(e.start,!0),i=e.end-e.start,j=e._lineCount,f=e._model.getCharCount(),
a=e._model.getLineCount()-1;this.onChanging({type:"Changing",text:e._model.getText(),start:b,removedCharCount:i,addedCharCount:f,removedLineCount:j,addedLineCount:a});var c=this._binarySearch(d,e.start);d.splice(c,0,e);this.onChanged({type:"Changed",start:b,removedCharCount:i,addedCharCount:f,removedLineCount:j,addedLineCount:a})}},getProjections:function(){return this._projections.slice(0)},getBaseModel:function(){return this._model},mapOffset:function(e,b){var d=this._projections,i=0,j,f;if(b){for(j=
0;j<d.length;j++){f=d[j];if(f.start>e)break;if(f.end>e)return-1;i+=f._model.getCharCount()-(f.end-f.start)}return e+i}for(j=0;j<d.length;j++){f=d[j];if(f.start>e-i)break;var a=f._model.getCharCount();if(f.start+a>e-i)return-1;i+=a-(f.end-f.start)}return e-i},removeProjection:function(e){var b,d=0;for(b=0;b<this._projections.length;b++){var i=this._projections[b];if(i===e){e=i;break}d+=i._model.getCharCount()-(i.end-i.start)}if(b<this._projections.length){var i=this._model,d=e.start+d,j=e.end-e.start,
f=e._lineCount,a=e._model.getCharCount(),c=e._model.getLineCount()-1;this.onChanging({type:"Changing",text:i.getText(e.start,e.end),start:d,removedCharCount:a,addedCharCount:j,removedLineCount:c,addedLineCount:f});this._projections.splice(b,1);this.onChanged({type:"Changed",start:d,removedCharCount:a,addedCharCount:j,removedLineCount:c,addedLineCount:f})}},_binarySearch:function(e,b){for(var d=e.length,i=-1,j;d-i>1;)j=Math.floor((d+i)/2),b<=e[j].start?d=j:i=j;return d},getCharCount:function(){for(var e=
this._model.getCharCount(),b=this._projections,d=0;d<b.length;d++){var i=b[d];e+=i._model.getCharCount()-(i.end-i.start)}return e},getLine:function(e,b){if(e<0)return null;var d=this._model,i=this._projections,j=0,f=[],a=0,c,h,m;for(c=0;c<i.length;c++){m=i[c];if(m._lineIndex>=e-j)break;h=m._model.getLineCount()-1;if(m._lineIndex+h>=e-j)if(a=e-(m._lineIndex+j),a<h)return m._model.getLine(a,b);else f.push(m._model.getLine(h));a=m.end;j+=h-m._lineCount}for(a=Math.max(a,d.getLineStart(e-j));c<i.length;c++){m=
i[c];if(m._lineIndex>e-j)break;f.push(d.getText(a,m.start));h=m._model.getLineCount()-1;if(m._lineIndex+h>e-j)return f.push(m._model.getLine(0,b)),f.join("");f.push(m._model.getText());a=m.end;j+=h-m._lineCount}i=d.getLineEnd(e-j,b);a<i&&f.push(d.getText(a,i));return f.join("")},getLineAtOffset:function(e){for(var b=this._model,d=this._projections,i=0,j=0,f=0;f<d.length;f++){var a=d[f];if(a.start>e-i)break;var c=a._model.getCharCount();if(a.start+c>e-i){d=e-(a.start+i);j+=a._model.getLineAtOffset(d);
i+=d;break}j+=a._model.getLineCount()-1-a._lineCount;i+=c-(a.end-a.start)}return b.getLineAtOffset(e-i)+j},getLineCount:function(){for(var e=this._projections,b=this._model.getLineCount(),d=0;d<e.length;d++){var i=e[d];b+=i._model.getLineCount()-1-i._lineCount}return b},getLineDelimiter:function(){return this._model.getLineDelimiter()},getLineEnd:function(e,b){if(e<0)return-1;for(var d=this._model,i=this._projections,j=0,f=0,a=0;a<i.length;a++){var c=i[a];if(c._lineIndex>e-j)break;var h=c._model.getLineCount()-
1;if(c._lineIndex+h>e-j)return c._model.getLineEnd(e-(c._lineIndex+j),b)+c.start+f;f+=c._model.getCharCount()-(c.end-c.start);j+=h-c._lineCount}return d.getLineEnd(e-j,b)+f},getLineStart:function(e){if(e<0)return-1;for(var b=this._model,d=this._projections,i=0,j=0,f=0;f<d.length;f++){var a=d[f];if(a._lineIndex>=e-i)break;var c=a._model.getLineCount()-1;if(a._lineIndex+c>=e-i)return a._model.getLineStart(e-(a._lineIndex+i))+a.start+j;j+=a._model.getCharCount()-(a.end-a.start);i+=c-a._lineCount}return b.getLineStart(e-
i)+j},getText:function(e,b){e===void 0&&(e=0);var d=this._model,i=this._projections,j=0,f=[],a,c,h;for(a=0;a<i.length;a++){c=i[a];if(c.start>e-j)break;h=c._model.getCharCount();if(c.start+h>e-j)if(b!==void 0&&c.start+h>b-j)return c._model.getText(e-(c.start+j),b-(c.start+j));else f.push(c._model.getText(e-(c.start+j))),e=c.end+j+h-(c.end-c.start);j+=h-(c.end-c.start)}var m=e-j;if(b!==void 0){for(;a<i.length;a++){c=i[a];if(c.start>b-j)break;f.push(d.getText(m,c.start));h=c._model.getCharCount();if(c.start+
h>b-j)return f.push(c._model.getText(0,b-(c.start+j))),f.join("");f.push(c._model.getText());m=c.end;j+=h-(c.end-c.start)}f.push(d.getText(m,b-j))}else{for(;a<i.length;a++)c=i[a],f.push(d.getText(m,c.start)),f.push(c._model.getText()),m=c.end;f.push(d.getText(m))}return f.join("")},_onChanging:function(e,b,d,i,j,f){for(var a=this._model,c=this._projections,h,m=0,l,n=b+d;h<c.length;h++){d=c[h];if(d.start>b)break;m+=d._model.getCharCount()-(d.end-d.start)}b+=m;for(var q=h;h<c.length;h++){d=c[h];if(d.start>
n)break;m+=d._model.getCharCount()-(d.end-d.start);l+=d._model.getLineCount()-1-d._lineCount}d=n+m;m=h;this.onChanging(b,d-b,i,j+l,f);c.splice(c,m-q);for(e=e.length-(d-b);h<c.length;h++)d=c[h],d.start+=e,d.end+=e,d._lineIndex=a.getLineAtOffset(d.start)},onChanging:function(e){return this.dispatchEvent(e)},onChanged:function(e){return this.dispatchEvent(e)},setLineDelimiter:function(e){this._model.setLineDelimiter(e)},setText:function(e,b,d){e===void 0&&(e="");b===void 0&&(b=0);var i=b,j=d,f=this._model,
a=this._projections,c=0,h=0,m,l,n,q,r,k=0;for(m=0;m<a.length;m++){l=a[m];if(l.start>b-c)break;n=l._model.getCharCount();if(l.start+n>b-c)if(d!==void 0&&l.start+n>d-c){l._model.setText(e,b-(l.start+c),d-(l.start+c));return}else k=l._model.getLineCount()-1-l._model.getLineAtOffset(b-(l.start+c)),q={projection:l,start:b-(l.start+c)},b=l.end+c+n-(l.end-l.start);h+=l._model.getLineCount()-1-l._lineCount;c+=n-(l.end-l.start)}b-=c;var o=m,k=f.getLineAtOffset(b)+h-k;if(d!==void 0)for(;m<a.length;m++){l=a[m];
if(l.start>d-c)break;n=l._model.getCharCount();if(l.start+n>d-c){h+=l._model.getLineAtOffset(d-(l.start+c));n=d-(l.start+c);d=l.end+c;r={projection:l,end:n};break}h+=l._model.getLineCount()-1-l._lineCount;c+=n-(l.end-l.start)}else{for(;m<a.length;m++)l=a[m],h+=l._model.getLineCount()-1-l._lineCount,c+=l._model.getCharCount()-(l.end-l.start);d=j=f.getCharCount()+c}d-=c;l=f.getLineAtOffset(d)+h;j-=i;for(var h=l-k,k=e.length,g=n=l=c=0;;){l!==-1&&l<=g&&(l=e.indexOf("\r",g));n!==-1&&n<=g&&(n=e.indexOf("\n",
g));if(n===-1&&l===-1)break;g=l!==-1&&n!==-1?l+1===n?n+1:(l<n?l:n)+1:l!==-1?l+1:n+1;c++}this.onChanging({type:"Changing",text:e,start:i,removedCharCount:j,addedCharCount:k,removedLineCount:h,addedLineCount:c});f.setText(e,b,d);if(q)l=q.projection,l._model.setText("",q.start);if(r)l=r.projection,l._model.setText("",0,r.end),l.start=l.end,l._lineCount=0;a.splice(o,m-o);for(e=e.length-(d-b);m<a.length;m++)l=a[m],l.start+=e,l.end+=e,l._lineIndex=f.getLineAtOffset(l.start);this.onChanged({type:"Changed",
start:i,removedCharCount:j,addedCharCount:k,removedLineCount:h,addedLineCount:c})}};p.EventTarget.addMixin(o.prototype);return{ProjectionTextModel:o}});
...
b}:d.rangeStyle={styleClass:"annotationRange "+b};e.registerType(a,d)}function d(){}function i(a){this._annotations=[];var c=this;this._listener={onChanged:function(a){c._onChanged(a)}};this.setTextModel(a)}function j(a,c){this._view=a;this._annotationModel=c;var b=this;this._listener={onDestroy:function(a){b._onDestroy(a)},onLineStyle:function(a){b._onLineStyle(a)},onChanged:function(a){b._onAnnotationModelChanged(a)}};a.addEventListener("Destroy",this._listener.onDestroy);a.addEventListener("postLineStyle",
...
this;b.sort(function(a,c){return d.getAnnotationTypePriority(a.type)-d.getAnnotationTypePriority(c.type)});return b},isAnnotationTypeVisible:function(a){return this.getAnnotationTypePriority(a)!==0},removeAnnotationType:function(a){if(this._annotationTypes)for(var c=0;c<this._annotationTypes.length;c++)if(this._annotationTypes[c]===a){this._annotationTypes.splice(c,1);break}}};i.prototype={addAnnotation:function(a){if(a){var c=this._annotations,b=this._binarySearch(c,a.start);c.splice(b,0,a);this.onChanged({type:"Changed",
added:[a],removed:[],changed:[]})}},getTextModel:function(){return this._model},getAnnotations:function(a,c){var b=this._annotations,d,f=0,n=function(){for(;f<b.length;){var d=b[f++];if(a===d.start||(a>d.start?a<d.end:d.start<c))return d;if(d.start>=c)break}return null};d=n();return{next:function(){var a=d;a&&(d=n());return a},hasNext:function(){return d!==null}}},modifyAnnotation:function(a){if(a&&!(this._getAnnotationIndex(a)<0))this.onChanged({type:"Changed",added:[],removed:[],changed:[a]})},
...
n,e=[];if(a)for(d=a.length-1;d>=0;d--)n=a[d],f=this._getAnnotationIndex(n),f<0||(b.splice(f,1),e.splice(0,0,n));c||(c=[]);for(d=0;d<c.length;d++)n=c[d],f=this._binarySearch(b,n.start),b.splice(f,0,n);this.onChanged({type:"Changed",removed:e,added:c,changed:[]})},setTextModel:function(a){this._model&&this._model.removeEventListener("Changed",this._listener.onChanged);(this._model=a)&&this._model.addEventListener("Changed",this._listener.onChanged)},_binarySearch:function(a,c){for(var b=a.length,d=
-1,f;b-d>1;)f=Math.floor((b+d)/2),c<=a[f].start?b=f:d=f;return b},_getAnnotationIndex:function(a){for(var c=this._annotations,b=this._binarySearch(c,a.start);b<c.length&&c[b].start===a.start;){if(c[b]===a)return b;b++}return-1},_onChanged:function(a){var c=a.start,b=a.removedCharCount,d=this._annotations,f=c+b;if(0<d.length){for(var n={type:"Changed",added:[],removed:[],changed:[],textModelChangedEvent:a},a=a.addedCharCount-b,b=0;b<d.length;b++){var e=d[b];e.start>=f?(e.start+=a,e.end+=a,n.changed.push(e)):
e.end<=c||(e.start<c&&f<e.end?(e.end+=a,n.changed.push(e)):(d.splice(b,1),n.removed.push(e),b--))}if(n.added.length>0||n.removed.length>0||n.changed.length>0)this.onChanged(n)}}};p.EventTarget.addMixin(i.prototype);j.prototype={destroy:function(){var a=this._view;if(a)a.removeEventListener("Destroy",this._listener.onDestroy),a.removeEventListener("LineStyle",this._listener.onLineStyle),this.view=null;(a=this._annotationModel)&&a.removeEventListener("Changed",this._listener.onChanged)},_mergeStyle:function(a,
...
f.start)break;if(!(c.start>=f.end)){b=this._mergeStyle({},f.style);b=this._mergeStyle(b,c.style);var n=[];n.push(d,1);c.start<f.start&&n.push({start:c.start,end:f.start,style:c.style});c.start>f.start&&n.push({start:f.start,end:c.start,style:f.style});n.push({start:Math.max(f.start,c.start),end:Math.min(f.end,c.end),style:b});c.end<f.end&&n.push({start:c.end,end:f.end,style:f.style});c=c.end>f.end?{start:f.end,end:c.end,style:c.style}:null;Array.prototype.splice.apply(a,n)}}c&&(b=this._mergeStyle({},
c.style),a.splice(d,0,{start:c.start,end:c.end,style:b}));return a},_onAnnotationModelChanged:function(a){function c(a){for(var c=0;c<a.length;c++)if(d.isAnnotationTypeVisible(a[c].type)){var e=a[c].start,i=a[c].end;f.getBaseModel&&(e=f.mapOffset(e,!0),i=f.mapOffset(i,!0));e!==-1&&i!==-1&&b.redrawRange(e,i)}}if(!a.textModelChangedEvent){var b=this._view;if(b){var d=this,f=b.getModel();c(a.added);c(a.removed);c(a.changed)}}},_onDestroy:function(){this.destroy()},_onLineStyle:function(a){var c=this._annotationModel,
b=a.textView.getModel(),d=c.getTextModel(),f=a.lineStart,n=a.lineStart+a.lineText.length;d!==b&&(f=b.mapOffset(f),n=b.mapOffset(n));for(c=c.getAnnotations(f,n);c.hasNext();)if(f=c.next(),this.isAnnotationTypeVisible(f.type)){if(f.rangeStyle){var n=f.start,e=f.end;d!==b&&(n=b.mapOffset(n,!0),e=b.mapOffset(e,!0));a.ranges=this._mergeStyleRanges(a.ranges,{start:n,end:e,style:f.rangeStyle})}if(f.lineStyle)a.style=this._mergeStyle({},a.style),a.style=this._mergeStyle(a.style,f.lineStyle)}}};d.addMixin(j.prototype);
return{FoldingAnnotation:o,AnnotationType:e,AnnotationTypeList:d,AnnotationModel:i,AnnotationStyler:j}});
...
else if(this._isNode(c))a.appendChild(c);else if(c instanceof e.ProjectionTextModel){var h=this._view,m=h.getOptions();m.wrapMode=!1;m.parent=a;var l=m.themeClass;l?((l=l.replace("tooltip",""))&&(l=" "+l),l="tooltip"+l):l="tooltip";m.themeClass=l;m=this._contentsView=new p.TextView(m);m._clientDiv.contentEditable=!1;m.addEventListener("LineStyle",function(a){h.onLineStyle(a)});m.setModel(c);c=m.computeSize();a.style.width=c.width+"px";a.style.height=c.height+"px";m.resize()}else return;a=f.ownerDocument.documentElement;
d.anchor==="right"?(c=a.clientWidth-d.x,f.style.right=c+"px"):(c=parseInt(this._getNodeStyle(f,"padding-left","0"),10),c+=parseInt(this._getNodeStyle(f,"border-left-width","0"),10),c=d.x-c,f.style.left=c+"px");f.style.maxWidth=a.clientWidth-c-10+"px";c=parseInt(this._getNodeStyle(f,"padding-top","0"),10);c+=parseInt(this._getNodeStyle(f,"border-top-width","0"),10);c=d.y-c;f.style.top=c+"px";f.style.maxHeight=a.clientHeight-c-10+"px";f.style.opacity="1";f.style.visibility="visible";if(b){var n=this,
q=this._getWindow();n._hideTimeout=q.setTimeout(function(){var a=parseFloat(n._getNodeStyle(f,"opacity","1"));n._fadeTimeout=q.setInterval(function(){f.style.visibility==="visible"&&a>0?(a-=0.1,f.style.opacity=a):n.hide()},50)},5E3)}}}},_getAnnotationContents:function(b){function d(c){var b=c.title;if(b==="")return null;var h="<div>";c.html&&(h+=c.html+"&nbsp;");if(!b)b=c.end,c=a.getLineStart(a.getLineAtOffset(c.start)),b=a.getLineEnd(a.getLineAtOffset(b),!0),b=a.getText(c,b);b=b.replace(/</g,"&lt;").replace(/>/g,
"&gt;");h+="<span style='vertical-align:middle;'>"+b+"</span><div>";return h}if(b.length===0)return null;var f=this._view.getModel(),a=f.getBaseModel?f.getBaseModel():f;if(b.length===1)if(f=b[0],f.title!==void 0)return d(f);else{var b=new e.ProjectionTextModel(a),c=a.getLineStart(a.getLineAtOffset(f.start)),h=a.getCharCount();f.end!==h&&b.addProjection({start:f.end,end:h});c>0&&b.addProjection({start:0,end:c});return b}else{c="<div><em>"+k.multipleAnnotations+"</em></div>";for(h=0;h<b.length;h++)f=
...
define("orion/editor/rulers",["i18n!orion/editor/nls/messages","orion/editor/annotations","orion/editor/tooltip","orion/util"],function(k,p,o,e){function b(a,c,b,d){this._location=c||"left";this._overview=b||"page";this._rulerStyle=d;this._view=null;var f=this;this._listener={onTextModelChanged:function(a){f._onTextModelChanged(a)},onAnnotationModelChanged:function(a){f._onAnnotationModelChanged(a)}};this.setAnnotationModel(a)}function d(a,c,h,d,f){b.call(this,a,c,"page",h);this._oddStyle=d||{style:{backgroundColor:"white"}};
this._evenStyle=f||{style:{backgroundColor:"white"}};this._numOfDigits=0}function i(a,c,h){b.call(this,a,c,"page",h)}function j(a,c,h){b.call(this,a,c,"document",h)}function f(a,c,b){i.call(this,a,c,b)}b.prototype={getAnnotations:function(a,c){var b=this._annotationModel;if(!b)return[];var d=this._view.getModel(),f=d.getLineStart(a),n=d.getLineEnd(c-1),e=d;d.getBaseModel&&(e=d.getBaseModel(),f=d.mapOffset(f),n=d.mapOffset(n));for(var i=[],b=this.getAnnotationsByType(b,f,n),f=0;f<b.length;f++)for(var n=
b[f],j=e.getLineAtOffset(n.start),k=e.getLineAtOffset(Math.max(n.start,n.end-1)),g=j;g<=k;g++){var o=g;if(d!==e){o=e.getLineStart(g);o=d.mapOffset(o,!0);if(o===-1)continue;o=d.getLineAtOffset(o)}if(a<=o&&o<c){var p=this._mergeAnnotation(i[o],n,g-j,k-j+1);p&&(i[o]=p)}}if(!this._multiAnnotation&&this._multiAnnotationOverlay)for(var w in i)i[w]._multiple&&(i[w].html+=this._multiAnnotationOverlay.html);return i},getAnnotationModel:function(){return this._annotationModel},getLocation:function(){return this._location},
...
a},setView:function(a){this._onTextModelChanged&&this._view&&this._view.removeEventListener("ModelChanged",this._listener.onTextModelChanged);this._view=a;this._onTextModelChanged&&this._view&&this._view.addEventListener("ModelChanged",this._listener.onTextModelChanged)},onClick:function(a){if(a!==void 0){var c=this._view,b=c.getModel(),d=b,f=b.getLineStart(a),n=f,e=this._annotationModel;if(e){n=c.getSelection();c=Math.max(n.start,n.end);n=b.getLineEnd(a,!0);f<=c&&c<b.getLineEnd(a)&&(f=c+1);b.getBaseModel&&
(f=b.mapOffset(f),n=b.mapOffset(n),d=b.getBaseModel());for(var i,a=e.getAnnotations(f,n);!i&&a.hasNext();)n=a.next(),this.isAnnotationTypeVisible(n.type)&&(i=n);i&&d.getLineAtOffset(i.start)===d.getLineAtOffset(f)?(f=i.start,n=i.end):n=f;b.getBaseModel&&(f=b.mapOffset(f,!0),n=b.mapOffset(n,!0))}(b=o.Tooltip.getTooltip(this._view))&&b.setTarget(null);this._view.setSelection(n,f,1/3,function(){})}},onDblClick:function(){},onMouseMove:function(a,c){var b=o.Tooltip.getTooltip(this._view);if(b&&!(b.isVisible()&&
this._tooltipLineIndex===a)){this._tooltipLineIndex=a;var d=this;b.setTarget({y:c.clientY,getTooltipInfo:function(){return d._getTooltipInfo(d._tooltipLineIndex,this.y)}})}},onMouseOver:function(a,c){this.onMouseMove(a,c)},onMouseOut:function(){var a=o.Tooltip.getTooltip(this._view);a&&a.setTarget(null)},_getTooltipInfo:function(a,c){if(a!==void 0){var b=this._view,d=b.getModel(),f=this._annotationModel,e=[];if(f){var e=d.getLineStart(a),i=d.getLineEnd(a);d.getBaseModel&&(e=d.mapOffset(e),i=d.mapOffset(i));
e=this.getAnnotationsByType(f,e,i)}f=this._getTooltipContents(a,e);if(!f)return null;f={contents:f,anchor:this.getLocation()};e=b.getClientArea();e.y=this.getOverview()==="document"?b.convert({y:c},"view","document").y:b.getLocationAtOffset(d.getLineStart(a)).y;b.convert(e,"document","page");f.x=e.x;f.y=e.y;f.anchor==="right"&&(f.x+=e.width);return f}},_getTooltipContents:function(a,c){return c},_onAnnotationModelChanged:function(a){function c(a){for(var c=0;c<a.length;c++)if(f.isAnnotationTypeVisible(a[c].type)){var e=
a[c].start,n=a[c].end;d.getBaseModel&&(e=d.mapOffset(e,!0),n=d.mapOffset(n,!0));e!==-1&&n!==-1&&b.redrawLines(d.getLineAtOffset(e),d.getLineAtOffset(Math.max(e,n-1))+1,f)}}var b=this._view;if(b){var d=b.getModel(),f=this,e=d.getLineCount();a.textModelChangedEvent?(a=a.textModelChangedEvent.start,d.getBaseModel&&(a=d.mapOffset(a,!0)),a=d.getLineAtOffset(a),b.redrawLines(a,e,f)):(c(a.added),c(a.removed),c(a.changed))}},_mergeAnnotation:function(a,c,b){a||(a={});if(b===0)if(a.html&&c.html){if(c.html!==
...
1&&c[0].expanded?null:i.prototype._getTooltipContents.call(this,a,c)};f.prototype._onAnnotationModelChanged=function(a){function c(a){for(e=0;e<a.length;e++)if(f.isAnnotationTypeVisible(a[e].type)){var c=a[e].start;d.getBaseModel&&(c=d.mapOffset(c,!0));c!==-1&&(k=Math.min(k,d.getLineAtOffset(c)))}}if(a.textModelChangedEvent)i.prototype._onAnnotationModelChanged.call(this,a);else{var b=this._view;if(b){var d=b.getModel(),f=this,e,j=d.getLineCount(),k=j;c(a.added);c(a.removed);c(a.changed);a=b.getRulers();
for(e=0;e<a.length;e++)b.redrawLines(k,j,a[e])}}};return{Ruler:b,AnnotationRuler:i,LineNumberRuler:d,OverviewRuler:j,FoldingRuler:f}});
define("orion/editor/undoStack",[],function(){function k(e,b,d){this.offset=e;this.text=b;this.previousText=d}function p(e){this.owner=e;this.changes=[]}function o(e,b){this.view=e;this.size=b!==void 0?b:100;this.reset();var d=e.getModel();d.getBaseModel&&(d=d.getBaseModel());this.model=d;var i=this;this._listener={onChanging:function(b){i._onChanging(b)},onDestroy:function(b){i._onDestroy(b)}};d.addEventListener("Changing",this._listener.onChanging);e.addEventListener("Destroy",this._listener.onDestroy)}
k.prototype={undo:function(e,b){this._doUndoRedo(this.offset,this.previousText,this.text,e,b);return!0},redo:function(e,b){this._doUndoRedo(this.offset,this.text,this.previousText,e,b);return!0},_doUndoRedo:function(e,b,d,i,j){var f=i.getModel();if(f.mapOffset&&i.annotationModel){var a=f.mapOffset(e,!0);if(a<0)for(var c=i.annotationModel.getAnnotations(e,e+1);c.hasNext();){var h=c.next();if(h.type==="orion.annotation.folding"){h.expand();a=f.mapOffset(e,!0);break}}if(a<0)return;e=a}f.setText(b,e,
e+d.length);j&&i.setSelection(e,e+b.length)}};p.prototype={add:function(e){this.changes.push(e)},end:function(e){this.endSelection=e.getSelection();this.endCaret=e.getCaretOffset();(e=this.owner)&&e.end&&e.end()},undo:function(e,b){this.changes.length>1&&e.setRedraw(!1);for(var d=this.changes.length-1;d>=0;d--)this.changes[d].undo(e,!1);this.changes.length>1&&e.setRedraw(!0);if(b){var d=this.startSelection.start,i=this.startSelection.end;e.setSelection(this.startCaret?d:i,this.startCaret?i:d)}(d=
this.owner)&&d.undo&&d.undo();return this.changes.length>0},redo:function(e,b){this.changes.length>1&&e.setRedraw(!1);for(var d=0;d<this.changes.length;d++)this.changes[d].redo(e,!1);this.changes.length>1&&e.setRedraw(!0);if(b){var d=this.endSelection.start,i=this.endSelection.end;e.setSelection(this.endCaret?d:i,this.endCaret?i:d)}(d=this.owner)&&d.redo&&d.redo();return this.changes.length>0},start:function(e){this.startSelection=e.getSelection();this.startCaret=e.getCaretOffset();(e=this.owner)&&
...
"",this._undoText)):this.add(new k(this._undoStart,this._undoText,"")),this._undoStart=void 0,this._undoText="",this._undoType=0;this.endCompoundChange()},_onDestroy:function(){this.model.removeEventListener("Changing",this._listener.onChanging);this.view.removeEventListener("Destroy",this._listener.onDestroy)},_onChanging:function(e){var b=e.text,d=e.start,i=e.removedCharCount,e=e.addedCharCount;if(!this._ignoreUndo){this._undoStart!==void 0&&!(e===1&&i===0&&this._undoType===1&&d===this._undoStart+
this._undoText.length||e===0&&i===1&&this._undoType===-1&&(d+1===this._undoStart||d===this._undoStart))&&this._commitUndo();if(!this.compoundChange)if(e===1&&i===0){if(this._undoStart===void 0)this._undoStart=d;this._undoText+=b;this._undoType=1;return}else if(e===0&&i===1){b=this._undoText.length>0&&this._undoStart===d;this._undoStart=d;this._undoType=-1;b?this._undoText+=this.model.getText(d,d+i):this._undoText=this.model.getText(d,d+i)+this._undoText;return}this.add(new k(d,b,this.model.getText(d,
d+i)))}}};return{UndoStack:o}});
...
if(!e)return null;var l=c.getOffsetAtLocation(b,a);if(l===-1)return null;l=this.mapOffset(l);e=e.getAnnotationsByType(d,l,l+1);d=[];for(l=0;l<e.length;l++)e[l].rangeStyle&&d.push(e[l]);if(d.length===0)return null;c=c.convert({x:b,y:a},"document","page");return{contents:d,anchor:"left",x:c.x+10,y:c.y+20}},_highlightCurrentLine:function(d,a){var c=this._annotationModel;if(c){var h=this._textView.getModel(),e=a?h.getLineAtOffset(a.start):-1,l=h.getLineAtOffset(d.start),n=d.start===d.end,i=!a||a.start===
a.end,j=h.getLineStart(l),k=h.getLineEnd(l);h.getBaseModel&&(j=h.mapOffset(j),k=h.mapOffset(k));h=this._currentLineAnnotation;if(!(e===l&&i&&n&&h&&h.start===j&&h.end===k)){var e=h?[h]:null,o;n&&(h=b.AnnotationType.createAnnotation(b.AnnotationType.ANNOTATION_CURRENT_LINE,j,k),o=[h]);this._currentLineAnnotation=h;c.replaceAnnotations(e,o)}}},installTextView:function(){this._textView=this._textViewFactory();if(this._undoStackFactory)this._undoStack=this._undoStackFactory.createUndoStack(this);if(this._textDNDFactory)this._textDND=
...
this._keyBindingFactory.createKeyBindings(d,this._undoStack,this._contentAssist));var h=function(a){if(a!==void 0&&a!==-1){for(var c=this.getView().getModel(),h=this.getAnnotationModel(),e=d.mapOffset(c.getLineStart(a)),a=d.mapOffset(c.getLineEnd(a)),c=h.getAnnotations(e,a),m=null;c.hasNext();){var g=c.next();if(g.type===b.AnnotationType.ANNOTATION_BOOKMARK){m=g;break}}m?h.removeAnnotation(m):(m=b.AnnotationType.createAnnotation(b.AnnotationType.ANNOTATION_BOOKMARK,e,a),m.title=void 0,h.addAnnotation(m))}};
...
textView:b})},_updateCursorStatus:function(){var b=this.getModel(),a=this.getCaretOffset(),c=b.getLineAtOffset(a),b=b.getLineStart(c);a-=b;for(var b=this.getKeyModes(),h=0;h<b.length;h++){var e=b[h];if(e.isActive()&&e.isStatusActive&&e.isStatusActive())return}this.reportStatus(d.formatMessage(k.lineColumn,c+1,a+1))},showProblems:function(d){var a=this._annotationModel;if(a){for(var c=[],h=[],e=a.getTextModel(),l=a.getAnnotations(0,e.getCharCount()),n;l.hasNext();)n=l.next(),(n.type===b.AnnotationType.ANNOTATION_ERROR||
n.type===b.AnnotationType.ANNOTATION_WARNING)&&c.push(n);if(d)for(l=0;l<d.length;l++)if(n=d[l]){var i=n.description.replace(/'/g,"&#39;").replace(/"/g,"&#34;"),j=e.getLineStart(n.line-1);n=b.AnnotationType.createAnnotation(n.severity==="error"?b.AnnotationType.ANNOTATION_ERROR:b.AnnotationType.ANNOTATION_WARNING,j+n.start-1,j+n.end,i);h.push(n)}a.replaceAnnotations(c,h)}},showOccurrences:function(d){var a=this._annotationModel;if(a){for(var c=[],h=[],e=a.getTextModel(),l=a.getAnnotations(0,e.getCharCount()),
n;l.hasNext();)n=l.next(),(n.type===b.AnnotationType.ANNOTATION_READ_OCCURRENCE||n.type===b.AnnotationType.ANNOTATION_WRITE_OCCURRENCE)&&c.push(n);if(d)for(l=0;l<d.length;l++)if(n=d[l]){var i=e.getLineStart(n.line-1);n=b.AnnotationType.createAnnotation(n.readAccess===!0?b.AnnotationType.ANNOTATION_READ_OCCURRENCE:b.AnnotationType.ANNOTATION_WRITE_OCCURRENCE,i+n.start-1,i+n.end,n.description);h.push(n)}a.replaceAnnotations(c,h)}},showSelection:function(b,a,c,d,e){typeof b==="number"?(typeof a!=="number"&&
...
this._textView.focus()));this.onInputChanged({type:"InputChanged",title:b,message:a,contents:c,contentsSaved:d})},onInputChanged:function(b){return this.dispatchEvent(b)},onGotoLine:function(b,a,c){if(this._textView){var d=this.getModel(),b=Math.max(0,Math.min(b,d.getLineCount()-1)),e=d.getLineStart(b),l=0;c===void 0&&(c=0);typeof a==="string"?(b=d.getLine(b).indexOf(a),b!==-1&&(l=b,c=l+a.length)):(l=a,a=d.getLineEnd(b)-e,l=Math.min(l,a),c=Math.min(c,a));this.moveSelection(e+l,e+c)}},onDirtyChanged:function(b){return this.dispatchEvent(b)}};
o.EventTarget.addMixin(i.prototype);if(!Function.prototype.bind)Function.prototype.bind=j;return{Editor:i}});define("orion/editor/regex",[],function(){return{escape:function(k){return k.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&")},parse:function(k){return(k=/^\s*\/(.+)\/([gim]{0,3})\s*$/.exec(k))?{pattern:k[1],flags:k[2]}:null}}});
...
define("orion/editor/find","i18n!orion/editor/nls/messages,orion/keyBinding,orion/editor/keyModes,orion/editor/annotations,orion/editor/regex,orion/objects,orion/util".split(","),function(k,p,o,e,b,d,i){function j(a){var d=a.getTextView();o.KeyMode.call(this,d);this.editor=a;this._active=!1;this._success=!0;this._ignoreSelection=!1;this._prefix="";d.setAction("incrementalFindCancel",function(){this.setActive(!1);return!0}.bind(this));d.setAction("incrementalFindBackspace",function(){return this._backspace()}.bind(this));
var f=this;this._listener={onVerify:function(a){var c=f.editor,d=c.getModel(),h=c.mapOffset(a.start),c=c.mapOffset(a.end),d=d.getText(h,c);if((d=f._prefix.match(RegExp("^"+b.escape(d),"i")))&&d.length>0)f._prefix+=a.text,f._success=!0,f._status(),f.find(f._forward,!0),a.text=null},onSelection:function(){f._ignoreSelection||f.setActive(!1)}}}function f(a,b,d){if(a){this._editor=a;this._undoStack=b;this._showAll=!0;this._visible=!1;this._wrap=this._caseInsensitive=!0;this._wholeWord=!1;this._incremental=
...
a.length-1);return a.length===0?(this._ignoreSelection=this._success=!0,this.editor.setCaretOffset(this.editor.getSelection().start),this._ignoreSelection=!1,this._status(),!0):this.find(this._forward,!0)},_status:function(){if(this.isActive()){var a;a=this._forward?this._success?k.incrementalFindStr:k.incrementalFindStrNotFound:this._success?k.incrementalFindReverseStr:k.incrementalFindReverseStrNotFound;a=i.formatMessage(a,this._prefix);this.editor.reportStatus(a,this._success?"":"error")}else this.editor.reportStatus("")}});
...
this._undoStack.startCompoundChange()},endUndo:function(){this._undoStack&&this._undoStack.endCompoundChange()},_doFind:function(a,b,d){var d=d||1,f=this._editor;if(!a)return this._removeAllAnnotations(),null;this._lastString=a;for(var b=f.getModel().find({string:a,start:b,end:this._end,reverse:this._reverse,wrap:this._wrap,regex:this._regex,wholeWord:this._wholeWord,caseInsensitive:this._caseInsensitive}),n,i=0;i<d&&b.hasNext();i++)n=b.next();if(!this._replacingAll){n?this._editor.reportStatus(""):
this._editor.reportStatus(k.notFound,"error");if(this.isVisible()){d=e.AnnotationType.ANNOTATION_CURRENT_SEARCH;if(b=f.getAnnotationModel())b.removeAnnotations(d),n&&b.addAnnotation(e.AnnotationType.createAnnotation(d,n.start,n.end));if(this._showAll){this._timer&&window.clearTimeout(this._timer);var j=this;this._timer=window.setTimeout(function(){j._markAllOccurrences(!!n,a);j._timer=null},500)}}n&&f.moveSelection(n.start,n.end,null,!1)}return n},_doReplace:function(a,b,d,f){var e=this._editor;if(this._regex&&
(f=e.getText(a,b).replace(RegExp(d,this._caseInsensitive?"i":""),f),!f))return;e.setText(f,a,b);e.setSelection(a,a+f.length,!0)},_markAllOccurrences:function(a,b){var d=this._editor.getAnnotationModel();if(d){for(var f=e.AnnotationType.ANNOTATION_MATCHING_SEARCH,n=d.getAnnotations(0,d.getTextModel().getCharCount()),i=[],j;n.hasNext();){var k=n.next();k.type===f&&i.push(k)}if(this.isVisible()&&a&&b){n=this._editor.getModel().find({string:b,regex:this._regex,wholeWord:this._wholeWord,caseInsensitive:this._caseInsensitive});
for(j=[];n.hasNext();)k=n.next(),j.push(e.AnnotationType.createAnnotation(f,k.start,k.end))}d.replaceAnnotations(i,j)}},_removeAllAnnotations:function(){var a=this._editor.getAnnotationModel();a&&(a.removeAnnotations(e.AnnotationType.ANNOTATION_CURRENT_SEARCH),a.removeAnnotations(e.AnnotationType.ANNOTATION_MATCHING_SEARCH))},_removeCurrentAnnotation:function(){var a=this._editor.getAnnotationModel();a&&a.removeAnnotations(e.AnnotationType.ANNOTATION_CURRENT_SEARCH)}};a.Find=f;return a});
define("orion/editor/actions","i18n!orion/editor/nls/messages,orion/keyBinding,orion/editor/annotations,orion/editor/tooltip,orion/editor/find,orion/util".split(","),function(k,p,o,e,b,d){function i(a,c,d){this.editor=a;this.undoStack=c;this._incrementalFind=new b.IncrementalFind(a);this._find=d?d:new b.Find(a,c);this._lastEditLocation=null;this.init()}function j(a,c,b,d){this.editor=a;this.undoStack=c;this.contentAssist=b;this.linkedMode=d;this.contentAssist&&this.contentAssist.addEventListener("ProposalApplied",
this.contentAssistProposalApplied.bind(this));this.init()}var f={};i.prototype={init:function(){var a=this.editor.getTextView();this._lastEditListener={onModelChanged:function(a){if(this.editor.isDirty())this._lastEditLocation=a.start+a.addedCharCount}.bind(this)};a.addEventListener("ModelChanged",this._lastEditListener.onModelChanged);a.setAction("undo",function(){return this.undoStack?(this.undoStack.undo(),!0):!1}.bind(this),{name:k.undo});a.setAction("redo",function(){return this.undoStack?(this.undoStack.redo(),
...
d=c.getLineEnd(b,!0),e=c.getLineCount(),i="",f=c.getText(f,d);b===e-1&&(f=(i=c.getLineDelimiter())+f);a.setText(f,d,d);a.setSelection(d+i.length,d+f.length);return!0},copyLinesUp:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getModel(),b=a.getSelection(),d=c.getLineAtOffset(b.start),b=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),d=c.getLineStart(d),f=c.getLineEnd(b,!0),e=c.getLineCount(),i="",f=c.getText(d,f);b===e-1&&(f+=i=c.getLineDelimiter());a.setText(f,
d,d);a.setSelection(d,d+f.length-i.length);return!0},deleteLines:function(a){var c=this.editor;if(c.getTextView().getOptions("readonly"))return!1;var b=1;if(a&&a.count)b=a.count;var d=c.getSelection(),f=c.getModel(),e=f.getLineAtOffset(d.start),a=f.getLineStart(e),b=d.start!==d.end||b===1?f.getLineAtOffset(d.end>d.start?d.end-1:d.end):Math.min(e+b-1,f.getLineCount()-1),b=f.getLineEnd(b,!0);c.setText("",a,b);return!0},expandAnnotation:function(a){var c=this.editor,b=c.getAnnotationModel();if(!b)return!0;
var d=c.getModel(),f=c.getCaretOffset(),e=d.getLineAtOffset(f),f=d.getLineStart(e),e=d.getLineEnd(e,!0);d.getBaseModel&&(f=d.mapOffset(f),e=d.mapOffset(e),d.getBaseModel());for(var i,d=b.getAnnotations(f,e);!i&&d.hasNext();)f=d.next(),f.type===o.AnnotationType.ANNOTATION_FOLDING&&(i=f);i&&a!==i.expanded&&(a?i.expand():(c.setCaretOffset(i.start),i.collapse()),b.modifyAnnotation(i));return!0},expandAnnotations:function(a){var c=this.editor,b=c.getTextView(),d=c.getAnnotationModel();if(!d)return!0;var c=
c.getModel(),f=d.getAnnotations(0,c.getCharCount());for(b.setRedraw(!1);f.hasNext();)c=f.next(),c.type===o.AnnotationType.ANNOTATION_FOLDING&&a!==c.expanded&&(a?c.expand():c.collapse(),d.modifyAnnotation(c));b.setRedraw(!0);return!0},indentLines:function(){var a=this.editor,c=a.getTextView();if(c.getOptions("readonly"))return!1;if(c.getOptions("tabMode")){var b=a.getModel(),d=a.getSelection(),f=b.getLineAtOffset(d.start),e=b.getLineAtOffset(d.end>d.start?d.end-1:d.end);if(f!==e){var i=[];i.push("");
for(var j=f;j<=e;j++)i.push(b.getLine(j,!0));j=b.getLineStart(f);b=b.getLineEnd(e,!0);c=c.getOptions("tabSize","expandTab");c=c.expandTab?Array(c.tabSize+1).join(" "):"\t";a.setText(i.join(c),j,b);a.setSelection(j===d.start?d.start:d.start+c.length,d.end+(e-f+1)*c.length);return!0}return!1}},gotoLastEdit:function(){typeof this._lastEditLocation==="number"&&this.editor.showSelection(this._lastEditLocation);return!0},gotoLine:function(){var a=this.editor,c=a.getModel().getLineAtOffset(a.getCaretOffset());
if(c=prompt(k.gotoLinePrompty,c+1))c=parseInt(c,10),a.onGotoLine(c-1,0);return!0},moveLinesDown:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getModel(),b=a.getSelection(),d=c.getLineAtOffset(b.start),f=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),e=c.getLineCount();if(f===e-1)return!0;var d=c.getLineStart(d),b=c.getLineEnd(f,!0),i=c.getLineEnd(f+1,!0)-(b-d),j=0;f!==e-2?c=c.getText(d,b):(f=c.getLineEnd(f),c=c.getText(f,b)+c.getText(d,f),j+=b-f);this.startUndo();
a.setText("",d,b);a.setText(c,i,i);a.setSelection(i+j,i+j+c.length);this.endUndo();return!0},moveLinesUp:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var b=a.getModel(),d=a.getSelection(),f=b.getLineAtOffset(d.start);if(f===0)return!0;var e=b.getLineAtOffset(d.end>d.start?d.end-1:d.end),i=b.getLineCount(),d=b.getLineStart(f-1),j=b.getLineStart(f),k=b.getLineEnd(e,!0),o=b.getText(j,k),p=0;e===i-1&&(e=b.getLineEnd(f-1),f=b.getLineEnd(f-1,!0),o+=b.getText(e,f),j=e,
p=f-e);this.startUndo();a.setText("",j,k);a.setText(o,d,d);a.setSelection(d,d+o.length-p);this.endUndo();return!0},nextAnnotation:function(a){var b=this.editor,d=b.getAnnotationModel();if(!d)return!0;for(var f=b.getModel(),i=b.getCaretOffset(),d=d.getAnnotations(a?i:0,a?f.getCharCount():i),n=null;d.hasNext();){var j=d.next();if(a){if(j.start<=i)continue}else if(j.start>=i)continue;switch(j.type){case o.AnnotationType.ANNOTATION_ERROR:case o.AnnotationType.ANNOTATION_WARNING:case o.AnnotationType.ANNOTATION_TASK:case o.AnnotationType.ANNOTATION_BOOKMARK:break;
default:continue}n=j;if(a)break}if(n){var k=b.getTextView(),t=f.getLineAtOffset(n.start),p=e.Tooltip.getTooltip(k);if(!p)return b.moveSelection(n.start),!0;b.moveSelection(n.start,n.start,function(){p.setTarget({getTooltipInfo:function(){var a=k.convert({x:k.getLocationAtOffset(n.start).x,y:k.getLocationAtOffset(f.getLineStart(t)).y},"document","page");return{contents:[n],x:a.x,y:a.y+Math.floor(k.getLineHeight(t)*1.33)}}},0)})}return!0},unindentLines:function(){var a=this.editor,b=a.getTextView();
if(b.getOptions("readonly"))return!1;if(b.getOptions("tabMode")){for(var d=a.getModel(),f=a.getSelection(),e=d.getLineAtOffset(f.start),i=d.getLineAtOffset(f.end>f.start?f.end-1:f.end),j=b.getOptions("tabSize"),k=Array(j+1).join(" "),o=[],p=b=0,g=e;g<=i;g++){var s=d.getLine(g,!0);if(d.getLineStart(g)!==d.getLineEnd(g))if(s.indexOf("\t")===0)s=s.substring(1),b++;else if(s.indexOf(k)===0)s=s.substring(j),b+=j;else return!0;g===e&&(p=b);o.push(s)}e=d.getLineStart(e);j=d.getLineEnd(i,!0);d=d.getLineStart(i);
a.setText(o.join(""),e,j);i=e===f.start?f.start:f.start-p;f=Math.max(i,f.end-b+(f.end===d+1&&f.start!==f.end?1:0));a.setSelection(i,f);return!0}},startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()}};f.TextActions=i;j.prototype={init:function(){var a=this.editor.getTextView();a.setAction("lineStart",function(){return this.lineStart()}.bind(this));a.setAction("enter",function(){return this.autoIndent()}.bind(this));
a.setKeyBinding(new p.KeyBinding(191,!0),"toggleLineComment");a.setAction("toggleLineComment",function(){return this.toggleLineComment()}.bind(this),{name:k.toggleLineComment});a.setKeyBinding(new p.KeyBinding(191,!0,!d.isMac,!1,d.isMac),"addBlockComment");a.setAction("addBlockComment",function(){return this.addBlockComment()}.bind(this),{name:k.addBlockComment});a.setKeyBinding(new p.KeyBinding(220,!0,!d.isMac,!1,d.isMac),"removeBlockComment");a.setAction("removeBlockComment",function(){return this.removeBlockComment()}.bind(this),
{name:k.removeBlockComment})},autoIndent:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var b=a.getSelection();if(b.start===b.end){for(var d=a.getModel(),f=d.getLineAtOffset(b.start),e=d.getLine(f,!0),i=d.getLineStart(f),f=0,i=b.start-i,j;f<i&&((j=e.charCodeAt(f))===32||j===9);)f++;if(f>0){for(var k=e.substring(0,f),f=i;f<e.length&&((j=e.charCodeAt(f++))===32||j===9);)b.end++;a.setText(d.getLineDelimiter()+k,b.start,b.end);return!0}}return!1},addBlockComment:function(){var a=
...
[],d=0;d<a.positions.length;++d)b[d]={positions:[{offset:a.positions[d].offset,length:a.positions[d].length}]};this.linkedMode.enterLinkedMode({groups:b,escapePosition:a.escapePosition})}else a.groups&&a.groups.length>0&&this.linkedMode?this.linkedMode.enterLinkedMode({groups:a.groups,escapePosition:a.escapePosition}):a.escapePosition&&this.editor.getTextView().setCaretOffset(a.escapePosition);return!0},_findEnclosingComment:function(a,b,d){var f=a.getLineAtOffset(b),e=a.getLineAtOffset(d),i,j,k,
o,p,g;for(i=f;i>=0;i--)if(j=a.getLine(i),k=i===f?b-a.getLineStart(f):j.length,o=j.lastIndexOf("/*",k),j=j.lastIndexOf("*/",k),j>o)break;else if(o!==-1){p=a.getLineStart(i)+o;break}for(i=e;i<a.getLineCount();i++)if(j=a.getLine(i),k=i===e?d-a.getLineStart(e):0,o=j.indexOf("/*",k),j=j.indexOf("*/",k),o!==-1&&o<j)break;else if(j!==-1){g=a.getLineStart(i)+j;break}return{commentStart:p,commentEnd:g}},lineStart:function(){for(var a=this.editor,b=a.getModel(),d=a.getCaretOffset(),f=b.getLineAtOffset(d),e=
b.getLineStart(f),b=b.getLine(f),f=0;f<b.length;f++){var i=b.charCodeAt(f);if(!(i===32||i===9))break}f+=e;return d!==f?(a.setSelection(f,f),!0):!1},removeBlockComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var b=a.getModel(),d=a.getSelection(),f=b.getText(d.start,d.end),e,i,j;for(j=0;j<f.length;j++)if(f.substring(j,j+2)==="/*"){e=d.start+j;break}for(;j<f.length;j++)if(f.substring(j,j+2)==="*/"){i=d.start+j;break}if(e!==void 0&&i!==void 0)a.setText(b.getText(e+
2,i),e,i+2),a.setSelection(e,i);else{f=this._findEnclosingComment(b,d.start,d.end);if(f.commentStart===void 0||f.commentEnd===void 0)return!0;b=b.getText(f.commentStart+2,f.commentEnd);a.setText(b,f.commentStart,f.commentEnd+2);a.setSelection(d.start-2,d.end-2)}return!0},toggleLineComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;for(var b=a.getModel(),d=a.getSelection(),f=b.getLineAtOffset(d.start),e=b.getLineAtOffset(d.end>d.start?d.end-1:d.end),i=!0,j=[],k,
o,p=f;p<=e;p++)if(k=b.getLine(p,!0),j.push(k),!i||(o=k.indexOf("//"))===-1)i=!1;else if(o!==0){var g;for(g=0;g<o;g++)if(i=k.charCodeAt(g),!(i===32||i===9))break;i=g===o}p=b.getLineStart(f);g=b.getLineEnd(e,!0);if(i){for(i=0;i<j.length;i++)k=j[i],o=k.indexOf("//"),j[i]=k.substring(0,o)+k.substring(o+2);j=j.join("");k=b.getLineStart(e);b=p===d.start?d.start:d.start-2;d=d.end-2*(e-f+1)+(d.end===k+1?2:0)}else j.splice(0,0,""),j=j.join("//"),b=p===d.start?d.start:d.start+2,d=d.end+2*(e-f+1);a.setText(j,
p,g);a.setSelection(b,d);return!0},startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()}};f.SourceCodeActions=j;return f});
define("orion/editor/templates",[],function(){function k(k,e,b){this.prefix=k;this.description=e;this.template=b;this._parse()}function p(k,e){this._keywords=k||[];this._templates=[];this.addTemplates(e||[])}k.prototype={getProposal:function(k,e,b){var k=e-k.length,e={},d,i=b.delimiter!==void 0?b.delimiter:"\n";b.indentation&&(i+=b.indentation);for(var j=b.tab!==void 0?b.tab:"\t",f=0,a=this.variables,c=this.segments,b=[],h=0;h<c.length;h++){var m=c[h],l=a[m];if(l!==void 0)switch(m){case "${tab}":m=
j;break;case "${delimiter}":m=i;break;case "${cursor}":m="";d=f;break;default:var n=e[m];n||(n=e[m]={data:l.data,positions:[]});m=l.substitution;n.data&&n.data.values&&(m=n.data.values[0]);n.positions.push({offset:k+f,length:m.length})}b.push(m);f+=m.length}var i=[],q;for(q in e)e.hasOwnProperty(q)&&i.push(e[q]);b=b.join("");if(d===void 0)d=b.length;return{proposal:b,description:this.description,groups:i,escapePosition:k+d}},match:function(k){return this.prefix.indexOf(k)===0},_parse:function(){var k=
this.template,e=[],b={},d,i=0,k=k.replace(/\n/g,"${delimiter}"),k=k.replace(/\t/g,"${tab}");k.replace(/\$\{((?:[^\\}]+|\\.))*\}/g,function(j,f,a){var c=j.substring(2,j.length-1),f=j,h=c,m=null,l=h.indexOf(":");l!==-1&&(h=h.substring(0,l),f="${"+h+"}",m=JSON.parse(c.substring(l+1).replace("\\}","}").trim()));(c=b[f])||(c=b[f]={});c.substitution=h;if(m)c.data=m;(d=k.substring(i,a))&&e.push(d);e.push(f);i=a+j.length;return h});(d=k.substring(i,k.length))&&e.push(d);this.segments=e;this.variables=b}};
p.prototype={addTemplates:function(o){for(var e=this.getTemplates(),b=0;b<o.length;b++)e.push(new k(o[b].prefix,o[b].description,o[b].template))},computeProposals:function(k,e,b){var d=this.getPrefix(k,e,b),i=[];if(!this.isValid(d,k,e,b))return i;i=i.concat(this.getTemplateProposals(d,e,b));return i=i.concat(this.getKeywordProposals(d))},getKeywords:function(){return this._keywords},getKeywordProposals:function(k){var e=[],b=this.getKeywords();if(b)for(var d=0;d<b.length;d++)b[d].indexOf(k)===0&&
e.push({proposal:b[d].substring(k.length),description:b[d]});return e},getPrefix:function(k,e,b){return b.prefix},getTemplates:function(){return this._templates},getTemplateProposals:function(k,e,b){for(var d=[],i=this.getTemplates(),j=0;j<i.length;j++){var f=i[j];f.match(k)&&(f=f.getProposal(k,e,b),this.removePrefix(k,f),d.push(f))}return d},removePrefix:function(k,e){if(!(e.overwrite=e.proposal.substring(0,k.length)!==k))e.proposal=e.proposal.substring(k.length)},isValid:function(){return!0}};return{Template:k,
TemplateContentAssist:p}});
define("orion/editor/linkedMode","i18n!orion/editor/nls/messages,orion/keyBinding,orion/editor/keyModes,orion/editor/annotations,orion/editor/templates,orion/objects,orion/util".split(","),function(k,p,o,e,b,d){function i(b,a,c){var d=b.getTextView();o.KeyMode.call(this,d);this.editor=b;this.undoStack=a;this.contentAssist=c;this.linkedModeModel=null;d.setAction("linkedModeEnter",function(){this.exitLinkedMode(!0);return!0}.bind(this));d.setAction("linkedModeCancel",function(){this.exitLinkedMode(!1);return!0}.bind(this));
...
a):""},a.offset=c.offset,a.deactivate(),a.activate();else if(this._groupContentAssistProvider)this._groupContentAssistProvider=null,a.deactivate()}this._updateAnnotations()},_getModelPositions:function(b,a,c){for(var d=a.groups,e=0;e<d.length;e++)for(var i=d[e].positions,n=0;n<i.length;n++){var j=i[n];c&&(j={offset:j.offset+c,length:j.length});j={index:n,group:e,count:i.length,model:a,position:j};b.push(j);if(a.nextModel&&a.nextModel.parentGroup===e)j.ansestor=!0,this._getModelPositions(b,a.nextModel,
(c||0)+i[n].offset-i[0].offset)}},_getSortedPositions:function(b){var a=this._sortedPositions;if(!a){for(a=[];b.previousModel;)b=b.previousModel;for(this._getModelPositions(a,b);b;)b.escapePosition!==void 0&&a.push({escape:!0,model:b,position:{offset:b.escapePosition,length:0}}),b=b.nextModel;a.sort(function(a,b){return a.position.offset-b.position.offset});this._sortedPositions=a}return a},_getPositionChanged:function(b,a,c){for(var d,b=this._getSortedPositions(b),e=b.length-1;e>=0;e--){var i=b[e].position;
if(i.offset<=a&&c<=i.offset+i.length){d=b[e];break}}return{position:d,positions:b}},_updateAnnotations:function(b){var a=this.editor.getAnnotationModel();if(a){for(var c=[],d=[],i=a.getTextModel(),i=a.getAnnotations(0,i.getCharCount()),j;i.hasNext();)switch(j=i.next(),j.type){case e.AnnotationType.ANNOTATION_LINKED_GROUP:case e.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP:case e.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:c.push(j)}if(i=this.linkedModeModel)for(var b=b||this._getSortedPositions(i),
n=0;n<b.length;n++)if(j=b[n],j.model===i){var k=e.AnnotationType.ANNOTATION_LINKED_GROUP;j.group===i.selectedGroupIndex&&(k=j.index===0?e.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:e.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP);j=j.position;j=e.AnnotationType.createAnnotation(k,j.offset,j.offset+j.length,"");d.push(j)}a.replaceAnnotations(c,d)}}});j.LinkedMode=i;return j});
define("orion/editor/factories","orion/editor/actions,orion/editor/undoStack,orion/editor/rulers,orion/editor/annotations,orion/editor/textDND,orion/editor/linkedMode".split(","),function(k,p,o,e,b,d){function i(){}function j(){}function f(){}function a(){}function c(){}function h(){}var m={};i.prototype={createKeyBindings:function(a,b,c,f){var f=new k.TextActions(a,b,f),e=new d.LinkedMode(a,b,c),a=new k.SourceCodeActions(a,b,c,e);return{textActions:f,linkedMode:e,sourceCodeActions:a}}};m.KeyBindingsFactory=
...
createAnnotationStyler:function(a,b){return new e.AnnotationStyler(a,b)},createAnnotationRulers:function(a){var b=new o.AnnotationRuler(a,"left",{styleClass:"ruler annotations"}),a=new o.OverviewRuler(a,"right",{styleClass:"ruler overview"});return{annotationRuler:b,overviewRuler:a}}};m.AnnotationFactory=c;h.prototype={createTextDND:function(a,c){return new b.TextDND(a.getTextView(),c)}};m.TextDNDFactory=h;return m});
...
(function(k,p){typeof define==="function"&&define.amd?define("orion/Deferred",p):typeof exports==="object"?module.exports=p():(k.orion=k.orion||{},k.orion.Deferred=p())})(this,function(){function k(){for(var a;a=i.shift()||j.shift();)a();f=!1}function p(a,b){(b?j:i).push(a);f||(f=!0,b?setTimeout(k,0):k())}function o(a){return function(){a.apply(null,arguments)}}function e(){}function b(){var a=Error("Cancel");a.name="Cancel";return a}function d(){function a(){for(var a;a=i.shift();){var b=a.deferred,
d=f==="resolved"?"resolve":"reject";if(typeof a[d]==="function")try{var j=a[d](c);j&&typeof j.then==="function"?(b.cancel=j.cancel||e,j.then(o(b.resolve),o(b.reject),b.progress)):b.resolve(j)}catch(l){b.reject(l)}else b[d](c)}}var c,f,i=[],j=this;this.reject=function(b){f||(f="rejected",c=b,i.length&&p(a));return j.promise};this.resolve=function(b){f||(f="resolved",c=b,i.length&&p(a));return j.promise};this.progress=function(a){f||i.forEach(function(b){b.progress&&b.progress(a)});return j.promise};
this.cancel=function(){f||j.reject(b())};this.then=function(b,c,e){var b={resolve:b,reject:c,progress:e,deferred:new d},k=b.deferred,o=!1,g=function(){o||(o=!0,p(function(){var a=k.cancel===g?j.cancel:k.cancel;typeof a==="function"&&a()},!0))};k.cancel=g;i.push(b);f&&p(a,!0);return k.promise};this.promise=Object.create(Object.prototype,{then:{value:j.then},cancel:{get:function(){return j.cancel},set:function(a){j.cancel=a}}})}var i=[],j=[],f=!1;d.all=function(a,b){function f(a,b){k||(j[a]=b,--i===
0&&o.resolve(j))}function e(a,d){if(!k){if(b)try{f(a,b(d));return}catch(g){d=g}o.reject(d)}}var i=a.length,j=[],k=!1,o=new d;o.then(null,function(){k=!0;a.forEach(function(a){a.cancel&&a.cancel()})});i===0?o.resolve(j):a.forEach(function(a,b){a.then(f.bind(null,b),e.bind(null,b))});return o.promise};d.when=function(a,b,f,e){var i;if(!(a&&typeof a.then==="function"))i=new d,i.resolve(a),a=i.promise;return a.then(b,f,e)};return d});
define("orion/editor/contentAssist","i18n!orion/editor/nls/messages,orion/keyBinding,orion/editor/keyModes,orion/editor/eventTarget,orion/Deferred,orion/objects,orion/util".split(","),function(k,p,o,e,b,d,i){var j,f,a;function c(b){this.textView=b;this.state=j;this.providers=[];var c=this;this.contentAssistListener={onModelChanging:function(b){c.isDeactivatingChange(b)?c.setState(j):c.state===f&&c.setState(a)},onScroll:function(){c.setState(j)},onSelection:function(){var b=c.state;if(b===f||b===a)c.computeProposals(),
c.setState(a)}};b.setKeyBinding(i.isMac?new p.KeyBinding(" ",!1,!1,!1,!0):new p.KeyBinding(" ",!0),"contentAssist");b.setAction("contentAssist",function(){c.activate();return!0},{name:k.contentAssist})}function h(a,b){var c=a.textView;o.KeyMode.call(this,c);this.contentAssist=a;this.widget=b;this.proposals=[];var d=this;this.contentAssist.addEventListener("ProposalsComputed",function(a){d.proposals=a.data.proposals;d.selectedIndex=d.proposals.length?0:-1});c.setAction("contentAssistApply",function(){return this.enter()}.bind(this));
...
this.parentNode=typeof b==="string"?c.getElementById(b):b;if(!this.parentNode){this.parentNode=i.createElement(c,"div");this.parentNode.className="contentassist";var d=c.getElementsByTagName("body")[0];if(d)d.appendChild(this.parentNode);else throw Error("parentNode is required");}var f=this;this.textViewListener={onMouseDown:function(a){a.event.target.parentElement!==f.parentNode&&f.contentAssist.deactivate()}};this.contentAssist.addEventListener("ProposalsComputed",function(a){f.setProposals(a.data.proposals);
...
define("orion/editor/cssContentAssist",["orion/editor/templates","orion/editor/keywords"],function(k,p){function o(a){return JSON.stringify(a).replace("}","\\}")}function e(){}for(var b={type:"link",values:"visible,hidden,scroll,auto,no-display,no-content".split(",")},d={type:"link",values:"solid,dashed,dotted,double,groove,ridge,inset,outset".split(",")},i={type:"link",values:[]},j=0;j<10;j++)i.values.push(j.toString());for(var f={type:"link",values:"black,white,red,green,blue,magenta,yellow,cyan,grey,darkred,darkgreen,darkblue,darkmagenta,darkcyan,darkyellow,darkgray,lightgray".split(",")},
a=[{prefix:"rule",description:"rule - class selector rule",template:".${class} {\n\t${cursor}\n}"},{prefix:"rule",description:"rule - id selector rule",template:"#${id} {\n\t${cursor}\n}"},{prefix:"outline",description:"outline - outline style",template:"outline: ${color:"+o(f)+"} ${style:"+o(d)+"} ${width:"+o(i)+"}px;"},{prefix:"background-image",description:"background-image - image style",template:'background-image: url("${uri}");'},{prefix:"url",description:"url - url image",template:'url("${uri}");'},
...
0;j<c.length;j++)b=c[j],a.push({prefix:b,description:b+" - "+b+" style",template:b+": ${width:"+o(i)+"}px ${style:"+o(d)+"} ${color:"+o(f)+"};"});e.prototype=new k.TemplateContentAssist(p.CSSKeywords,a);e.prototype.getPrefix=function(a,b){for(var c=b;c&&/[A-Za-z\-\@]/.test(a.charAt(c-1));)c--;return c?a.substring(c,b):""};return{CssContentAssistProvider:e}});
...
template:'<a href="${cursor}"></a>'},{prefix:"<ul",description:"<ul> - HTML unordered list",template:"<ul>\n\t<li>${cursor}</li>\n</ul>"},{prefix:"<ol",description:"<ol> - HTML ordered list",template:"<ol>\n\t<li>${cursor}</li>\n</ol>"},{prefix:"<dl",description:"<dl> - HTML definition list",template:"<dl>\n\t<dt>${cursor}</dt>\n\t<dd></dd>\n</dl>"},{prefix:"<table",description:"<table> - basic HTML table",template:"<table>\n\t<tr>\n\t\t<td>${cursor}</td>\n\t</tr>\n</table>"}],b,d,i,j,f="abbr,b,button,canvas,cite,command,dd,del,dfn,dt,em,embed,font,h1,h2,h3,h4,h5,h6,i,ins,kbd,label,li,mark,meter,object,option,output,progress,q,rp,rt,samp,small,strong,sub,sup,td,time,title,tt,u,var".split(",");
for(j=0;j<f.length;j++)b=f[j],i="<"+b+"></"+b+">",d="<"+b+">${cursor}</"+b+">",e.push({prefix:"<"+b,description:i,template:d});f="address,article,aside,audio,bdo,blockquote,body,caption,code,colgroup,datalist,details,div,fieldset,figure,footer,form,head,header,hgroup,iframe,legend,map,menu,nav,noframes,noscript,optgroup,p,pre,ruby,script,section,select,span,style,tbody,textarea,tfoot,th,thead,tr,video".split(",");for(j=0;j<f.length;j++)b=f[j],i="<"+b+"></"+b+">",d="<"+b+">\n\t${cursor}\n</"+b+">",
e.push({prefix:"<"+b,description:i,template:d});f="area,base,br,col,hr,input,link,meta,param,keygen,source".split(",");for(j=0;j<f.length;j++)b=f[j],d=i="<"+b+"/>",e.push({prefix:"<"+b,description:i,template:d});p.prototype=new k.TemplateContentAssist([],e);p.prototype.getPrefix=function(a,b){for(var d=b;d&&/[A-Za-z<]/.test(a.charAt(d-1));)if(d--,a.charAt(d)==="<")break;return d?a.substring(d,b):""};p.prototype.computeProposals=function(a,b,d){return a.length===0?[o.getProposal("",b,d)]:k.TemplateContentAssist.prototype.computeProposals.call(this,
...
onStyleReady:function(b){var d=b.lineStyles||b.style,b=Number.MAX_VALUE,f=-1,a=this.textView.getModel(),c;for(c in d)d.hasOwnProperty(c)&&(this.lineStyles[c]=d[c],b=Math.min(b,c),f=Math.max(f,c));b=Math.max(b,0);f=Math.min(f,a.getLineCount());if(d=this.annotationModel){for(var e=d.getAnnotations(a.getLineStart(b),a.getLineEnd(f)),m=[];e.hasNext();){var l=e.next();l.type==="orion.annotation.highlightError"&&m.push(l)}e=[];for(l=b;l<=f;l++){c=l;var n=this.lineStyles[c],n=n&&n.errors;c=a.getLineStart(c);
if(n)for(var k=0;k<n.length;k++){var o=n[k];e.push(p.AnnotationType.createAnnotation("orion.annotation.highlightError",o.start+c,o.end+c))}}d.replaceAnnotations(m,e)}this.textView.redrawLines(b,f+1)},onLineStyle:function(b){function d(a,b){for(var f=a.length,e=[],i=0;i<f;i++){var j=a[i];e.push({start:j.start+b,end:j.end+b,style:j.style})}return e}var f=this.lineStyles[b.lineIndex];if(f)if(f.ranges)b.ranges=d(f.ranges,b.lineStart);else if(f.style)b.style=f.style},_getEmptyStyle:function(b){for(var d=
...
_newLines:function(b){for(var a=[],c=0;c<b;c++)a.push({style:null,eolState:null});return a},setMode:function(b,a){if(b)this.mode=this.codeMirror.getMode(this.codeMirror.options,b),this.lines=this._newLines(this.model.getLineCount()),a&&this.highlight()},highlight:function(b,a,c){if(this.mode){for(var d=this.model.getLineCount(),b=typeof b==="undefined"?0:b,a=typeof a==="undefined"?d-1:Math.min(a,d-1),d=this.mode,e=this.getState(b),i=b;i<=a;i++){var j=this.lines[i];this.highlightLine(i,j,e);j.eolState=
...
0&&this.lines[e].eolState)?this.codeMirror.copyState(this.mode,e):this.mode.startState(),i=0,j=d;j<c;j++){var k=this.lines[j],o=k.eolState,p=this.highlightLine(j,k,e);k.eolState=this.codeMirror.copyState(this.mode,e);p&&this._expandRange(d,j+1);var k=a&&o&&a(o,k.eolState),u=!a&&!p&&i++>3;if(k||u)break;else if(!o||p)i=0;o=j<c||this.dirtyLines.length;if(+new Date>b&&o){this.highlightLater(j+1);this.onHighlightDone();return}}}this.onHighlightDone()},onHighlightDone:function(){this.startLine!==Number.MAX_VALUE&&
this.endLine!==-1&&this.dispatchEvent({type:"Highlight",start:this.startLine,end:this.endLine});this.startLine=Number.MAX_VALUE;this.endLine=-1},_getResumeLineIndex:function(b){for(var a=this.lines,c=b-1;c>=0;c--)if(a[c].eolState||b-c>40)return c;return-1},getState:function(b){var a=this.mode,c=this.lines,d,e;for(d=b-1;d>=0;d--)if(e=c[d],e.eolState||b-d>40)break;var i=d>=0&&c[d].eolState;if(i){i=this.codeMirror.copyState(a,i);for(d=Math.max(0,d);d<b-1;d++)e=c[d],this.highlightLine(d,e,i),e.eolState=
this.codeMirror.copyState(a,i);return i}else return a.startState()},highlightLine:function(b,a,c){if(this.mode){var d=this.model;d.getLineStart(b)===d.getLineEnd(b)&&this.mode.blankLine&&this.mode.blankLine(c);for(var i=a.style||[],b=d.getLine(b),b=new e(b),d=!a.style,j=[],k=0;!b.eol();k++){var o=this.mode.token(b,c)||null,p=b.current();this._whitespaceStyle(o,p,b.tokenStart);o=[b.tokenStart,b.pos,o];p=i[k];j.push(o);d=d||!p||p[0]!==o[0]||p[1]!==o[1]||p[2]!==o[2];b.advance()}if(d=d||j.length!==i.length)a.style=
j.length?j:null;return d}},_whitespaceStyle:function(b,a,c){if(!b&&this.isWhitespaceVisible&&/\s+/.test(a)){for(var b=[],d,e,i=0;i<a.length;i++){var j=a[i];j!==e&&(e&&b.push([c+d,c+i,e==="\t"?"token_tab":"token_space"]),d=i,e=j)}b.push([c+d,c+i,e==="\t"?"token_tab":"token_space"]);return b}return null},_expandRange:function(b,a){this.startLine=Math.min(this.startLine,b);this.endLine=Math.max(this.endLine,a)},toStyleRangesAndErrors:function(b,a){var c=b.style;if(!c)return null;for(var d=[],e=[],i=
typeof a==="undefined"?0:this.model.getLineStart(a),j=0;j<c.length;j++){var k=c[j],o=!k[2]?null:k[2]==="token_tab"||k[2]==="token_space"?k[2]:"cm-"+k[2];o&&(k={start:i+k[0],end:i+k[1],style:{styleClass:o}},d.push(k),o==="cm-error"&&e.push(k))}return[d,e]},getLineStyle:function(b){return this.lines[b]},getLineStyles:function(){return this.lines}};p.EventTarget.addMixin(i.prototype);o.AnnotationType.registerType("orion.annotation.highlightError",{title:k.syntaxError,html:"<div class='annotationHTML error'></div>",
rangeStyle:{styleClass:"annotationRange error"}});j.prototype={init:function(b,a,c){this.textView=b;this.annotationModel=c;this.modeApplier=new i(b.getModel(),a);var d=this;this.listener={onLineStyle:function(a){d.onLineStyle(a)},onDestroy:function(a){d.onDestroy(a)},onHighlight:function(a){d.onHighlight(a)}};b.addEventListener("LineStyle",this.listener.onLineStyle);b.addEventListener("Destroy",this.listener.onDestroy);this.modeApplier.addEventListener("Highlight",this.listener.onHighlight)},destroy:function(){this.modeApplier&&
...
c.highlight(a,Math.min(a+20,e-1),!0);d=c.getLineStyle(a)}e=this.textView.getModel();if(d){var i=c.toStyleRangesAndErrors(d,a);if(i&&(b.ranges=i[0],b=this.annotationModel)){c=[];d=[];if(i=i[1])for(var j=0;j<i.length;j++){var k=i[j];k.style.styleClass==="cm-error"&&d.push(o.AnnotationType.createAnnotation("orion.annotation.highlightError",k.start,k.end))}for(a=b.getAnnotations(e.getLineStart(a),e.getLineEnd(a));a.hasNext();)e=a.next(),e.type==="orion.annotation.highlightError"&&c.push(e);b.replaceAnnotations(c,
d)}}},onHighlight:function(b){this.textView.redrawLines(b.start,b.end)},onDestroy:function(){this.destroy()}};return{Mirror:b,ModeApplier:i,CodeMirrorStyler:j}});
...
func:function(){return"option on/off for subexp"}},{regex:/\(\?<([=!])/,func:function(b){return b[1]==="="?"lookbehind":"negative lookbehind"}},{regex:/\(\?>/,func:function(){return"atomic group"}}],toRegExp:function(b){function d(a,b){throw Error('Unsupported regex feature "'+a+'": "'+b[0]+'" at index: '+b.index+" in "+b.input);}var i="",j,b=e.processGlobalFlag("x",b,function(a){for(var b="",d=!1,e=a.length,f=0;f<e;){var i=a.charAt(f);if(!d&&i==="#")for(;f<e&&i!=="\r"&&i!=="\n";)i=a.charAt(++f);
else if(!d&&/\s/.test(i))for(;f<e&&/\s/.test(i);)i=a.charAt(++f);else i==="\\"?(b+=i,/\s/.test(a.charAt(f+1))||(b+=a.charAt(f+1),f+=1)):(i==="["?d=!0:i==="]"&&(d=!1),b+=i),f+=1}return b}),b=e.processGlobalFlag("i",b,function(a){i+="i";return a});for(j=0;j<this.unsupported.length;j++){var f;(f=this.unsupported[j].regex.exec(b))&&d(this.unsupported[j].func(f),f)}return RegExp(b,i)},processGlobalFlag:function(b,d,e){function j(a,b){for(var d=0,e=a.length,f=-1,i=b;i<e&&f===-1;i++)switch(a.charAt(i)){case "\\":i++;
break;case "(":d++;break;case ")":d--,d===0&&(f=i)}return f}var f="(?"+b+")",b="(?"+b+":";if(d.substring(0,f.length)===f)return e(d.substring(f.length));else if(d.substring(0,b.length)===b){f=j(d,0);if(f<d.length-1)throw Error("Only a "+b+") group that encloses the entire regex is supported in: "+d);return e(d.substring(b.length,f))}return d},hasBackReference:function(b){return/\\\d+/.test(b.source)},getSubstitutedRegex:function(b,d,e){for(var e=typeof e==="undefined"?!0:!1,b=b.source.split(/(\\\d+)/g),
j=[],f=0;f<b.length;f++){var a=b[f],c=/\\(\d+)/.exec(a);c?(a=d[c[1]]||"",j.push(e?k.escape(a):a)):j.push(a)}return RegExp(j.join(""))},groupify:function(b,d){for(var e=b.source,j=e.length,f=[],a=0,c=[],h=1,k=1,l=[],n={},o={},p=0;p<j;p++){var t=f[f.length-1],u=e.charAt(p);switch(u){case "(":if(t===4)f.pop(),l.push(")"),c[c.length-1].end=p;var g=p+2<j?e.charAt(p+1)+""+e.charAt(p+2):null;if(g==="?:"||g==="?="||g==="?!"){var s;g==="?:"?s=1:(s=3,a++);f.push(s);c.push({start:p,end:-1,type:s});l.push(u);
l.push(g);p+=g.length}else f.push(2),c.push({start:p,end:-1,type:2,oldNum:h,num:k}),l.push(u),a===0&&(o[k]=null),n[h]=k,h++,k++;break;case ")":t=f.pop();t===3&&a--;c[c.length-1].end=p;l.push(u);break;case "*":case "+":case "?":case "}":var A=u,w=e.charAt(p-1),g=p-1;if(u==="}"){for(s=p-1;e.charAt(s)!=="{"&&s>=0;s--);w=e.charAt(s-1);g=s-1;A=e.substring(s,p+1)}s=c[c.length-1];if(w===")"&&(s.type===2||s.type===4)){l.splice(s.start,0,"(");l.push(A);l.push(")");u={start:s.start,end:l.length-1,type:4,num:s.num};
for(w=0;w<c.length;w++)if(t=c[w],(t.type===2||t.type===4)&&t.start>=s.start&&t.end<=g)if(t.start+=1,t.end+=1,t.num+=1,t.type===2)n[t.oldNum]=t.num;c.push(u);k++;break}default:u!=="|"&&t!==2&&t!==4&&a===0&&(f.push(4),c.push({start:p,end:-1,type:4,num:k}),l.push("("),o[k]=null,k++),l.push(u),u==="\\"&&(u=e.charAt(p+1),l.push(u),p+=1)}}for(;f.length;)f.pop(),l.push(")");var e=RegExp(l.join("")),j={},d=d||n,C;for(C in d)d.hasOwnProperty(C)&&(j[C]="\\"+d[C]);e=this.getSubstitutedRegex(e,j,!1);return[e,
n,o]},complexCaptures:function(b){if(!b)return!1;for(var d in b)if(b.hasOwnProperty(d)&&d!=="0")return!0;return!1}};o.prototype={initialize:function(b){this.textView=b;this.textView.stylerOptions=this;var d=this;this._listener={onModelChanged:function(b){d.onModelChanged(b)},onDestroy:function(b){d.onDestroy(b)},onLineStyle:function(b){d.onLineStyle(b)},onStorage:function(b){d.onStorage(b)}};b.addEventListener("ModelChanged",this._listener.onModelChanged);b.addEventListener("Destroy",this._listener.onDestroy);
...
d.length;e++)this._styles[b].push(d.slice(0,e+1).join("-"))}},addStylesForCaptures:function(b){for(var d in b)b.hasOwnProperty(d)&&this.addStyles(b[d].name)},ContainerRule:function(){function b(b){this.rule=b;this.subrules=b.patterns}b.prototype.valueOf=function(){return"aa"};return b}(),BeginEndRule:function(){function b(b){this.rule=b;this.beginRegex=e.toRegExp(b.begin);this.endRegex=e.toRegExp(b.end);this.subrules=b.patterns||[];this.endRegexHasBackRef=e.hasBackReference(this.endRegex);var i=e.complexCaptures(b.captures),
b=e.complexCaptures(b.beginCaptures)||e.complexCaptures(b.endCaptures);if(this.isComplex=i||b)i=e.groupify(this.beginRegex),this.beginRegex=i[0],this.beginOld2New=i[1],this.beginConsuming=i[2],i=e.groupify(this.endRegex,this.beginOld2New),this.endRegex=i[0],this.endOld2New=i[1],this.endConsuming=i[2]}b.prototype.valueOf=function(){return this.beginRegex};return b}(),MatchRule:function(){function b(b){this.rule=b;this.matchRegex=e.toRegExp(b.match);if(this.isComplex=e.complexCaptures(b.captures))b=
...
f);for(var a=0;a<f.children.length;a++)e.push(f.children[a])}}return j||this._tree},isDamaged:function(b,d,e){return b.start<=e&&b.end>d},parse:function(b,d,e,j,f,a){var c=this.textView.getModel(),h=c.getLineStart(c.getLineCount()-1),k=c.getCharCount(),l=this.getInitialExpected(b,e),n=-1;if(d)b.repaired=!0,b.endNeedsUpdate=!0,n=(n=b.children[b.children.length-1])?c.getLineEnd(c.getLineAtOffset(n.end+(f-a))):-1,j=c.getLineEnd(c.getLineAtOffset(j+a)),n=Math.max(n,j);for(var n=n===-1?k:n,j=l,o=b,p=!1,
t=e,u=-1;o&&(!d||t<n);){var g=this.getNextMatch(c,o,t);g||(t=t>=h?k:c.getLineStart(c.getLineAtOffset(t)+1));var s=g&&g.match,A=g&&g.rule,w=g&&g.isEnd;if(g&&g.isSub){if(t=this.afterMatch(s),A instanceof this.BeginEndRule)p=!0,d&&A===j.rule&&o===j.parent?(o=j,o.setStart(s),o.repaired=!0,o.endNeedsUpdate=!0,j=this.getNextExpected(j,"begin")):(d&&(this.prune(o,j),d=!1),s=new this.BeginEndNode(o,A,s),o.addChild(s),o=s)}else if(w||t===k){if(o instanceof this.BeginEndNode)s?(p=!0,u=Math.max(u,o.end),o.setEnd(s),
t=this.afterMatch(s),d&&o===j&&o.parent===j.parent?(o.repaired=!0,delete o.endNeedsUpdate,j=this.getNextExpected(j,"end")):d&&(this.prune(o,j),d=!1)):(o.setEnd(k),delete o.endNeedsUpdate);o=o.parent}d&&t>=n&&!p&&(this.prune(b,l),d=!1)}this.removeUnrepairedChildren(b,d,e);this.cleanup(d,b,e,n,k,f,a);return d?Math.max(u,t):t},removeUnrepairedChildren:function(b,d,e){if(d){for(var d=b.children,j=-1,f=0;f<d.length;f++){var a=d[f];if(!a.repaired&&this.isDamaged(a,e,Number.MAX_VALUE)){j=f;break}}if(j!==
...
a=b.getText(e,f),c=[],h=[],b=[],f=[];for(this.push(c,d.rule.subrules);c.length;){var k=c.length?c.pop():null,k=k&&k._resolvedRule._typedRule;if(k instanceof this.ContainerRule&&h.indexOf(k)===-1)h.push(k),this.push(c,k.subrules);else if(!k||!j||k.matchRegex){var l=k&&this.exec(k.matchRegex||k.beginRegex,a,e);l&&(b.push(l),f.push(k))}}c=Number.MAX_VALUE;h=-1;for(k=0;k<b.length;k++)if(l=b[k],l.index<c)c=l.index,h=k;if(!j&&(e=this.getEndMatch(d,a,e)))if(j=d.rule.applyEndPatternLast,h===-1||e.index<c||
!j&&e.index===c)return{isEnd:!0,rule:d.rule,match:e};return h===-1?null:{isSub:!0,rule:f[h],match:b[h]}},getInitialExpected:function(b,d){var e,j;if(b===this._tree)for(e=0;e<b.children.length;e++){if(j=b.children[e],j.start>=d)return j}else if(b instanceof this.BeginEndNode&&b.endMatch){var f=b.endMatch.index;for(e=0;e<b.children.length;e++)if(j=b.children[e],j.start>=d)break;if(j&&j.start<f)return j}return b},getNextExpected:function(b,d){if(d==="begin"){var e=b.children[0];return e?e:b}else if(d===
...
f,d,j);b.ranges=this.toStyleRanges(d);b.ranges.sort(function(a,b){return a.start-b.start})},getLineScope:function(b,d,e,j){for(var f=e,a=this.getInitialExpected(d,e),c=[],h=[];d&&f<j;){var k=this.getNextMatch(b,d,f);if(!k)break;var l=k&&k.match,n=k&&k.rule,o=k&&k.isSub,k=k&&k.isEnd;l.index!==f&&h.push({start:f,end:l.index,node:d});if(o)f=this.afterMatch(l),n instanceof this.BeginEndRule?(this.addBeginScope(c,l,n),d=a,a=this.getNextExpected(a,"begin")):this.addMatchScope(c,l,n);else if(k)f=this.afterMatch(l),
this.addEndScope(c,l,n),a=this.getNextExpected(a,"end"),d=d.parent}f<j&&h.push({start:f,end:j,node:d});b=this.getInheritedLineScope(h,e,j);return c.concat(b)},getInheritedLineScope:function(b){for(var d=[],e=0;e<b.length;e++)for(var j=b[e],f=j.node;f;){var a=f.rule.rule,c=a.name;if(a=a.contentName||c){this.addScopeRange(d,j.start,j.end,a);break}f=f.parent}return d},addBeginScope:function(b,d,e){var j=e.rule;this.addCapturesScope(b,d,j.beginCaptures||j.captures,e.isComplex,e.beginOld2New,e.beginConsuming)},
...
{1:0},c=0,h=1;d[h]!==void 0;h++)a[h]!==void 0&&(c+=d[h].length),d[h+1]!==void 0&&(j[h+1]=c);a=d.index;for(c=1;e[c];c++){var h=e[c].name,k=f[c],l=a+j[k];typeof d[k]!=="undefined"&&this.addScopeRange(b,l,l+d[k].length,h)}}else this.addScope(b,d,e[0]&&e[0].name)},getIntersecting:function(b,d){for(var e=[],j=this._tree?[this._tree]:[];j.length;){var f=j.pop(),a=!1;f instanceof this.ContainerNode?a=!0:this.isDamaged(f,b,d)&&(a=!0,e.push(f));if(a)for(var a=f.children.length,c=0;c<a;c++)j.push(f.children[c])}return e.reverse()},
...
a===9||a===-1||a===60||a===64||a===84));this._unread(a);return 1}}};d.prototype=new o(null);d.prototype._default=function(a){for(;;)switch(a=this._read(),a){case 47:case 34:case 39:case -1:return this._unread(a),1}};i.prototype={destroy:function(){var a=this.view;if(a){var b=a.getModel();b.getBaseModel&&(b=b.getBaseModel());b.removeEventListener("Changed",this._listener.onChanged);a.removeEventListener("MouseDown",this._listener.onMouseDown);a.removeEventListener("Selection",this._listener.onSelection);
...
void 0;for(var d=[],f=0;f<c.length;f++)a.parent=c[f],d.push(I(a));return d}}if(!b)throw"no parent";a=K(b,a);if(typeof a.theme==="string"){var c=o.TextTheme.getTheme(a.theme),f=a.theme.lastIndexOf("/"),i=a.theme;f!==-1&&(i=i.substring(f+1));i.substring(i.length-4)===".css"&&(i=i.substring(0,i.length-4));c.setThemeClass(i,{href:a.theme});a.theme=c}var j;a.readonly||(d={createContentAssistMode:function(a){j=new l.ContentAssist(a.getTextView());a=new l.ContentAssistWidget(j);a=new l.ContentAssistMode(j,
a);j.setMode(a);return a}});d=new h.Editor({textViewFactory:function(){return new k.TextView({parent:b,model:new e.ProjectionTextModel(new p.TextModel("")),tabSize:a.tabSize?a.tabSize:4,readonly:a.readonly,fullSelection:a.fullSelection,tabMode:a.tabMode,expandTab:a.expandTab,themeClass:a.themeClass,theme:a.theme,wrapMode:a.wrapMode})},undoStackFactory:new m.UndoFactory,annotationFactory:new m.AnnotationFactory,lineNumberRulerFactory:new m.LineNumberRulerFactory,foldingRulerFactory:new m.FoldingRulerFactory,
