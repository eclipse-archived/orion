...
(function(k){function p(a,g){var t,c,s,d,b,i,f,n,m,h=g&&g.split("/"),e=l.map,j=e&&e["*"]||{};if(a&&a.charAt(0)===".")if(g){h=h.slice(0,h.length-1);a=h.concat(a.split("/"));for(n=0;n<a.length;n+=1)if(t=a[n],t===".")a.splice(n,1),n-=1;else if(t==="..")if(n===1&&(a[2]===".."||a[0]===".."))break;else n>0&&(a.splice(n-1,2),n-=2);a=a.join("/")}else a.indexOf("./")===0&&(a=a.substring(2));if((h||j)&&e){t=a.split("/");for(n=t.length;n>0;n-=1){c=t.slice(0,n).join("/");if(h)for(m=h.length;m>0;m-=1)if(s=e[h.slice(0,
m).join("/")])if(s=s[c]){d=s;b=n;break}if(d)break;!i&&j&&j[c]&&(i=j[c],f=n)}!d&&i&&(d=i,b=f);d&&(t.splice(0,b,d),a=t.join("/"))}return a}function o(c,g){return function(){return a.apply(k,u.call(arguments,0).concat([c,g]))}}function e(a){return function(g){return p(g,a)}}function b(a){return function(g){n[a]=g}}function d(a){if(r.call(m,a)){var g=m[a];delete m[a];q[a]=!0;f.apply(k,g)}if(!r.call(n,a)&&!r.call(q,a))throw Error("No "+a);return n[a]}function h(a){var g,t=a?a.indexOf("!"):-1;t>-1&&(g=
a.substring(0,t),a=a.substring(t+1,a.length));return[g,a]}function j(a){return function(){return l&&l.config&&l.config[a]||{}}}var f,a,c,i,n={},m={},l={},q={},r=Object.prototype.hasOwnProperty,u=[].slice;c=function(a,g){var t,c=h(a),s=c[0],a=c[1];s&&(s=p(s,g),t=d(s));s?a=t&&t.normalize?t.normalize(a,e(g)):p(a,g):(a=p(a,g),c=h(a),s=c[0],a=c[1],s&&(t=d(s)));return{f:s?s+"!"+a:a,n:a,pr:s,p:t}};i={require:function(a){return o(a)},exports:function(a){var g=n[a];return typeof g!=="undefined"?g:n[a]={}},
module:function(a){return{id:a,uri:"",exports:n[a],config:j(a)}}};f=function(a,g,t,x){var s,f,h,l,e=[],j,x=x||a;if(typeof t==="function"){g=!g.length&&t.length?["require","exports","module"]:g;for(l=0;l<g.length;l+=1)if(h=c(g[l],x),f=h.f,f==="require")e[l]=i.require(a);else if(f==="exports")e[l]=i.exports(a),j=!0;else if(f==="module")s=e[l]=i.module(a);else if(r.call(n,f)||r.call(m,f)||r.call(q,f))e[l]=d(f);else if(h.p)h.p.load(h.n,o(x,!0),b(f),{}),e[l]=n[f];else throw Error(a+" missing "+f);g=t.apply(n[a],
e);if(a)if(s&&s.exports!==k&&s.exports!==n[a])n[a]=s.exports;else if(g!==k||!j)n[a]=g}else a&&(n[a]=t)};requirejs=require=a=function(b,g,t,x,s){if(typeof b==="string")return i[b]?i[b](g):d(c(b,g).f);else b.splice||(l=b,g.splice?(b=g,g=t,t=null):b=k);g=g||function(){};typeof t==="function"&&(t=x,x=s);x?f(k,b,g,t):setTimeout(function(){f(k,b,g,t)},4);return a};a.config=function(c){l=c;return a};define=function(a,g,t){g.splice||(t=g,g=[]);!r.call(n,a)&&!r.call(m,a)&&(m[a]=[a,g,t])};define.amd={jQuery:!0}})();
...
var c=e.exec(b),i=c[1],n=c[4],m=c[5],l=n.split("-"),q=[],r={},u,v="";if(c[5])i=c[1],b=i+m;else{m=c[4];n=d.locale;if(!n)n=d.locale=typeof navigator==="undefined"?"root":(navigator.language||navigator.userLanguage||"root").toLowerCase();l=n.split("-")}if(a.isBuild){q.push(b);p(j,"root",q,i,m);for(u=0;u<l.length;u++)a=l[u],v+=(v?"-":"")+a,p(j,v,q,i,m);j(q,function(){f()})}else j([b],function(g){var t=[],a;k("root",g,t,q,i,m);for(u=0;u<l.length;u++)a=l[u],v+=(v?"-":"")+a,k(v,g,t,q,i,m);j(q,function(){var a,
c,d;for(a=t.length-1;a>-1&&t[a];a--){d=t[a];c=g[d];if(c===!0||c===1)c=j(i+d+"/"+m);o(r,c)}f(r)})})}}})})();define("orion/editor/i18n",{load:function(k,p,o){p.specified&&p.specified("orion/bootstrap")?p(["orion/i18n!"+k],function(e){o(e)}):o({})}});
...
i=e.start||0,e=e.end,n=e!==null&&e!==void 0,m="";m.indexOf("g")===-1&&(m+="g");h&&m.indexOf("i")===-1&&(m+="i");c&&(d="\\b"+d+"\\b");var l=this._text[0],q,r,k=0;n&&(h=i<e?i:e,l=l.substring(h,i<e?e:i),k=h);var o=RegExp(d,m);if(b)f=function(){var g=null;for(o.lastIndex=0;;){r=o.lastIndex;q=o.exec(l);if(r===o.lastIndex)return null;if(q){if(!(q.index+k<i)){if(!a||g)break;i=l.length+k}g={start:q.index+k,end:o.lastIndex+k}}else break}if(g)i=g.start;return g};else{if(!n)o.lastIndex=i;f=function(){for(;;){r=
o.lastIndex;q=o.exec(l);if(r===o.lastIndex)break;if(q)return{start:q.index+k,end:o.lastIndex+k};if(!(r!==0&&a))break}return null}}j=f()}return{next:function(){var g=j;g&&(j=f());return g},hasNext:function(){return j!==null}}},getCharCount:function(){for(var e=0,b=0;b<this._text.length;b++)e+=this._text[b].length;return e},getLine:function(e,b){var d=this.getLineCount();if(!(0<=e&&e<d))return null;var h=this._lineOffsets[e];if(e+1<d){d=this.getText(h,this._lineOffsets[e+1]);if(b)return d;for(var h=
...
d-b,c=j-h,i=e.length,n=0,m=this.getLineCount(),l=0,q=0,r=0,k=[];;){l!==-1&&l<=r&&(l=e.indexOf("\r",r));q!==-1&&q<=r&&(q=e.indexOf("\n",r));if(q===-1&&l===-1)break;r=l!==-1&&q!==-1?l+1===q?q+1:(l<q?l:q)+1:l!==-1?l+1:q+1;k.push(b+r);n++}this.onChanging({type:"Changing",text:e,start:f,removedCharCount:a,addedCharCount:i,removedLineCount:c,addedLineCount:n});k.length===0&&(r=this.getLineStart(h),j=j+1<m?this.getLineStart(j+1):this.getCharCount(),b!==r&&(e=this.getText(r,b)+e,b=r),d!==j&&(e+=this.getText(d,
j),d=j));r=i-a;for(j=h+c+1;j<m;j++)this._lineOffsets[j]+=r;if(k.length<5E4)h=[h+1,c].concat(k),Array.prototype.splice.apply(this._lineOffsets,h);else{r=h+1;this._lineOffsets.splice(r,c);for(m=0;m<k.length;m+=5E4)h=[r,0].concat(k.slice(m,Math.min(k.length,m+5E4))),Array.prototype.splice.apply(this._lineOffsets,h),r+=5E4}for(r=m=0;r<this._text.length;){j=this._text[r].length;if(b<=m+j)break;m+=j;r++}h=m;for(k=r;r<this._text.length;){j=this._text[r].length;if(d<=m+j)break;m+=j;r++}j=this._text[r];b=
this._text[k].substring(0,b-h);d=j.substring(d-m);k=[k,r-k+1];b&&k.push(b);e&&k.push(e);d&&k.push(d);Array.prototype.splice.apply(this._text,k);if(this._text.length===0)this._text=[""];this.onChanged({type:"Changed",start:f,removedCharCount:a,addedCharCount:i,removedLineCount:c,addedLineCount:n})}}};k.EventTarget.addMixin(o.prototype);return{TextModel:o}});
...
this;return c}},_createLine:function(g,a,b){var s=this.view,i=s._model,f=i.getLine(b),n=i.getLineStart(b),m={type:"LineStyle",textView:s,lineIndex:b,lineText:f,lineStart:n};if(f.length<2E3)s.onLineStyle(m);i=a||d.createElement(g.ownerDocument,"div");if(!a||!c(a.viewStyle,m.style)){j(m.style,i,a);if(a)a._trim=null;i.viewStyle=m.style;i.setAttribute("role","presentation")}i.lineIndex=b;b=[];this._createRanges(m.ranges,f,0,f.length,n,{tabOffset:0,ranges:b});f=" ";!s._fullSelection&&d.isIE<9&&(f="\ufeff");
d.isWebkit&&(f="\u200c");m={text:f,style:s._metrics.largestFontStyle,ignoreChars:1};b.length===0||!b[b.length-1].style||b[b.length-1].style.tagName!=="div"?b.push(m):b.splice(b.length-1,0,m);var l,e,h,q,r,f=s=0,k,o;if(a){if(e=a.modelChangedEvent)e.removedLineCount===0&&e.addedLineCount===0?(o=e.start-n,k=e.addedCharCount-e.removedCharCount):o=-1,a.modelChangedEvent=void 0;e=a.firstChild}for(n=0;n<b.length;n++){m=b[n];q=m.text;s+=q.length;l=m.style;if(e)if(r=e.firstChild.data,h=e.viewStyle,r===q&&
c(l,h)){f+=r.length;e._rectsCache=void 0;l=e=e.nextSibling;continue}else for(;e;){if(o!==-1){h=s;h>=o&&(h-=k);r=(r=e.firstChild.data)?r.length:0;if(f+r>h)break;f+=r}h=e.nextSibling;i.removeChild(e);e=h}l=this._createSpan(i,q,l,m.ignoreChars);e?i.insertBefore(l,e):i.appendChild(l);if(a)a.lineWidth=void 0}if(a)for(g=l?l.nextSibling:null;g;)h=g.nextSibling,a.removeChild(g),g=h;else g.appendChild(i);return i},_createRanges:function(g,a,d,s,b,i){if(!(d>s)){if(g)for(var f=0;f<g.length;f++){var n=g[f];if(!(n.end<
b+d)){var m=Math.max(b+d,n.start)-b;if(m>s)break;var l=Math.min(b+s,n.end)-b;if(m<=l){m=Math.max(d,m);l=Math.min(s,l);for(d<m&&this._createRange(a,d,m,null,i);f+1<g.length&&g[f+1].start-b===l&&c(n.style,g[f+1].style);)n=g[f+1],l=Math.min(b+s,n.end)-b,f++;this._createRange(a,m,l,n.style,i);d=l}}}d<s&&this._createRange(a,d,s,null,i)}},_createRange:function(g,a,c,s,d){if(!(a>c)){var b=this.view._customTabSize;if(b&&b!==8)for(var i=g.indexOf("\t",a);i!==-1;){a<i&&(a={text:g.substring(a,i),style:s},d.ranges.push(a),
d.tabOffset+=a.text.length);a=b-d.tabOffset%b;if(a>0){for(var f="\u00a0",n=1;n<a;n++)f+=" ";a={text:f,style:s,ignoreChars:a-1};d.ranges.push(a);d.tabOffset+=a.text.length}a=i+1;if(a===c)return;i=g.indexOf("\t",a)}a<=c&&(a={text:g.substring(a,c),style:s},d.ranges.push(a),d.tabOffset+=a.text.length)}},_createSpan:function(g,a,c,s){var b=this.view,i="span";c&&c.tagName&&(i=c.tagName.toLowerCase());var f=i==="a";if(f)g.hasLink=!0;f&&!b._linksVisible&&(i="span");f=g.ownerDocument;g=d.createElement(g.ownerDocument,
i);c&&c.html?(g.innerHTML=c.html,g.ignore=!0):c&&c.node?(g.appendChild(c.node),g.ignore=!0):g.appendChild(f.createTextNode(c&&c.text?c.text:a));j(c,g);if(i==="a"){var n=b._getWindow();h(g,"click",function(g){return b._handleLinkClick(g?g:n.event)},!1)}g.viewStyle=c;if(s)g.ignoreChars=s;return g},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(g,a){var c=this._ensureCreated(),s=this.view;if(g===void 0)return this._getLineBoundingClientRect(c,
!0);var b=s._model,i=c.ownerDocument,f=this.lineIndex,n=null;if(g<b.getLineEnd(f)){b=b.getLineStart(f);for(f=c.firstChild;f;){if(!f.ignore){var m=f.firstChild,l=m.length;f.ignoreChars&&(l-=f.ignoreChars);if(b+l>g){n=g-b;if(s._isRangeRects)i=i.createRange(),i.setStart(m,n),i.setEnd(m,n+1),n=new q(i.getBoundingClientRect());else if(d.isIE)i=i.body.createTextRange(),i.moveToElementText(f),i.collapse(),i.moveEnd("character",n+1),i.moveStart("character",n),n=new q(i.getBoundingClientRect());else{var e=
m.data;f.removeChild(m);f.appendChild(i.createTextNode(e.substring(0,n)));var h=d.createElement(i,"span");h.appendChild(i.createTextNode(e.substring(n,n+1)));f.appendChild(h);f.appendChild(i.createTextNode(e.substring(n+1)));n=new q(h.getBoundingClientRect());f.innerHTML="";f.appendChild(m);this._createdDiv||(i=s._getSelection(),(b<=i.start&&i.start<b+l||b<=i.end&&i.end<b+l)&&s._updateDOMSelection())}d.isIE&&(i=c.ownerDocument.defaultView||c.ownerDocument.parentWindow,c=i.screen.logicalXDPI/i.screen.deviceXDPI,
i=i.screen.logicalYDPI/i.screen.deviceYDPI,n.left*=c,n.right*=c,n.top*=i,n.bottom*=i);break}b+=l}f=f.nextSibling}}c=this.getBoundingClientRect();if(!n)s._wrapMode?(s=this.getClientRects(),n=s[s.length-1],n.left=n.right,n.left+=c.left,n.top+=c.top,n.right+=c.left,n.bottom+=c.top):(n=new q(c),n.left=n.right);if(a||a===void 0)n.left-=c.left,n.top-=c.top,n.right-=c.left,n.bottom-=c.top;return n},_getClientRects:function(g,a){var c,s,d,b;if(!g._rectsCache){c=g.getClientRects();s=Array(c.length);for(b=
0;b<c.length;b++)d=s[b]=new q(c[b]),d.left-=a.left,d.top-=a.top,d.right-=a.left,d.bottom-=a.top;g._rectsCache=s}c=g._rectsCache;s=[c.length];for(b=0;b<c.length;b++)s[b]=new q(c[b]);return s},getClientRects:function(g){if(!this.view._wrapMode)return[this.getBoundingClientRect()];for(var a=this._ensureCreated(),c=[],s=a.firstChild,d,b=a.getBoundingClientRect();s;){if(!s.ignore)for(var i=this._getClientRects(s,b),a=0;a<i.length;a++){var f=i[a],n;if(f.top!==f.bottom){var m=f.top+(f.bottom-f.top)/2;for(n=
0;n<c.length;n++)if(d=c[n],d.top<=m&&m<d.bottom)break;if(n===c.length)c.push(f);else{if(f.left<d.left)d.left=f.left;if(f.top<d.top)d.top=f.top;if(f.right>d.right)d.right=f.right;if(f.bottom>d.bottom)d.bottom=f.bottom}}}s=s.nextSibling}return g!==void 0?c[g]:c},_getLineBoundingClientRect:function(g,a){var c=new q(g.getBoundingClientRect());if(!this.view._wrapMode){c.right=c.left;for(var d=g.lastChild;d&&d.ignoreChars===d.firstChild.length;)d=d.previousSibling;if(d)d=d.getBoundingClientRect(),c.right=
d.right+m(g).right}a&&(d=m(g),c.left+=d.left,c.right-=d.right);return c},getLineCount:function(){return!this.view._wrapMode?1:this.getClientRects().length},getLineIndex:function(g){if(!this.view._wrapMode)return 0;for(var a=this.getClientRects(),g=this.getBoundingClientRect(g),g=g.top+(g.bottom-g.top)/2,c=0;c<a.length;c++)if(a[c].top<=g&&g<a[c].bottom)return c;return a.length-1},getLineStart:function(g){if(!this.view._wrapMode||g===0)return this.view._model.getLineStart(g);var a=this.getClientRects();
return this.getOffset(a[g].left+1,a[g].top+1)},getOffset:function(g,a){var c=this.view,s=c._model,b=this.lineIndex,i=s.getLineStart(b),f=s.getLineEnd(b);if(i===f)return i;var n=this._ensureCreated(),m=this.getBoundingClientRect(),l,e;if(c._wrapMode){l=this.getClientRects();if(a<l[0].top)a=l[0].top;for(var h=0;h<l.length;h++)if(e=l[h],e.top<=a&&a<e.bottom)break;if(g<e.left)g=e.left;g>e.right&&(g=e.right-1)}else g<0&&(g=0),g>m.right-m.left&&(g=m.right-m.left);var j=n.ownerDocument,h=j.defaultView||
j.parentWindow,q=d.isIE?h.screen.logicalXDPI/h.screen.deviceXDPI:1,r=d.isIE?h.screen.logicalYDPI/h.screen.deviceYDPI:1,h=i,k=n.firstChild;a:for(;k;){if(!k.ignore){var o=k.firstChild,n=o.length;k.ignoreChars&&(n-=k.ignoreChars);var u,p,v;l=this._getClientRects(k,m);for(var z=0;z<l.length;z++)if(e=l[z],e.left<=g&&g<e.right&&(!c._wrapMode||e.top<=a&&a<e.bottom)){if(d.isIE||c._isRangeRects){for(var j=c._isRangeRects?j.createRange():j.body.createTextRange(),z=n,C=-1;z-C>1;){var D=Math.floor((z+C)/2);l=
C+1;e=D===n-1&&k.ignoreChars?o.length:D+1;c._isRangeRects?(j.setStart(o,l),j.setEnd(o,e)):(j.moveToElementText(k),j.move("character",l),j.moveEnd("character",e-l));l=j.getClientRects();for(var J=!1,F=0;F<l.length;F++)if(e=l[F],u=e.left*q-m.left,v=e.right*q-m.left,p=e.top*r-m.top,e=e.bottom*r-m.top,u<=g&&g<v&&(!c._wrapMode||p<=a&&a<e)){J=!0;break}J?z=D:C=D}h+=z;l=z;e=z===n-1&&k.ignoreChars?o.length:Math.min(z+1,o.length);c._isRangeRects?(j.setStart(o,l),j.setEnd(o,e)):(j.moveToElementText(k),j.move("character",
l),j.moveEnd("character",e-l));e=j.getClientRects()[0];u=e.left*q-m.left;v=e.right*q-m.left;c=g>u+(v-u)/2;m=h-i;s=s.getLine(b);b=s.charCodeAt(m);55296<=b&&b<=56319&&c?m<s.length&&(b=s.charCodeAt(m+1),56320<=b&&b<=57343&&(h+=1)):56320<=b&&b<=57343&&!c&&m>0&&(b=s.charCodeAt(m-1),55296<=b&&b<=56319&&(h-=1));c&&h++}else{s=[];for(b=0;b<n;b++)s.push("<span>"),b===n-1?s.push(o.data.substring(b)):s.push(o.data.substring(b,b+1)),s.push("</span>");k.innerHTML=s.join("");for(s=k.firstChild;s;){e=s.getBoundingClientRect();
u=e.left-m.left;v=e.right-m.left;if(u<=g&&g<v){g>u+(v-u)/2&&h++;break}h++;s=s.nextSibling}if(!this._createdDiv)k.innerHTML="",k.appendChild(o),m=c._getSelection(),(h<=m.start&&m.start<h+n||h<=m.end&&m.end<h+n)&&c._updateDOMSelection()}break a}h+=n}k=k.nextSibling}return Math.min(f,Math.max(i,h))},getNextOffset:function(g,a){if(a.unit==="line"){var c=this.view._model,b=c.getLineAtOffset(g);if(a.count>0)return a.count--,c.getLineEnd(b);a.count++;return c.getLineStart(b)}return a.unit==="wordend"||a.unit===
"wordWS"||a.unit==="wordendWS"?this._getNextOffset_W3C(g,a):d.isIE?this._getNextOffset_IE(g,a):this._getNextOffset_W3C(g,a)},_getNextOffset_W3C:function(g,a){function c(g){return 33<=g&&g<=47||58<=g&&g<=64||91<=g&&g<=94||g===96||123<=g&&g<=126}function d(g){return g===32||g===9}var b=this.view._model,i=b.getLineAtOffset(g),f=b.getLine(i),n=b.getLineStart(i),b=b.getLineEnd(i),i=f.length,m=g-n,l,e=a.count<0?-1:1;if(a.unit==="word"||a.unit==="wordend"||a.unit==="wordWS"||a.unit==="wordendWS")for(var h,
j,q;a.count!==0;){if(a.count>0){if(m===i)return b;l=f.charCodeAt(m);h=c(l);j=!h&&!d(l);for(m++;m<i;){l=f.charCodeAt(m);if(a.unit!=="wordWS"&&a.unit!=="wordendWS"){q=c(l);if(a.unit==="wordend"){if(!q&&h)break}else if(q&&!h)break;l=!q&&!d(l)}else l=!d(l);if(a.unit==="wordend"||a.unit==="wordendWS"){if(!l&&j)break}else if(l&&!j)break;j=l;h=q;m++}}else{if(m===0)return n;m--;l=f.charCodeAt(m);h=c(l);for(j=!h&&!d(l);0<m;){l=f.charCodeAt(m-1);if(a.unit!=="wordWS"&&a.unit!=="wordendWS"){q=c(l);if(a.unit===
"wordend"){if(q&&!h)break}else if(!q&&h)break;l=!q&&!d(l)}else l=!d(l);if(a.unit==="wordend"||a.unit==="wordendWS"){if(l&&!j)break}else if(!l&&j)break;j=l;h=q;m--}}a.count-=e}else for(;a.count!==0&&0<=m+e&&m+e<=i;)m+=e,l=f.charCodeAt(m),56320<=l&&l<=57343&&m>0&&(l=f.charCodeAt(m-1),55296<=l&&l<=56319&&(m+=e)),a.count-=e;return n+m},_getNextOffset_IE:function(g,a){for(var c=this._ensureCreated(),d=this.view._model,b=this.lineIndex,i=0,f,n=d.getLineStart(b),m=c.ownerDocument,l=a.count<0?-1:1;a.count!==
0;){if(g===d.getLineEnd(b)){for(f=c.lastChild;f&&f.ignoreChars;)f=f.previousSibling;if(!f)return n;i=m.body.createTextRange();i.moveToElementText(f);f=i.text.length;i.moveEnd(a.unit,a.count);i=g+i.text.length-f}else if(g===n&&a.count<0)i=n;else for(f=c.firstChild;f;){var e=f.firstChild.length;f.ignoreChars&&(e-=f.ignoreChars);if(n+e>g){i=m.body.createTextRange();g===n&&a.count<0?i.moveToElementText(f.previousSibling):(i.moveToElementText(f),i.collapse(),i.moveEnd("character",g-n));f=i.text.length;
i.moveEnd(a.unit,a.count);i=g+i.text.length-f;break}n=e+n;f=f.nextSibling}a.count-=l}return i},destroy:function(){var g=this._createdDiv;if(g)g.parentNode.removeChild(g),this._createdDiv=null}};u.prototype={addKeyMode:function(g,a){var c=this._keyModes;a!==void 0?c.splice(a,0,g):c.push(g);g._modeAdded&&g._modeAdded()},addRuler:function(g,a){g.setView(this);var c=this._rulers;if(a!==void 0){var d,b;for(d=0,b=0;d<c.length&&b<a;d++)g.getLocation()===c[d].getLocation()&&b++;c.splice(b,0,g);a=b}else c.push(g);
this._createRuler(g,a);this._update()},computeSize:function(){var g=0,a=0,c=this._model,b=this._clientDiv;if(!b)return{width:g,height:a};var i=b.style.width;if(d.isWebkit)b.style.width="0x7fffffffpx";for(var c=c.getLineCount(),f=0;f<c;f++){var n=this._getLine(f),m=n.getBoundingClientRect(),g=Math.max(g,m.right-m.left);a+=m.bottom-m.top;n.destroy()}if(d.isWebkit)b.style.width=i;b=this._getViewPadding();g+=b.right+b.left+this._metrics.scrollWidth;a+=b.bottom+b.top+this._metrics.scrollWidth;return{width:g,
height:a}},convert:function(g,a,c){if(this._clientDiv){var d=this._getScroll(),b=this._getViewPadding(),i=this._viewDiv.getBoundingClientRect();a==="document"&&(g.x!==void 0&&(g.x+=-d.x+i.left+b.left),g.y!==void 0&&(g.y+=-d.y+i.top+b.top));c==="document"&&(g.x!==void 0&&(g.x+=d.x-i.left-b.left),g.y!==void 0&&(g.y+=d.y-i.top-b.top));return g}},destroy:function(){for(var g=0;g<this._rulers.length;g++)this._rulers[g].setView(null);this.rulers=null;this._destroyView();this.onDestroy({type:"Destroy"});
this._actions=this._keyModes=this._doubleClickSelection=this._selection=this._theme=this._model=this._parent=null},focus:function(){this._clientDiv&&(this._updateDOMSelection(),d.isOpera&&this._clientDiv.blur(),this._clientDiv.focus(),this._updateDOMSelection())},hasFocus:function(){return this._hasFocus},getActionDescription:function(g){if(g=this._actions[g])return g.actionDescription},getActions:function(g){var a=[],c=this._actions,d;for(d in c)c.hasOwnProperty(d)&&(g||!c[d].defaultHandler)&&a.push(d);
...
a,c){if(g){var d=this._actions,b=d[g];b||(b=d[g]={});b.handler=a;if(c!==void 0)b.actionDescription=c}},setKeyBinding:function(g,a){this._keyModes[0].setKeyBinding(g,a)},setCaretOffset:function(g,a,c){var d=this._model.getCharCount(),g=Math.max(0,Math.min(g,d));this._setSelection(new l(g,g,!1),a===void 0||a,!0,c)},setHorizontalPixel:function(g){this._clientDiv&&(g=Math.max(0,g),this._scrollView(g-this._getScroll().x,0))},setRedraw:function(g){g?--this._redrawCount===0&&this.redraw():this._redrawCount++},
setModel:function(g){if(g&&g!==this._model){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);var a=this._model.getLineCount(),c=this._model.getCharCount(),d=g.getLineCount(),b=g.getCharCount(),i={type:"ModelChanging",text:g.getText(),start:0,removedCharCount:c,addedCharCount:b,removedLineCount:a,addedLineCount:d};this.onModelChanging(i);this._model=g;i={type:"ModelChanged",start:0,removedCharCount:c,
addedCharCount:b,removedLineCount:a,addedLineCount:d};this.onModelChanged(i);this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._reset();this._update()}},setOptions:function(g){var a=this._defaultOptions(),d;for(d in g)if(g.hasOwnProperty(d)){var b=g[d];if(!c(this["_"+d],b)){var i=a[d]?a[d].update:null;i?i.call(this,b):this["_"+d]=f(b)}}},setSelection:function(g,a,c,d){var b=g>a;if(b)var i=g,g=a,
a=i;i=this._model.getCharCount();g=Math.max(0,Math.min(g,i));a=Math.max(0,Math.min(a,i));this._setSelection(new l(g,a,b),c===void 0||c,!0,d)},setText:function(g,a,c){var b=a===void 0&&c===void 0;a===void 0&&(a=0);c===void 0&&(c=this._model.getCharCount());if(b)this._variableLineHeight=!1;this._modifyContent({text:g,start:a,end:c,_code:!0},!b);if(b)this._columnX=-1,this._setSelection(new l(0,0,!1),!0),d.isFirefox&&this._fixCaret()},setTopIndex:function(g){this._clientDiv&&this._scrollView(0,this._getLinePixel(Math.max(0,
...
return!0},_doCut:function(a){var c=this._getSelection();return!c.isEmpty()?(c=this._getBaseText(c.start,c.end),this._doContent(""),this._setClipboardText(c,a)):!0},_doDelete:function(a){var c=this._getSelection();c.isEmpty()&&this._doMove(a,c);this._modifyContent({text:"",start:c.start,end:c.end},!0);return!0},_doEnd:function(a){var c=this._getSelection(),d=this._model,b;if(a.ctrl)c.extend(d.getCharCount()),b=function(){};else{var i=c.getCaret(),f=d.getLineAtOffset(i);if(this._wrapMode){var n=this._getLine(f),
i=n.getLineIndex(i),i=i===n.getLineCount()-1?d.getLineEnd(f):n.getLineStart(i+1)-1;n.destroy()}else i=d.getLineEnd(f);c.extend(i)}a.select||c.collapse();this._setSelection(c,!0,!0,b);return!0},_doEnter:function(a){var c=this._model,d=this._getSelection();this._doContent(c.getLineDelimiter());if(a&&a.noCursor)d.end=d.start,this._setSelection(d,!0);return!0},_doHome:function(a){var c=this._getSelection(),d=this._model,b;if(a.ctrl)c.extend(0),b=function(){};else{var i=c.getCaret(),f=d.getLineAtOffset(i);
this._wrapMode?(d=this._getLine(f),i=d.getLineIndex(i),i=d.getLineStart(i),d.destroy()):i=d.getLineStart(f);c.extend(i)}a.select||c.collapse();this._setSelection(c,!0,!0,b);return!0},_doLineDown:function(a){var c=this._model,b=this._getSelection(),i=b.getCaret(),f=c.getLineAtOffset(i),n=this._getLine(f),m=this._columnX,l=1,e=!1;if(m===-1||a.wholeLine||a.select&&d.isIE)m=a.wholeLine?c.getLineEnd(f+1):i,m=n.getBoundingClientRect(m).left;(i=n.getLineIndex(i))<n.getLineCount()-1?l=n.getClientRects(i+
1).top+1:(i=c.getLineCount()-1,e=f===i,a.count&&a.count>0?f=Math.min(f+a.count,i):f++);i=!1;if(e){if(a.select||d.isMac||d.isLinux)b.extend(c.getCharCount()),i=!0}else n.lineIndex!==f&&(n.destroy(),n=this._getLine(f)),b.extend(n.getOffset(m,l)),i=!0;i&&(a.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=m;n.destroy();return!0},_doLineUp:function(a){var c=this._model,b=this._getSelection(),i=b.getCaret(),f=c.getLineAtOffset(i),n=this._getLine(f),m=this._columnX,l=!1,e;if(m===-1||a.wholeLine||
a.select&&d.isIE)m=a.wholeLine?c.getLineStart(f-1):i,m=n.getBoundingClientRect(m).left;(i=n.getLineIndex(i))>0?e=n.getClientRects(i-1).top+1:(l=f===0,l||(a.count&&a.count>0?f=Math.max(f-a.count,0):f--,e=this._getLineHeight(f)-1));i=!1;if(l){if(a.select||d.isMac||d.isLinux)b.extend(0),i=!0}else n.lineIndex!==f&&(n.destroy(),n=this._getLine(f)),b.extend(n.getOffset(m,e)),i=!0;i&&(a.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=m;n.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(a){var c=
this,b=this._model,i=this._getSelection(),f=i.getCaret(),n=b.getLineAtOffset(f),m=b.getLineCount(),l=this._getScroll(),b=this._getClientHeight(),e,h;if(this._lineHeight){e=this._columnX;l=this._getBoundsAtOffset(f);if(e===-1||a.select&&d.isIE)e=l.left;f=this._getLineIndex(l.top+b);h=this._getLine(f);n=this._getLinePixel(f);f=h.getOffset(e,l.top+b-n);b=h.getBoundingClientRect(f);h.destroy();i.extend(f);a.select||i.collapse();this._setSelection(i,!0,!0,function(){c._columnX=e},b.top+n-l.top);return!0}if(n<
m-1){var j=this._getLineHeight(),q=Math.min(m-n-1,Math.floor(b/j)),q=Math.max(1,q);e=this._columnX;if(e===-1||a.select&&d.isIE)h=this._getLine(n),e=h.getBoundingClientRect(f).left,h.destroy();h=this._getLine(n+q);i.extend(h.getOffset(e,0));h.destroy();a.select||i.collapse();a=m*j;f=l.y+q*j;f+b>a&&(f=a-b);this._setSelection(i,!0,!0,function(){c._columnX=e},f-l.y)}return!0},_doPageUp:function(a){var c=this,b=this._model,i=this._getSelection(),f=i.getCaret(),n=b.getLineAtOffset(f),m=this._getScroll(),
l=this._getClientHeight(),e;if(this._lineHeight){e=this._columnX;m=this._getBoundsAtOffset(f);if(e===-1||a.select&&d.isIE)e=m.left;f=this._getLineIndex(m.bottom-l);b=this._getLine(f);n=this._getLinePixel(f);f=b.getOffset(e,m.bottom-l-n);l=b.getBoundingClientRect(f);b.destroy();i.extend(f);a.select||i.collapse();this._setSelection(i,!0,!0,function(){c._columnX=e},l.top+n-m.top);return!0}if(n>0){var h=this._getLineHeight(),l=Math.max(1,Math.min(n,Math.floor(l/h)));e=this._columnX;if(e===-1||a.select&&
d.isIE)b=this._getLine(n),e=b.getBoundingClientRect(f).left,b.destroy();b=this._getLine(n-l);i.extend(b.getOffset(e,this._getLineHeight(n-l)-1));b.destroy();a.select||i.collapse();a=Math.max(0,m.y-l*h);this._setSelection(i,!0,!0,function(){c._columnX=e},a-m.y)}return!0},_doPaste:function(a){var c=this;return this._getClipboardText(a,function(a){a&&(d.isLinux&&c._lastMouseButton===2&&(new Date).getTime()-c._lastMouseTime<=c._clickTime&&c._setSelectionTo(c._lastMouseX,c._lastMouseY),c._doContent(a))})!==
null},_doScroll:function(a){var c=a.type,b=this._model,d=b.getLineCount(),a=this._getClientHeight(),i=this._getLineHeight();d*=i;var f=this._getScroll().y,n;switch(c){case "textStart":n=0;break;case "textEnd":n=d-a;break;case "pageDown":n=f+a;break;case "pageUp":n=f-a;break;case "lineDown":n=f+i;break;case "lineUp":n=f-i;break;case "centerLine":c=this._getSelection(),n=b.getLineAtOffset(c.start),b=(b.getLineAtOffset(c.end)-n+1)*i,n=n*i-a/2+b/2}n!==void 0&&(n=Math.min(Math.max(0,n),d-a),this._scrollViewAnimated(0,
...
_doOverwriteMode:function(){if(!this._readonly)return this.setOptions({overwriteMode:!this.getOptions("overwriteMode")}),!0},_doTabMode:function(){this._tabMode=!this._tabMode;return!0},_doWrapMode:function(){this.setOptions({wrapMode:!this.getOptions("wrapMode")});return!0},_autoScroll:function(){var a=this._model,c=this._getSelection(),b=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),i=c.getCaret(),f=a.getLineCount(),n=a.getLineAtOffset(i),m;if(this._autoScrollDir==="up"||
this._autoScrollDir==="down")i=this._autoScrollY/this._getLineHeight(),i=i<0?Math.floor(i):Math.ceil(i),m=Math.max(0,Math.min(f-1,n+i));else if(this._autoScrollDir==="left"||this._autoScrollDir==="right")m=this._getLineIndex(b.y),n=this._getLine(n),b.x+=n.getBoundingClientRect(i,!1).left,n.destroy();m===0&&(d.isMac||d.isLinux)?c.extend(0):m===f-1&&(d.isMac||d.isLinux)?c.extend(a.getCharCount()):(n=this._getLine(m),c.extend(n.getOffset(b.x,b.y-this._getLinePixel(m))),n.destroy());this._setSelection(c,
!0)},_autoScrollTimer:function(){this._autoScroll();var a=this;this._autoScrollTimerID=this._getWindow().setTimeout(function(){a._autoScrollTimer()},this._AUTO_SCROLL_RATE)},_calculateLineHeightTimer:function(a){if(this._lineHeight&&!this._calculateLHTimer){var c=this._model.getLineCount(),b=0;if(a){for(var a=0,d=(new Date).getTime(),i=0;b<c;)if(this._lineHeight[b]||(a++,i||(i=b),this._lineHeight[b]=this._calculateLineHeight(b)),b++,(new Date).getTime()-d>100)break;this.redrawRulers(0,c);this._queueUpdate()}a=
...
"normal";var i={type:"LineStyle",textView:this,0:0,lineText:this._model.getLine(0),lineStart:0};this.onLineStyle(i);j(i.style,b);b.style.position="fixed";b.style.left="-1000px";var f=d.createElement(c,"span");f.appendChild(c.createTextNode(" "));b.appendChild(f);var l=d.createElement(c,"span");l.style.fontStyle="italic";l.appendChild(c.createTextNode(" "));b.appendChild(l);var e=d.createElement(c,"span");e.style.fontWeight="bold";e.appendChild(c.createTextNode(" "));b.appendChild(e);i=d.createElement(c,
"span");i.style.fontWeight="bold";i.style.fontStyle="italic";i.appendChild(c.createTextNode(" "));b.appendChild(i);a.appendChild(b);var h=b.getBoundingClientRect(),f=f.getBoundingClientRect(),l=l.getBoundingClientRect(),e=e.getBoundingClientRect(),i=i.getBoundingClientRect(),f=f.bottom-f.top,l=l.bottom-l.top,e=e.bottom-e.top,q=i.bottom-i.top,r=0,i=h.bottom-h.top<=0,h=Math.max(1,h.bottom-h.top);l>f&&(r=1);e>l&&(r=2);q>e&&(r=3);var k;if(r!==0){k={style:{}};if((r&1)!==0)k.style.fontStyle="italic";if((r&
2)!==0)k.style.fontWeight="bold"}f=m(b);a.removeChild(b);l=n(this._viewDiv);b=d.createElement(c,"div");b.style.position="fixed";b.style.left="-1000px";b.style.paddingLeft=l.left+"px";b.style.paddingTop=l.top+"px";b.style.paddingRight=l.right+"px";b.style.paddingBottom=l.bottom+"px";b.style.width="100px";b.style.height="100px";e=d.createElement(c,"div");e.style.width="100%";e.style.height="100%";b.appendChild(e);a.appendChild(b);c=b.getBoundingClientRect();l=e.getBoundingClientRect();b.style.overflow=
"hidden";e.style.height="200px";e=b.clientWidth;b.style.overflow="scroll";q=b.clientWidth;a.removeChild(b);l={left:l.left-c.left,top:l.top-c.top,right:c.right-l.right,bottom:c.bottom-l.bottom};return{lineHeight:h,largestFontStyle:k,lineTrim:f,viewPadding:l,scrollWidth:e-q,invalid:i}},_cancelAnimation:function(){if(this._animation)this._animation.stop(),this._animation=null},_clearSelection:function(a){var c=this._getSelection();if(c.isEmpty())return!1;a==="next"?c.start=c.end:c.end=c.start;this._setSelection(c,
...
a.top+=b;a.bottom+=b;c.destroy();return a},_getClientHeight:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientHeight-a.top-a.bottom)},_getClientWidth:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientWidth-a.left-a.right)},_getClipboardText:function(a,c){var b=this._model.getLineDelimiter(),f,n,m=this._getWindow();if(m.clipboardData)return f=[],n=m.clipboardData.getData("Text"),i(n,function(a){f.push(a)},function(){f.push(b)}),n=f.join(""),c&&
c(n),n;if(d.isFirefox){this._ignoreFocus=!0;var l=this._clipboardDiv;l.innerHTML="<pre contenteditable=''></pre>";l.firstChild.focus();var e=this,h=function(){var a=e._getTextFromElement(l);l.innerHTML="";f=[];i(a,function(a){f.push(a)},function(){f.push(b)});return f.join("")},j=!1;this._ignorePaste=!0;if(!d.isLinux||this._lastMouseButton!==2)try{j=l.ownerDocument.execCommand("paste",!1,null)}catch(q){j=l.childNodes.length>1||l.firstChild&&l.firstChild.childNodes.length>0}this._ignorePaste=!1;if(!j)return a?
(m.setTimeout(function(){e.focus();(n=h())&&c&&c(n);e._ignoreFocus=!1},0),null):(this.focus(),this._ignoreFocus=!1,"");this.focus();this._ignoreFocus=!1;(n=h())&&c&&c(n);return n}return a&&a.clipboardData?(f=[],n=a.clipboardData.getData("text/plain"),i(n,function(a){f.push(a)},function(){f.push(b)}),(n=f.join(""))&&c&&c(n),n):""},_getDOMText:function(a,c){for(var b=a.firstChild,d="",i=0;b;){var f;if(!b.ignore)if(b.ignoreChars){f=b.lastChild;for(var n=0,m=[],l=-1;f;){for(var e=f.data,h=e.length-1;h>=
0;h--){var j=e.substring(h,h+1);n<b.ignoreChars&&(j===" "||j==="\u200c"||j==="\ufeff")?n++:m.push(j==="\u00a0"?"\t":j)}if(c===f)l=m.length;f=f.previousSibling}m=m.reverse().join("");l!==-1&&(i=d.length+m.length-l);d+=m}else for(f=b.firstChild;f;){if(c===f)i=d.length;d+=f.data;f=f.nextSibling}b=b.nextSibling}return{text:d,offset:i}},_getTextFromElement:function(a){var c=a.ownerDocument,b=c.defaultView;if(!b.getSelection)return a.innerText||a.textContent;c=c.createRange();c.selectNode(a);var a=b.getSelection(),
...
a),this._model.getLineCount());if(this._lineHeight){var c=this._getTopIndex(),b=-this._topIndexY+this._getScroll().y;if(a>c)for(;c<a;c++)b+=this._getLineHeight(c);else for(c-=1;c>=a;c--)b-=this._getLineHeight(c);return b}return this._getLineHeight()*a},_getLineIndex:function(a){var c,b=0,d=this._model.getLineCount();if(this._lineHeight){var b=this._getTopIndex(),i=-this._topIndexY+this._getScroll().y;if(a!==i)if(a<i)for(;a<i&&b>0;)a+=this._getLineHeight(--b);else for(c=this._getLineHeight(b);a-c>=
i&&b<d-1;)a-=c,c=this._getLineHeight(++b)}else c=this._getLineHeight(),b=Math.floor(a/c);return Math.max(0,Math.min(d-1,b))},_getScroll:function(a){(a===void 0||a)&&this._cancelAnimation();a=this._viewDiv;return{x:a.scrollLeft,y:a.scrollTop}},_getSelection:function(){return this._selection.clone()},_getTopIndex:function(a){var c=this._topChild;if(a&&this._getClientHeight()>this._getLineHeight()){var a=c.getBoundingClientRect(),b=this._getViewPadding(),d=this._viewDiv.getBoundingClientRect();a.top<
d.top+b.top&&(c=this._getLineNext(c)||c)}return c.lineIndex},_hookEvents:function(){var a=this;this._modelListener={onChanging:function(c){a._onModelChanging(c)},onChanged:function(c){a._onModelChanged(c)}};this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._themeListener={onChanged:function(){a._setThemeClass(a._themeClass)}};this._theme.addEventListener("ThemeChanged",this._themeListener.onChanged);
var c=this._handlers=[],b=this._clientDiv,i=this._viewDiv,f=this._rootDiv,n=this._overlayDiv||b,m=b.ownerDocument,l=this._getWindow(),e=d.isIE?m:l;c.push({target:l,type:"resize",handler:function(c){return a._handleResize(c?c:l.event)}});c.push({target:b,type:"blur",handler:function(c){return a._handleBlur(c?c:l.event)}});c.push({target:b,type:"focus",handler:function(c){return a._handleFocus(c?c:l.event)}});c.push({target:i,type:"focus",handler:function(){b.focus()}});c.push({target:i,type:"scroll",
...
c:l.event)}});c.push({target:b,type:"copy",handler:function(c){return a._handleCopy(c?c:l.event)}});c.push({target:b,type:"cut",handler:function(c){return a._handleCut(c?c:l.event)}});c.push({target:b,type:"paste",handler:function(c){return a._handlePaste(c?c:l.event)}});if(d.isIOS||d.isAndroid)c.push({target:m,type:"selectionchange",handler:function(c){return a._handleSelectionChange(c?c:l.event)}}),c.push({target:b,type:"touchstart",handler:function(c){return a._handleTouchStart(c?c:l.event)}}),
...
type:"mouseout",handler:function(c){return a._handleMouseOut(c?c:l.event)}});c.push({target:e,type:"mouseup",handler:function(c){return a._handleMouseUp(c?c:l.event)}});c.push({target:e,type:"mousemove",handler:function(c){return a._handleMouseMove(c?c:l.event)}});c.push({target:f,type:"mousedown",handler:function(c){return a._handleRootMouseDown(c?c:l.event)}});c.push({target:f,type:"mouseup",handler:function(c){return a._handleRootMouseUp(c?c:l.event)}});c.push({target:n,type:"dragstart",handler:function(c){return a._handleDragStart(c?
c:l.event)}});c.push({target:n,type:"drag",handler:function(c){return a._handleDrag(c?c:l.event)}});c.push({target:n,type:"dragend",handler:function(c){return a._handleDragEnd(c?c:l.event)}});c.push({target:n,type:"dragenter",handler:function(c){return a._handleDragEnter(c?c:l.event)}});c.push({target:n,type:"dragover",handler:function(c){return a._handleDragOver(c?c:l.event)}});c.push({target:n,type:"dragleave",handler:function(c){return a._handleDragLeave(c?c:l.event)}});c.push({target:n,type:"drop",
...
type:"dblclick",handler:function(c){return a._handleDblclick(c?c:l.event)}})}i=this._leftDiv;f=this._rightDiv;d.isIE&&c.push({target:i,type:"selectstart",handler:function(){return!1}});c.push({target:i,type:d.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(c){return a._handleMouseWheel(c?c:l.event)}});c.push({target:i,type:"click",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:i,type:"dblclick",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:i,
type:"mousemove",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:i,type:"mouseover",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:i,type:"mouseout",handler:function(c){a._handleRulerEvent(c?c:l.event)}});d.isIE&&c.push({target:f,type:"selectstart",handler:function(){return!1}});c.push({target:f,type:d.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(c){return a._handleMouseWheel(c?c:l.event)}});c.push({target:f,type:"click",handler:function(c){a._handleRulerEvent(c?
c:l.event)}});c.push({target:f,type:"dblclick",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:f,type:"mousemove",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:f,type:"mouseover",handler:function(c){a._handleRulerEvent(c?c:l.event)}});c.push({target:f,type:"mouseout",handler:function(c){a._handleRulerEvent(c?c:l.event)}});for(i=0;i<c.length;i++)f=c[i],h(f.target,f.type,f.handler,f.capture)},_getWindow:function(){return this._parent.ownerDocument.defaultView||
this._parent.ownerDocument.parentWindow},_ignoreEvent:function(a){for(a=a.target;a&&a!==this._clientDiv;){if(a.ignore)return!0;a=a.parentNode}return!1},_init:function(a){var c=a.parent;typeof c==="string"&&(c=(a.document||document).getElementById(c));if(!c)throw"no parent";a.parent=c;a.model=a.model||new p.TextModel;var b=this._defaultOptions(),i;for(i in b)b.hasOwnProperty(i)&&(this["_"+i]=a[i]!==void 0?a[i]:b[i].value);this._keyModes=[];this._rulers=[];this._selection=new l(0,0,!1);this._linksVisible=
...
this._getSelection(),b.setCaret(a.start+a.text.length),this._setSelection(b,!0));this.onModify({type:"Modify"})}},_onModelChanged:function(a){a.type="ModelChanged";this.onModelChanged(a);a.type="Changed";var c=a.start,b=a.addedCharCount,d=a.removedCharCount,i=a.addedLineCount,f=a.removedLineCount,n=this._getSelection();n.end>c&&(n.end>c&&n.start<c+d?n.setCaret(c+b):(n.start+=b-d,n.end+=b-d),this._setSelection(n,!1,!1));c=this._model.getLineAtOffset(c);for(b=this._getLineNext();b;){d=b.lineIndex;if(c<=
d&&d<=c+f)c===d&&!b.modelChangedEvent&&!b.lineRemoved?(b.modelChangedEvent=a,b.lineChanged=!0):(b.lineRemoved=!0,b.lineChanged=!1,b.modelChangedEvent=null);if(d>c+f)b.lineIndex=d+i-f,b._line.lineIndex=b.lineIndex;b=this._getLineNext(b)}this._lineHeight&&(a=[c,f].concat(Array(i)),Array.prototype.splice.apply(this._lineHeight,a));if(!this._wrapMode&&c<=this._maxLineIndex&&this._maxLineIndex<=c+f)this._checkMaxLineIndex=this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0;this._update()},_onModelChanging:function(a){a.type=
...
!1,(c=this._hasFocus)&&a.blur(),a.contentEditable=!1,a.contentEditable=!0,c&&a.focus(),this._ignoreFocus=!1}},_scrollViewAnimated:function(a,c,b){if(b&&this._scrollAnimation){var d=this;this._animation=new v({window:this._getWindow(),duration:this._scrollAnimation,curve:[c,0],onAnimate:function(a){a=c-Math.floor(a);d._scrollView(0,a);c-=a},onEnd:function(){d._animation=null;d._scrollView(a,c);b&&b()}});this._animation.play()}else this._scrollView(a,c),b&&b()},_scrollView:function(a,c){this._ensureCaretVisible=
!1;var b=this._viewDiv;a&&(b.scrollLeft+=a);c&&(b.scrollTop+=c)},_setClipboardText:function(a,c){var b,f=this._parent.ownerDocument,n=this._getWindow();if(n.clipboardData)return b=[],i(a,function(a){b.push(a)},function(){b.push(d.platformDelimiter)}),n.clipboardData.setData("Text",b.join(""));if(c&&c.clipboardData&&(b=[],i(a,function(a){b.push(a)},function(){b.push(d.platformDelimiter)}),c.clipboardData.setData("text/plain",b.join(""))))return!0;var l=d.createElement(f,"pre");l.style.position="fixed";
l.style.left="-1000px";i(a,function(a){l.appendChild(f.createTextNode(a))},function(){l.appendChild(d.createElement(f,"br"))});l.appendChild(f.createTextNode(" "));this._clientDiv.appendChild(l);var m=f.createRange();m.setStart(l.firstChild,0);m.setEndBefore(l.lastChild);var e=n.getSelection();e.rangeCount>0&&e.removeAllRanges();e.addRange(m);var h=this,m=function(){l&&l.parentNode===h._clientDiv&&h._clientDiv.removeChild(l);h._updateDOMSelection()},e=!1;this._ignoreCopy=!0;try{e=f.execCommand("copy",
!1,null)}catch(j){}this._ignoreCopy=!1;if(!e&&c)return n.setTimeout(m,0),!1;m();return!0},_setDOMSelection:function(a,c,b,i,f){for(var n,l,m,e,h=0,j=a.firstChild,q,r,k=this._model.getLine(a.lineIndex).length;j;){if(!j.ignore){q=j.firstChild;r=q.length;j.ignoreChars&&(r-=j.ignoreChars);if(h+r>c||h+r>=k){n=q;l=c-h;j.ignoreChars&&r>0&&l===r&&(l+=j.ignoreChars);break}h+=r}j=j.nextSibling}for(var h=0,j=b.firstChild,o=this._model.getLine(b.lineIndex).length;j;){if(!j.ignore){q=j.firstChild;r=q.length;j.ignoreChars&&
(r-=j.ignoreChars);if(r+h>i||h+r>=o){m=q;e=i-h;j.ignoreChars&&r>0&&e===r&&(e+=j.ignoreChars);break}h+=r}j=j.nextSibling}this._setDOMFullSelection(a,c,k,b,i,o);c=this._getWindow();a=this._parent.ownerDocument;if(c.getSelection){c=c.getSelection();a=a.createRange();a.setStart(n,l);a.setEnd(m,e);if(this._hasFocus&&(c.anchorNode!==n||c.anchorOffset!==l||c.focusNode!==m||c.focusOffset!==e||c.anchorNode!==m||c.anchorOffset!==e||c.focusNode!==n||c.focusOffset!==l))this._ignoreSelect=!1,c.rangeCount>0&&c.removeAllRanges(),
c.addRange(a),this._ignoreSelect=!0;if(this._cursorDiv)f?a.setEnd(n,l):a.setStart(m,e),m=a.getClientRects()[0],e=this._cursorDiv.parentNode,n=e.getBoundingClientRect(),this._cursorDiv.style.top=m.top-n.top+e.scrollTop+"px",this._cursorDiv.style.left=m.left-n.left+e.scrollLeft+"px"}else if(a.selection&&this._hasFocus)f=a.body,a=d.createElement(a,"div"),f.appendChild(a),f.removeChild(a),a=f.createTextRange(),a.moveToElementText(n.parentNode),a.moveStart("character",l),n=f.createTextRange(),n.moveToElementText(m.parentNode),
n.moveStart("character",e),a.setEndPoint("EndToStart",n),this._ignoreSelect=!1,a.select(),this._ignoreSelect=!0},_setDOMFullSelection:function(a,c,b,d,i){if(this._selDiv1&&(b=this._selDiv1,b.style.width="0px",b.style.height="0px",b=this._selDiv2,b.style.width="0px",b.style.height="0px",b=this._selDiv3,b.style.width="0px",b.style.height="0px",!(a===d&&c===i))){var f=this._model,n=this._getViewPadding(),l=this._clientDiv.getBoundingClientRect(),m=this._viewDiv.getBoundingClientRect(),b=m.left+n.left,
e=l.right,n=m.top+n.top,h=l.bottom,m=l=0;this._clipDiv?(m=this._clipDiv.getBoundingClientRect(),l=m.left-this._clipDiv.scrollLeft):(m=this._rootDiv.getBoundingClientRect(),l=m.left);m=m.top;this._ignoreDOMSelection=!0;var a=(new r(this,a.lineIndex,a)).getBoundingClientRect(f.getLineStart(a.lineIndex)+c,!1),j=a.left,i=(new r(this,d.lineIndex,d)).getBoundingClientRect(f.getLineStart(d.lineIndex)+i,!1),c=i.left;this._ignoreDOMSelection=!1;var f=this._selDiv1,j=Math.min(e,Math.max(b,j)),q=Math.min(h,
Math.max(n,a.top)),k=e,d=Math.min(h,Math.max(n,a.bottom));f.style.left=j-l+"px";f.style.top=q-m+"px";f.style.width=Math.max(0,k-j)+"px";f.style.height=Math.max(0,d-q)+"px";if(a.top===i.top)k=Math.min(c,e),f.style.width=Math.max(0,k-j)+"px";else if(a=Math.min(h,Math.max(n,i.top)),c=Math.min(e,Math.max(b,c)),n=Math.min(h,Math.max(n,i.bottom)),h=this._selDiv3,h.style.left=b-l+"px",h.style.top=a-m+"px",h.style.width=Math.max(0,c-b)+"px",h.style.height=Math.max(0,n-a)+"px",a-d>0)n=this._selDiv2,n.style.left=
b-l+"px",n.style.top=d-m+"px",n.style.width=Math.max(0,e-b)+"px",n.style.height=Math.max(0,a-d)+"px"}},_setGrab:function(a){if(a!==this._grabControl)a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null)},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=a;if(d.isIE&&a)this._hadFocus=this._hasFocus;var c=this._clientDiv;c.contentEditable=!a;this._hadFocus&&!a&&c.focus();if(this._overlayDiv)this._overlayDiv.style.zIndex=
a?"-1":"1";for(a=this._getLineNext();a;){if(a.hasLink)for(c=a.firstChild;c;)if(c.ignore)c=c.nextSibling;else{var b=c.nextSibling,i=c.viewStyle;i&&i.tagName&&i.tagName.toLowerCase()==="a"&&a.replaceChild(a._line._createSpan(a,c.firstChild.data,i),c);c=b}a=this._getLineNext(a)}this._updateDOMSelection()}},_setSelection:function(a,c,b,d,i){if(a){this._columnX=-1;b===void 0&&(b=!0);var f=this._selection;this._selection=a;c!==!1&&this._showCaret(!1,d,c,i);b&&this._updateDOMSelection();if(!f.equals(a))this.onSelection({type:"Selection",
oldValue:{start:f.start,end:f.end},newValue:{start:a.start,end:a.end}})}},_setSelectionTo:function(a,c,b,d){var i=this._model,f=this._getSelection(),c=this.convert({x:a,y:c},"page","document"),a=this._getLineIndex(c.y);if(this._clickCount===1){i=this._getLine(a);a=i.getOffset(c.x,c.y-this._getLinePixel(a));i.destroy();if(d&&!b&&f.start<=a&&a<f.end)return this._dragOffset=a,!1;f.extend(a);b||f.collapse()}else(this._clickCount&1)===0?(i=this._getLine(a),a=i.getOffset(c.x,c.y-this._getLinePixel(a)),
this._doubleClickSelection?a>=this._doubleClickSelection.start?(b=this._doubleClickSelection.start,d=i.getNextOffset(a,{unit:"wordend",count:1})):(b=i.getNextOffset(a,{unit:"word",count:-1}),d=this._doubleClickSelection.end):(b=i.getNextOffset(a,{unit:"word",count:-1}),d=i.getNextOffset(b,{unit:"wordend",count:1})),i.destroy()):this._doubleClickSelection?(d=i.getLineAtOffset(this._doubleClickSelection.start),a>=d?(b=i.getLineStart(d),d=i.getLineEnd(a)):(b=i.getLineStart(a),d=i.getLineEnd(d))):(b=
i.getLineStart(a),d=i.getLineEnd(a)),f.setCaret(b),f.extend(d);this._setSelection(f,!0,!0);return!0},_setFullSelection:function(a,c){this._fullSelection=a;if(d.isWebkit)this._fullSelection=!0;var b=this._clipDiv||this._rootDiv;if(b)if(this._fullSelection){if(!this._selDiv1&&this._fullSelection&&!d.isIOS){var i=b.ownerDocument;this._highlightRGB=d.isWebkit?"transparent":"Highlight";var f=d.createElement(i,"div");this._selDiv1=f;f.style.position="absolute";f.style.borderWidth="0px";f.style.margin="0px";
f.style.padding="0px";f.style.outline="none";f.style.background=this._highlightRGB;f.style.width="0px";f.style.height="0px";f.style.zIndex="0";b.appendChild(f);var n=d.createElement(i,"div");this._selDiv2=n;n.style.position="absolute";n.style.borderWidth="0px";n.style.margin="0px";n.style.padding="0px";n.style.outline="none";n.style.background=this._highlightRGB;n.style.width="0px";n.style.height="0px";n.style.zIndex="0";b.appendChild(n);this._selDiv3=i=d.createElement(i,"div");i.style.position="absolute";
...
4){if(b)b.style.MozTabSize=this._tabSize+""}else if(this._tabSize!==8)this._customTabSize=this._tabSize;c||(this.redrawLines(),this._resetLineWidth())},_setTheme:function(a){this._theme&&this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);(this._theme=a)&&this._theme.addEventListener("ThemeChanged",this._themeListener.onChanged);this._setThemeClass(this._themeClass)},_setThemeClass:function(a,c){this._themeClass=a;var b="textview",i=this._theme.getThemeClass();i&&(b+=" "+
i);this._themeClass&&i!==this._themeClass&&(b+=" "+this._themeClass);this._rootDiv.className=b;this._updateStyle(c)},_setWrapMode:function(a,c){this._wrapMode=a&&this._wrappable;var b=this._clientDiv,i=this._viewDiv;a?(b.style.whiteSpace="pre-wrap",b.style.wordWrap="break-word",i.style.overflowX="hidden",i.style.overflowY="scroll"):(b.style.whiteSpace="pre",b.style.wordWrap="normal",i.style.overflowX="auto",i.style.overflowY="auto");c||(this.redraw(),this._resetLineWidth());this._resetLineHeight()},
_showCaret:function(a,c,b,i){if(this._clientDiv){var d=this._model,f=this._getSelection(),n=this._getScroll(),l=f.getCaret(),m=f.start,e=f.end,h=d.getLineAtOffset(e),j=Math.max(Math.max(m,d.getLineStart(h)),e-1),d=this._getClientWidth(),h=this._getClientHeight(),q=d/4,r=this._getBoundsAtOffset(l===m?m:j),k=r.left,o=r.right,u=r.top,p=r.bottom;a&&!f.isEmpty()&&(r=this._getBoundsAtOffset(l===e?m:j),r.top===u?l===m?o=k+Math.min(r.right-k,d):k=o-Math.min(o-r.left,d):l===m?p=u+Math.min(r.bottom-u,h):u=
p-Math.min(p-r.top,h));a=0;k<n.x&&(a=Math.min(k-n.x,-q));o>n.x+d&&(a=Math.max(o-n.x-d,q));f=0;u<n.y?f=u-n.y:p>n.y+h&&(f=p-n.y-h);i&&(i>0?f>0&&(f=Math.max(f,i)):f<0&&(f=Math.min(f,i)));if(a!==0||f!==0)return f!==0&&typeof b==="number"&&(b<0&&(b=0),b>1&&(b=1),f+=Math.floor(f>0?b*h:-b*h)),this._scrollViewAnimated(a,f,c),h!==this._getClientHeight()||d!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0;else c&&c();return!1}},_startIME:function(){if(this._imeOffset===-1){var a=this._getSelection();
a.isEmpty()||this._modifyContent({text:"",start:a.start,end:a.end},!0);this._imeOffset=a.start}},_unhookEvents:function(){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);this._modelListener=null;for(var a=0;a<this._handlers.length;a++){var c=this._handlers[a],b=c.target,i=c.type,c=c.handler;typeof b.removeEventListener===
"function"?b.removeEventListener(i,c,!1):b.detachEvent("on"+i,c)}this._handlers=null;if(this._mutationObserver)this._mutationObserver.disconnect(),this._mutationObserver=null},_updateDOMSelection:function(){if(!this._ignoreDOMSelection&&this._clientDiv){var a=this._getSelection(),c=this._model,b=c.getLineAtOffset(a.start),i=c.getLineAtOffset(a.end),d=this._getLineNext();if(d){var f=this._getLinePrevious(),n;b<d.lineIndex?(n=d,b=0):b>f.lineIndex?(n=f,b=0):(n=this._getLineNode(b),b=a.start-c.getLineStart(b));
i<d.lineIndex?c=0:i>f.lineIndex?(d=f,c=0):(d=this._getLineNode(i),c=a.end-c.getLineStart(i));this._setDOMSelection(n,b,d,c,a.caret)}}},_update:function(a){if(!(this._redrawCount>0)){if(this._updateTimer)this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,a=!1;var c=this._clientDiv;if(c){if(this._metrics.invalid)this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1;var b=this._model,i=this._getScroll(!1),f=this._getViewPadding(),n=b.getLineCount(),l=this._getLineHeight(),
m=this._getClientWidth();if(this._wrapMode)c.style.width=m+"px";var e,h,j,q,k=0,o=0;if(this._lineHeight){for(;o<n;){h=this._getLineHeight(o);if(k+h>i.y)break;k+=h;o++}e=o;h=Math.max(0,e-1);j=b=i.y-k;e>0&&(b+=this._getLineHeight(e-1))}else q=Math.max(0,i.y)/l,e=Math.floor(q),h=Math.max(0,e-1),b=Math.round((q-h)*l),j=Math.round((q-e)*l);this._topIndexY=j;q=this._parent;var u=q.clientWidth,p=q.clientHeight;q=this._getClientHeight();if(a){l=0;this._leftDiv&&(e=this._leftDiv.getBoundingClientRect(),l=
e.right-e.left);e=m;for(this._wrapMode||(e=Math.max(this._maxLineWidth,e));o<n;)h=this._getLineHeight(o,!1),k+=h,o++;n=k}else{m=this._viewDiv;j=Math.min(e+Math.floor((q+j)/l),n-1);for(var i=Math.min(j+1,n-1),v,w=c.firstChild;w;){v=w.lineIndex;var y=w.nextSibling;if(!(h<=v&&v<=i)||w.lineRemoved||w.lineIndex===-1)this._mouseWheelLine===w?(w.style.display="none",w.lineIndex=-1):c.removeChild(w);w=y}var w=this._getLineNext(),y=m.ownerDocument,A=y.createDocumentFragment();for(v=h;v<=i;v++)if(!w||w.lineIndex>
v)(new r(this,v)).create(A,null);else{A.firstChild&&(c.insertBefore(A,w),A=y.createDocumentFragment());if(w&&w.lineChanged)w=(new r(this,v)).create(A,w),w.lineChanged=!1;w=this._getLineNext(w)}A.firstChild&&c.insertBefore(A,w);if(d.isWebkit&&!this._wrapMode)c.style.width="0x7fffffffpx";w=this._getLineNext();v=q+b;for(A=!1;w;){h=w.lineWidth;if(h===void 0)if(y=w._line.getBoundingClientRect(),h=w.lineWidth=Math.ceil(y.right-y.left),y=y.bottom-y.top,this._lineHeight)this._lineHeight[w.lineIndex]=Math.ceil(y);
else if(l!==0&&y!==0&&l!==y)this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[w.lineIndex]=Math.ceil(y);if(this._lineHeight&&!A&&(v-=this._lineHeight[w.lineIndex],v<0))j=w.lineIndex,A=!0;if(!this._wrapMode){if(h>=this._maxLineWidth)this._maxLineWidth=h,this._maxLineIndex=w.lineIndex;if(this._checkMaxLineIndex===w.lineIndex)this._checkMaxLineIndex=-1}if(w.lineIndex===e)this._topChild=w;if(w.lineIndex===j)this._bottomChild=w;w=this._getLineNext(w)}if(this._checkMaxLineIndex!==-1&&(v=
this._checkMaxLineIndex,this._checkMaxLineIndex=-1,0<=v&&v<n)){l=new r(this,v);y=l.getBoundingClientRect();h=y.right-y.left;if(h>=this._maxLineWidth)this._maxLineWidth=h,this._maxLineIndex=v;l.destroy()}for(;o<n;)h=this._getLineHeight(o,o<=j),k+=h,o++;n=k;this._updateRuler(this._leftDiv,e,i,p);this._updateRuler(this._rightDiv,e,i,p);l=0;this._leftDiv&&(e=this._leftDiv.getBoundingClientRect(),l=e.right-e.left);i=0;this._rightDiv&&(i=this._rightDiv.getBoundingClientRect(),i=i.right-i.left);m.style.left=
l+"px";m.style.right=i+"px";i=this._scrollDiv;i.style.height=n+"px";k=m=this._getClientWidth();this._wrapMode||(k=Math.max(this._maxLineWidth,k));e=k;if((!d.isIE||d.isIE>=9)&&this._maxLineWidth>m)k+=f.right+f.left;i.style.width=k+"px";if(this._clipScrollDiv)this._clipScrollDiv.style.width=k+"px";i=this._getScroll(!1)}if(this._vScrollDiv)k=q-8,o=Math.max(15,Math.ceil(Math.min(1,k/(n+f.top+f.bottom))*k)),this._vScrollDiv.style.left=l+m-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,i.y*k/n))+
"px",this._vScrollDiv.style.height=o+"px";if(!this._wrapMode&&this._hScrollDiv)k=m-8,o=Math.max(15,Math.ceil(Math.min(1,k/(this._maxLineWidth+f.left+f.right))*k)),this._hScrollDiv.style.left=l+Math.floor(Math.max(0,Math.floor(i.x*k/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=q-9+"px",this._hScrollDiv.style.width=o+"px";w=i.x;h=this._clipDiv;k=this._overlayDiv;if(h){h.scrollLeft=w;o=l+f.left;j=f.top;a=m;l=q;w=0;v=-b;if(i.x===0)o-=f.left,a+=f.left,w=f.left;i.x+m===e&&(a+=f.right);i.y===0&&
(j-=f.top,l+=f.top,v+=f.top);i.y+q===n&&(l+=f.bottom);h.style.left=o+"px";h.style.top=j+"px";h.style.right=u-a-o+"px";h.style.bottom=p-l-j+"px";c.style.left=w+"px";c.style.top=v+"px";c.style.width=e+"px";c.style.height=q+b+"px";if(k)k.style.left=c.style.left,k.style.top=c.style.top,k.style.width=c.style.width,k.style.height=c.style.height}else{o=w;j=b;u=w+m;p=b+q;o===0&&(o-=f.left);j===0&&(j-=f.top);u===e&&(u+=f.right);i.y+q===n&&(p+=f.bottom);c.style.clip="rect("+j+"px,"+u+"px,"+p+"px,"+o+"px)";
c.style.left=-w+l+f.left+"px";c.style.width=(d.isWebkit?e:m+w)+"px";if(!a)c.style.top=-b+f.top+"px",c.style.height=q+b+"px";if(k&&(k.style.clip=c.style.clip,k.style.left=c.style.left,k.style.width=c.style.width,!a))k.style.top=c.style.top,k.style.height=c.style.height}this._updateDOMSelection();c=this._ensureCaretVisible;this._ensureCaretVisible=!1;q!==this._getClientHeight()&&(this._update(),c&&this._showCaret())}}},_updateRuler:function(a,c,b,i){if(a)for(var f=this._parent.ownerDocument,n=this._getLineHeight(),
l=this._getViewPadding(),a=a.firstChild;a;){var m=a._ruler,e=n,h=m.getOverview();h==="page"&&(e+=this._topIndexY);a.style.top=-e+"px";a.style.height=i+e+"px";a.rulerChanged&&j(m.getRulerStyle(),a);var q,r=a.firstChild;r?(q=r,r=r.nextSibling):(q=d.createElement(f,"div"),q.style.visibility="hidden",a.appendChild(q));var k;if(a.rulerChanged&&q){e=-1;if(k=m.getWidestAnnotation())if(j(k.style,q),k.html)q.innerHTML=k.html;q.lineIndex=e;q.style.height=n+l.top+"px"}var o;if(h==="page"){for(m=m.getAnnotations(c,
b+1);r;)e=r.lineIndex,k=r.nextSibling,(!(c<=e&&e<=b)||r.lineChanged)&&a.removeChild(r),r=k;r=a.firstChild.nextSibling;o=f.createDocumentFragment();for(e=c;e<=b;e++)if(!r||r.lineIndex>e){q=d.createElement(f,"div");if(k=m[e]){j(k.style,q);if(k.html)q.innerHTML=k.html;q.annotation=k}q.lineIndex=e;q.style.height=this._getLineHeight(e)+"px";o.appendChild(q)}else if(o.firstChild&&(a.insertBefore(o,r),o=f.createDocumentFragment()),r)r=r.nextSibling;o.firstChild&&a.insertBefore(o,r)}else{k=this._getClientHeight();
e=this._model.getLineCount();r=k+l.top+l.bottom-2*this._metrics.scrollWidth;h=n*e<r?n:r/e;if(a.rulerChanged){for(k=a.childNodes.length;k>1;)a.removeChild(a.lastChild),k--;m=m.getAnnotations(0,e);o=f.createDocumentFragment();for(var u in m)if(e=u>>>0,!(e<0)){q=d.createElement(f,"div");k=m[u];j(k.style,q);q.style.position="absolute";q.style.top=this._metrics.scrollWidth+n+Math.floor(e*h)+"px";if(k.html)q.innerHTML=k.html;q.annotation=k;q.lineIndex=e;o.appendChild(q)}a.appendChild(o)}else if(a._oldTrackHeight!==
r)for(q=a.firstChild?a.firstChild.nextSibling:null;q;)q.style.top=this._metrics.scrollWidth+n+Math.floor(q.lineIndex*h)+"px",q=q.nextSibling;a._oldTrackHeight=r}a.rulerChanged=!1;a=a.nextSibling}},_updateStyleSheet:function(){var a="";d.isWebkit&&this._metrics.scrollWidth>0&&(a+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");d.isFirefox&&d.isMac&&this._highlightRGB&&this._highlightRGB!=="Highlight"&&(a+="\n.textview ::-moz-selection {background: "+this._highlightRGB+";}");if(a){var c=
...
(c.lineTrim.top+c.lineTrim.bottom)+"px":"normal";this._updateStyleSheet();a||(this.redraw(),this._resetLineWidth())}};e.EventTarget.addMixin(u.prototype);return{TextView:u}});
...
this._model.getCharCount(),b=this._projections,d=0;d<b.length;d++){var h=b[d];e+=h._model.getCharCount()-(h.end-h.start)}return e},getLine:function(e,b){if(e<0)return null;var d=this._model,h=this._projections,j=0,f=[],a=0,c,i,n;for(c=0;c<h.length;c++){n=h[c];if(n._lineIndex>=e-j)break;i=n._model.getLineCount()-1;if(n._lineIndex+i>=e-j)if(a=e-(n._lineIndex+j),a<i)return n._model.getLine(a,b);else f.push(n._model.getLine(i));a=n.end;j+=i-n._lineCount}for(a=Math.max(a,d.getLineStart(e-j));c<h.length;c++){n=
h[c];if(n._lineIndex>e-j)break;f.push(d.getText(a,n.start));i=n._model.getLineCount()-1;if(n._lineIndex+i>e-j)return f.push(n._model.getLine(0,b)),f.join("");f.push(n._model.getText());a=n.end;j+=i-n._lineCount}h=d.getLineEnd(e-j,b);a<h&&f.push(d.getText(a,h));return f.join("")},getLineAtOffset:function(e){for(var b=this._model,d=this._projections,h=0,j=0,f=0;f<d.length;f++){var a=d[f];if(a.start>e-h)break;var c=a._model.getCharCount();if(a.start+c>e-h){d=e-(a.start+h);j+=a._model.getLineAtOffset(d);
...
h)+j},getText:function(e,b){e===void 0&&(e=0);var d=this._model,h=this._projections,j=0,f=[],a,c,i;for(a=0;a<h.length;a++){c=h[a];if(c.start>e-j)break;i=c._model.getCharCount();if(c.start+i>e-j)if(b!==void 0&&c.start+i>b-j)return c._model.getText(e-(c.start+j),b-(c.start+j));else f.push(c._model.getText(e-(c.start+j))),e=c.end+j+i-(c.end-c.start);j+=i-(c.end-c.start)}var n=e-j;if(b!==void 0){for(;a<h.length;a++){c=h[a];if(c.start>b-j)break;f.push(d.getText(n,c.start));i=c._model.getCharCount();if(c.start+
i>b-j)return f.push(c._model.getText(0,b-(c.start+j))),f.join("");f.push(c._model.getText());n=c.end;j+=i-(c.end-c.start)}f.push(d.getText(n,b-j))}else{for(;a<h.length;a++)c=h[a],f.push(d.getText(n,c.start)),f.push(c._model.getText()),n=c.end;f.push(d.getText(n))}return f.join("")},_onChanging:function(e,b,d,h,j,f){for(var a=this._model,c=this._projections,i,n=0,m,l=b+d;i<c.length;i++){d=c[i];if(d.start>b)break;n+=d._model.getCharCount()-(d.end-d.start)}b+=n;for(var q=i;i<c.length;i++){d=c[i];if(d.start>
l)break;n+=d._model.getCharCount()-(d.end-d.start);m+=d._model.getLineCount()-1-d._lineCount}d=l+n;n=i;this.onChanging(b,d-b,h,j+m,f);c.splice(c,n-q);for(e=e.length-(d-b);i<c.length;i++)d=c[i],d.start+=e,d.end+=e,d._lineIndex=a.getLineAtOffset(d.start)},onChanging:function(e){return this.dispatchEvent(e)},onChanged:function(e){return this.dispatchEvent(e)},setLineDelimiter:function(e){this._model.setLineDelimiter(e)},setText:function(e,b,d){e===void 0&&(e="");b===void 0&&(b=0);var h=b,j=d,f=this._model,
a=this._projections,c=0,i=0,n,m,l,q,r,k=0;for(n=0;n<a.length;n++){m=a[n];if(m.start>b-c)break;l=m._model.getCharCount();if(m.start+l>b-c)if(d!==void 0&&m.start+l>d-c){m._model.setText(e,b-(m.start+c),d-(m.start+c));return}else k=m._model.getLineCount()-1-m._model.getLineAtOffset(b-(m.start+c)),q={projection:m,start:b-(m.start+c)},b=m.end+c+l-(m.end-m.start);i+=m._model.getLineCount()-1-m._lineCount;c+=l-(m.end-m.start)}b-=c;var o=n,k=f.getLineAtOffset(b)+i-k;if(d!==void 0)for(;n<a.length;n++){m=a[n];
if(m.start>d-c)break;l=m._model.getCharCount();if(m.start+l>d-c){i+=m._model.getLineAtOffset(d-(m.start+c));l=d-(m.start+c);d=m.end+c;r={projection:m,end:l};break}i+=m._model.getLineCount()-1-m._lineCount;c+=l-(m.end-m.start)}else{for(;n<a.length;n++)m=a[n],i+=m._model.getLineCount()-1-m._lineCount,c+=m._model.getCharCount()-(m.end-m.start);d=j=f.getCharCount()+c}d-=c;m=f.getLineAtOffset(d)+i;j-=h;for(var i=m-k,k=e.length,g=l=m=c=0;;){m!==-1&&m<=g&&(m=e.indexOf("\r",g));l!==-1&&l<=g&&(l=e.indexOf("\n",
g));if(l===-1&&m===-1)break;g=m!==-1&&l!==-1?m+1===l?l+1:(m<l?m:l)+1:m!==-1?m+1:l+1;c++}this.onChanging({type:"Changing",text:e,start:h,removedCharCount:j,addedCharCount:k,removedLineCount:i,addedLineCount:c});f.setText(e,b,d);if(q)m=q.projection,m._model.setText("",q.start);if(r)m=r.projection,m._model.setText("",0,r.end),m.start=m.end,m._lineCount=0;a.splice(o,n-o);for(e=e.length-(d-b);n<a.length;n++)m=a[n],m.start+=e,m.end+=e,m._lineIndex=f.getLineAtOffset(m.start);this.onChanged({type:"Changed",
...
else if(this._isNode(c))a.appendChild(c);else if(c instanceof e.ProjectionTextModel){var i=this._view,n=i.getOptions();n.wrapMode=!1;n.parent=a;var m=n.themeClass;m?((m=m.replace("tooltip",""))&&(m=" "+m),m="tooltip"+m):m="tooltip";n.themeClass=m;n=this._contentsView=new p.TextView(n);n._clientDiv.contentEditable=!1;n.addEventListener("LineStyle",function(a){i.onLineStyle(a)});n.setModel(c);c=n.computeSize();a.style.width=c.width+"px";a.style.height=c.height+"px";n.resize()}else return;a=f.ownerDocument.documentElement;
...
this._keyBindingFactory.createKeyBindings(d,this._undoStack,this._contentAssist));var i=function(a){if(a!==void 0&&a!==-1){for(var c=this.getView().getModel(),i=this.getAnnotationModel(),e=d.mapOffset(c.getLineStart(a)),a=d.mapOffset(c.getLineEnd(a)),c=i.getAnnotations(e,a),n=null;c.hasNext();){var g=c.next();if(g.type===b.AnnotationType.ANNOTATION_BOOKMARK){n=g;break}}n?i.removeAnnotation(n):(n=b.AnnotationType.createAnnotation(b.AnnotationType.ANNOTATION_BOOKMARK,e,a),n.title=void 0,i.addAnnotation(n))}};
if(this._annotationFactory){var n=a.getModel();n.getBaseModel&&(n=n.getBaseModel());if(this._annotationModel=this._annotationFactory.createAnnotationModel(n))if(n=this._annotationStyler=this._annotationFactory.createAnnotationStyler(a,this._annotationModel))n.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_SEARCH),n.addAnnotationType(b.AnnotationType.ANNOTATION_MATCHING_SEARCH),n.addAnnotationType(b.AnnotationType.ANNOTATION_ERROR),n.addAnnotationType(b.AnnotationType.ANNOTATION_WARNING),n.addAnnotationType(b.AnnotationType.ANNOTATION_MATCHING_BRACKET),
n.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_BRACKET),n.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_LINE),n.addAnnotationType(b.AnnotationType.ANNOTATION_READ_OCCURRENCE),n.addAnnotationType(b.AnnotationType.ANNOTATION_WRITE_OCCURRENCE),n.addAnnotationType(b.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP),n.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP),n.addAnnotationType(b.AnnotationType.ANNOTATION_LINKED_GROUP),n.addAnnotationType("orion.annotation.highlightError");
a.annotationModel=this._annotationModel;var n=this._annotationFactory.createAnnotationRulers(this._annotationModel),m=this._annotationRuler=n.annotationRuler;if(m)m.onDblClick=i,m.setMultiAnnotationOverlay({html:"<div class='annotationHTML overlay'></div>"}),m.addAnnotationType(b.AnnotationType.ANNOTATION_ERROR),m.addAnnotationType(b.AnnotationType.ANNOTATION_WARNING),m.addAnnotationType(b.AnnotationType.ANNOTATION_TASK),m.addAnnotationType(b.AnnotationType.ANNOTATION_BOOKMARK);this.setAnnotationRulerVisible(!0);
if(m=this._overviewRuler=n.overviewRuler)m.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_SEARCH),m.addAnnotationType(b.AnnotationType.ANNOTATION_MATCHING_SEARCH),m.addAnnotationType(b.AnnotationType.ANNOTATION_ERROR),m.addAnnotationType(b.AnnotationType.ANNOTATION_WARNING),m.addAnnotationType(b.AnnotationType.ANNOTATION_TASK),m.addAnnotationType(b.AnnotationType.ANNOTATION_BOOKMARK),m.addAnnotationType(b.AnnotationType.ANNOTATION_MATCHING_BRACKET),m.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_BRACKET),
m.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_LINE),m.addAnnotationType(b.AnnotationType.ANNOTATION_READ_OCCURRENCE),m.addAnnotationType(b.AnnotationType.ANNOTATION_WRITE_OCCURRENCE);this.setOverviewRulerVisible(!0)}if(this._lineNumberRulerFactory)this._lineNumberRuler=this._lineNumberRulerFactory.createLineNumberRuler(this._annotationModel),this._lineNumberRuler.onDblClick=i,this.setLineNumberRulerVisible(!0);if(this._foldingRulerFactory)this._foldingRuler=this._foldingRulerFactory.createFoldingRuler(this._annotationModel),
...
for(var j=f;j<=e;j++)h.push(b.getLine(j,!0));j=b.getLineStart(f);b=b.getLineEnd(e,!0);c=c.getOptions("tabSize","expandTab");c=c.expandTab?Array(c.tabSize+1).join(" "):"\t";a.setText(h.join(c),j,b);a.setSelection(j===d.start?d.start:d.start+c.length,d.end+(e-f+1)*c.length);return!0}return!1}},gotoLastEdit:function(){typeof this._lastEditLocation==="number"&&this.editor.showSelection(this._lastEditLocation);return!0},gotoLine:function(){var a=this.editor,c=a.getModel().getLineAtOffset(a.getCaretOffset());
...
{name:k.removeBlockComment})},autoIndent:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getSelection();if(c.start===c.end){for(var b=a.getModel(),d=b.getLineAtOffset(c.start),f=b.getLine(d,!0),e=b.getLineStart(d),d=0,e=c.start-e,h;d<e&&((h=f.charCodeAt(d))===32||h===9);)d++;if(d>0){for(var j=f.substring(0,d),d=e;d<f.length&&((h=f.charCodeAt(d++))===32||h===9);)c.end++;a.setText(b.getLineDelimiter()+j,c.start,c.end);return!0}}return!1},addBlockComment:function(){var a=
this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getModel(),b=a.getSelection(),d=this._findEnclosingComment(c,b.start,b.end);if(d.commentStart!==void 0&&d.commentEnd!==void 0)return!0;c=c.getText(b.start,b.end);if(c.length===0)return!0;var d=c.length,c=c.replace(/\/\*|\*\//g,""),f=c.length;a.setText("/*"+c+"*/",b.start,b.end);a.setSelection(b.start+2,b.end+2+(f-d));return!0},contentAssistProposalApplied:function(a){a=a.data.proposal;if(a.positions&&a.positions.length>0&&this.linkedMode){for(var c=
[],b=0;b<a.positions.length;++b)c[b]={positions:[{offset:a.positions[b].offset,length:a.positions[b].length}]};this.linkedMode.enterLinkedMode({groups:c,escapePosition:a.escapePosition})}else a.groups&&a.groups.length>0&&this.linkedMode?this.linkedMode.enterLinkedMode({groups:a.groups,escapePosition:a.escapePosition}):a.escapePosition&&this.editor.getTextView().setCaretOffset(a.escapePosition);return!0},_findEnclosingComment:function(a,c,b){var d=a.getLineAtOffset(c),f=a.getLineAtOffset(b),e,h,j,
k,o,g;for(e=d;e>=0;e--)if(h=a.getLine(e),j=e===d?c-a.getLineStart(d):h.length,k=h.lastIndexOf("/*",j),h=h.lastIndexOf("*/",j),h>k)break;else if(k!==-1){o=a.getLineStart(e)+k;break}for(e=f;e<a.getLineCount();e++)if(h=a.getLine(e),j=e===f?b-a.getLineStart(f):0,k=h.indexOf("/*",j),h=h.indexOf("*/",j),k!==-1&&k<h)break;else if(h!==-1){g=a.getLineStart(e)+h;break}return{commentStart:o,commentEnd:g}},lineStart:function(){for(var a=this.editor,c=a.getModel(),b=a.getCaretOffset(),d=c.getLineAtOffset(b),f=
c.getLineStart(d),c=c.getLine(d),d=0;d<c.length;d++){var e=c.charCodeAt(d);if(!(e===32||e===9))break}d+=f;return b!==d?(a.setSelection(d,d),!0):!1},removeBlockComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getModel(),b=a.getSelection(),d=c.getText(b.start,b.end),f,e,h;for(h=0;h<d.length;h++)if(d.substring(h,h+2)==="/*"){f=b.start+h;break}for(;h<d.length;h++)if(d.substring(h,h+2)==="*/"){e=b.start+h;break}if(f!==void 0&&e!==void 0)a.setText(c.getText(f+
2,e),f,e+2),a.setSelection(f,e);else{d=this._findEnclosingComment(c,b.start,b.end);if(d.commentStart===void 0||d.commentEnd===void 0)return!0;c=c.getText(d.commentStart+2,d.commentEnd);a.setText(c,d.commentStart,d.commentEnd+2);a.setSelection(b.start-2,b.end-2)}return!0},toggleLineComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;for(var c=a.getModel(),b=a.getSelection(),d=c.getLineAtOffset(b.start),f=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),e=!0,h=[],j,
k,o=d;o<=f;o++)if(j=c.getLine(o,!0),h.push(j),!e||(k=j.indexOf("//"))===-1)e=!1;else if(k!==0){var g;for(g=0;g<k;g++)if(e=j.charCodeAt(g),!(e===32||e===9))break;e=g===k}o=c.getLineStart(d);g=c.getLineEnd(f,!0);if(e){for(e=0;e<h.length;e++)j=h[e],k=j.indexOf("//"),h[e]=j.substring(0,k)+j.substring(k+2);h=h.join("");j=c.getLineStart(f);c=o===b.start?b.start:b.start-2;b=b.end-2*(f-d+1)+(b.end===j+1?2:0)}else h.splice(0,0,""),h=h.join("//"),c=o===b.start?b.start:b.start+2,b=b.end+2*(f-d+1);a.setText(h,
o,g);a.setSelection(c,b);return!0},startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()}};f.SourceCodeActions=j;return f});
define("orion/editor/templates",[],function(){function k(k,e,b){this.prefix=k;this.description=e;this.template=b;this._parse()}function p(k,e){this._keywords=k||[];this._templates=[];this.addTemplates(e||[])}k.prototype={getProposal:function(k,e,b){var k=e-k.length,e={},d,h=b.delimiter!==void 0?b.delimiter:"\n";b.indentation&&(h+=b.indentation);for(var j=b.tab!==void 0?b.tab:"\t",f=0,a=this.variables,c=this.segments,b=[],i=0;i<c.length;i++){var n=c[i],m=a[n];if(m!==void 0)switch(n){case "${tab}":n=
j;break;case "${delimiter}":n=h;break;case "${cursor}":n="";d=f;break;default:var l=e[n];l||(l=e[n]={data:m.data,positions:[]});n=m.substitution;l.data&&l.data.values&&(n=l.data.values[0]);l.positions.push({offset:k+f,length:n.length})}b.push(n);f+=n.length}var h=[],q;for(q in e)e.hasOwnProperty(q)&&h.push(e[q]);b=b.join("");if(d===void 0)d=b.length;return{proposal:b,description:this.description,groups:h,escapePosition:k+d}},match:function(k){return this.prefix.indexOf(k)===0},_parse:function(){var k=
this.template,e=[],b={},d,h=0,k=k.replace(/\n/g,"${delimiter}"),k=k.replace(/\t/g,"${tab}");k.replace(/\$\{((?:[^\\}]+|\\.))*\}/g,function(j,f,a){var c=j.substring(2,j.length-1),f=j,i=c,n=null,m=i.indexOf(":");m!==-1&&(i=i.substring(0,m),f="${"+i+"}",n=JSON.parse(c.substring(m+1).replace("\\}","}").trim()));(c=b[f])||(c=b[f]={});c.substitution=i;if(n)c.data=n;(d=k.substring(h,a))&&e.push(d);e.push(f);h=a+j.length;return i});(d=k.substring(h,k.length))&&e.push(d);this.segments=e;this.variables=b}};
...
onModelChanged:function(a){if(!this.ignoreVerify){for(var c=this.linkedModeModel,b,d;c;)if(b=this._getPositionChanged(c,a.start,a.start+a.removedCharCount),d=b.position,d===void 0||d.model!==c)this.exitLinkedMode(!1),c=this.linkedModeModel;else break;if(c){c=0;d=a.addedCharCount-a.removedCharCount;b=b.positions;for(var f,e,h=0;h<b.length;++h){e=b[h];f=e.position;var g=f.offset<=a.start&&a.start<=f.offset+f.length;g&&!e.ansestor?(f.offset+=c,f.length+=d,c+=d):(f.offset+=c,e.ansestor&&g&&(f.length+=
d));if(e.escape)e.model.escapePosition=f.offset}this._updateAnnotations(b)}}}.bind(this),onVerify:function(a){if(!this.ignoreVerify){for(var c=this.linkedModeModel,b,d;c;)if(b=this._getPositionChanged(c,a.start,a.end),d=b.position,d===void 0||d.model!==c)this.exitLinkedMode(!1),c=this.linkedModeModel;else break;if(c){var f=this._compoundChange;f?f.owner.model===c&&f.owner.group===d.group||(this.endUndo(),this.startUndo()):this.startUndo();c.selectedGroupIndex=d.group;var f=0,e=a.text.length-(a.end-
a.start);b=b.positions;for(var h,g,i=a.start-d.position.offset,j=a.end-d.position.offset,k=0;k<b.length;++k)if(g=b[k],h=g.position,g.oldOffset=h.offset,g.model===c&&g.group===d.group?(h.offset+=f,h.length+=e,f+=e):(h.offset+=f,g.ansestor&&(h.length+=d.count*e)),g.escape)g.model.escapePosition=h.offset;this.ignoreVerify=!0;f=this.editor.getTextView();for(k=b.length-1;k>=0;k--)g=b[k],g.model===c&&g.group===d.group&&f.setText(a.text,g.oldOffset+i,g.oldOffset+j);this.ignoreVerify=!1;a.text=null;this._updateAnnotations(b)}}}.bind(this)}}
...
define("orion/editor/factories","orion/editor/actions,orion/editor/undoStack,orion/editor/rulers,orion/editor/annotations,orion/editor/textDND,orion/editor/linkedMode".split(","),function(k,p,o,e,b,d){function h(){}function j(){}function f(){}function a(){}function c(){}function i(){}var n={};h.prototype={createKeyBindings:function(a,b,c,f){var f=new k.TextActions(a,b,f),e=new d.LinkedMode(a,b,c),a=new k.SourceCodeActions(a,b,c,e);return{textActions:f,linkedMode:e,sourceCodeActions:a}}};n.KeyBindingsFactory=
h;j.prototype={createUndoStack:function(a){a=a.getTextView();return new p.UndoStack(a,200)}};n.UndoFactory=j;f.prototype={createLineNumberRuler:function(a){return new o.LineNumberRuler(a,"left",{styleClass:"ruler lines"},{styleClass:"rulerLines odd"},{styleClass:"rulerLines even"})}};n.LineNumberRulerFactory=f;a.prototype={createFoldingRuler:function(a){return new o.FoldingRuler(a,"left",{styleClass:"ruler folding"})}};n.FoldingRulerFactory=a;c.prototype={createAnnotationModel:function(a){return new e.AnnotationModel(a)},
createAnnotationStyler:function(a,b){return new e.AnnotationStyler(a,b)},createAnnotationRulers:function(a){var b=new o.AnnotationRuler(a,"left",{styleClass:"ruler annotations"}),a=new o.OverviewRuler(a,"right",{styleClass:"ruler overview"});return{annotationRuler:b,overviewRuler:a}}};n.AnnotationFactory=c;i.prototype={createTextDND:function(a,c){return new b.TextDND(a.getTextView(),c)}};n.TextDNDFactory=i;return n});
...
d=f==="resolved"?"resolve":"reject";if(typeof a[d]==="function")try{var j=a[d](c);j&&typeof j.then==="function"?(b.cancel=j.cancel||e,j.then(o(b.resolve),o(b.reject),b.progress)):b.resolve(j)}catch(m){b.reject(m)}else b[d](c)}}var c,f,h=[],j=this;this.reject=function(b){f||(f="rejected",c=b,h.length&&p(a));return j.promise};this.resolve=function(b){f||(f="resolved",c=b,h.length&&p(a));return j.promise};this.progress=function(a){f||h.forEach(function(b){b.progress&&b.progress(a)});return j.promise};
...
delimiter:f.getLineDelimiter(),tab:i,indentation:h},n=this,c=c.map(function(c){var d=c.computeProposals||c.getProposals,f;try{typeof d==="function"&&(f=n.progress?n.progress.progress(d.apply(c,[e,a,j]),"Generating content assist proposal"):d.apply(c,[e,a,j]))}catch(g){n.handleError(g)}return b.when(f)});return b.all(c,this.handleError).then(function(a){return a.reduce(function(a,b){return b instanceof Array?a.concat(b):a},[])})},setProviders:function(a){this.providers=a.slice(0)},setProgress:function(a){this.progress=
...
this.proposals.length-1?0:this.selectedIndex+1;this.proposals[a].unselectable&&a<this.proposals.length-1;)a++;this.selectedIndex=a;this.widget&&this.widget.setSelectedIndex(this.selectedIndex);return!0},enter:function(){return this.contentAssist.apply(this.proposals[this.selectedIndex]||null)},tab:function(){return this.widget?(this.widget.createAccessible(this),this.widget.parentNode.focus(),!0):!1}});n.prototype={onClick:function(a){this.contentAssist.apply(this.getProposal(a.target));this.textView.focus()},
...
27)return a.cancel();else if(b.keyCode===38)return a.lineUp();else if(b.keyCode===40)return a.lineDown();else if(b.keyCode===13)return a.enter();return!1});this._isAccessible=!0},calculateClasses:function(a,b){var c=m[a];if(!c)c=m.dfault;return b?c+m.selected:c},getDisplayString:function(a){return typeof a==="string"?a:a.description&&typeof a.description==="string"?a.description:a.proposal},getProposal:function(a){for(var b=0,c=this.parentNode.firstChild;c!==null;c=c.nextSibling){if(c===a)return this.proposals[b]||
null;b++}return null},setSelectedIndex:function(a){this.selectedIndex=a;this.selectNode(this.parentNode.childNodes[this.selectedIndex])},selectNode:function(a){for(var b=this.parentNode.childNodes,c=0;c<b.length;c++){var d=b[c],f=d.className.indexOf(m.selected);if(f>=0)d.className=d.className.substring(0,f)+d.className.substring(f+m.selected.length);d===a&&(d.className+=m.selected,this.parentNode.setAttribute("aria-activedescendant",d.id),d.focus(),d.offsetTop<this.parentNode.scrollTop?d.scrollIntoView(!0):
...
onStyleReady:function(b){var d=b.lineStyles||b.style,b=Number.MAX_VALUE,f=-1,a=this.textView.getModel(),c;for(c in d)d.hasOwnProperty(c)&&(this.lineStyles[c]=d[c],b=Math.min(b,c),f=Math.max(f,c));b=Math.max(b,0);f=Math.min(f,a.getLineCount());if(d=this.annotationModel){for(var e=d.getAnnotations(a.getLineStart(b),a.getLineEnd(f)),n=[];e.hasNext();){var m=e.next();m.type==="orion.annotation.highlightError"&&n.push(m)}e=[];for(m=b;m<=f;m++){c=m;var l=this.lineStyles[c],l=l&&l.errors;c=a.getLineStart(c);
if(l)for(var k=0;k<l.length;k++){var o=l[k];e.push(p.AnnotationType.createAnnotation("orion.annotation.highlightError",o.start+c,o.end+c))}}d.replaceAnnotations(n,e)}this.textView.redrawLines(b,f+1)},onLineStyle:function(b){function d(a,b){for(var f=a.length,e=[],h=0;h<f;h++){var j=a[h];e.push({start:j.start+b,end:j.end+b,style:j.style})}return e}var f=this.lineStyles[b.lineIndex];if(f)if(f.ranges)b.ranges=d(f.ranges,b.lineStart);else if(f.style)b.style=f.style},_getEmptyStyle:function(b){for(var d=
...
j=[],f=0;f<b.length;f++){var a=b[f],c=/\\(\d+)/.exec(a);c?(a=d[c[1]]||"",j.push(e?k.escape(a):a)):j.push(a)}return RegExp(j.join(""))},groupify:function(b,d){for(var e=b.source,j=e.length,f=[],a=0,c=[],i=1,k=1,m=[],l={},o={},p=0;p<j;p++){var u=f[f.length-1],v=e.charAt(p);switch(v){case "(":if(u===4)f.pop(),m.push(")"),c[c.length-1].end=p;var g=p+2<j?e.charAt(p+1)+""+e.charAt(p+2):null;if(g==="?:"||g==="?="||g==="?!"){var t;g==="?:"?t=1:(t=3,a++);f.push(t);c.push({start:p,end:-1,type:t});m.push(v);
m.push(g);p+=g.length}else f.push(2),c.push({start:p,end:-1,type:2,oldNum:i,num:k}),m.push(v),a===0&&(o[k]=null),l[i]=k,i++,k++;break;case ")":u=f.pop();u===3&&a--;c[c.length-1].end=p;m.push(v);break;case "*":case "+":case "?":case "}":var x=v,s=e.charAt(p-1),g=p-1;if(v==="}"){for(t=p-1;e.charAt(t)!=="{"&&t>=0;t--);s=e.charAt(t-1);g=t-1;x=e.substring(t,p+1)}t=c[c.length-1];if(s===")"&&(t.type===2||t.type===4)){m.splice(t.start,0,"(");m.push(x);m.push(")");v={start:t.start,end:m.length-1,type:4,num:t.num};
for(s=0;s<c.length;s++)if(u=c[s],(u.type===2||u.type===4)&&u.start>=t.start&&u.end<=g)if(u.start+=1,u.end+=1,u.num+=1,u.type===2)l[u.oldNum]=u.num;c.push(v);k++;break}default:v!=="|"&&u!==2&&u!==4&&a===0&&(f.push(4),c.push({start:p,end:-1,type:4,num:k}),m.push("("),o[k]=null,k++),m.push(v),v==="\\"&&(v=e.charAt(p+1),m.push(v),p+=1)}}for(;f.length;)f.pop(),m.push(")");var e=RegExp(m.join("")),j={},d=d||l,B;for(B in d)d.hasOwnProperty(B)&&(j[B]="\\"+d[B]);e=this.getSubstitutedRegex(e,j,!1);return[e,
...
f);for(var a=0;a<f.children.length;a++)e.push(f.children[a])}}return j||this._tree},isDamaged:function(b,d,e){return b.start<=e&&b.end>d},parse:function(b,d,e,j,f,a){var c=this.textView.getModel(),i=c.getLineStart(c.getLineCount()-1),k=c.getCharCount(),m=this.getInitialExpected(b,e),l=-1;if(d)b.repaired=!0,b.endNeedsUpdate=!0,l=(l=b.children[b.children.length-1])?c.getLineEnd(c.getLineAtOffset(l.end+(f-a))):-1,j=c.getLineEnd(c.getLineAtOffset(j+a)),l=Math.max(l,j);for(var l=l===-1?k:l,j=m,o=b,p=!1,
u=e,v=-1;o&&(!d||u<l);){var g=this.getNextMatch(c,o,u);g||(u=u>=i?k:c.getLineStart(c.getLineAtOffset(u)+1));var t=g&&g.match,x=g&&g.rule,s=g&&g.isEnd;if(g&&g.isSub){if(u=this.afterMatch(t),x instanceof this.BeginEndRule)p=!0,d&&x===j.rule&&o===j.parent?(o=j,o.setStart(t),o.repaired=!0,o.endNeedsUpdate=!0,j=this.getNextExpected(j,"begin")):(d&&(this.prune(o,j),d=!1),t=new this.BeginEndNode(o,x,t),o.addChild(t),o=t)}else if(s||u===k){if(o instanceof this.BeginEndNode)t?(p=!0,v=Math.max(v,o.end),o.setEnd(t),
u=this.afterMatch(t),d&&o===j&&o.parent===j.parent?(o.repaired=!0,delete o.endNeedsUpdate,j=this.getNextExpected(j,"end")):d&&(this.prune(o,j),d=!1)):(o.setEnd(k),delete o.endNeedsUpdate);o=o.parent}d&&u>=l&&!p&&(this.prune(b,m),d=!1)}this.removeUnrepairedChildren(b,d,e);this.cleanup(d,b,e,l,k,f,a);return d?Math.max(v,u):u},removeUnrepairedChildren:function(b,d,e){if(d){for(var d=b.children,j=-1,f=0;f<d.length;f++){var a=d[f];if(!a.repaired&&this.isDamaged(a,e,Number.MAX_VALUE)){j=f;break}}if(j!==
...
a=b.getText(e,f),c=[],i=[],b=[],f=[];for(this.push(c,d.rule.subrules);c.length;){var k=c.length?c.pop():null,k=k&&k._resolvedRule._typedRule;if(k instanceof this.ContainerRule&&i.indexOf(k)===-1)i.push(k),this.push(c,k.subrules);else if(!k||!j||k.matchRegex){var m=k&&this.exec(k.matchRegex||k.beginRegex,a,e);m&&(b.push(m),f.push(k))}}c=Number.MAX_VALUE;i=-1;for(k=0;k<b.length;k++)if(m=b[k],m.index<c)c=m.index,i=k;if(!j&&(e=this.getEndMatch(d,a,e)))if(j=d.rule.applyEndPatternLast,i===-1||e.index<c||
...
{1:0},c=0,i=1;d[i]!==void 0;i++)a[i]!==void 0&&(c+=d[i].length),d[i+1]!==void 0&&(j[i+1]=c);a=d.index;for(c=1;e[c];c++){var i=e[c].name,k=f[c],m=a+j[k];typeof d[k]!=="undefined"&&this.addScopeRange(b,m,m+d[k].length,i)}}else this.addScope(b,d,e[0]&&e[0].name)},getIntersecting:function(b,d){for(var e=[],j=this._tree?[this._tree]:[];j.length;){var f=j.pop(),a=!1;f instanceof this.ContainerNode?a=!0:this.isDamaged(f,b,d)&&(a=!0,e.push(f));if(a)for(var a=f.children.length,c=0;c<a;c++)j.push(f.children[c])}return e.reverse()},
