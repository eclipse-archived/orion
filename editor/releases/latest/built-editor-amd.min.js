/*
 ...
 IBM Corporation - initial API and implementation
*/
define("orion/editor/shim",[],function(){if(!Object.create)Object.create=function(k,m){function p(){}p.prototype=k;var h=new p;if(m)for(var c in m)m.hasOwnProperty(c)&&(h[c]=m[c].hasOwnProperty("value")?m[c].value:function(){if(arguments.length>0)return m[c].get();else m[c].set(arguments)});return h};if(!Object.keys)Object.keys=function(k){var m=[],p;for(p in k)k.hasOwnProperty(p)&&m.push(p);return m};if(!Function.prototype.bind)Function.prototype.bind=function(k){var m=this,p=Array.prototype.slice.call(arguments,
...
0;m<this.length;m++)k(this[m],m)};if(!Array.prototype.map)Array.prototype.map=function(k){for(var m=Array(this.length),p=0;p<this.length;p++)m[p]=k(this[p]);return m};if(!Array.prototype.reduce)Array.prototype.reduce=function(k,m){var p,h=!1;1<arguments.length&&(p=m,h=!0);for(var c=0;this.length>c;++c)h?p=k(p,this[c],c,this):(p=this[c],h=!0);return p};if(!String.prototype.trim)String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")};if(!String.prototype.trimLeft)String.prototype.trimLeft=
...
(function(){function k(c,d,f,j,g,b){d[c]&&(f.push(c),(d[c]===!0||d[c]===1)&&j.push(g+c+"/"+b))}function m(c,d,f,j,g){d=j+d+"/"+g;require._fileExists(c.toUrl(d+".js"))&&f.push(d)}function p(c,d,f){for(var j in d)d.hasOwnProperty(j)&&(!c.hasOwnProperty(j)||f)?c[j]=d[j]:typeof d[j]==="object"&&p(c[j],d[j],f)}var h=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(c){var d=c.config?c.config():{};return{version:"2.0.1+",load:function(f,c,g,b){b=b||{};if(b.locale)d.locale=b.locale;
var a=h.exec(f),e=a[1],l=a[4],q=a[5],r=l.split("-"),o=[],n={},t,v="";if(a[5])e=a[1],f=e+q;else{q=a[4];l=d.locale;if(!l)l=d.locale=typeof navigator==="undefined"?"root":(navigator.language||navigator.userLanguage||"root").toLowerCase();r=l.split("-")}if(b.isBuild){o.push(f);m(c,"root",o,e,q);for(t=0;t<r.length;t++)b=r[t],v+=(v?"-":"")+b,m(c,v,o,e,q);c(o,function(){g()})}else c([f],function(a){var b=[],i;k("root",a,b,o,e,q);for(t=0;t<r.length;t++)i=r[t],v+=(v?"-":"")+i,k(v,a,b,o,e,q);c(o,function(){var i,
x,f;for(i=b.length-1;i>-1&&b[i];i--){f=b[i];x=a[f];if(x===!0||x===1)x=c(e+f+"/"+q);p(n,x)}g(n)})})}}})})();define("orion/editor/i18n",{load:function(k,m,p){m.specified&&m.specified("orion/bootstrap")?m(["orion/i18n!"+k],function(h){p(h)}):p({})}});
...
define("orion/editor/nls/messages",["orion/editor/i18n!orion/editor/nls/messages","orion/editor/nls/root/messages"],function(k,m){var p={root:m},h;for(h in k)k.hasOwnProperty(h)&&typeof p[h]==="undefined"&&(p[h]=k[h]);return p});
define("orion/editor/eventTarget",[],function(){function k(){}k.addMixin=function(m){var p=k.prototype,h;for(h in p)p.hasOwnProperty(h)&&(m[h]=p[h])};k.prototype={addEventListener:function(k,p,h){if(!this._eventTypes)this._eventTypes={};var c=this._eventTypes[k];c||(c=this._eventTypes[k]={level:0,listeners:[]});c.listeners.push({listener:p,useCapture:h})},dispatchEvent:function(k){var p=k.type;this._dispatchEvent("pre"+p,k);this._dispatchEvent(p,k);this._dispatchEvent("post"+p,k)},_dispatchEvent:function(k,
p){var h=this._eventTypes?this._eventTypes[k]:null;if(h){var c=h.listeners;try{if(h.level++,c)for(var d=0,f=c.length;d<f;d++)if(c[d]){var j=c[d].listener;typeof j==="function"?j.call(this,p):j.handleEvent&&typeof j.handleEvent==="function"&&j.handleEvent(p)}}finally{if(h.level--,h.compact&&h.level===0){for(d=c.length-1;d>=0;d--)c[d]||c.splice(d,1);c.length===0&&delete this._eventTypes[k];h.compact=!1}}}},isListening:function(k){return!this._eventTypes?!1:this._eventTypes[k]!==void 0},removeEventListener:function(k,
p,h){if(this._eventTypes){var c=this._eventTypes[k];if(c){for(var d=c.listeners,f=0,j=d.length;f<j;f++){var g=d[f];if(g&&g.listener===p&&g.useCapture===h){c.level!==0?(d[f]=null,c.compact=!0):d.splice(f,1);break}}d.length===0&&delete this._eventTypes[k]}}}};return{EventTarget:k}});define("orion/regex",[],function(){return{escape:function(k){return k.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&")},parse:function(k){return(k=/^\s*\/(.+)\/([gim]{0,3})\s*$/.exec(k))?{pattern:k[1],flags:k[2]}:null}}});
define("orion/util",[],function(){var k=navigator.userAgent,m=k.indexOf("MSIE")!==-1||k.indexOf("Trident")!==-1?document.documentMode:void 0,p=parseFloat(k.split("Firefox/")[1]||k.split("Minefield/")[1])||void 0,h=k.indexOf("Opera")!==-1?parseFloat(k.split("Version/")[1]):void 0,c=parseFloat(k.split("Chrome/")[1])||void 0,d=k.indexOf("Safari")!==-1&&!c,f=parseFloat(k.split("WebKit/")[1])||void 0,j=k.indexOf("Android")!==-1,g=k.indexOf("iPad")!==-1,k=k.indexOf("iPhone")!==-1,b=g||k,a=navigator.platform.indexOf("Mac")!==
-1,e=navigator.platform.indexOf("Win")!==-1,l=navigator.platform.indexOf("Linux")!==-1;return{formatMessage:function(a){var b=arguments;return a.replace(/\$\{([^\}]+)\}/g,function(a,e){return b[(e<<0)+1]})},createElement:function(a,b){return a.createElementNS?a.createElementNS("http://www.w3.org/1999/xhtml",b):a.createElement(b)},isIE:m,isFirefox:p,isOpera:h,isChrome:c,isSafari:d,isWebkit:f,isAndroid:j,isIPad:g,isIPhone:k,isIOS:b,isMac:a,isWindows:e,isLinux:l,platformDelimiter:e?"\r\n":"\n"}});
define("orion/editor/textModel",["orion/editor/eventTarget","orion/regex","orion/util"],function(k,m,p){function h(c,d){this._lastLineIndex=-1;this._text=[""];this._lineOffsets=[0];this.setText(c);this.setLineDelimiter(d)}h.prototype={destroy:function(){},find:function(c){if(this._text.length>1)this._text=[this._text.join("")];var d=c.string,f=c.regex,j=d,g="",b=c.caseInsensitive;if(j)if(f){if(d=m.parse(j))j=d.pattern,g=d.flags}else j=d.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&"),b&&(j=j.replace(/[iI\u0130\u0131]/g,
"[Ii\u0130\u0131]"));var a=null,e;if(j){var d=c.reverse,l=c.wrap,f=c.wholeWord,q=c.start||0,c=c.end,h=c!==null&&c!==void 0;g.indexOf("g")===-1&&(g+="g");g.indexOf("m")===-1&&(g+="m");b&&g.indexOf("i")===-1&&(g+="i");f&&(j="\\b"+j+"\\b");var o=this._text[0],n,t,v=0;h&&(b=q<c?q:c,o=o.substring(b,q<c?c:q),v=b);var s=RegExp(j,g);if(d)e=function(){var a=null;for(s.lastIndex=0;;){t=s.lastIndex;n=s.exec(o);if(t===s.lastIndex)return null;if(n){if(!(n.index+v<q)){if(!l||a)break;q=o.length+v}a={start:n.index+
v,end:s.lastIndex+v}}else break}if(a)q=a.start;return a};else{if(!h)s.lastIndex=q;e=function(){for(;;){t=s.lastIndex;n=s.exec(o);if(t===s.lastIndex)break;if(n)return{start:n.index+v,end:s.lastIndex+v};if(!(t!==0&&l))break}return null}}a=e()}return{next:function(){var b=a;b&&(a=e());return b},hasNext:function(){return a!==null}}},getCharCount:function(){for(var c=0,d=0;d<this._text.length;d++)c+=this._text[d].length;return c},getLine:function(c,d){var f=this.getLineCount();if(!(0<=c&&c<f))return null;
var j=this._lineOffsets[c];if(c+1<f){f=this.getText(j,this._lineOffsets[c+1]);if(d)return f;for(var j=f.length,g;(g=f.charCodeAt(j-1))===10||g===13;)j--;return f.substring(0,j)}else return this.getText(j)},getLineAtOffset:function(c){var d=this.getCharCount();if(!(0<=c&&c<=d))return-1;var f=this.getLineCount();if(c===d)return f-1;var j,g,b=this._lastLineIndex;if(0<=b&&b<f&&(j=this._lineOffsets[b],g=b+1<f?this._lineOffsets[b+1]:d,j<=c&&c<g))return b;for(var a=f,e=-1;a-e>1;)if(b=Math.floor((a+e)/2),
j=this._lineOffsets[b],g=b+1<f?this._lineOffsets[b+1]:d,c<=j)a=b;else if(c<g){a=b;break}else e=b;return this._lastLineIndex=a},getLineCount:function(){return this._lineOffsets.length},getLineDelimiter:function(){return this._lineDelimiter},getLineEnd:function(c,d){var f=this.getLineCount();if(!(0<=c&&c<f))return-1;if(c+1<f){f=this._lineOffsets[c+1];if(d)return f;for(var j=this.getText(Math.max(this._lineOffsets[c],f-2),f),g=j.length,b;(b=j.charCodeAt(g-1))===10||b===13;)g--;return f-(j.length-g)}else return this.getCharCount()},
getLineStart:function(c){return!(0<=c&&c<this.getLineCount())?-1:this._lineOffsets[c]},getText:function(c,d){c===void 0&&(c=0);d===void 0&&(d=this.getCharCount());if(c===d)return"";for(var f=0,j=0,g;j<this._text.length;){g=this._text[j].length;if(c<=f+g)break;f+=g;j++}for(var b=f,a=j;j<this._text.length;){g=this._text[j].length;if(d<=f+g)break;f+=g;j++}if(a===j)return this._text[a].substring(c-b,d-f);b=this._text[a].substring(c-b);f=this._text[j].substring(0,d-f);return b+this._text.slice(a+1,j).join("")+
f},onChanging:function(c){return this.dispatchEvent(c)},onChanged:function(c){return this.dispatchEvent(c)},setLineDelimiter:function(c,d){c==="auto"&&(c=void 0,this.getLineCount()>1&&(c=this.getText(this.getLineEnd(0),this.getLineEnd(0,!0))));this._lineDelimiter=c?c:p.platformDelimiter;if(d){var f=this.getLineCount();if(f>1){for(var j=Array(f),g=0;g<f;g++)j[g]=this.getLine(g);this.setText(j.join(this._lineDelimiter))}}},setText:function(c,d,f){c===void 0&&(c="");d===void 0&&(d=0);f===void 0&&(f=
this.getCharCount());if(!(d===f&&c==="")){for(var j=this.getLineAtOffset(d),g=this.getLineAtOffset(f),b=d,a=f-d,e=g-j,l=c.length,q=0,h=this.getLineCount(),o=0,n=0,t=0,v=[];;){o!==-1&&o<=t&&(o=c.indexOf("\r",t));n!==-1&&n<=t&&(n=c.indexOf("\n",t));if(n===-1&&o===-1)break;t=o!==-1&&n!==-1?o+1===n?n+1:(o<n?o:n)+1:o!==-1?o+1:n+1;v.push(d+t);q++}this.onChanging({type:"Changing",text:c,start:b,removedCharCount:a,addedCharCount:l,removedLineCount:e,addedLineCount:q});v.length===0&&(t=this.getLineStart(j),
g=g+1<h?this.getLineStart(g+1):this.getCharCount(),d!==t&&(c=this.getText(t,d)+c,d=t),f!==g&&(c+=this.getText(f,g),f=g));t=l-a;for(g=j+e+1;g<h;g++)this._lineOffsets[g]+=t;if(v.length<5E4)j=[j+1,e].concat(v),Array.prototype.splice.apply(this._lineOffsets,j);else{t=j+1;this._lineOffsets.splice(t,e);for(h=0;h<v.length;h+=5E4)j=[t,0].concat(v.slice(h,Math.min(v.length,h+5E4))),Array.prototype.splice.apply(this._lineOffsets,j),t+=5E4}for(t=h=0;t<this._text.length;){g=this._text[t].length;if(d<=h+g)break;
h+=g;t++}j=h;for(v=t;t<this._text.length;){g=this._text[t].length;if(f<=h+g)break;h+=g;t++}g=this._text[t];d=this._text[v].substring(0,d-j);f=g.substring(f-h);v=[v,t-v+1];d&&v.push(d);c&&v.push(c);f&&v.push(f);Array.prototype.splice.apply(this._text,v);if(this._text.length===0)this._text=[""];this.onChanged({type:"Changed",start:b,removedCharCount:a,addedCharCount:l,removedLineCount:e,addedLineCount:q})}}};k.EventTarget.addMixin(h.prototype);return{TextModel:h}});
define("orion/keyBinding",["orion/util"],function(k){function m(h,c,d,f,j,g){this.type=g||"keydown";this.keyCode=typeof h==="string"&&this.type==="keydown"?h.toUpperCase().charCodeAt(0):h;this.mod1=c!==void 0&&c!==null?c:!1;this.mod2=d!==void 0&&d!==null?d:!1;this.mod3=f!==void 0&&f!==null?f:!1;this.mod4=j!==void 0&&j!==null?j:!1}function p(h){this.keys=h}m.prototype={getKeys:function(){return[this]},match:function(h,c){if(c!==void 0){if(c!==0)return!1}else if(h instanceof Array){if(h.length>1)return!1;
h=h[0]}return h.type!==this.type?!1:this.keyCode===h.keyCode||this.keyCode===String.fromCharCode(k.isOpera?h.which:h.charCode!==void 0?h.charCode:h.keyCode)?this.mod1!==(k.isMac?h.metaKey:h.ctrlKey)?!1:this.type==="keydown"&&this.mod2!==h.shiftKey?!1:this.mod3!==h.altKey?!1:k.isMac&&this.mod4!==h.ctrlKey?!1:!0:!1},equals:function(h){return!h?!1:this.keyCode!==h.keyCode?!1:this.mod1!==h.mod1?!1:this.mod2!==h.mod2?!1:this.mod3!==h.mod3?!1:this.mod4!==h.mod4?!1:this.type!==h.type?!1:!0}};p.prototype=
{getKeys:function(){return this.keys.slice(0)},match:function(h,c){var d=this.keys;if(c!==void 0)return c>d.length?!1:d[c].match(h)?c===d.length-1?!0:c+1:!1;else{h instanceof Array||(h=[h]);if(h.length>d.length)return!1;var f;for(f=0;f<h.length;f++)if(!d[f].match(h[f]))return!1;return f===d.length?!0:f}},equals:function(h){if(!h.keys)return!1;if(h.keys.length!==this.keys.length)return!1;for(var c=0;c<h.keys.length;c++)if(!h.keys[c].equals(this.keys[c]))return!1;return!0}};return{KeyBinding:m,KeyStroke:m,
KeySequence:p}});
...
define("orion/editor/textTheme",["require","orion/editor/eventTarget","orion/util"],function(k,m,p){function h(c){c=c||{};this._document=c.document||document}var c={};h.getTheme=function(d){var d=d||"default",f=c[d];f||(f=c[d]=new h);return f};h.prototype={getThemeClass:function(){return this._themeClass},setThemeClass:function(c,f){var j=this,g=j._themeClass;j._themeClass=c;this._load(c,f,function(){j.onThemeChanged({type:"ThemeChanged",oldValue:g,newValue:j.getThemeClass()})})},onThemeChanged:function(c){return this.dispatchEvent(c)},
buildStyleSheet:function(c,f){function j(b,a,e){a&&(g.push("."+c+" ."+b+" {"),g.push("\t"+(e?"background-color":"color")+": "+a+";"),g.push("}"))}var g=[];g.push("");g.push("."+c+" {");f.fontFamily&&g.push("\tfont-family: "+f.fontFamily+";");f.fontSize&&g.push("\tfont-size: "+f.fontSize+";");f.fontSize&&g.push("\tcolor: "+f.text+";");g.push("}");g.push("."+c+".textview {");f.background&&g.push("\tbackground-color: "+f.background+";");g.push("}");j("ruler.annotations",f.annotationRuler,!0);j("ruler.lines",
...
j("comment.block.documentation",f.comment,!1);j("keyword.other.documentation.markup",f.comment,!1);return g.join("\n")},_createStyle:function(c,f,j,g){var b=this._document,c="orion-theme-"+c,a=b.getElementById(c);if(a){if(g||a.firstChild.data===f)return;a.removeChild(a.firstChild);a.appendChild(b.createTextNode(f))}else g?(a=p.createElement(b,"link"),a.rel="stylesheet",a.type="text/css",a.href=f,a.addEventListener("load",function(){j()})):(a=p.createElement(b,"style"),a.appendChild(b.createTextNode(f))),
a.id=c,(b.getElementsByTagName("head")[0]||b.documentElement).appendChild(a);g||j()},_load:function(c,f,j){if(c)if(typeof f==="string")this._createStyle(c,f,j);else if(f=f.href,f.substring(f.length-4)!==".css"&&(f+=".css"),/^\//.test(f)||/[a-zA-Z0-9]+:\/\//i.test(f)||!k.toUrl)this._createStyle(c,f,j,!0);else{var g=this;k(["text!"+f],function(b){g._createStyle(c,b,j,!1)})}else j()}};m.EventTarget.addMixin(h.prototype);return{TextTheme:h}});
define("orion/editor/util",[],function(){return{contains:function(k,m){if(!m)return!1;if(!k.compareDocumentPosition){for(var p=m;p;){if(k===p)return!0;p=p.parentNode}return!1}return k===m||(k.compareDocumentPosition(m)&16)!==0},addEventListener:function(k,m,p,h){typeof k.addEventListener==="function"?k.addEventListener(m,p,h===!0):k.attachEvent("on"+m,p)},removeEventListener:function(k,m,p,h){typeof k.removeEventListener==="function"?k.removeEventListener(m,p,h===!0):k.detachEvent("on"+m,p)}}});
define("orion/editor/textView","i18n!orion/editor/nls/messages,orion/editor/textModel,orion/editor/keyModes,orion/editor/eventTarget,orion/editor/textTheme,orion/editor/util,orion/util".split(","),function(k,m,p,h,c,d,f){function j(i,a,x){if(x){a.className="";for(var x=a.attributes,b=x.length;b-- >0;)(!f.isIE||f.isIE>=9||f.isIE<9&&x[b].specified)&&a.removeAttribute(x[b].name)}if(i){if(i.styleClass)a.className=i.styleClass;if(x=i.style)for(var e in x)x.hasOwnProperty(e)&&(a.style[e]=x[e]);if(i=i.attributes)for(var c in i)i.hasOwnProperty(c)&&
a.setAttribute(c,i[c])}}function g(i){return i instanceof Array?i.slice(0):i}function b(i,a){if(!i)return a;if(!a)return i;for(var x in a)a.hasOwnProperty(x)&&(i.hasOwnProperty(x)||(i[x]=a[x]));return i}function a(i,w){if(i===w)return!0;if(i&&!w||!i&&w)return!1;if(i&&i.constructor===String||w&&w.constructor===String)return!1;if(i instanceof Array||w instanceof Array){if(!(i instanceof Array&&w instanceof Array))return!1;if(i.length!==w.length)return!1;for(var x=0;x<i.length;x++)if(!a(i[x],w[x]))return!1;
...
a=parseInt(a,10)||0;b=parseInt(b,10)||0;e=parseInt(e,10)||0;c=parseInt(c,10)||0;f.left+=a;f.top+=b;f.right+=e;f.bottom+=c;i._trim=f}return f}function r(i,a,b){this.start=i;this.end=a;this.caret=b}function o(i){this.left=i.left;this.top=i.top;this.right=i.right;this.bottom=i.bottom}function n(i,a,b){this.view=i;this.lineIndex=a;this._lineDiv=b}function t(i){this._init(i||{})}var v=d.addEventListener,s=d.removeEventListener,u=function(){function i(i){this.options=i}i.prototype.play=function(){var i=
...
q={text:l,style:e._metrics.largestFontStyle,ignoreChars:1};b.length===0||!b[b.length-1].style||b[b.length-1].style.tagName!=="div"?b.push(q):b.splice(b.length-1,0,q);var g,n,h,r,o,l=e=0,s,t;if(w){if(n=w.modelChangedEvent)n.removedLineCount===0&&n.addedLineCount===0?(t=n.start-d,s=n.addedCharCount-n.removedCharCount):t=-1,w.modelChangedEvent=void 0;n=w.firstChild}for(d=0;d<b.length;d++){q=b[d];r=q.text;e+=r.length;g=q.style;if(n)if(o=n.firstChild.data,h=n.viewStyle,o===r&&a(g,h)){l+=o.length;n._rectsCache=
void 0;g=n=n.nextSibling;continue}else for(;n;){if(t!==-1){h=e;h>=t&&(h-=s);o=(o=n.firstChild.data)?o.length:0;if(l+o>h)break;l+=o}h=n.nextSibling;c.removeChild(n);n=h}g=this._createSpan(c,r,g,q.ignoreChars);n?c.insertBefore(g,n):c.appendChild(g);if(w)w.lineWidth=void 0}if(w)for(i=g?g.nextSibling:null;i;)h=i.nextSibling,w.removeChild(i),i=h;else i.appendChild(c);return c},_createRanges:function(i,w,b,e,c,f){if(!(b>e)){if(i)for(var l=0;l<i.length;l++){var d=i[l];if(!(d.end<c+b)){var q=Math.max(c+b,
d.start)-c;if(q>e)break;var g=Math.min(c+e,d.end)-c;if(q<=g){q=Math.max(b,q);g=Math.min(e,g);b<q&&this._createRange(w,b,q,null,f);if(!d.style||!d.style.unmergeable)for(;l+1<i.length&&i[l+1].start-c===g&&a(d.style,i[l+1].style);)d=i[l+1],g=Math.min(c+e,d.end)-c,l++;this._createRange(w,q,g,d.style,f);b=g}}}b<e&&this._createRange(w,b,e,null,f)}},_createRange:function(i,a,b,e,c){if(!(a>b)){var f=this.view._customTabSize;if(f&&f!==8)for(var l=i.indexOf("\t",a);l!==-1&&l<b;){a<l&&(a={text:i.substring(a,
...
e=this.view;if(i===void 0)return this._getLineBoundingClientRect(b,!0);var c=e._model,l=b.ownerDocument,d=this.lineIndex,q=null;if(i<c.getLineEnd(d)){d=c.getLineStart(d);for(c=b.firstChild;c;){if(!c.ignore){var g=c.firstChild,j=g.length;c.ignoreChars&&(j-=c.ignoreChars);if(d+j>i){q=i-d;if(g.length===1)q=new o(c.getBoundingClientRect());else if(e._isRangeRects)l=l.createRange(),l.setStart(g,q),l.setEnd(g,q+1),q=new o(l.getBoundingClientRect());else if(f.isIE){if(l=l.body.createTextRange(),l.moveToElementText(c),
l.collapse(),(d=q===0&&f.isIE===8)&&(q=1),l.moveEnd("character",q+1),l.moveStart("character",q),q=new o(l.getBoundingClientRect()),d)q.left=c.getClientRects()[0].left}else{var n=g.data;c.removeChild(g);c.appendChild(l.createTextNode(n.substring(0,q)));var h=f.createElement(l,"span");h.appendChild(l.createTextNode(n.substring(q,q+1)));c.appendChild(h);c.appendChild(l.createTextNode(n.substring(q+1)));q=new o(h.getBoundingClientRect());c.innerHTML="";c.appendChild(g);this._createdDiv||(l=e._getSelection(),
(d<=l.start&&l.start<d+j||d<=l.end&&l.end<d+j)&&e._updateDOMSelection())}f.isIE&&(l=b.ownerDocument.defaultView||b.ownerDocument.parentWindow,b=l.screen.logicalXDPI/l.screen.deviceXDPI,l=l.screen.logicalYDPI/l.screen.deviceYDPI,q.left*=b,q.right*=b,q.top*=l,q.bottom*=l);break}d+=j}c=c.nextSibling}}b=this.getBoundingClientRect();if(!q)e._wrapMode?(e=this.getClientRects(),q=e[e.length-1],q.left=q.right,q.left+=b.left,q.top+=b.top,q.right+=b.left,q.bottom+=b.top):(q=new o(b),q.left=q.right);if(a||a===
void 0)q.left-=b.left,q.top-=b.top,q.right-=b.left,q.bottom-=b.top;return q},_getClientRects:function(i,a){var b,e,c,l;if(!i._rectsCache){b=i.getClientRects();e=Array(b.length);for(l=0;l<b.length;l++)c=e[l]=new o(b[l]),c.left-=a.left,c.top-=a.top,c.right-=a.left,c.bottom-=a.top;i._rectsCache=e}b=i._rectsCache;e=[b.length];for(l=0;l<b.length;l++)e[l]=new o(b[l]);return e},getClientRects:function(i){if(!this.view._wrapMode)return[this.getBoundingClientRect()];for(var a=this._ensureCreated(),b=[],e=
a.firstChild,c,l=a.getBoundingClientRect();e;){if(!e.ignore)for(var f=this._getClientRects(e,l),a=0;a<f.length;a++){var q=f[a],d;if(q.top!==q.bottom){var g=q.top+(q.bottom-q.top)/2;for(d=0;d<b.length;d++)if(c=b[d],c.top<=g&&g<c.bottom)break;if(d===b.length)b.push(q);else{if(q.left<c.left)c.left=q.left;if(q.top<c.top)c.top=q.top;if(q.right>c.right)c.right=q.right;if(q.bottom>c.bottom)c.bottom=q.bottom}}}e=e.nextSibling}return i!==void 0?b[i]:b},_getLineBoundingClientRect:function(i,a){var b=new o(i.getBoundingClientRect());
...
i<a[b].bottom)return b;return a.length-1},getLineStart:function(i){if(!this.view._wrapMode||i===0)return this.view._model.getLineStart(i);var a=this.getClientRects();return this.getOffset(a[i].left+1,a[i].top+1)},getOffset:function(i,a){var b=this.view,e=b._model,c=this.lineIndex,l=e.getLineStart(c),q=e.getLineEnd(c);if(l===q)return l;var d=this._ensureCreated(),g=this.getBoundingClientRect(),j,n;if(b._wrapMode){j=this.getClientRects();if(a<j[0].top)a=j[0].top;for(var h=0;h<j.length;h++)if(n=j[h],
n.top<=a&&a<n.bottom)break;if(i<n.left)i=n.left;i>n.right&&(i=n.right-1)}else i<0&&(i=0),i>g.right-g.left&&(i=g.right-g.left);var o=d.ownerDocument,h=o.defaultView||o.parentWindow,r=f.isIE?h.screen.logicalXDPI/h.screen.deviceXDPI:1,s=f.isIE?h.screen.logicalYDPI/h.screen.deviceYDPI:1,h=l,t=d.firstChild;a:for(;t;){if(!t.ignore){var u=t.firstChild,d=u.length;t.ignoreChars&&(d-=t.ignoreChars);var v,k,p;j=this._getClientRects(t,g);for(var m=0;m<j.length;m++)if(n=j[m],n.left<=i&&i<n.right&&(!b._wrapMode||
n.top<=a&&a<n.bottom)){var m=n.left+g.left,z;if(f.isIE||b._isRangeRects){for(var o=b._isRangeRects?o.createRange():o.body.createTextRange(),y=d,C=-1;y-C>1;){var J=Math.floor((y+C)/2);j=C+1;n=J===d-1&&t.ignoreChars?u.length:J+1;z=j===0&&f.isIE===8;b._isRangeRects?(o.setStart(u,j),o.setEnd(u,n)):(z&&(j=1),o.moveToElementText(t),o.move("character",j),o.moveEnd("character",n-j));j=o.getClientRects();for(var N=!1,L=0;L<j.length;L++)if(n=j[L],v=(z?m:n.left)*r-g.left,p=n.right*r-g.left,k=n.top*s-g.top,n=
n.bottom*s-g.top,v<=i&&i<p&&(!b._wrapMode||k<=a&&a<n)){N=!0;break}N?y=J:C=J}h+=y;j=y;n=y===d-1&&t.ignoreChars?u.length:Math.min(y+1,u.length);b._isRangeRects?(o.setStart(u,j),o.setEnd(u,n)):(o.moveToElementText(t),o.move("character",j),o.moveEnd("character",n-j));j=o.getClientRects();b=!1;j.length>0&&(n=j[0],v=(z?m:n.left)*r-g.left,p=n.right*r-g.left,b=i>v+(p-v)/2);g=h-l;e=e.getLine(c);c=e.charCodeAt(g);55296<=c&&c<=56319&&b?g<e.length&&(c=e.charCodeAt(g+1),56320<=c&&c<=57343&&(h+=1)):56320<=c&&c<=
57343&&!b&&g>0&&(c=e.charCodeAt(g-1),55296<=c&&c<=56319&&(h-=1));b&&h++}else{e=[];for(c=0;c<d;c++)e.push("<span>"),c===d-1?e.push(u.data.substring(c)):e.push(u.data.substring(c,c+1)),e.push("</span>");t.innerHTML=e.join("");for(e=t.firstChild;e;){n=e.getBoundingClientRect();v=n.left-g.left;p=n.right-g.left;if(v<=i&&i<p){i>v+(p-v)/2&&h++;break}h++;e=e.nextSibling}if(!this._createdDiv)t.innerHTML="",t.appendChild(u),g=b._getSelection(),(h<=g.start&&g.start<h+d||h<=g.end&&g.end<h+d)&&b._updateDOMSelection()}break a}h+=
d}t=t.nextSibling}return Math.min(q,Math.max(l,h))},getNextOffset:function(i,a){if(a.unit==="line"){var b=this.view._model,e=b.getLineAtOffset(i);if(a.count>0)return a.count--,b.getLineEnd(e);a.count++;return b.getLineStart(e)}return a.unit==="wordend"||a.unit==="wordWS"||a.unit==="wordendWS"?this._getNextOffset_W3C(i,a):f.isIE?this._getNextOffset_IE(i,a):this._getNextOffset_W3C(i,a)},_getNextOffset_W3C:function(i,a){function b(i){return 33<=i&&i<=47||58<=i&&i<=64||91<=i&&i<=94||i===96||123<=i&&i<=
126}function e(i){return i===32||i===9}var c=this.view._model,l=c.getLineAtOffset(i),f=c.getLine(l),q=c.getLineStart(l),c=c.getLineEnd(l),l=f.length,d=i-q,g,j=a.count<0?-1:1;if(a.unit==="word"||a.unit==="wordend"||a.unit==="wordWS"||a.unit==="wordendWS")for(var n,h,o;a.count!==0;){if(a.count>0){if(d===l)return c;g=f.charCodeAt(d);n=b(g);h=!n&&!e(g);for(d++;d<l;){g=f.charCodeAt(d);if(a.unit!=="wordWS"&&a.unit!=="wordendWS"){o=b(g);if(a.unit==="wordend"){if(!o&&n)break}else if(o&&!n)break;g=!o&&!e(g)}else g=
!e(g);if(a.unit==="wordend"||a.unit==="wordendWS"){if(!g&&h)break}else if(g&&!h)break;h=g;n=o;d++}}else{if(d===0)return q;d--;g=f.charCodeAt(d);n=b(g);for(h=!n&&!e(g);0<d;){g=f.charCodeAt(d-1);if(a.unit!=="wordWS"&&a.unit!=="wordendWS"){o=b(g);if(a.unit==="wordend"){if(o&&!n)break}else if(!o&&n)break;g=!o&&!e(g)}else g=!e(g);if(a.unit==="wordend"||a.unit==="wordendWS"){if(g&&!h)break}else if(!g&&h)break;h=g;n=o;d--}}a.count-=j}else for(;a.count!==0&&0<=d+j&&d+j<=l;)d+=j,g=f.charCodeAt(d),56320<=g&&
g<=57343&&d>0&&(g=f.charCodeAt(d-1),55296<=g&&g<=56319&&(d+=j)),a.count-=j;return q+d},_getNextOffset_IE:function(i,a){var b=this._ensureCreated(),e=this.view._model,c=this.lineIndex,l=0,f;f=e.getLineStart(c);var d=b.ownerDocument,q=a.count<0?-1:1;if(i===e.getLineEnd(c)){for(b=b.lastChild;b&&b.ignoreChars===b.firstChild.length;)b=b.previousSibling;if(!b)return f;l=d.body.createTextRange();l.moveToElementText(b);f=l.text.length;l.moveEnd(a.unit,q);l=i+l.text.length-f}else if(i===f&&a.count<0)l=f;else for(b=
...
a){var b=new r(i,i,!1);this._doMove(a,b);return b.getCaret()},getOptions:function(){var i;if(arguments.length===0)i=this._defaultOptions();else if(arguments.length===1){if(i=arguments[0],typeof i==="string")return g(this["_"+i])}else{i={};for(var a in arguments)arguments.hasOwnProperty(a)&&(i[arguments[a]]=void 0)}for(var b in i)i.hasOwnProperty(b)&&(i[b]=g(this["_"+b]));return i},getModel:function(){return this._model},getOffsetAtLocation:function(i,a){if(!this._clientDiv)return 0;var b=this._getLineIndex(a),
...
c||(c=e[i]={});c.handler=a;if(b!==void 0)c.actionDescription=b}},setKeyBinding:function(i,a){this._keyModes[0].setKeyBinding(i,a)},setCaretOffset:function(i,a,b){var e=this._model.getCharCount(),i=Math.max(0,Math.min(i,e));this._setSelection(new r(i,i,!1),a===void 0||a,!0,b)},setHorizontalPixel:function(i){this._clientDiv&&(i=Math.max(0,i),this._scrollView(i-this._getScroll().x,0))},setRedraw:function(i){i?--this._redrawCount===0&&this.redraw():this._redrawCount++},setModel:function(i){if(i&&i!==
...
addedLineCount:e};this.onModelChanged(l);this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._reset();this._update()}},setOptions:function(i){var b=this._defaultOptions(),e;for(e in i)if(i.hasOwnProperty(e)){var c=i[e];if(!a(this["_"+e],c)){var l=b[e]?b[e].update:null;l?l.call(this,c):this["_"+e]=g(c)}}},setSelection:function(i,a,b,e){var c=i>a;if(c)var l=i,i=a,a=l;l=this._model.getCharCount();i=
Math.max(0,Math.min(i,l));a=Math.max(0,Math.min(a,l));this._setSelection(new r(i,a,c),b===void 0||b,!0,e)},setText:function(i,a,b){var e=a===void 0&&b===void 0;a===void 0&&(a=0);b===void 0&&(b=this._model.getCharCount());if(e)this._variableLineHeight=!1;this._modifyContent({text:i,start:a,end:b,_code:!0},!e);if(e)this._columnX=-1,this._setSelection(new r(0,0,!1),!0),f.isFirefox&&this._fixCaret()},setTopIndex:function(i){this._clientDiv&&this._scrollView(0,this._getLinePixel(Math.max(0,i))-this._getScroll().y)},
...
i));if(!this._linksVisible&&a&&this._isMouseDown){if(this._dragOffset!==-1)a=this._getSelection(),a.extend(this._dragOffset),a.collapse(),this._setSelection(a,!0,!0),this._dragOffset=-1;this._isMouseDown=!1;this._endAutoScroll();this._isW3CEvents&&this._setGrab(null);f.isFirefox&&i.preventDefault()}},_handleMouseWheel:function(i){var a=this._getLineHeight(),b=0,e=0;f.isIE||f.isOpera?e=-i.wheelDelta/40*a:f.isFirefox?(a=f.isMac?i.detail*3:Math.max(-256,Math.min(256,i.detail))*a,i.axis===i.HORIZONTAL_AXIS?
b=a:e=a):f.isMac?(e=i.timeStamp-this._wheelTimeStamp,this._wheelTimeStamp=i.timeStamp,b=i.wheelDeltaX%120!==0?1:e<40?40/(40-e):40,e=i.wheelDeltaY%120!==0?1:e<40?40/(40-e):40,b=Math.ceil(-i.wheelDeltaX/b),-1<b&&b<0&&(b=-1),0<b&&b<1&&(b=1),e=Math.ceil(-i.wheelDeltaY/e),-1<e&&e<0&&(e=-1),0<e&&e<1&&(e=1)):(b=-i.wheelDeltaX,e=-i.wheelDeltaY/120*8*a);if(f.isSafari){for(a=i.target;a&&a.lineIndex===void 0;)a=a.parentNode;this._mouseWheelLine=a}a=this._getScroll();this._scrollView(b,e);b=this._getScroll();
if(a.x!==b.x||a.y!==b.y)return i.preventDefault&&i.preventDefault(),!1},_handlePaste:function(i){if(!this._ignoreEvent(i)&&!this._ignorePaste&&this._doPaste(i)){if(f.isIE){var a=this;this._ignoreFocus=!0;this._getWindow().setTimeout(function(){a._updateDOMSelection();a._ignoreFocus=!1},0)}i.preventDefault&&i.preventDefault();return!1}},_handleResize:function(){var i=this._rootDiv.clientWidth,b=this._rootDiv.clientHeight;if(this._rootWidth!==i||this._rootHeight!==b){this._rootWidth!==i&&this._wrapMode&&
this._resetLineHeight();this._rootWidth=i;this._rootHeight=b;i=f.isIE<9;b=this._calculateMetrics();if(!a(b,this._metrics)){if(this._variableLineHeight)this._variableLineHeight=!1,this._resetLineHeight();this._metrics=b;i=!0}i?this._queueUpdate():this._update()}},_handleRulerEvent:function(i){for(var a=i.target?i.target:i.srcElement,b=a.lineIndex;a&&!a._ruler;){if(b===void 0&&a.lineIndex!==void 0)b=a.lineIndex;a=a.parentNode}var e=a?a._ruler:null;if(b===void 0&&e&&e.getOverview()==="document"){var b=
this._getClientHeight(),c=this._model.getLineCount(),l=this._getViewPadding(),f=this._viewDiv.getBoundingClientRect(),b=Math.floor((i.clientY-f.top-this._metrics.scrollWidth)*c/(b+l.top+l.bottom-2*this._metrics.scrollWidth));0<=b&&b<c||(b=void 0)}if(e)switch(i.type){case "click":if(e.onClick)e.onClick(b,i);break;case "dblclick":if(e.onDblClick)e.onDblClick(b,i);break;case "mousemove":if(e.onMouseMove)e.onMouseMove(b,i);break;case "mouseover":if(e.onMouseOver)e.onMouseOver(b,i);break;case "mouseout":if(e.onMouseOut){for(c=
i.relatedTarget;c&&c!==this._rootDiv;){if(c===a)return;c=c.parentNode}e.onMouseOut(b,i)}}},_handleScroll:function(){var i=this._getScroll(!1),a=this._hScroll,b=this._vScroll;if(a!==i.x||b!==i.y)this._hScroll=i.x,this._vScroll=i.y,this._commitIME(),this._update(b===i.y),this.onScroll({type:"Scroll",oldValue:{x:a,y:b},newValue:i})},_handleSelectStart:function(i){if(this._ignoreSelect)return i&&i.preventDefault&&i.preventDefault(),!1},_getModelOffset:function(i,a){if(i){var b;b=i.tagName==="DIV"?i:i.parentNode.parentNode;
var e=0,c=b.lineIndex;if(i.tagName!=="DIV")for(b=b.firstChild;b;){var l=b.firstChild;if(l===i){b.ignoreChars&&(e-=b.ignoreChars);e+=a;break}b.ignoreChars&&(e-=b.ignoreChars);e+=l.data.length;b=b.nextSibling}return Math.max(0,e)+this._model.getLineStart(c)}},_updateSelectionFromDOM:function(){var i=this._getWindow().getSelection(),a=this._getModelOffset(i.anchorNode,i.anchorOffset),i=this._getModelOffset(i.focusNode,i.focusOffset);a===void 0||i===void 0||this._setSelection(new r(a,i),!1,!1)},_handleSelectionChange:function(){if(this._imeOffset===
-1)if(f.isAndroid){var i=this._getWindow();this._selTimer&&i.clearTimeout(this._selTimer);var a=this;this._selTimer=i.setTimeout(function(){if(a._clientDiv)a._selTimer=null,a._updateSelectionFromDOM()},250)}else this._updateSelectionFromDOM()},_handleTextInput:function(i){if(!this._ignoreEvent(i)){this._imeOffset=-1;var a=this._getWindow().getSelection();if(a.anchorNode!==this._anchorNode||a.focusNode!==this._focusNode||a.anchorOffset!==this._anchorOffset||a.focusOffset!==this._focusOffset){for(var b=
...
a++;l=f.substring(b,a+c);b+=e;a+=e;this._modifyContent({text:l,start:b,end:a,_ignoreDOMSelection:!0},!0)}}else this._doContent(i.data);i.preventDefault()}},_handleTouchStart:function(i){this._commitIME();var a=this._getWindow();if(this._touchScrollTimer)this._vScrollDiv.style.display="none",this._hScrollDiv.style.display="none",a.clearInterval(this._touchScrollTimer),this._touchScrollTimer=null;var b=i.touches;if(b.length===1){var b=b[0],e=b.clientX,c=b.clientY;this._touchStartX=e;this._touchStartY=
c;if(f.isAndroid&&(c<b.pageY-a.pageYOffset||e<b.pageX-a.pageXOffset))e=b.pageX-a.pageXOffset,c=b.pageY-a.pageYOffset;a=this.convert({x:e,y:c},"page","document");this._lastTouchOffset=this.getOffsetAtLocation(a.x,a.y);this._touchStartTime=i.timeStamp;this._touching=!0}},_handleTouchMove:function(i){var a=i.touches;if(a.length===1){a=a[0];this._touchCurrentX=a.clientX;this._touchCurrentY=a.clientY;if(!this._touchScrollTimer&&i.timeStamp-this._touchStartTime<200){this._vScrollDiv.style.display="block";
...
b._touchScrollTimer=null;return}else i=b._touchSpeedX*10,a=b._touchSpeedY*10,b._touchSpeedX*=0.95,b._touchSpeedY*=0.95;b._scrollView(i,a)},10)}this._touchScrollTimer&&i.preventDefault()}},_handleTouchEnd:function(i){if(i.touches.length===0)this._touching=!1},_doAction:function(i){var a,b,e=this._keyModes;for(b=e.length-1;b>=0;b--)if(a=e[b],typeof a.match==="function"&&(a=a.match(i),a!==void 0))return this.invokeAction(a);return!1},_doMove:function(i,a){var b=this._model,e=a.getCaret(),c=b.getLineAtOffset(e);
if(!i.count)i.count=1;for(;i.count!==0;){var l=b.getLineStart(c);if(i.count<0&&e===l)if(c>0)i.unit==="character"&&i.count++,c--,a.extend(b.getLineEnd(c));else break;else if(i.count>0&&e===b.getLineEnd(c))if(c+1<b.getLineCount())i.unit==="character"&&i.count--,c++,a.extend(b.getLineStart(c));else break;else{var f=!1;i.expandTab&&i.unit==="character"&&(e-l)%this._tabSize===0&&(f=!/[^ ]/.test(b.getText(l,e)));f?(a.extend(e-this._tabSize),i.count+=i.count<0?1:-1):(l=this._getLine(c),a.extend(l.getNextOffset(e,
i)),l.destroy())}e=a.getCaret()}return a},_doBackspace:function(i){var a=this._getSelection();if(a.isEmpty()){if(!i.count)i.count=1;i.count*=-1;i.expandTab=this._expandTab;this._doMove(i,a)}this._modifyContent({text:"",start:a.start,end:a.end},!0);return!0},_doCase:function(i){var a=this._getSelection();this._doMove(i,a);var b=this.getText(a.start,a.end);this._setSelection(a,!0);switch(i.type){case "lower":b=b.toLowerCase();break;case "capitalize":b=b.replace(/(?:^|\s)\S/g,function(i){return i.toUpperCase()});
break;case "reverse":i="";for(a=0;a<b.length;a++){var e=b[a],c=e.toLowerCase(),e=c!==e?c:e.toUpperCase();i+=e}b=i;break;default:b=b.toUpperCase()}this._doContent(b);return!0},_doContent:function(i){var a=this._getSelection();if(this._overwriteMode&&a.isEmpty()){var b=this._model,e=b.getLineAtOffset(a.end);a.end<b.getLineEnd(e)&&(b=this._getLine(e),a.extend(b.getNextOffset(a.getCaret(),{unit:"character",count:1})),b.destroy())}this._modifyContent({text:i,start:a.start,end:a.end,_ignoreDOMSelection:!0},
!0)},_doCopy:function(i){var a=this._getSelection();return!a.isEmpty()?this._setClipboardText(this._getBaseText(a.start,a.end),i):!0},_doCursorNext:function(i){var a=this._getSelection();!a.isEmpty()&&!i.select?a.start=a.end:this._doMove(i,a);i.select||a.collapse();this._setSelection(a,!0);return!0},_doCursorPrevious:function(i){var a=this._getSelection();if(!a.isEmpty()&&!i.select)a.end=a.start;else{if(!i.count)i.count=1;i.count*=-1;this._doMove(i,a)}i.select||a.collapse();this._setSelection(a,!0);
return!0},_doCut:function(i){var a=this._getSelection();return!a.isEmpty()?(a=this._getBaseText(a.start,a.end),this._doContent(""),this._setClipboardText(a,i)):!0},_doDelete:function(i){var a=this._getSelection();a.isEmpty()&&this._doMove(i,a);this._modifyContent({text:"",start:a.start,end:a.end},!0);return!0},_doEnd:function(i){var a=this._getSelection(),b=this._model,e;if(i.ctrl)a.extend(b.getCharCount()),e=function(){};else{var c=a.getCaret(),l=b.getLineAtOffset(c);if(this._wrapMode){var f=this._getLine(l),
c=f.getLineIndex(c),c=c===f.getLineCount()-1?b.getLineEnd(l):f.getLineStart(c+1)-1;f.destroy()}else i.count&&i.count>0&&(l=Math.min(l+i.count-1,b.getLineCount()-1)),c=b.getLineEnd(l);a.extend(c)}i.select||a.collapse();this._setSelection(a,!0,!0,e);return!0},_doEnter:function(i){var a=this._model,b=this._getSelection();this._doContent(a.getLineDelimiter());if(i&&i.noCursor)b.end=b.start,this._setSelection(b,!0);return!0},_doHome:function(i){var a=this._getSelection(),b=this._model,e;if(i.ctrl)a.extend(0),
e=function(){};else{var c=a.getCaret(),l=b.getLineAtOffset(c);this._wrapMode?(b=this._getLine(l),c=b.getLineIndex(c),c=b.getLineStart(c),b.destroy()):c=b.getLineStart(l);a.extend(c)}i.select||a.collapse();this._setSelection(a,!0,!0,e);return!0},_doLineDown:function(i){var a=this._model,b=this._getSelection(),e=b.getCaret(),c=a.getLineAtOffset(e),l=this._getLine(c),d=this._columnX,q=1,g=!1;if(d===-1||i.wholeLine||i.select&&f.isIE)d=i.wholeLine?a.getLineEnd(c+1):e,d=l.getBoundingClientRect(d).left;
(e=l.getLineIndex(e))<l.getLineCount()-1?q=l.getClientRects(e+1).top+1:(e=a.getLineCount()-1,g=c===e,i.count&&i.count>0?c=Math.min(c+i.count,e):c++);e=!1;if(g){if(i.select||f.isMac||f.isLinux)b.extend(a.getCharCount()),e=!0}else l.lineIndex!==c&&(l.destroy(),l=this._getLine(c)),b.extend(l.getOffset(d,q)),e=!0;e&&(i.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=d;l.destroy();return!0},_doLineUp:function(i){var a=this._model,b=this._getSelection(),e=b.getCaret(),c=a.getLineAtOffset(e),
l=this._getLine(c),d=this._columnX,q=!1,g;if(d===-1||i.wholeLine||i.select&&f.isIE)d=i.wholeLine?a.getLineStart(c-1):e,d=l.getBoundingClientRect(d).left;(e=l.getLineIndex(e))>0?g=l.getClientRects(e-1).top+1:(q=c===0,q||(i.count&&i.count>0?c=Math.max(c-i.count,0):c--,g=this._getLineHeight(c)-1));e=!1;if(q){if(i.select||f.isMac||f.isLinux)b.extend(0),e=!0}else l.lineIndex!==c&&(l.destroy(),l=this._getLine(c)),b.extend(l.getOffset(d,g)),e=!0;e&&(i.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=
d;l.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(i){var a=this,b=this._model,e=this._getSelection(),c=e.getCaret(),l=b.getLineAtOffset(c),d=b.getLineCount(),q=this._getScroll(),b=this._getClientHeight(),g,j;if(this._lineHeight){g=this._columnX;q=this._getBoundsAtOffset(c);if(g===-1||i.select&&f.isIE)g=q.left;c=this._getLineIndex(q.top+b);j=this._getLine(c);l=this._getLinePixel(c);c=j.getOffset(g,q.top+b-l);b=j.getBoundingClientRect(c);j.destroy();e.extend(c);i.select||e.collapse();
this._setSelection(e,!0,!0,function(){a._columnX=g},b.top+l-q.top);return!0}if(l<d-1){var n=this._getLineHeight(),h=Math.min(d-l-1,Math.floor(b/n)),h=Math.max(1,h);g=this._columnX;if(g===-1||i.select&&f.isIE)j=this._getLine(l),g=j.getBoundingClientRect(c).left,j.destroy();j=this._getLine(l+h);e.extend(j.getOffset(g,0));j.destroy();i.select||e.collapse();i=d*n;c=q.y+h*n;c+b>i&&(c=i-b);this._setSelection(e,!0,!0,function(){a._columnX=g},c-q.y)}return!0},_doPageUp:function(i){var a=this,b=this._model,
e=this._getSelection(),c=e.getCaret(),l=b.getLineAtOffset(c),d=this._getScroll(),q=this._getClientHeight(),g;if(this._lineHeight){g=this._columnX;d=this._getBoundsAtOffset(c);if(g===-1||i.select&&f.isIE)g=d.left;c=this._getLineIndex(d.bottom-q);b=this._getLine(c);l=this._getLinePixel(c);c=b.getOffset(g,d.bottom-q-l);q=b.getBoundingClientRect(c);b.destroy();e.extend(c);i.select||e.collapse();this._setSelection(e,!0,!0,function(){a._columnX=g},q.top+l-d.top);return!0}if(l>0){var j=this._getLineHeight(),
q=Math.max(1,Math.min(l,Math.floor(q/j)));g=this._columnX;if(g===-1||i.select&&f.isIE)b=this._getLine(l),g=b.getBoundingClientRect(c).left,b.destroy();b=this._getLine(l-q);e.extend(b.getOffset(g,this._getLineHeight(l-q)-1));b.destroy();i.select||e.collapse();i=Math.max(0,d.y-q*j);this._setSelection(e,!0,!0,function(){a._columnX=g},i-d.y)}return!0},_doPaste:function(i){var a=this;return this._getClipboardText(i,function(i){i&&(f.isLinux&&a._lastMouseButton===2&&(new Date).getTime()-a._lastMouseTime<=
a._clickTime&&a._setSelectionTo(a._lastMouseX,a._lastMouseY),a._doContent(i))})!==null},_doScroll:function(i){var a=i.type,b=this._model,e=b.getLineCount(),i=this._getClientHeight(),c=this._getLineHeight();e*=c;var l=this._getScroll().y,f;switch(a){case "textStart":f=0;break;case "textEnd":f=e-i;break;case "pageDown":f=l+i;break;case "pageUp":f=l-i;break;case "lineDown":f=l+c;break;case "lineUp":f=l-c;break;case "centerLine":a=this._getSelection(),f=b.getLineAtOffset(a.start),b=(b.getLineAtOffset(a.end)-
f+1)*c,f=f*c-i/2+b/2}f!==void 0&&(f=Math.min(Math.max(0,f),e-i),this._scrollViewAnimated(0,f-l,function(){}));return!0},_doSelectAll:function(){var i=this._model,a=this._getSelection();a.setCaret(0);a.extend(i.getCharCount());this._setSelection(a,!1);return!0},_doTab:function(){if(this._tabMode&&!this._readonly){var i="\t";if(this._expandTab)var a=this._model,i=this._getSelection().getCaret(),b=a.getLineAtOffset(i),a=a.getLineStart(b),i=Array(this._tabSize-(i-a)%this._tabSize+1).join(" ");this._doContent(i);
return!0}},_doShiftTab:function(){return!this._tabMode||this._readonly?void 0:!0},_doOverwriteMode:function(){if(!this._readonly)return this.setOptions({overwriteMode:!this.getOptions("overwriteMode")}),!0},_doTabMode:function(){this._tabMode=!this._tabMode;return!0},_doWrapMode:function(){this.setOptions({wrapMode:!this.getOptions("wrapMode")});return!0},_autoScroll:function(){var i=this._model,a=this._getSelection(),b=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),e=a.getCaret(),
c=i.getLineCount(),l=i.getLineAtOffset(e),d;if(this._autoScrollDir==="up"||this._autoScrollDir==="down")e=this._autoScrollY/this._getLineHeight(),e=e<0?Math.floor(e):Math.ceil(e),d=Math.max(0,Math.min(c-1,l+e));else if(this._autoScrollDir==="left"||this._autoScrollDir==="right")d=this._getLineIndex(b.y),l=this._getLine(l),b.x+=l.getBoundingClientRect(e,!1).left,l.destroy();d===0&&(f.isMac||f.isLinux)?a.extend(0):d===c-1&&(f.isMac||f.isLinux)?a.extend(i.getCharCount()):(l=this._getLine(d),a.extend(l.getOffset(b.x,
b.y-this._getLinePixel(d))),l.destroy());this._setSelection(a,!0)},_autoScrollTimer:function(){this._autoScroll();var i=this;this._autoScrollTimerID=this._getWindow().setTimeout(function(){i._autoScrollTimer()},this._AUTO_SCROLL_RATE)},_calculateLineHeightTimer:function(i){if(this._lineHeight&&!this._calculateLHTimer){var a=this._model.getLineCount(),b=0;if(i){for(var i=0,e=(new Date).getTime(),c=0;b<a;)if(this._lineHeight[b]||(i++,c||(c=b),this._lineHeight[b]=this._calculateLineHeight(b)),b++,(new Date).getTime()-
e>100)break;this.redrawRulers(0,a);this._queueUpdate()}i=this._getWindow();if(b!==a){var l=this;this._calculateLHTimer=i.setTimeout(function(){l._calculateLHTimer=null;l._calculateLineHeightTimer(!0)},0)}else if(this._calculateLHTimer)i.clearTimeout(this._calculateLHTimer),this._calculateLHTimer=void 0}},_calculateLineHeight:function(i){var i=this._getLine(i),a=i.getBoundingClientRect();i.destroy();return Math.max(1,a.bottom-a.top)},_calculateMetrics:function(){var a=this._clientDiv,b=a.ownerDocument,
e=f.createElement(b,"div");e.style.lineHeight="normal";var c={type:"LineStyle",textView:this,0:0,lineText:this._model.getLine(0),lineStart:0};this.onLineStyle(c);j(c.style,e);e.style.position="fixed";e.style.left="-1000px";var d=f.createElement(b,"span");d.appendChild(b.createTextNode(" "));e.appendChild(d);var g=f.createElement(b,"span");g.style.fontStyle="italic";g.appendChild(b.createTextNode(" "));e.appendChild(g);var n=f.createElement(b,"span");n.style.fontWeight="bold";n.appendChild(b.createTextNode(" "));
e.appendChild(n);c=f.createElement(b,"span");c.style.fontWeight="bold";c.style.fontStyle="italic";c.appendChild(b.createTextNode(" "));e.appendChild(c);a.appendChild(e);var h=e.getBoundingClientRect(),d=d.getBoundingClientRect(),g=g.getBoundingClientRect(),n=n.getBoundingClientRect(),c=c.getBoundingClientRect(),d=d.bottom-d.top,g=g.bottom-g.top,n=n.bottom-n.top,o=c.bottom-c.top,r=0,c=h.bottom-h.top<=0,h=Math.max(1,h.bottom-h.top);g>d&&(r=1);n>g&&(r=2);o>n&&(r=3);var s;if(r!==0){s={style:{}};if((r&
1)!==0)s.style.fontStyle="italic";if((r&2)!==0)s.style.fontWeight="bold"}d=q(e);a.removeChild(e);o=l(this._viewDiv);e=f.createElement(b,"div");e.style.position="fixed";e.style.left="-1000px";e.style.paddingLeft=o.left+"px";e.style.paddingTop=o.top+"px";e.style.paddingRight=o.right+"px";e.style.paddingBottom=o.bottom+"px";e.style.width="100px";e.style.height="100px";o=f.createElement(b,"div");o.style.width="100%";o.style.height="100%";e.appendChild(o);a.appendChild(e);r=e.getBoundingClientRect();g=
o.getBoundingClientRect();n=0;if(!this._singleMode)e.style.overflow="hidden",o.style.height="200px",n=e.clientWidth,e.style.overflow="scroll",n-=e.clientWidth;a.removeChild(e);o={left:g.left-r.left,top:g.top-r.top,right:r.right-g.right,bottom:r.bottom-g.bottom};g=r=0;if(!c&&(this._wrapOffset||this._marginOffset))e=f.createElement(b,"div"),e.style.position="fixed",e.style.left="-1000px",e.innerHTML=Array(this._wrapOffset+1).join(" "),a.appendChild(e),r=e.getBoundingClientRect(),r=Math.ceil(r.right-
r.left),e.innerHTML=Array(this._marginOffset+1).join(" "),g=e.getBoundingClientRect(),g=Math.ceil(g.right-g.left),a.removeChild(e);return{lineHeight:h,largestFontStyle:s,lineTrim:d,viewPadding:o,scrollWidth:n,wrapWidth:r,marginWidth:g,invalid:c}},_cancelAnimation:function(){if(this._animation)this._animation.stop(),this._animation=null},_clearSelection:function(a){var b=this._getSelection();if(b.isEmpty())return!1;a==="next"?b.start=b.end:b.end=b.start;this._setSelection(b,!0);return!0},_commitIME:function(){if(this._imeOffset!==
-1){this._scrollDiv.focus();this._clientDiv.focus();var a=this._model,b=a.getLineAtOffset(this._imeOffset),e=a.getLineStart(b),c=this._getDOMText(this._getLineNode(b)).text,a=a.getLine(b),e=this._imeOffset-e,a=e+c.length-a.length;e!==a&&this._doContent(c.substring(e,a));this._imeOffset=-1}},_createActions:function(){this.addKeyMode(new p.DefaultKeyMode(this));var a=this;this._actions={noop:{defaultHandler:function(){return a._doNoop()}},lineUp:{defaultHandler:function(e){return a._doLineUp(b(e,{select:!1}))},
...
this._viewDiv.clientHeight-a.top-a.bottom)},_getClientWidth:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientWidth-a.left-a.right)},_getClipboardText:function(a,b){var c=this._model.getLineDelimiter(),l,d,q=this._getWindow(),g=q.clipboardData;if(!g&&a)g=a.clipboardData;if(g)return l=[],d=g.getData(f.isIE?"Text":"text/plain"),e(d,function(a){l.push(a)},function(){l.push(c)}),d=l.join(""),b&&b(d),d;if(f.isFirefox){this._ignoreFocus=!0;var j=this._clipboardDiv,g=this._rootDiv.ownerDocument;
if(!j)this._clipboardDiv=j=f.createElement(g,"div"),j.style.position="fixed",j.style.whiteSpace="pre",j.style.left="-1000px",this._rootDiv.appendChild(j);j.innerHTML="<pre contenteditable=''></pre>";j.firstChild.focus();var n=this,h=function(){var a=n._getTextFromElement(j);j.innerHTML="";l=[];e(a,function(a){l.push(a)},function(){l.push(c)});return l.join("")},o=!1;this._ignorePaste=!0;if(!f.isLinux||this._lastMouseButton!==2)try{o=g.execCommand("paste",!1,null)}catch(r){o=j.childNodes.length>1||
j.firstChild&&j.firstChild.childNodes.length>0}this._ignorePaste=!1;if(!o)return a?(q.setTimeout(function(){n.focus();(d=h())&&b&&b(d);n._ignoreFocus=!1},0),null):(this.focus(),this._ignoreFocus=!1,"");this.focus();this._ignoreFocus=!1;(d=h())&&b&&b(d);return d}return""},_getDOMText:function(a,b){for(var e=a.firstChild,c="",l=0;e;){var f;if(!e.ignore)if(e.ignoreChars){f=e.lastChild;for(var d=0,q=[],g=-1;f;){var j=f.data;if(j)for(var n=j.length-1;n>=0;n--){var h=j.substring(n,n+1);d<e.ignoreChars&&
(h===" "||h==="\u200b"||h==="\ufeff")?d++:q.push(h==="\u00a0"?"\t":h)}if(b===f)g=q.length;f=f.previousSibling}q=q.reverse().join("");g!==-1&&(l=c.length+q.length-g);c+=q}else for(f=e.firstChild;f;){if(b===f)l=c.length;c+=f.data;f=f.nextSibling}e=e.nextSibling}return{text:c,offset:l}},_getTextFromElement:function(a){var b=a.ownerDocument,e=b.defaultView;if(!e.getSelection)return a.innerText||a.textContent;b=b.createRange();b.selectNode(a);var a=e.getSelection(),e=[],c;for(c=0;c<a.rangeCount;c++)e.push(a.getRangeAt(c));
this._ignoreSelect=!0;a.removeAllRanges();a.addRange(b);b=a.toString();a.removeAllRanges();for(c=0;c<e.length;c++)a.addRange(e[c]);this._ignoreSelect=!1;return b},_getViewPadding:function(){return this._metrics.viewPadding},_getLine:function(a){var b=this._getLineNode(a);return b&&!b.lineChanged&&!b.lineRemoved?b._line:new n(this,a)},_getLineHeight:function(a,b){if(a!==void 0&&this._lineHeight){var e=this._lineHeight[a];if(e)return e;if(b||b===void 0)return this._lineHeight[a]=this._calculateLineHeight(a)}return this._metrics.lineHeight},
...
this._themeListener.onChanged);var b=this._handlers=[],e=this._clientDiv,c=this._viewDiv,l=this._rootDiv,d=this._overlayDiv||e,q=e.ownerDocument,g=this._getWindow(),j=f.isIE?q:g;b.push({target:g,type:"resize",handler:function(b){return a._handleResize(b?b:g.event)}});b.push({target:e,type:"blur",handler:function(b){return a._handleBlur(b?b:g.event)}});b.push({target:e,type:"focus",handler:function(b){return a._handleFocus(b?b:g.event)}});b.push({target:c,type:"focus",handler:function(){e.focus()}});
b.push({target:c,type:"scroll",handler:function(b){return a._handleScroll(b?b:g.event)}});b.push({target:e,type:"textInput",handler:function(b){return a._handleTextInput(b?b:g.event)}});b.push({target:e,type:"keydown",handler:function(b){return a._handleKeyDown(b?b:g.event)}});b.push({target:e,type:"keypress",handler:function(b){return a._handleKeyPress(b?b:g.event)}});b.push({target:e,type:"keyup",handler:function(b){return a._handleKeyUp(b?b:g.event)}});f.isIE&&b.push({target:q,type:"keyup",handler:function(b){return a._handleDocKeyUp(b?
b:g.event)}});b.push({target:e,type:"contextmenu",handler:function(b){return a._handleContextMenu(b?b:g.event)}});b.push({target:e,type:"copy",handler:function(b){return a._handleCopy(b?b:g.event)}});b.push({target:e,type:"cut",handler:function(b){return a._handleCut(b?b:g.event)}});b.push({target:e,type:"paste",handler:function(b){return a._handlePaste(b?b:g.event)}});if(f.isIOS||f.isAndroid)b.push({target:q,type:"selectionchange",handler:function(b){return a._handleSelectionChange(b?b:g.event)}}),
...
type:"mouseover",handler:function(b){return a._handleMouseOver(b?b:g.event)}});b.push({target:e,type:"mouseout",handler:function(b){return a._handleMouseOut(b?b:g.event)}});b.push({target:j,type:"mouseup",handler:function(b){return a._handleMouseUp(b?b:g.event)}});b.push({target:j,type:"mousemove",handler:function(b){return a._handleMouseMove(b?b:g.event)}});b.push({target:l,type:"mousedown",handler:function(b){return a._handleRootMouseDown(b?b:g.event)}});b.push({target:l,type:"mouseup",handler:function(b){return a._handleRootMouseUp(b?
...
typeof b==="string"&&(b=(a.document||document).getElementById(b));if(!b)throw"no parent";a.parent=b;a.model=a.model||new m.TextModel;var e=this._defaultOptions(),c;for(c in e)e.hasOwnProperty(c)&&(this["_"+c]=a[c]!==void 0?a[c]:e[c].value);this._keyModes=[];this._rulers=[];this._selection=new r(0,0,!1);this._linksVisible=!1;this._maxLineWidth=this._redrawCount=0;this._maxLineIndex=-1;this._ignoreSelect=!0;this._hasFocus=this._ignoreFocus=!1;this._dragOffset=this._columnX=-1;this._isRangeRects=(!f.isIE||
...
l=this._getWindow(),d=l.clipboardData;if(!d&&b)d=b.clipboardData;if(d&&(c=[],e(a,function(a){c.push(a)},function(){c.push(f.platformDelimiter)}),d.setData(f.isIE?"Text":"text/plain",c.join(""))))return!0;var q=this._parent.ownerDocument,g=f.createElement(q,"pre");g.style.position="fixed";g.style.left="-1000px";e(a,function(a){g.appendChild(q.createTextNode(a))},function(){g.appendChild(f.createElement(q,"br"))});g.appendChild(q.createTextNode(" "));this._clientDiv.appendChild(g);d=q.createRange();
d.setStart(g.firstChild,0);d.setEndBefore(g.lastChild);var j=l.getSelection();j.rangeCount>0&&j.removeAllRanges();j.addRange(d);var n=this,d=function(){g&&g.parentNode===n._clientDiv&&n._clientDiv.removeChild(g);n._updateDOMSelection()},j=!1;this._ignoreCopy=!0;try{j=q.execCommand("copy",!1,null)}catch(h){}this._ignoreCopy=!1;if(!j&&b)return l.setTimeout(d,0),!1;d();return!0},_setDOMSelection:function(a,b,e,c,l){for(var d,q,g,j,n=0,h=a.firstChild,o,r,s=this._model.getLine(a.lineIndex).length;h;){if(!h.ignore){o=
h.firstChild;r=o.length;h.ignoreChars&&(r-=h.ignoreChars);if(n+r>b||n+r>=s){d=o;q=b-n;h.ignoreChars&&r>0&&q===r&&(q+=h.ignoreChars);break}n+=r}h=h.nextSibling}for(var n=0,h=e.firstChild,t=this._model.getLine(e.lineIndex).length;h;){if(!h.ignore){o=h.firstChild;r=o.length;h.ignoreChars&&(r-=h.ignoreChars);if(r+n>c||n+r>=t){g=o;j=c-n;h.ignoreChars&&r>0&&j===r&&(j+=h.ignoreChars);break}n+=r}h=h.nextSibling}this._setDOMFullSelection(a,b,s,e,c,t);a=this._getWindow();b=this._parent.ownerDocument;if(a.getSelection){e=
a.getSelection();a=b.createRange();a.setStart(d,q);a.setEnd(g,j);if(this._hasFocus&&(e.anchorNode!==d||e.anchorOffset!==q||e.focusNode!==g||e.focusOffset!==j||e.anchorNode!==g||e.anchorOffset!==j||e.focusNode!==d||e.focusOffset!==q))this._anchorNode=d,this._anchorOffset=q,this._focusNode=g,this._focusOffset=j,this._ignoreSelect=!1,e.rangeCount>0&&e.removeAllRanges(),e.addRange(a),this._ignoreSelect=!0;if(this._cursorDiv&&(a=b.createRange(),l?(a.setStart(d,q),a.setEnd(d,q)):(a.setStart(g,j),a.setEnd(g,
j)),g=a.getClientRects()[0],j=this._cursorDiv.parentNode,d=j.getBoundingClientRect(),g&&d))this._cursorDiv.style.top=g.top-d.top+j.scrollTop+"px",this._cursorDiv.style.left=g.left-d.left+j.scrollLeft+"px"}else if(b.selection&&this._hasFocus)l=b.body,a=f.createElement(b,"div"),l.appendChild(a),l.removeChild(a),a=l.createTextRange(),a.moveToElementText(d.parentNode),a.moveStart("character",q),d=l.createTextRange(),d.moveToElementText(g.parentNode),d.moveStart("character",j),a.setEndPoint("EndToStart",
d),this._ignoreSelect=!1,a.select(),this._ignoreSelect=!0},_setDOMFullSelection:function(a,b,e,c,l){if(this._selDiv1&&(e=this._selDiv1,e.style.width="0px",e.style.height="0px",e=this._selDiv2,e.style.width="0px",e.style.height="0px",e=this._selDiv3,e.style.width="0px",e.style.height="0px",!(a===c&&b===l))){var f=this._model,d=this._getViewPadding(),q=this._clientDiv.getBoundingClientRect(),g=this._viewDiv.getBoundingClientRect(),e=g.left+d.left,j=q.right,d=g.top+d.top,h=q.bottom,g=q=0;this._clipDiv?
(g=this._clipDiv.getBoundingClientRect(),q=g.left-this._clipDiv.scrollLeft):(g=this._rootDiv.getBoundingClientRect(),q=g.left);g=g.top;this._ignoreDOMSelection=!0;var o=(new n(this,a.lineIndex,a)).getBoundingClientRect(f.getLineStart(a.lineIndex)+b,!1),r=o.left,b=(new n(this,c.lineIndex,c)).getBoundingClientRect(f.getLineStart(c.lineIndex)+l,!1),f=b.left;this._ignoreDOMSelection=!1;var s=this._selDiv1,r=Math.min(j,Math.max(e,r)),t=Math.min(h,Math.max(d,o.top)),u=j,l=Math.min(h,Math.max(d,o.bottom));
s.style.left=r-q+"px";s.style.top=t-g+"px";s.style.width=Math.max(0,u-r)+"px";s.style.height=Math.max(0,l-t)+"px";if(a.lineIndex===c.lineIndex)u=Math.min(f,j),s.style.width=Math.max(0,u-r)+"px";else if(o=Math.min(h,Math.max(d,b.top)),f=Math.min(j,Math.max(e,f)),d=Math.min(h,Math.max(d,b.bottom)),h=this._selDiv3,h.style.left=e-q+"px",h.style.top=o-g+"px",h.style.width=Math.max(0,f-e)+"px",h.style.height=Math.max(0,d-o)+"px",Math.abs(a.lineIndex-c.lineIndex)>1)a=this._selDiv2,a.style.left=e-q+"px",
a.style.top=l-g+"px",a.style.width=Math.max(0,j-e)+"px",a.style.height=Math.max(0,o-l)+"px"}},_setGrab:function(a){if(a!==this._grabControl)a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null)},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=a;if(f.isIE&&a)this._hadFocus=this._hasFocus;var b=this._clientDiv;b.contentEditable=!a;this._hadFocus&&!a&&b.focus();if(this._overlayDiv)this._overlayDiv.style.zIndex=
...
b){this._wrapMode=a&&this._wrappable;var e=this._clientDiv;this._wrapMode?(e.style.whiteSpace="pre-wrap",e.style.wordWrap="break-word"):(e.style.whiteSpace="pre",e.style.wordWrap="normal");this._updateOverflow();b||(this.redraw(),this._resetLineWidth());this._resetLineHeight()},_showCaret:function(a,b,e,c){if(this._clientDiv){var l=this._model,f=this._getSelection(),d=this._getScroll(),q=f.getCaret(),g=f.start,j=f.end,n=l.getLineAtOffset(j),h=Math.max(Math.max(g,l.getLineStart(n)),j-1),l=this._getClientWidth(),
n=this._getClientHeight(),o=l/4,r=this._getBoundsAtOffset(q===g?g:h),s=r.left,t=r.right,u=r.top,v=r.bottom;a&&!f.isEmpty()&&(r=this._getBoundsAtOffset(q===j?g:h),r.top===u?q===g?t=s+Math.min(r.right-s,l):s=t-Math.min(t-r.left,l):q===g?v=u+Math.min(r.bottom-u,n):u=v-Math.min(v-r.top,n));a=0;s<d.x&&(a=Math.min(s-d.x,-o));t>d.x+l&&(a=Math.max(t-d.x-l,o));f=0;u<d.y?f=u-d.y:v>d.y+n&&(f=v-d.y-n);c&&(c>0?f>0&&(f=Math.max(f,c)):f<0&&(f=Math.min(f,c)));if(a!==0||f!==0)return f!==0&&typeof e==="number"&&(e<
0&&(e=0),e>1&&(e=1),f+=Math.floor(f>0?e*n:-e*n)),this._scrollViewAnimated(a,f,b),n!==this._getClientHeight()||l!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0;else b&&b();return!1}},_startIME:function(){if(this._imeOffset===-1){var a=this._getSelection();a.isEmpty()||this._modifyContent({text:"",start:a.start,end:a.end},!0);this._imeOffset=a.start}},_unhookEvents:function(){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",
...
if(b){if(this._metrics.invalid)this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1;var c=this._model,l=this._getScroll(!1),d=this._getViewPadding(),q=c.getLineCount(),g=this._getLineHeight(),j=!1,h=!1,o=!1,r=this._metrics.scrollWidth;if(this._wrapMode)b.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px";var s,t,u,v,k=0,p=0,m;if(this._lineHeight){for(;p<q;){m=this._getLineHeight(p);if(k+m>l.y)break;k+=m;p++}s=p;t=Math.max(0,s-1);u=c=l.y-k;s>0&&(c+=this._getLineHeight(s-
1))}else v=Math.max(0,l.y)/g,s=Math.floor(v),t=Math.max(0,s-1),c=Math.round((v-t)*g),u=Math.round((v-s)*g);this._topIndexY=u;v=this._rootDiv;var I=v.clientWidth,F=v.clientHeight;if(a){g=0;this._leftDiv&&(s=this._leftDiv.getBoundingClientRect(),g=s.right-s.left);s=this._getClientWidth();v=this._getClientHeight();h=s;if(this._wrapMode){if(this._metrics.wrapWidth)h=this._metrics.wrapWidth}else h=Math.max(this._maxLineWidth,h);for(;p<q;)m=this._getLineHeight(p,!1),k+=m,p++;q=k}else{v=this._getClientHeight();
u=Math.min(s+Math.floor((v+u)/g),q-1);var l=Math.min(u+1,q-1),z;for(m=b.firstChild;m;){z=m.lineIndex;var y=m.nextSibling;if(!(t<=z&&z<=l)||m.lineRemoved||m.lineIndex===-1)this._mouseWheelLine===m?(m.style.display="none",m.lineIndex=-1):b.removeChild(m);m=y}m=this._getLineNext();var y=e.ownerDocument,C=y.createDocumentFragment();for(z=t;z<=l;z++)if(!m||m.lineIndex>z)(new n(this,z)).create(C,null);else{C.firstChild&&(b.insertBefore(C,m),C=y.createDocumentFragment());if(m&&m.lineChanged)m=(new n(this,
z)).create(C,m),m.lineChanged=!1;m=this._getLineNext(m)}C.firstChild&&b.insertBefore(C,m);if(f.isWebkit&&!this._wrapMode)b.style.width="0x7fffffffpx";m=this._getLineNext();z=v+c;for(C=!1;m;){t=m.lineWidth;if(t===void 0)if(y=m._line.getBoundingClientRect(),t=m.lineWidth=Math.ceil(y.right-y.left),y=y.bottom-y.top,this._lineHeight)this._lineHeight[m.lineIndex]=y;else if(g!==0&&y!==0&&Math.ceil(g)!==Math.ceil(y))this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[m.lineIndex]=y;if(this._lineHeight&&
!C&&(z-=this._lineHeight[m.lineIndex],z<0))u=m.lineIndex,C=!0;if(!this._wrapMode){if(t>=this._maxLineWidth)this._maxLineWidth=t,this._maxLineIndex=m.lineIndex;if(this._checkMaxLineIndex===m.lineIndex)this._checkMaxLineIndex=-1}if(m.lineIndex===s)this._topChild=m;if(m.lineIndex===u)this._bottomChild=m;m=this._getLineNext(m)}if(this._checkMaxLineIndex!==-1&&(z=this._checkMaxLineIndex,this._checkMaxLineIndex=-1,0<=z&&z<q)){g=new n(this,z);y=g.getBoundingClientRect();t=y.right-y.left;if(t>=this._maxLineWidth)this._maxLineWidth=
t,this._maxLineIndex=z;g.destroy()}for(;p<q;)m=this._getLineHeight(p,p<=u),k+=m,p++;q=k;this._updateRuler(this._leftDiv,s,l,F);this._updateRuler(this._rightDiv,s,l,F);this._updateRuler(this._marginDiv,s,l,F);g=0;this._leftDiv&&(s=this._leftDiv.getBoundingClientRect(),g=s.right-s.left);l=0;this._rightDiv&&(l=this._rightDiv.getBoundingClientRect(),l=l.right-l.left);e.style.left=g+"px";e.style.right=l+"px";l=this._scrollDiv;l.style.height=q+"px";s=this._getClientWidth();if(!this._singleMode&&!this._wrapMode){k=
j=v;(p=e.style.overflowX==="scroll")?j+=r:k-=r;m=u=s;(t=e.style.overflowY==="scroll")?u+=r:m-=r;v=j;s=u;q>v&&(o=!0,s=m);this._maxLineWidth>s&&(h=!0,v=k,q>v&&(o=!0,s=m));if(p!==h)e.style.overflowX=h?"scroll":"hidden";if(t!==o)e.style.overflowY=o?"scroll":"hidden";j=p!==h||t!==o}o=s;if(this._wrapMode){if(this._metrics.wrapWidth)o=this._metrics.wrapWidth}else o=Math.max(this._maxLineWidth,o);h=o;if((!f.isIE||f.isIE>=9)&&this._maxLineWidth>s)o+=d.right+d.left;l.style.width=o+"px";if(this._clipScrollDiv)this._clipScrollDiv.style.width=
o+"px";l=this._getScroll(!1)}if(this._vScrollDiv)o=v-8,k=Math.max(15,Math.ceil(Math.min(1,o/(q+d.top+d.bottom))*o)),this._vScrollDiv.style.left=g+s-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,l.y*o/q))+"px",this._vScrollDiv.style.height=k+"px";if(!this._wrapMode&&this._hScrollDiv)o=s-8,k=Math.max(15,Math.ceil(Math.min(1,o/(this._maxLineWidth+d.left+d.right))*o)),this._hScrollDiv.style.left=g+Math.floor(Math.max(0,Math.floor(l.x*o/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=v-
9+"px",this._hScrollDiv.style.width=k+"px";p=l.x;k=this._clipDiv;o=this._overlayDiv;if(u=this._marginDiv)u.style.left=-p+g+this._metrics.marginWidth+d.left+"px",u.style.bottom=(e.style.overflowX==="scroll"?r:0)+"px";if(k){k.scrollLeft=p;k.scrollTop=0;e=g+d.left;r=d.top;a=s;g=v;p=0;u=-c;if(l.x===0)e-=d.left,a+=d.left,p=d.left;l.x+s===h&&(a+=d.right);l.y===0&&(r-=d.top,g+=d.top,u+=d.top);l.y+v===q&&(g+=d.bottom);k.style.left=e+"px";k.style.top=r+"px";k.style.right=I-a-e+"px";k.style.bottom=F-g-r+"px";
b.style.left=p+"px";b.style.top=u+"px";b.style.width=h+"px";b.style.height=v+c+"px";if(o)o.style.left=b.style.left,o.style.top=b.style.top,o.style.width=b.style.width,o.style.height=b.style.height}else{e=p;r=c;I=p+s;F=c+v;e===0&&(e-=d.left);r===0&&(r-=d.top);I===h&&(I+=d.right);l.y+v===q&&(F+=d.bottom);b.style.clip="rect("+r+"px,"+I+"px,"+F+"px,"+e+"px)";b.style.left=-p+g+d.left+"px";b.style.width=(this._wrapMode||f.isWebkit?h:s+p)+"px";if(!a)b.style.top=-c+d.top+"px",b.style.height=v+c+"px";if(o&&
(o.style.clip=b.style.clip,o.style.left=b.style.left,o.style.width=b.style.width,!a))o.style.top=b.style.top,o.style.height=b.style.height}this._updateDOMSelection();if(j)b=this._ensureCaretVisible,this._ensureCaretVisible=!1,b&&this._showCaret(),this._queueUpdate()}}},_updateOverflow:function(){var a=this._viewDiv;this._wrapMode?(a.style.overflowX="hidden",a.style.overflowY="scroll"):a.style.overflow="hidden"},_updateRuler:function(a,b,e,c){if(a)for(var l=this._parent.ownerDocument,d=this._getLineHeight(),
q=this._getViewPadding(),a=a.firstChild;a;){var g=a._ruler,n=d,h=g.getOverview();h==="page"&&(n+=this._topIndexY);a.style.top=-n+"px";a.style.height=c+n+"px";a.rulerChanged&&j(g.getRulerStyle(),a);var o,r=a.firstChild;r?(o=r,r=r.nextSibling):(o=f.createElement(l,"div"),o.style.visibility="hidden",a.appendChild(o));var s;if(a.rulerChanged&&o){n=-1;if(s=g.getWidestAnnotation())if(j(s.style,o),s.html)o.innerHTML=s.html;o.lineIndex=n;o.style.height=d+q.top+"px"}var t;if(h==="page"){for(g=g.getAnnotations(b,
e+1);r;)n=r.lineIndex,s=r.nextSibling,(!(b<=n&&n<=e)||r.lineChanged)&&a.removeChild(r),r=s;r=a.firstChild.nextSibling;t=l.createDocumentFragment();for(n=b;n<=e;n++)if(!r||r.lineIndex>n){o=f.createElement(l,"div");if(s=g[n]){j(s.style,o);if(s.html)o.innerHTML=s.html;o.annotation=s}o.lineIndex=n;o.style.height=this._getLineHeight(n)+"px";t.appendChild(o)}else if(t.firstChild&&(a.insertBefore(t,r),t=l.createDocumentFragment()),r)r=r.nextSibling;t.firstChild&&a.insertBefore(t,r)}else{s=this._getClientHeight();
n=this._model.getLineCount();r=s+q.top+q.bottom-2*this._metrics.scrollWidth;h=d*n<r?d:r/n;if(a.rulerChanged){for(s=a.childNodes.length;s>1;)a.removeChild(a.lastChild),s--;g=g.getAnnotations(0,n);t=l.createDocumentFragment();for(var u in g)if(n=u>>>0,!(n<0)){o=f.createElement(l,"div");s=g[u];j(s.style,o);o.style.position="absolute";o.style.top=this._metrics.scrollWidth+d+Math.floor(n*h)+"px";if(s.html)o.innerHTML=s.html;o.annotation=s;o.lineIndex=n;t.appendChild(o)}a.appendChild(t)}else if(a._oldTrackHeight!==
r)for(o=a.firstChild?a.firstChild.nextSibling:null;o;)o.style.top=this._metrics.scrollWidth+d+Math.floor(o.lineIndex*h)+"px",o=o.nextSibling;a._oldTrackHeight=r}a.rulerChanged=!1;a=a.nextSibling}},_updateStyleSheet:function(){var a="";f.isWebkit&&this._metrics.scrollWidth>0&&(a+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");f.isFirefox&&f.isMac&&this._highlightRGB&&this._highlightRGB!=="Highlight"&&(a+="\n.textview ::-moz-selection {background: "+this._highlightRGB+";}");if(a){var b=
...
(b.lineTrim.top+b.lineTrim.bottom)+"px":"normal";this._updateStyleSheet();a||(this.redraw(),this._resetLineWidth())}};h.EventTarget.addMixin(t.prototype);return{TextView:t}});
define("orion/editor/projectionTextModel",["orion/editor/textModel","orion/editor/eventTarget"],function(k,m){function p(h){this._model=h;this._projections=[];var c=this;this._listener={onChanged:function(d){c._onChanged(d)},onChanging:function(d){c._onChanging(d)}};h.addEventListener("postChanged",this._listener.onChanged);h.addEventListener("preChanging",this._listener.onChanging)}p.prototype={destroy:function(){if(this._model)this._model.removeEventListener("postChanged",this._listener.onChanged),
this._model.removeEventListener("preChanging",this._listener.onChanging),this._model=null},addProjection:function(h){if(h){var c=this._model,d=this._projections;h._lineIndex=c.getLineAtOffset(h.start);h._lineCount=c.getLineAtOffset(h.end)-h._lineIndex;var f=h.text;f||(f="");h._model=typeof f==="string"?new k.TextModel(f,c.getLineDelimiter()):f;var c=this.mapOffset(h.start,!0),f=h.end-h.start,j=h._lineCount,g=h._model.getCharCount(),b=h._model.getLineCount()-1;this.onChanging({type:"Changing",text:h._model.getText(),
start:c,removedCharCount:f,addedCharCount:g,removedLineCount:j,addedLineCount:b});var a=this._binarySearch(d,h.start);d.splice(a,0,h);this.onChanged({type:"Changed",start:c,removedCharCount:f,addedCharCount:g,removedLineCount:j,addedLineCount:b})}},getProjections:function(){return this._projections.slice(0)},getBaseModel:function(){return this._model},mapOffset:function(h,c){var d=this._projections,f=0,j,g;if(c){for(j=0;j<d.length;j++){g=d[j];if(g.start>h)break;if(g.end>h)return-1;f+=g._model.getCharCount()-
(g.end-g.start)}return h+f}for(j=0;j<d.length;j++){g=d[j];if(g.start>h-f)break;var b=g._model.getCharCount();if(g.start+b>h-f)return-1;f+=b-(g.end-g.start)}return h-f},removeProjection:function(h){var c,d=0;for(c=0;c<this._projections.length;c++){var f=this._projections[c];if(f===h){h=f;break}d+=f._model.getCharCount()-(f.end-f.start)}if(c<this._projections.length){var f=this._model,d=h.start+d,j=h.end-h.start,g=h._lineCount,b=h._model.getCharCount(),a=h._model.getLineCount()-1;this.onChanging({type:"Changing",
text:f.getText(h.start,h.end),start:d,removedCharCount:b,addedCharCount:j,removedLineCount:a,addedLineCount:g});this._projections.splice(c,1);this.onChanged({type:"Changed",start:d,removedCharCount:b,addedCharCount:j,removedLineCount:a,addedLineCount:g})}},_binarySearch:function(h,c){for(var d=h.length,f=-1,j;d-f>1;)j=Math.floor((d+f)/2),c<=h[j].start?d=j:f=j;return d},getCharCount:function(){for(var h=this._model.getCharCount(),c=this._projections,d=0;d<c.length;d++){var f=c[d];h+=f._model.getCharCount()-
(f.end-f.start)}return h},getLine:function(h,c){if(h<0)return null;var d=this._model,f=this._projections,j=0,g=[],b=0,a,e,l;for(a=0;a<f.length;a++){l=f[a];if(l._lineIndex>=h-j)break;e=l._model.getLineCount()-1;if(l._lineIndex+e>=h-j)if(b=h-(l._lineIndex+j),b<e)return l._model.getLine(b,c);else g.push(l._model.getLine(e));b=l.end;j+=e-l._lineCount}for(b=Math.max(b,d.getLineStart(h-j));a<f.length;a++){l=f[a];if(l._lineIndex>h-j)break;g.push(d.getText(b,l.start));e=l._model.getLineCount()-1;if(l._lineIndex+
e>h-j)return g.push(l._model.getLine(0,c)),g.join("");g.push(l._model.getText());b=l.end;j+=e-l._lineCount}f=d.getLineEnd(h-j,c);b<f&&g.push(d.getText(b,f));return g.join("")},getLineAtOffset:function(h){for(var c=this._model,d=this._projections,f=0,j=0,g=0;g<d.length;g++){var b=d[g];if(b.start>h-f)break;var a=b._model.getCharCount();if(b.start+a>h-f){d=h-(b.start+f);j+=b._model.getLineAtOffset(d);f+=d;break}j+=b._model.getLineCount()-1-b._lineCount;f+=a-(b.end-b.start)}return c.getLineAtOffset(h-
f)+j},getLineCount:function(){for(var h=this._projections,c=this._model.getLineCount(),d=0;d<h.length;d++){var f=h[d];c+=f._model.getLineCount()-1-f._lineCount}return c},getLineDelimiter:function(){return this._model.getLineDelimiter()},getLineEnd:function(h,c){if(h<0)return-1;for(var d=this._model,f=this._projections,j=0,g=0,b=0;b<f.length;b++){var a=f[b];if(a._lineIndex>h-j)break;var e=a._model.getLineCount()-1;if(a._lineIndex+e>h-j)return a._model.getLineEnd(h-(a._lineIndex+j),c)+a.start+g;g+=
a._model.getCharCount()-(a.end-a.start);j+=e-a._lineCount}return d.getLineEnd(h-j,c)+g},getLineStart:function(h){if(h<0)return-1;for(var c=this._model,d=this._projections,f=0,j=0,g=0;g<d.length;g++){var b=d[g];if(b._lineIndex>=h-f)break;var a=b._model.getLineCount()-1;if(b._lineIndex+a>=h-f)return b._model.getLineStart(h-(b._lineIndex+f))+b.start+j;j+=b._model.getCharCount()-(b.end-b.start);f+=a-b._lineCount}return c.getLineStart(h-f)+j},getText:function(h,c){h===void 0&&(h=0);var d=this._model,f=
this._projections,j=0,g=[],b,a,e;for(b=0;b<f.length;b++){a=f[b];if(a.start>h-j)break;e=a._model.getCharCount();if(a.start+e>h-j)if(c!==void 0&&a.start+e>c-j)return a._model.getText(h-(a.start+j),c-(a.start+j));else g.push(a._model.getText(h-(a.start+j))),h=a.end+j+e-(a.end-a.start);j+=e-(a.end-a.start)}var l=h-j;if(c!==void 0){for(;b<f.length;b++){a=f[b];if(a.start>c-j)break;g.push(d.getText(l,a.start));e=a._model.getCharCount();if(a.start+e>c-j)return g.push(a._model.getText(0,c-(a.start+j))),g.join("");
g.push(a._model.getText());l=a.end;j+=e-(a.end-a.start)}g.push(d.getText(l,c-j))}else{for(;b<f.length;b++)a=f[b],g.push(d.getText(l,a.start)),g.push(a._model.getText()),l=a.end;g.push(d.getText(l))}return g.join("")},_onChanged:function(){var h=this._change,c=h.baseStart,d=h.baseEnd,f,j,g=this._projections;for(f=0;f<g.length;f++)if(j=g[f],j.end>c)break;var b=f;for(f=0;f<g.length;f++)if(j=g[f],j.start>=d)break;var a=f,e=this._model,c=h.baseText.length-(d-c);for(f=a;f<g.length;f++)j=g[f],j.start+=c,
j.end+=c,j._lineIndex=e.getLineAtOffset(j.start);j=g.splice(b,a-b);for(f=0;f<j.length;f++)j[f].annotation&&j[f].annotation._expand();this.onChanged({type:"Changed",start:h.start,removedCharCount:h.removedCharCount,addedCharCount:h.addedCharCount,removedLineCount:h.removedLineCount,addedLineCount:h.addedLineCount});this._change=void 0},_onChanging:function(h){var c=!!this._change,d=this._change||{},f=h.start,j=f+h.removedCharCount;d.baseStart=f;d.baseEnd=j;d.baseText=h.text;d.addedLineCount=h.addedLineCount;
if(!c){this._change=d;d.text=h.text;var g=this._projections,b,a,e,h=function(c){for(a=0,b=0;a<g.length;a++){e=g[a];if(e.start>c)break;if(e.end>c)return-1;b+=e._model.getCharCount()-(e.end-e.start)}return c+b};d.start=h(f);if(d.start===-1)d.text=this._model.getText(e.start,f)+d.text,d.addedLineCount+=this._model.getLineAtOffset(f)-this._model.getLineAtOffset(e.start),d.start=e.start+b;d.end=h(j);if(d.end===-1)d.text+=this._model.getText(j,e.end),d.addedLineCount+=this._model.getLineAtOffset(e.end)-
this._model.getLineAtOffset(j),d.end=e.start+b}d.addedCharCount=d.text.length;d.removedCharCount=d.end-d.start;d.removedLineCount=this.getLineAtOffset(d.end)-this.getLineAtOffset(d.start);this.onChanging({type:"Changing",text:d.text,start:d.start,removedCharCount:d.removedCharCount,addedCharCount:d.addedCharCount,removedLineCount:d.removedLineCount,addedLineCount:d.addedLineCount})},onChanging:function(h){return this.dispatchEvent(h)},onChanged:function(h){return this.dispatchEvent(h)},setLineDelimiter:function(h){this._model.setLineDelimiter(h)},
setText:function(h,c,d){function f(e){for(b=0,g=0;b<j.length;b++){a=j[b];if(a.start>e-g)break;var c=a._model.getCharCount();if(a.start+c>e-g)return-1;g+=c-(a.end-a.start)}return e-g}this._change={text:h||"",start:c||0,end:d===void 0?this.getCharCount():d};var j=this._projections,g,b,a,e,l,h=f(this._change.start);if(h===-1)e={projection:a,start:this._change.start-(a.start+g)},h=a.end;c=f(this._change.end);if(c===-1)l={projection:a,end:this._change.end-(a.start+g)},c=a.start;if(e&&l&&e.projection===
l.projection)a._model.setText(this._change.text,e.start,l.end);else{this._model.setText(this._change.text,h,c);if(e)a=e.projection,a._model.setText("",e.start);if(l)a=l.projection,a._model.setText("",0,l.end),a.start=a.end,a._lineCount=0}this._change=void 0}};m.EventTarget.addMixin(p.prototype);return{ProjectionTextModel:p}});
define("orion/editor/annotations",["i18n!orion/editor/nls/messages","orion/editor/eventTarget"],function(k,m){function p(b,a,e){this.start=b;this.end=a;this._projectionModel=e;this.html=this._expandedHTML;this.style=this._expandedStyle;this.expanded=!0}function h(){}function c(b,a){var e=b.lastIndexOf("."),e=b.substring(e+1),c={title:k[e],style:{styleClass:"annotation "+e},html:"<div class='annotationHTML "+e+"'></div>",overviewStyle:{styleClass:"annotationOverview "+e}};a?c.lineStyle={styleClass:"annotationLine "+
e}:c.rangeStyle={styleClass:"annotationRange "+e};h.registerType(b,c)}function d(){}function f(b){this._annotations=[];var a=this;this._listener={onChanged:function(b){a._onChanged(b)}};this.setTextModel(b)}function j(b,a){this._view=b;this._annotationModel=a;var e=this;this._listener={onDestroy:function(a){e._onDestroy(a)},onLineStyle:function(a){e._onLineStyle(a)},onChanged:function(a){e._onAnnotationModelChanged(a)}};b.addEventListener("Destroy",this._listener.onDestroy);b.addEventListener("postLineStyle",
...
this._projectionModel.removeProjection(this._projection)}};h.ANNOTATION_ERROR="orion.annotation.error";h.ANNOTATION_WARNING="orion.annotation.warning";h.ANNOTATION_TASK="orion.annotation.task";h.ANNOTATION_BREAKPOINT="orion.annotation.breakpoint";h.ANNOTATION_BOOKMARK="orion.annotation.bookmark";h.ANNOTATION_FOLDING="orion.annotation.folding";h.ANNOTATION_CURRENT_BRACKET="orion.annotation.currentBracket";h.ANNOTATION_MATCHING_BRACKET="orion.annotation.matchingBracket";h.ANNOTATION_CURRENT_LINE="orion.annotation.currentLine";
h.ANNOTATION_CURRENT_SEARCH="orion.annotation.currentSearch";h.ANNOTATION_MATCHING_SEARCH="orion.annotation.matchingSearch";h.ANNOTATION_READ_OCCURRENCE="orion.annotation.readOccurrence";h.ANNOTATION_WRITE_OCCURRENCE="orion.annotation.writeOccurrence";h.ANNOTATION_SELECTED_LINKED_GROUP="orion.annotation.selectedLinkedGroup";h.ANNOTATION_CURRENT_LINKED_GROUP="orion.annotation.currentLinkedGroup";h.ANNOTATION_LINKED_GROUP="orion.annotation.linkedGroup";h.ANNOTATION_BLAME="orion.annotation.blame";h.ANNOTATION_CURRENT_BLAME=
"orion.annotation.currentBlame";var g={};h.registerType=function(b,a){var e=a;if(typeof e!=="function")e=function(a,b,e){this.start=a;this.end=b;if(e!==void 0)this.title=e},e.prototype=a;e.prototype.type=b;g[b]=e;return b};h.createAnnotation=function(b,a,e,c){return new (this.getType(b))(a,e,c)};h.getType=function(b){return g[b]};c(h.ANNOTATION_ERROR);c(h.ANNOTATION_WARNING);c(h.ANNOTATION_TASK);c(h.ANNOTATION_BREAKPOINT);c(h.ANNOTATION_BOOKMARK);c(h.ANNOTATION_CURRENT_BRACKET);c(h.ANNOTATION_MATCHING_BRACKET);
c(h.ANNOTATION_CURRENT_SEARCH);c(h.ANNOTATION_MATCHING_SEARCH);c(h.ANNOTATION_READ_OCCURRENCE);c(h.ANNOTATION_WRITE_OCCURRENCE);c(h.ANNOTATION_SELECTED_LINKED_GROUP);c(h.ANNOTATION_CURRENT_LINKED_GROUP);c(h.ANNOTATION_LINKED_GROUP);c(h.ANNOTATION_CURRENT_LINE,!0);c(h.ANNOTATION_BLAME,!0);c(h.ANNOTATION_CURRENT_BLAME,!0);h.registerType(h.ANNOTATION_FOLDING,p);d.addMixin=function(b){var a=d.prototype,e;for(e in a)a.hasOwnProperty(e)&&(b[e]=a[e])};d.prototype={addAnnotationType:function(b){if(!this._annotationTypes)this._annotationTypes=
...
g._oldEnd=g.end,g.start+=b,g.end+=b,f.changed.push(g);else if(!(g.end<=a))g.start<a&&d<g.end?(g._oldStart=g.start,g._oldEnd=g.end,g.end+=b,f.changed.push(g)):(c.splice(e,1),f.removed.push(g),g._annotationModel=null,g.expand&&g.expand(),e--)}if(f.added.length>0||f.removed.length>0||f.changed.length>0)this.onChanged(f)}}};m.EventTarget.addMixin(f.prototype);j.prototype={destroy:function(){var b=this._view;if(b)b.removeEventListener("Destroy",this._listener.onDestroy),b.removeEventListener("LineStyle",
...
e;else if(this._isNode(e))a.appendChild(e);else if(e instanceof h.ProjectionTextModel){var l=this._view,f=l.getOptions();f.wrapMode=!1;f.parent=a;var r=f.themeClass;r?((r=r.replace("tooltipTheme",""))&&(r=" "+r),r="tooltipTheme"+r):r="tooltipTheme";f.themeClass=r;f=this._contentsView=new m.TextView(f);f.addEventListener("LineStyle",function(a){l.onLineStyle(a)});f.setModel(e);e=f.computeSize();a.style.width=e.width+"px";a.style.height=e.height+"px";f.resize()}else return;a=b.ownerDocument.documentElement;
d.anchor==="right"?(e=a.clientWidth-d.x,b.style.right=e+"px"):(e=parseInt(this._getNodeStyle(b,"padding-left","0"),10),e+=parseInt(this._getNodeStyle(b,"border-left-width","0"),10),e=d.x-e,b.style.left=e+"px");b.style.maxWidth=a.clientWidth-e-10+"px";e=parseInt(this._getNodeStyle(b,"padding-top","0"),10);e+=parseInt(this._getNodeStyle(b,"border-top-width","0"),10);e=d.y-e;b.style.top=e+"px";b.style.maxHeight=a.clientHeight-e-10+"px";b.style.opacity="1";b.style.visibility="visible";if(c){var o=this,
n=this._getWindow();o._hideTimeout=n.setTimeout(function(){o._hideTimeout=null;var a=parseFloat(o._getNodeStyle(b,"opacity","1"));o._fadeTimeout=n.setInterval(function(){b.style.visibility==="visible"&&a>0?(a-=0.1,b.style.opacity=a):o._hide()},o._fadeDelay/10)},o._autoHideDelay)}}}},_getAnnotationContents:function(f){function g(a,b){var e=t.getLineStart(t.getLineAtOffset(a)),c=t.getLineEnd(t.getLineAtOffset(b),!0);return t.getText(e,c)}function b(a){var b=a.title,e=d.createElement(r,"div");e.className=
"tooltipRow";if(a.html)e.innerHTML=a.html,e.lastChild&&c.addEventListener(e.lastChild,"click",function(){var b=a.start,e=a.end;n.getBaseModel&&(b=n.mapOffset(b,!0),e=n.mapOffset(e,!0));o.setSelection(b,e,1/3,function(){q._hide()})},!1),e.appendChild(r.createTextNode("\u00a0"));b||(b=g(a.start,a.end));typeof b==="function"&&(b=a.title());if(typeof b==="string"){var i=d.createElement(r,"span");i.appendChild(r.createTextNode(b));b=i}e.appendChild(b);return e}for(var a,e=[],l=0;l<f.length;l++)a=f[l],
a.title!==""&&!a.groupAnnotation&&e.push(a);f=e;if(f.length===0)return null;var q=this,r=this._tooltipDiv.ownerDocument,o=this._view,n=o.getModel(),t=n.getBaseModel?n.getBaseModel():n;if(f.length===1)if(a=f[0],a.title!==void 0){a=b(a);if(a.firstChild)(f=a.firstChild.className)&&(f+=" "),f+="single",a.firstChild.className=f;return a}else return f=new h.ProjectionTextModel(t),e=t.getLineStart(t.getLineAtOffset(a.start)),l=t.getCharCount(),a.end!==l&&f.addProjection({start:a.end,end:l}),e>0&&f.addProjection({start:0,
end:e}),f;else{e=d.createElement(r,"div");a=d.createElement(r,"em");a.appendChild(r.createTextNode(k.multipleAnnotations));e.appendChild(a);for(l=0;l<f.length;l++)a=f[l],(a=b(a))&&e.appendChild(a);return e}},_getNodeStyle:function(c,d,b){var a;if(c&&(a=c.style[d],!a))if(c.currentStyle){for(a=0;(a=d.indexOf("-",a))!==-1;)d=d.substring(0,a)+d.substring(a+1,a+2).toUpperCase()+d.substring(a+2);a=c.currentStyle[d]}else a=(c=c.ownerDocument.defaultView.getComputedStyle(c,null))?c.getPropertyValue(d):null;
...
define("orion/editor/rulers",["i18n!orion/editor/nls/messages","orion/editor/annotations","orion/editor/tooltip","orion/util"],function(k,m,p,h){function c(b,a,e,c){this._location=a||"left";this._overview=e||"page";this._rulerStyle=c;this._view=null;var d=this;this._listener={onTextModelChanged:function(a){d._onTextModelChanged(a)},onAnnotationModelChanged:function(a){d._onAnnotationModelChanged(a)}};this.setAnnotationModel(b)}function d(b,a,e,l,d){c.call(this,b,a,"page",e);this._oddStyle=l||{style:{backgroundColor:"white"}};
this._evenStyle=d||{style:{backgroundColor:"white"}};this._numOfDigits=0;this._firstLine=1}function f(b,a,e){c.call(this,b,a,"page",e)}function j(b,a,e){c.call(this,b,a,"document",e)}function g(b,a,e){f.call(this,b,a,e)}c.prototype={getAnnotations:function(b,a){var e=this._annotationModel;if(!e)return[];var c=this._view.getModel(),d=c.getLineStart(b),f=c.getLineEnd(a-1),g=c;c.getBaseModel&&(g=c.getBaseModel(),d=c.mapOffset(d),f=c.mapOffset(f));for(var n=[],e=this.getAnnotationsByType(e,d,f),d=0;d<
e.length;d++)for(var f=e[d],h=g.getLineAtOffset(f.start),j=g.getLineAtOffset(Math.max(f.start,f.end-1)),s=h;s<=j;s++){var u=s;if(c!==g){u=g.getLineStart(s);u=c.mapOffset(u,!0);if(u===-1)continue;u=c.getLineAtOffset(u)}if(b<=u&&u<a){var i=this._mergeAnnotation(n[u],f,s-h,j-h+1);i&&(n[u]=i)}}if(!this._multiAnnotation&&this._multiAnnotationOverlay)for(var k in n)n[k]._multiple&&(n[k].html+=this._multiAnnotationOverlay.html);return n},getAnnotationModel:function(){return this._annotationModel},getLocation:function(){return this._location},
...
j.prototype._getTooltipContents=function(b,a){if(a.length===0){var e=this._view.getModel(),d=b;e.getBaseModel&&(d=e.getLineStart(d),d=e.getBaseModel().getLineAtOffset(e.mapOffset(d)));return h.formatMessage(k.line,d+1)}return c.prototype._getTooltipContents.call(this,b,a)};j.prototype._mergeAnnotation=function(b,a,e,c){if(e===0){if(!b)b={html:"&nbsp;",style:{style:{height:3*c+"px"}}},b.style=this._mergeStyle(b.style,a.overviewStyle);return b}};g.prototype=new f;g.prototype.onClick=function(b){if(b!==
...
for(g=0;g<b.length;g++)e.redrawLines(n,h,b[g])}}};return{Ruler:c,AnnotationRuler:f,LineNumberRuler:d,OverviewRuler:j,FoldingRuler:g}});
define("orion/editor/undoStack",[],function(){function k(h,c,d,f,j){this.model=h;this.offset=c;this.text=d;this.previousText=f;this.type=j}function m(h){this.owner=h;this.changes=[]}function p(h,c){this.size=c!==void 0?c:100;this.reset();var d=this;this._listener={onChanging:function(c){d._onChanging(c)},onDestroy:function(c){d._onDestroy(c)}};if(h.getModel){var f=h.getModel();f.getBaseModel&&(f=f.getBaseModel());this.model=f;this.setView(h)}else this.shared=!0,this.model=h;this.model.addEventListener("Changing",
this._listener.onChanging)}k.prototype={getRedoChanges:function(){return[{start:this.offset,end:this.offset+this.previousText.length,text:this.text}]},getUndoChanges:function(){return[{start:this.offset,end:this.offset+this.text.length,text:this.previousText}]},undo:function(h,c){this._doUndoRedo(this.offset,this.previousText,this.text,h,c);return!0},redo:function(h,c){this._doUndoRedo(this.offset,this.text,this.previousText,h,c);return!0},merge:function(h,c,d,f,j){if(f===this.type)if(f===1&&h===
this.offset+this.text.length)return this.text+=c,!0;else if(f===-1&&j===this.offset)return this.offset=h,this.previousText=d+this.previousText,!0;else if(f===-1&&h===this.offset)return this.previousText+=d,!0;return!1},_doUndoRedo:function(h,c,d,f,j){this.model.setText(c,h,h+d.length);j&&f&&(d=f.getModel(),d!==this.model&&(h=d.mapOffset(h,!0)),f.setSelection(h,h+c.length))}};m.prototype={getRedoChanges:function(){for(var h=[],c=0;c<this.changes.length;c++)h=h.concat(this.changes[c].getRedoChanges());
return h},getUndoChanges:function(){for(var h=[],c=this.changes.length-1;c>=0;c--)h=h.concat(this.changes[c].getUndoChanges());return h},add:function(h){this.changes.push(h)},end:function(h){if(h)this.endSelection=h.getSelection(),this.endCaret=h.getCaretOffset();(h=this.owner)&&h.end&&h.end()},undo:function(h,c){this.changes.length>1&&h&&h.setRedraw(!1);for(var d=this.changes.length-1;d>=0;d--)this.changes[d].undo(h,!1);this.changes.length>1&&h&&h.setRedraw(!0);if(c&&h){var d=this.startSelection.start,
f=this.startSelection.end;h.setSelection(this.startCaret?d:f,this.startCaret?f:d)}(d=this.owner)&&d.undo&&d.undo();return this.changes.length>0},redo:function(h,c){this.changes.length>1&&h&&h.setRedraw(!1);for(var d=0;d<this.changes.length;d++)this.changes[d].redo(h,!1);h&&h.setRedraw(!0);if(c&&h){var d=this.endSelection.start,f=this.endSelection.end;h.setSelection(this.endCaret?d:f,this.endCaret?f:d)}(d=this.owner)&&d.redo&&d.redo();return this.changes.length>0},merge:function(h,c,d,f,j){var g=this.changes.length;
return g>0?this.changes[g-1].merge(h,c,d,f,j):!1},start:function(h){if(h)this.startSelection=h.getSelection(),this.startCaret=h.getCaretOffset();(h=this.owner)&&h.start&&h.start()}};p.prototype={destroy:function(){this._onDestroy()},add:function(h){this.compoundChange?this.compoundChange.add(h):(this.stack.splice(this.index,this.stack.length-this.index,h),this.index++,this.stack.length>this.size&&(this.stack.shift(),this.index--))},markClean:function(){this._commitUndo();if(this.cleanChange=this.stack[this.index-
...
return h},getUndoChanges:function(){this._commitUndo();for(var h=[],c=this.index;c>=0;c--)h=h.concat(this.stack[c].getUndoChanges());return h},undo:function(){this._commitUndo();var h;h=!1;this._ignoreUndo=!0;do{if(this.index<=0)break;h=this.stack[--this.index]}while(!(h=h.undo(this.view,!0)));this._ignoreUndo=!1;return h},redo:function(){this._commitUndo();var h;this._ignoreUndo=!0;do{if(this.index>=this.stack.length)break;h=this.stack[this.index++]}while(!h.redo(this.view,!0));this._ignoreUndo=
!1;return!0},reset:function(){this.index=0;this.cleanChange=void 0;this.stack=[];this._ignoreUndo=!1;this._compoundChange=void 0},setView:function(h){if(this.view!==h)this.view&&h.removeEventListener("Destroy",this._listener.onDestroy),(this.view=h)&&h.addEventListener("Destroy",this._listener.onDestroy)},startCompoundChange:function(h){this._commitUndo();h=new m(h);this.add(h);this.compoundChange=h;this.compoundChange.start(this.view);return this.compoundChange},_commitUndo:function(){this.endCompoundChange()},
_onDestroy:function(h){(!h||!this.shared)&&this.model.removeEventListener("Changing",this._listener.onChanging);if(this.view)this.view.removeEventListener("Destroy",this._listener.onDestroy),this.view=null},_onChanging:function(h){if(!this._ignoreUndo){var c=h.text,d=h.start,f=h.addedCharCount,j=h.removedCharCount,h=d+j,g=0;f===0&&j===1?g=-1:f===1&&j===0&&(g=1);f=this.stack.length;j=this.model.getText(d,h);(!(f>0&&this.index===f)||!this.stack[f-1].merge(d,c,j,g,h))&&this.add(new k(this.model,d,c,
j,g))}}};return{UndoStack:p}});
define("orion/editor/textDND",["orion/util"],function(k){function m(k,h){this._view=k;this._undoStack=h;this._dragSelection=null;this._dropOffset=-1;this._dropText=null;var c=this;this._listener={onDragStart:function(d){c._onDragStart(d)},onDragEnd:function(d){c._onDragEnd(d)},onDragEnter:function(d){c._onDragEnter(d)},onDragOver:function(d){c._onDragOver(d)},onDrop:function(d){c._onDrop(d)},onDestroy:function(d){c._onDestroy(d)}};k.addEventListener("DragStart",this._listener.onDragStart);k.addEventListener("DragEnd",
...
this._listener.onDragOver),k.removeEventListener("Drop",this._listener.onDrop),k.removeEventListener("Destroy",this._listener.onDestroy),this._view=null},_onDestroy:function(){this.destroy()},_onDragStart:function(k){var h=this._view,c=h.getSelection(),h=h.getModel();if(h.getBaseModel)c.start=h.mapOffset(c.start),c.end=h.mapOffset(c.end),h=h.getBaseModel();if(h=h.getText(c.start,c.end))this._dragSelection=c,k.event.dataTransfer.effectAllowed="copyMove",k.event.dataTransfer.setData("Text",h)},_onDragEnd:function(m){if(this._dragSelection){var h=
this._view,c=m.event.dataTransfer.dropEffect;if(!k.isFirefox&&(c!=="none"||this._dropText))c=m.event.dataTransfer.dropEffect=this._dropEffect;this._undoStack&&this._undoStack.startCompoundChange();(m=c==="move")&&h.setText("",this._dragSelection.start,this._dragSelection.end);if(this._dropText){var c=this._dropText,d=this._dropOffset;if(m)if(d>=this._dragSelection.end)d-=this._dragSelection.end-this._dragSelection.start;else if(d>=this._dragSelection.start)d=this._dragSelection.start;h.setText(c,
d,d);h.setSelection(d,d+c.length);this._dropText=null;this._dropOffset=-1}this._undoStack&&this._undoStack.endCompoundChange()}this._dragSelection=null},_onDragEnter:function(k){this._onDragOver(k)},_onDragOver:function(m){var h=m.event.dataTransfer.types,c=!this._view.getOptions("readonly");c&&h&&(c=h.contains?h.contains("text/plain")||h.contains("Text"):h.indexOf("text/plain")!==-1||h.indexOf("Text")!==-1);if(c){if(!k.isFirefox)this._dropEffect=m.event.dataTransfer.dropEffect=(k.isMac?m.event.altKey:
m.event.ctrlKey)?"copy":"move"}else m.event.dataTransfer.dropEffect="none"},_onDrop:function(m){var h=this._view,c=m.event.dataTransfer.getData("Text");if(c){if(!k.isFirefox)m.event.dataTransfer.dropEffect=this._dropEffect;m=h.getOffsetAtLocation(m.x,m.y);this._dragSelection?(this._dropOffset=m,this._dropText=c):(h.setText(c,m,m),h.setSelection(m,m+c.length))}}};return{TextDND:m}});
define("orion/objects",[],function(){function k(k){for(var p=1;p<arguments.length;p++){var h=arguments[p],c;for(c in h)Object.prototype.hasOwnProperty.call(h,c)&&(k[c]=h[c])}return k}return{clone:function(m){if(Array.isArray(m))return Array.prototype.slice.call(m);var p=Object.create(Object.getPrototypeOf(m));k(p,m);return p},mixin:k,toArray:function(k){return Array.isArray(k)?k:[k]}}});
define("orion/editor/editor","i18n!orion/editor/nls/messages,orion/editor/eventTarget,orion/editor/tooltip,orion/editor/annotations,orion/objects,orion/util".split(","),function(k,m,p,h,c,d){function f(b){b=b||{};this._domNode=b.domNode;this._model=b.model;this._undoStack=b.undoStack;this._statusReporter=b.statusReporter;this._title=null;var a=this;this._listener={onChanged:function(b){a.onChanged(b)}};this._model&&this._model.addEventListener("Changed",this._listener.onChanged);this.checkDirty()}
...
c.getModel(),f=a?d.getLineAtOffset(a.start):-1,h=d.getLineAtOffset(b.start),c=b.start===b.end,n=!a||a.start===a.end,j=d.getLineStart(h),k=d.getLineEnd(h);d.getBaseModel&&(j=d.mapOffset(j),k=d.mapOffset(k));d=this._currentLineAnnotation;if(!(f===h&&n&&c&&d&&d.start===j&&d.end===k)){var f=d?[d]:null,s;c&&(d=g.createAnnotation(g.ANNOTATION_CURRENT_LINE,j,k),s=[d]);this._currentLineAnnotation=d;e.replaceAnnotations(f,s)}}}},installTextView:function(){this.install()},install:function(){if(!this._textView){this._textView=
...
var f=q.indexOf("("),j=q.indexOf(")"),q=q.substring(f+1,j);this._blameRGB=a=q.split(",").slice(0,3)}var o=function(){var a=h.AnnotationType.createAnnotation(this.groupType,this.start,this.end,this.title);a.style=c.mixin({},a.style);a.style.style=c.mixin({},a.style.style);a.style.style.backgroundColor="";this.groupAnnotation=a;a.blame=this.blame;a.html=this.html;a.creatorID=this.creatorID;return a},n=function(){var a=d.createElement(e,"div");a.className="tooltipTitle";var b=this.blame.Message.indexOf("\n");
if(b===-1)b=this.blame.Message.length;var c=d.createElement(e,"a");c.href=this.blame.CommitLink;c.appendChild(e.createTextNode(this.blame.Message.substring(0,b)));a.appendChild(c);a.appendChild(d.createElement(e,"br"));a.appendChild(e.createTextNode(d.formatMessage(k.committerOnTime,this.blame.AuthorName,this.blame.Time)));return a},t=this.getModel();this.showAnnotations(b,[g.ANNOTATION_BLAME,g.ANNOTATION_CURRENT_BLAME],function(b){var e=t.getLineStart(b.Start-1),d=t.getLineEnd(b.End-1,!0),e=h.AnnotationType.createAnnotation(g.ANNOTATION_BLAME,
e,d,n),d=a.slice(0);d.push(b.Shade);e.style=c.mixin({},e.style);e.style.style=c.mixin({},e.style.style);e.style.style.backgroundColor="rgba("+d.join()+")";e.groupId=b.Name;e.groupType=g.ANNOTATION_CURRENT_BLAME;e.createGroupAnnotation=o;e.html='<img class="annotationHTML blame" src="'+b.AuthorImage+'"/>';e.blame=b;return e})},showSelection:function(b,a,e,c,d){typeof b==="number"?(typeof a!=="number"&&(a=b),this.moveSelection(b,a)):typeof e==="number"&&(b=this.getModel().getLineStart(e-1),typeof c===
...
this._undoStack.startCompoundChange()},endUndo:function(){this._undoStack&&this._undoStack.endCompoundChange()},_find:function(a,b,c){return this._editor.getModel().find({string:a,start:b,end:this._end,reverse:this._reverse,wrap:c?!1:this._wrap,regex:this._regex,wholeWord:this._wholeWord,caseInsensitive:this._caseInsensitive})},_doFind:function(a,b,c,d){var c=c||1,f=this._editor;if(!a)return this._removeAllAnnotations(),null;this._lastString=a;var g,n;if(this._regex)try{n=this._find(a,b,d)}catch(j){f.reportStatus(j.message,
"error");return}else n=this._find(a,b,d);for(a=0;a<c&&n.hasNext();a++)g=n.next();if(!this._replacingAll){g?this._editor.reportStatus(""):this._editor.reportStatus(k.notFound,"error");if(this.isVisible()){c=h.AnnotationType.ANNOTATION_CURRENT_SEARCH;if(n=f.getAnnotationModel())n.removeAnnotations(c),g&&n.addAnnotation(h.AnnotationType.createAnnotation(c,g.start,g.end));if(this._showAll){this._timer&&window.clearTimeout(this._timer);var v=this;this._timer=window.setTimeout(function(){v._markAllOccurrences();
v._timer=null},500)}}this._findCallback?this._findCallback(g):g&&f.moveSelection(g.start,g.end,null,!1)}return g},_doReplace:function(a,b,c,d){var f=this._editor;if(this._regex&&(d=f.getText(a,b).replace(RegExp(c,this._caseInsensitive?"i":""),d),!d))return;f.setText(d,a,b);f.setSelection(a,a+d.length,!0)},_markAllOccurrences:function(){var a=this._editor.getAnnotationModel();if(a){for(var b=h.AnnotationType.ANNOTATION_MATCHING_SEARCH,c=a.getAnnotations(),d=[],f;c.hasNext();){var g=c.next();g.type===
b&&d.push(g)}if(this.isVisible()){c=this.getFindString();c=this._editor.getModel().find({string:c,regex:this._regex,wholeWord:this._wholeWord,caseInsensitive:this._caseInsensitive});for(f=[];c.hasNext();)g=c.next(),f.push(h.AnnotationType.createAnnotation(b,g.start,g.end))}a.replaceAnnotations(d,f)}},_removeAllAnnotations:function(){var a=this._editor.getAnnotationModel();a&&(a.removeAnnotations(h.AnnotationType.ANNOTATION_CURRENT_SEARCH),a.removeAnnotations(h.AnnotationType.ANNOTATION_MATCHING_SEARCH))},
_removeCurrentAnnotation:function(){var a=this._editor.getAnnotationModel();a&&a.removeAnnotations(h.AnnotationType.ANNOTATION_CURRENT_SEARCH)}};b.Find=g;return b});
define("orion/editor/actions","i18n!orion/editor/nls/messages,orion/keyBinding,orion/editor/annotations,orion/editor/tooltip,orion/editor/find,orion/util".split(","),function(k,m,p,h,c,d){function f(a,b,d){this.editor=a;this.undoStack=b;this._incrementalFind=new c.IncrementalFind(a);this._find=d?d:new c.Find(a,b);this._lastEditLocation=null;this.init()}function j(a,b,c,d){this.editor=a;this.undoStack=b;this.contentAssist=c;this.linkedMode=d;this.contentAssist&&this.contentAssist.addEventListener("ProposalApplied",
...
a.setKeyBinding(new m.KeyBinding('"',!1,!1,!1,!1,"keypress"),"autoPairDblQuotation");a.setAction("autoPairDblQuotation",function(){return this.autoPairQuotations('"')}.bind(this));a.setAction("deletePrevious",function(){return this.deletePrevious()}.bind(this))},autoIndent:function(){var a=this.editor,b=a.getTextView();if(b.getOptions("readonly"))return!1;var c=a.getSelection();if(c.start===c.end){for(var d=a.getModel(),f=d.getLineAtOffset(c.start),g=d.getLine(f,!1),h=d.getLineStart(f),j=0,k=c.start-
h,s;j<k&&((s=g.charCodeAt(j))===32||s===9);)j++;var h=g.substring(0,j),b=b.getOptions("tabSize","expandTab"),u=b.expandTab?Array(b.tabSize+1).join(" "):"\t",b=d.getLineDelimiter(),i=/^[\s]*\/\*[\*]*[\s]*$/,m=/^[\s]*\*/,p=/\*\/[\s]*$/,D=g.substring(0,k),B=g.substring(k),K;if(this.smartIndentation&&g.charCodeAt(K=D.trimRight().length-1)===123)return d=k-K-1,B=B.length-B.trimLeft().length,g=g.charCodeAt(k+B)===125?b+h+u+b+h:b+h+u,a.setText(g,c.start-d,c.end+B),a.setCaretOffset(c.start+b.length+h.length+
u.length-d),!0;else if(this.autoCompleteComments&&!p.test(D)&&(i.test(D)||m.test(D))){if(j=i.exec(D)){g=b+h+" * ";g+=p.test(B)?B.substring(0,B.length-2).trim():B.trim();if(d.getLineCount()===f+1||!m.test(d.getLine(f+1)))g+=b+h+" */";a.setText(g,c.start,c.end+B.length);a.setCaretOffset(c.start+b.length+h.length+3);return!0}if(j=m.exec(D))for(f-=1;f>=0;f--)if(j=d.getLine(f,!1),i.test(j))return p.test(B)||g.charCodeAt(k)===47?(g=b+h+"*"+B,h=c.start+b.length+h.length+1):(g=b+h+"* "+B,h=c.start+b.length+
h.length+2),a.setText(g,c.start,c.end+B.length),a.setCaretOffset(h),!0;else if(!m.test(j))break}else if(p.test(D)&&h.charCodeAt(h.length-1)===32)return g=b+h.substring(0,h.length-1),a.setText(g,c.start,c.end),a.setCaretOffset(c.start+g.length),!0;else if(j>0){for(j=k;j<g.length&&((s=g.charCodeAt(j++))===32||s===9);)c.end++;a.setText(d.getLineDelimiter()+h,c.start,c.end);return!0}}return!1},addBlockComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var b=a.getModel(),
...
var b=this.editor;if(b.getTextView().getOptions("readonly"))return!1;var c=b.getSelection(),d=b.getModel(),f=b.getCaretOffset(),g=f===0?"":d.getText(c.start-1,c.start).trim(),h=f===d.getCharCount()?"":d.getText(c.start,c.start+1).trim(),f=/^"$|^'$/,j=/\w/,k=/^$|[)}\]>]/;if(c.start!==c.end){d=d.getText(c.start,c.end);if(f.test(d))return!1;b.setText(a+d+a,c.start,c.end);b.setSelection(c.start+1,c.end+1)}else if(h===a)b.setCaretOffset(c.start+1);else if(g===a||f.test(h)||j.test(g)||!k.test(h))return!1;
...
1);return!1},_findEnclosingComment:function(a,b,c){var d=a.getLineAtOffset(b),f=a.getLineAtOffset(c),g,h,j,k,s,u;for(g=d;g>=0;g--)if(h=a.getLine(g),j=g===d?b-a.getLineStart(d):h.length,k=h.lastIndexOf("/*",j),h=h.lastIndexOf("*/",j),h>k)break;else if(k!==-1){s=a.getLineStart(g)+k;break}for(g=f;g<a.getLineCount();g++)if(h=a.getLine(g),j=g===f?c-a.getLineStart(f):0,k=h.indexOf("/*",j),h=h.indexOf("*/",j),k!==-1&&k<h)break;else if(h!==-1){u=a.getLineStart(g)+h;break}return{commentStart:s,commentEnd:u}},
...
f=b.getLineAtOffset(c.end>c.start?c.end-1:c.end),g=!0,h=[],j,k,s=d;s<=f;s++)if(j=b.getLine(s,!0),h.push(j),!g||(k=j.indexOf("//"))===-1)g=!1;else if(k!==0){var u;for(u=0;u<k;u++)if(g=j.charCodeAt(u),!(g===32||g===9))break;g=u===k}s=b.getLineStart(d);u=b.getLineEnd(f,!0);if(g){for(g=0;g<h.length;g++)j=h[g],k=j.indexOf("//"),h[g]=j.substring(0,k)+j.substring(k+2);h=h.join("");j=b.getLineStart(f);b=s===c.start?c.start:c.start-2;c=c.end-2*(f-d+1)+(c.end===j+1?2:0)}else h.splice(0,0,""),h=h.join("//"),
b=s===c.start?c.start:c.start+2,c=c.end+2*(f-d+1);a.setText(h,s,u);a.setSelection(b,c);return!0},trimTrailingWhitespaces:function(){var a=this.editor,b=a.getModel(),c=a.getSelection();a.getTextView().setRedraw(!1);a.getUndoStack().startCompoundChange();for(var d=/(\s+$)/,f=b.getLineCount(),g=0;g<f;g++){var h=b.getLine(g),j=d.exec(h);if(j){var k=b.getLineStart(g),h=j[0].length,j=k+j.index;b.setText("",j,j+h);if(c.start>j)c.start=Math.max(j,c.start-h);if(c.start!==c.end&&c.end>j)c.end=Math.max(j,c.end-
...
define("orion/editor/templates",[],function(){function k(k,h,c,d){this.prefix=k;this.description=h;this.template=c;this.name=d;this._parse()}function m(k,h){this._keywords=k||[];this._templates=[];this.addTemplates(h||[])}k.prototype={getProposal:function(k,h,c){var k=h-k.length,h={},d,f=c.delimiter!==void 0?c.delimiter:"\n";c.indentation&&(f+=c.indentation);for(var j=c.tab!==void 0?c.tab:"\t",g=0,b=this.variables,a=this.segments,c=[],e=0;e<a.length;e++){var l=a[e],q=b[l];if(q!==void 0)switch(l){case "${tab}":l=
j;break;case "${delimiter}":l=f;break;case "${cursor}":l="";d=g;break;default:var r=h[l];r||(r=h[l]={data:q.data,positions:[]});l=q.substitution;r.data&&r.data.values&&(l=r.data.values[0]);r.positions.push({offset:k+g,length:l.length})}c.push(l);g+=l.length}var f=[],o;for(o in h)h.hasOwnProperty(o)&&f.push(h[o]);c=c.join("");if(d===void 0)d=c.length;return{proposal:c,name:this.name,description:this.description,groups:f,escapePosition:k+d,style:"noemphasis"}},match:function(k){return this.prefix.indexOf(k)===
0},_parse:function(){var k=this.template,h=[],c={},d,f=0,k=k.replace(/\n/g,"${delimiter}"),k=k.replace(/\t/g,"${tab}");k.replace(/\$\{((?:[^\\}]+|\\.))*\}/g,function(j,g,b){var a=j.substring(2,j.length-1),g=j,e=a,l=null,q=e.indexOf(":");q!==-1&&(e=e.substring(0,q),g="${"+e+"}",l=JSON.parse(a.substring(q+1).replace("\\}","}").trim()));(a=c[g])||(a=c[g]={});a.substitution=e;if(l)a.data=l;(d=k.substring(f,b))&&h.push(d);h.push(g);f=b+j.length;return e});(d=k.substring(f,k.length))&&h.push(d);this.segments=
h;this.variables=c}};m.prototype={addTemplates:function(m){for(var h=this.getTemplates(),c=0;c<m.length;c++)h.push(new k(m[c].prefix,m[c].description,m[c].template,m[c].name))},computeProposals:function(k,h,c){var d=this.getPrefix(k,h,c),f=[];this.isValid(d,k,h,c)&&(f=f.concat(this.getTemplateProposals(d,h,c)),f=f.concat(this.getKeywordProposals(d)));return f},getKeywords:function(){return this._keywords},getKeywordProposals:function(k){var h=[],c=this.getKeywords();if(c){for(var d=0;d<c.length;d++)c[d].indexOf(k)===
0&&h.push({proposal:c[d].substring(k.length),description:c[d],style:"noemphasis_keyword"});0<h.length&&h.splice(0,0,{proposal:"",description:"Keywords",style:"noemphasis_title_keywords",unselectable:!0})}return h},getPrefix:function(k,h,c){return c.prefix},getTemplates:function(){return this._templates},getTemplateProposals:function(k,h,c){for(var d=[],f=this.getTemplates(),j=0;j<f.length;j++){var g=f[j];g.match(k)&&(g=g.getProposal(k,h,c),this.removePrefix(k,g),d.push(g))}0<d.length&&(d.sort(function(b,
a){return b.name<a.name?-1:b.name>a.name?1:0}),d.splice(0,0,{proposal:"",description:"Templates",style:"noemphasis_title",unselectable:!0}));return d},removePrefix:function(k,h){if(!(h.overwrite=h.proposal.substring(0,k.length)!==k))h.proposal=h.proposal.substring(k.length)},isValid:function(){return!0}};return{Template:k,TemplateContentAssist:m}});
define("orion/editor/linkedMode","i18n!orion/editor/nls/messages,orion/keyBinding,orion/editor/keyModes,orion/editor/annotations,orion/editor/templates,orion/objects,orion/util".split(","),function(k,m,p,h,c,d){function f(c,b,a){var e=c.getTextView();p.KeyMode.call(this,e);this.editor=c;this.undoStack=b;this.contentAssist=a;this.linkedModeModel=null;e.setAction("linkedModeEnter",function(){this.exitLinkedMode(!0);return!0}.bind(this));e.setAction("linkedModeCancel",function(){this.exitLinkedMode(!1);
...
(this.endUndo(),this.startUndo()):this.startUndo();d.selectedGroupIndex=g.group;var h=0,j=a.text.length-(e-c);f=f.positions;var i;c-=g.position.offset;for(var k=e-g.position.offset,m=0;m<f.length;++m)if(i=f[m],e=i.position,i.oldOffset=e.offset,i.model===d&&i.group===g.group?(e.offset+=h,e.length+=j,h+=j):(e.offset+=h,i.ansestor&&(e.length+=g.count*j)),i.escape)i.model.escapePosition=e.offset;this.ignoreVerify=!0;for(m=f.length-1;m>=0;m--)i=f[m],i.model===d&&i.group===g.group&&b.setText(a.text,i.oldOffset+
...
e.getSelection();return b.start===b.end&&(b=e.getCaretOffset(),a.offset<=b&&b<=a.offset+a.length)?e.getText(a.offset,b):""},b.offset=a.offset,b.deactivate(),b.activate();else if(this._groupContentAssistProvider)this._groupContentAssistProvider=null,b.deactivate()}this._updateAnnotations()},_getModelPositions:function(c,b,a){for(var e=b.groups,d=0;d<e.length;d++)for(var f=e[d].positions,h=0;h<f.length;h++){var j=f[h];a&&(j={offset:j.offset+a,length:j.length});j={index:h,group:d,count:f.length,model:b,
position:j};c.push(j);if(b.nextModel&&b.nextModel.parentGroup===d)j.ansestor=!0,this._getModelPositions(c,b.nextModel,(a||0)+f[h].offset-f[0].offset)}},_getSortedPositions:function(c){var b=this._sortedPositions;if(!b){for(b=[];c.previousModel;)c=c.previousModel;for(this._getModelPositions(b,c);c;)c.escapePosition!==void 0&&b.push({escape:!0,model:c,position:{offset:c.escapePosition,length:0}}),c=c.nextModel;b.sort(function(a,b){return a.position.offset-b.position.offset});this._sortedPositions=b}return b},
...
this.linkedModeModel)for(var c=c||this._getSortedPositions(d),j=0;j<c.length;j++)if(f=c[j],f.model===d){var k=h.AnnotationType.ANNOTATION_LINKED_GROUP;f.group===d.selectedGroupIndex&&(k=f.index===0?h.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:h.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP);f=f.position;f=h.AnnotationType.createAnnotation(k,f.offset,f.offset+f.length,"");e.push(f)}b.replaceAnnotations(a,e)}}});j.LinkedMode=f;return j});
define("orion/editor/factories","orion/editor/actions,orion/editor/undoStack,orion/editor/rulers,orion/editor/annotations,orion/editor/textDND,orion/editor/linkedMode".split(","),function(k,m,p,h,c,d){function f(){}function j(){}function g(){}function b(){}function a(){}function e(){}var l={};f.prototype={createKeyBindings:function(a,b,c,e){var e=new k.TextActions(a,b,e),f=new d.LinkedMode(a,b,c),a=new k.SourceCodeActions(a,b,c,f);return{textActions:e,linkedMode:f,sourceCodeActions:a}}};l.KeyBindingsFactory=
f;j.prototype={createUndoStack:function(a){a=a.getTextView();return new m.UndoStack(a,200)}};l.UndoFactory=j;g.prototype={createLineNumberRuler:function(a){return new p.LineNumberRuler(a,"left",{styleClass:"ruler lines"},{styleClass:"rulerLines odd"},{styleClass:"rulerLines even"})}};l.LineNumberRulerFactory=g;b.prototype={createFoldingRuler:function(a){return new p.FoldingRuler(a,"left",{styleClass:"ruler folding"})}};l.FoldingRulerFactory=b;a.prototype={createAnnotationModel:function(a){return new h.AnnotationModel(a)},
createAnnotationStyler:function(a,b){return new h.AnnotationStyler(a,b)},createAnnotationRulers:function(a){var b=new p.AnnotationRuler(a,"left",{styleClass:"ruler annotations"}),a=new p.OverviewRuler(a,"right",{styleClass:"ruler overview"});return{annotationRuler:b,overviewRuler:a}}};l.AnnotationFactory=a;e.prototype={createTextDND:function(a,b){return new c.TextDND(a.getTextView(),b)}};l.TextDNDFactory=e;return l});
define("orion/editor/editorFeatures",["orion/editor/factories","orion/editor/actions","orion/editor/linkedMode","orion/objects"],function(k,m,p,h){return h.mixin({},k,m,p)});
(function(k,m){typeof define==="function"&&define.amd?define("orion/Deferred",m):typeof exports==="object"?module.exports=m():(k.orion=k.orion||{},k.orion.Deferred=m())})(this,function(){function k(){for(var f;f=c.shift();)f();d=!1}function m(f){c.push(f);d||(d=!0,setTimeout(k,0))}function p(c){return function(){c.apply(void 0,arguments)}}function h(){function d(){for(var b;b=l.shift();){var f=b.deferred,g=e==="fulfilled"?"resolve":"reject";if(typeof b[g]==="function")try{var h=(0,b[g])(a),j=h&&(typeof h===
"object"||typeof h==="function")&&h.then;if(typeof j==="function")if(h===f.promise)f.reject(new TypeError);else{var k=h.cancel;typeof k==="function"?f._protected(c).parentCancel=k.bind(h):delete f._protected(c).parentCancel;j.call(h,p(f.resolve),p(f.reject),p(f.progress))}else f.resolve(h)}catch(i){f.reject(i)}else f[g](a)}}function j(b){delete r.parentCancel;e="rejected";a=b;l.length&&m(d)}function g(b){function c(a){return function(b){t||(t=!0,a(b))}}var t=!1;delete r.parentCancel;try{var v=b&&
(typeof b==="object"||typeof b==="function")&&b.then;if(typeof v==="function")if(b===k)j(new TypeError);else{e="assumed";var s=b&&b.cancel;if(typeof s!=="function"){var u=new h,b=u.promise;try{v(u.resolve,u.reject,u.progress)}catch(i){u.reject(i)}s=b.cancel;v=b.then}a=b;v.call(b,c(g),c(j));r.parentCancel=s.bind(b)}else e="fulfilled",a=b,l.length&&m(d)}catch(w){c(j)(w)}}function b(){var a=r.parentCancel;if(a)delete r.parentCancel,a();else if(!e)a=Error("Cancel"),a.name="Cancel",j(a)}var a,e,l=[],k=
this,r={};Object.defineProperty(this,"_protected",{value:function(a){if(a!==c)throw Error("protected");return r}});this.resolve=function(a){e||g(a);return k};this.reject=function(a){e||j(a);return k};this.progress=function(a){e||l.forEach(function(b){if(b.progress)try{b.progress(a)}catch(c){}});return k.promise};this.cancel=function(){r.parentCancel?setTimeout(b,0):b();return k};this.then=function(a,b,g){a={resolve:a,reject:b,progress:g,deferred:new h};l.push(a);a.deferred._protected(c).parentCancel=
k.promise.cancel.bind(k);(e==="fulfilled"||e==="rejected")&&m(d);return a.deferred.promise};this.promise={then:k.then,cancel:k.cancel}}var c=[],d=!1;h.all=function(c,d){function g(b,c){l||(e[b]=c,--a===0&&k.resolve(e))}function b(a,b){if(!l){if(d)try{g(a,d(b));return}catch(c){b=c}k.reject(b)}}var a=c.length,e=[],l=!1,k=new h;k.then(void 0,function(){l=!0;c.forEach(function(a){a.cancel&&a.cancel()})});a===0?k.resolve(e):c.forEach(function(a,c){a.then(g.bind(void 0,c),b.bind(void 0,c))});return k.promise};
h.when=function(c,d,g,b){var a;if(!(c&&typeof c.then==="function"))a=new h,a.resolve(c),c=a.promise;return c.then(d,g,b)};return h});
define("orion/webui/littlelib",["orion/util"],function(k){function m(c,b){b||(b=document);return b.querySelectorAll(c)}function p(c){var b=c.tabIndex;b===0&&k.isIE&&!{a:!0,body:!0,button:!0,frame:!0,iframe:!0,img:!0,input:!0,isindex:!0,object:!0,select:!0,textarea:!0}[c.nodeName.toLowerCase()]&&!c.attributes.tabIndex&&(b=-1);return b}function h(c){if(p(c)>=0)return c;if(c.hasChildNodes())for(var b=0;b<c.childNodes.length;b++){var a=h(c.childNodes[b]);if(a)return a}return null}function c(d){if(p(d)>=
...
this.widget.createAccessible())}function r(a,b){this.contentAssist=a;this.textView=this.contentAssist.getTextView();this.isShowing=this.textViewListenerAdded=!1;var c=this.textView.getOptions("parent").ownerDocument;this.parentNode=typeof b==="string"?c.getElementById(b):b;if(!this.parentNode){this.parentNode=j.createElement(c,"div");this.parentNode.className="contentassist";var d=c.getElementsByTagName("body")[0];if(d)d.appendChild(this.parentNode);else throw Error("parentNode is required");}this.parentNode.addEventListener("scroll",
this.onScroll.bind(this));var e=this;this.textViewListener={onMouseDown:function(a){(a.event.target||a.event.srcElement).parentElement!==e.parentNode&&e.contentAssist.deactivate()}};this.contentAssist.addEventListener("Deactivating",function(){e.hide()});this.scrollListener=function(){e.isShowing&&e.position()};f.addEventListener(c,"scroll",this.scrollListener)}b=1;a=2;e=3;var o={selected:"selected",hr:"proposal-hr",emphasis:"proposal-emphasis",noemphasis:"proposal-noemphasis",noemphasis_keyword:"proposal-noemphasis-keyword",
noemphasis_title:"proposal-noemphasis-title",noemphasis_title_keywords:"proposal-noemphasis-title-keywords",dfault:"proposal-default"};l.prototype={apply:function(a){if(!a)return!1;var c=this.textView,d=c.getSelection(),e=this._initialCaretOffset,f=e,i=d=Math.max(d.start,d.end),g=c.getModel();g.getBaseModel&&(f=g.mapOffset(f),i=g.mapOffset(i),g=g.getBaseModel());a.overwrite&&(e=this.getPrefixStart(g,f));f={proposal:a,start:f,end:i};this.setState(b);c.setText(typeof a==="string"?a:a.proposal,e,d);
...
(console.log("Error retrieving content assist proposals"),console.log(a&&a.stack))},_computeProposals:function(a){var b=this._providerInfoArray,e=this.textView,f=e.getSelection(),g=e.getModel(),i=a;if(g.getBaseModel)i=g.mapOffset(i),f.start=g.mapOffset(f.start),f.end=g.mapOffset(f.end),g=g.getBaseModel();for(var a=g.getLine(g.getLineAtOffset(i)),h=0;h<a.length&&/\s/.test(a.charAt(h));)h++;var h=a.substring(0,h),e=e.getOptions("tabSize","expandTab"),e=e.expandTab?Array(e.tabSize+1).join(" "):"\t",
j={line:a,offset:i,prefix:g.getText(this.getPrefixStart(g,i),i),selection:f,delimiter:g.getLineDelimiter(),tab:e,indentation:h},l=this,b=b.map(function(a){var a=a.provider,b;try{var e,f;if(e=a.computeContentAssist){var h=l.editorContextProvider,k=h.getEditorContext();j=d.mixin(j,h.getOptions());f=e.apply(a,[k,j])}else if(e=a.getProposals||a.computeProposals)f=e.apply(a,[g.getText(),i,j]);b=l.progress?l.progress.progress(f,"Generating content assist proposal"):f}catch(n){l.handleError(n)}return c.when(b)});
...
this._updateAutoTriggerListenerState()},resetProviderInfoArray:function(){this._providerInfoArray=[];this._charTriggersInstalled=!1;this._updateAutoTriggerListenerState()},setProgress:function(a){this.progress=a},setStyleAccessor:function(a){this._styleAccessor=a},_flatten:function(a){return a.reduce(function(a,b){var c=a;if(Array.isArray(b)&&b.length>0){var c=b,d=a;b[0].style&&0===o[b[0].style].indexOf(o.noemphasis)&&(c=a,d=b);c.length>0&&c[c.length-1].style&&o.hr!==o[c[c.length-1].style]&&(c=c.concat({proposal:"",
...
return this.lineDown(a,!0)}else return this.lineDown()},enter:function(){return this.contentAssist.apply(this.proposals[this.selectedIndex]||null)},tab:function(){return this.widget?(this.widget.parentNode.focus(),!0):!1}});r.prototype={onClick:function(a){if(!a)a=window.event;this.contentAssist.apply(this.getProposal(a.target||a.srcElement));this.textView.focus()},onScroll:function(){this.previousCloneNode&&!this.preserveCloneThroughScroll&&(this._removeCloneNode(),this.previousSelectedNode.classList.add(o.selected));
this.preserveCloneThroughScroll=!1},createDiv:function(a,b,c){var d=b.ownerDocument,e=j.createElement(d,"div");e.id="contentoption"+c;e.setAttribute("role","option");e.className=o[a.style]?o[a.style]:o.dfault;a.style==="hr"?a=j.createElement(d,"hr"):(a=this._createDisplayNode(e,a,c),e.contentAssistProposalIndex=c);e.appendChild(a);b.appendChild(e)},createAccessible:function(){var a=this._contentAssistMode,b=this;this.parentNode.addEventListener("keydown",function(c){if(!c)c=window.event;c.preventDefault&&
...
this.parentNode);var f=function(a){a.contentAssistProposalIndex=b.contentAssistProposalIndex;if(a.hasChildNodes())for(var c=0;c<a.childNodes.length;c++)f(a.childNodes[c])};f(a);b.classList.remove(o.selected);this.previousCloneNode=a}}this.previousSelectedNode=b},setContentAssistMode:function(a){this._contentAssistMode=a},show:function(){var a=this._contentAssistMode.getProposals();if(a.length===0)this.hide();else{this.parentNode.innerHTML="";for(var b=0;b<a.length;b++)this.createDiv(a[b],this.parentNode,
...
this.previousCloneNode=null}};return{ContentAssist:l,ContentAssistMode:q,ContentAssistWidget:r}});
...
define("orion/editor/cssContentAssist",["orion/editor/templates","orion/editor/stylers/text_css/syntax"],function(k,m){function p(a){return JSON.stringify(a).replace("}","\\}")}function h(){}for(var c={type:"link",values:"visible,hidden,scroll,auto,no-display,no-content".split(",")},d={type:"link",values:"solid,dashed,dotted,double,groove,ridge,inset,outset".split(",")},f={type:"link",values:[]},j=0;j<10;j++)f.values.push(j.toString());for(var g={type:"link",values:"black,white,red,green,blue,magenta,yellow,cyan,grey,darkred,darkgreen,darkblue,darkmagenta,darkcyan,darkyellow,darkgray,lightgray".split(",")},
...
0;j<a.length;j++)c=a[j],b.push({prefix:c,description:c+" - "+c+" style",template:c+": ${width:"+p(f)+"}px ${style:"+p(d)+"} ${color:"+p(g)+"};"});h.prototype=new k.TemplateContentAssist(m.keywords,b);h.prototype.getPrefix=function(a,b){for(var c=b;c&&/[A-Za-z\-\@]/.test(a.charAt(c-1));)c--;return c?a.substring(c,b):""};return{CssContentAssistProvider:h}});
define("orion/editor/htmlContentAssist",["orion/editor/templates"],function(k){function m(){}var p=new k.Template("","Simple HTML document",'<!DOCTYPE html>\n<html lang="en">\n\t<head>\n\t\t<meta charset=utf-8>\n\t\t<title>${title}</title>\n\t</head>\n\t<body>\n\t\t<h1>${header}</h1>\n\t\t<p>\n\t\t\t${cursor}\n\t\t</p>\n\t</body>\n</html>'),h=[{prefix:"<img",name:"<img>",description:" - HTML image element",template:'<img src="${cursor}" alt="${Image}"/>'},{prefix:"<a",name:"<a>",description:" - HTML anchor element",
...
{prefix:"<\!--",name:"<\!-- --\>",description:" - HTML comment",template:"<\!-- ${cursor} --\>"}],c,d,f,j,g="abbr,b,button,canvas,cite,command,dd,del,dfn,dt,em,embed,font,h1,h2,h3,h4,h5,h6,i,ins,kbd,label,li,mark,meter,object,option,output,progress,q,rp,rt,samp,small,strong,sub,sup,td,time,title,tt,u,var".split(",");for(j=0;j<g.length;j++)c=g[j],f="<"+c+"></"+c+">",d="<"+c+">${cursor}</"+c+">",h.push({prefix:"<"+c,description:f,template:d});g="address,article,aside,audio,bdo,blockquote,body,caption,code,colgroup,datalist,details,div,fieldset,figure,footer,form,head,header,hgroup,iframe,legend,map,menu,nav,noframes,noscript,optgroup,p,pre,ruby,script,section,select,span,style,tbody,textarea,tfoot,th,thead,tr,video".split(",");
for(j=0;j<g.length;j++)c=g[j],f="<"+c+"></"+c+">",d="<"+c+">\n\t${cursor}\n</"+c+">",h.push({prefix:"<"+c,description:f,template:d});g="area,base,br,col,hr,input,link,meta,param,keygen,source".split(",");for(j=0;j<g.length;j++)c=g[j],d=f="<"+c+"/>",h.push({prefix:"<"+c,description:f,template:d});m.prototype=new k.TemplateContentAssist([],h);m.prototype.getPrefix=function(b,a){for(var c="",d=a;d&&/[A-Za-z0-9<!-]/.test(b.charAt(d-1));)if(d--,b.charAt(d)==="<"){c=b.substring(d,a);break}return c};m.prototype.computeProposals=
...
define("orion/editor/jsTemplateContentAssist",["orion/editor/templates","orion/editor/stylers/application_javascript/syntax"],function(k,m){function p(){}var h=[{prefix:"if",name:"if",description:" - if statement",template:"if (${condition}) {\n\t${cursor}\n}"},{prefix:"if",name:"if",description:" - if else statement",template:"if (${condition}) {\n\t${cursor}\n} else {\n\t\n}"},{prefix:"for",name:"for",description:" - iterate over array",template:"for (var ${i}=0; ${i}<${array}.length; ${i}++) {\n\t${cursor}\n}"},
...
description:" - create a new AMQP connection exchange",template:"var exchange = ${connection}.exchange(${id}, {type: 'topic'}, function(exchange) {\n\t${cursor}\n});\n"}];p.prototype=new k.TemplateContentAssist(m.keywords,h);p.prototype.isValid=function(c,d,f){c=d.charAt(f-c.length-1);return!c||":!@#$^&*.?<>".indexOf(c)===-1};return{JSTemplateContentAssistProvider:p}});
...
onStyleReady:function(c){var d=c.lineStyles||c.style,c=Number.MAX_VALUE,g=-1,b=this.textView.getModel(),a;for(a in d)Object.prototype.hasOwnProperty.call(d,a)&&(this.lineStyles[a]=d[a],c=Math.min(c,a),g=Math.max(g,a));c=Math.max(c,0);g=Math.min(g,b.getLineCount());if(d=this.annotationModel){for(var e=d.getAnnotations(b.getLineStart(c),b.getLineEnd(g)),h=[];e.hasNext();){var k=e.next();k.type==="orion.annotation.highlightError"&&h.push(k)}e=[];for(k=c;k<=g;k++){a=k;var r=this.lineStyles[a],r=r&&r.errors;
a=b.getLineStart(a);if(r)for(var o=0;o<r.length;o++){var n=r[o];e.push(m.AnnotationType.createAnnotation("orion.annotation.highlightError",n.start+a,n.end+a))}}d.replaceAnnotations(h,e)}this.textView.redrawLines(c,g+1)},onLineStyle:function(c){function d(b,a){for(var c=b.length,f=[],g=0;g<c;g++){var h=b[g];f.push({start:h.start+a,end:h.end+a,style:h.style})}return f}var g=this.lineStyles[c.lineIndex];if(g)if(g.ranges)c.ranges=d(g.ranges,c.lineStart);else if(g.style)c.style=g.style},_getEmptyStyle:function(c){for(var d=
...
"undefined"&&console.log(Error(d))},removeServiceListener:function(c){typeof c.removeEventListener==="function"?(c.removeEventListener("orion.edit.highlighter.styleReady",this.listener.onStyleReady),c=this.services.indexOf(c),c!==-1&&this.services.splice(c,1)):typeof console!=="undefined"&&console.log(Error(d))}};return h});
define("orion/editor/mirror",["i18n!orion/editor/nls/messages","orion/editor/eventTarget","orion/editor/annotations"],function(k,m,p){function h(b){this.string=b;this.tokenStart=this.pos=0}function c(){return{token:function(b){return b.skipToEnd()}}}function d(){this._modes={};this.mimeModes={};this.options={};this.StringStream=h;this.defineMode("null",c);this.defineMIME("text/plain","null")}function f(b){var a=[],c;for(c in b)Object.prototype.hasOwnProperty.call(b,c)&&a.push(c);return a}function j(b,
a,c){c=c||{};this.model=b;this.codeMirror=a;this.isWhitespaceVisible=typeof c.whitespacesVisible==="undefined"?!1:c.whitespacesVisible;this.mode=null;this.isModeLoaded=!1;this.lines=[];this.dirtyLines=[];this.startLine=Number.MAX_VALUE;this.endLine=-1;this.timer=null;this.initialize(b)}function g(b,a,c){this.init(b,a,c)}h.prototype={eol:function(){return this.pos>=this.string.length},sol:function(){return this.pos===0},peek:function(){return this.string[this.pos]},next:function(){return this.string[this.pos++]},
...
this.viewportIndex,f=this.lines[d],d=f&&!f.eolState?d:this.dirtyLines.pop();if(d>=c)break;this._expandRange(d,d);for(var f=this._getResumeLineIndex(d),d=f+1,f=(f=f>=0&&this.lines[f].eolState)?this.codeMirror.copyState(this.mode,f):this.mode.startState(),g=0,h=d;h<c;h++){var j=this.lines[h],k=j.eolState,m=this.highlightLine(h,j,f);j.eolState=this.codeMirror.copyState(this.mode,f);m&&this._expandRange(d,h+1);var j=a&&k&&a(k,j.eolState),s=!a&&!m&&g++>3;if(j||s)break;else if(!k||m)g=0;k=h<c||this.dirtyLines.length;
...
h=[],g=0;g<c.length;g++){var b=c[g],a=/\\(\d+)/.exec(b);a?(b=d[a[1]]||"",h.push(f?k.escape(b):b)):h.push(b)}return RegExp(h.join(""))},groupify:function(c,d){for(var f=c.source,h=f.length,g=[],b=0,a=[],e=1,l=1,k=[],m={},o={},n=0;n<h;n++){var p=g[g.length-1],v=f.charAt(n);switch(v){case "(":if(p===4)g.pop(),k.push(")"),a[a.length-1].end=n;var s=n+2<h?f.charAt(n+1)+""+f.charAt(n+2):null;if(s==="?:"||s==="?="||s==="?!"){var u;s==="?:"?u=1:(u=3,b++);g.push(u);a.push({start:n,end:-1,type:u});k.push(v);
k.push(s);n+=s.length}else g.push(2),a.push({start:n,end:-1,type:2,oldNum:e,num:l}),k.push(v),b===0&&(o[l]=null),m[e]=l,e++,l++;break;case ")":p=g.pop();p===3&&b--;a[a.length-1].end=n;k.push(v);break;case "*":case "+":case "?":case "}":var i=v,w=f.charAt(n-1),s=n-1;if(v==="}"){for(u=n-1;f.charAt(u)!=="{"&&u>=0;u--);w=f.charAt(u-1);s=u-1;i=f.substring(u,n+1)}u=a[a.length-1];if(w===")"&&(u.type===2||u.type===4)){k.splice(u.start,0,"(");k.push(i);k.push(")");v={start:u.start,end:k.length-1,type:4,num:u.num};
for(w=0;w<a.length;w++)if(p=a[w],(p.type===2||p.type===4)&&p.start>=u.start&&p.end<=s)if(p.start+=1,p.end+=1,p.num+=1,p.type===2)m[p.oldNum]=p.num;a.push(v);l++;break}default:v!=="|"&&p!==2&&p!==4&&b===0&&(g.push(4),a.push({start:n,end:-1,type:4,num:l}),k.push("("),o[l]=null,l++),k.push(v),v==="\\"&&(v=f.charAt(n+1),k.push(v),n+=1)}}for(;g.length;)g.pop(),k.push(")");var f=RegExp(k.join("")),h={},d=d||m,x;for(x in d)d.hasOwnProperty(x)&&(h[x]="\\"+d[x]);f=this.getSubstitutedRegex(f,h,!1);return[f,
m,o]},complexCaptures:function(c){if(!c)return!1;for(var d in c)if(c.hasOwnProperty(d)&&d!=="0")return!0;return!1}};p.prototype={initialize:function(c){this.textView=c;this.textView.stylerOptions=this;var d=this;this._listener={onModelChanged:function(c){d.onModelChanged(c)},onDestroy:function(c){d.onDestroy(c)},onLineStyle:function(c){d.onLineStyle(c)},onStorage:function(c){d.onStorage(c)}};c.addEventListener("ModelChanged",this._listener.onModelChanged);c.addEventListener("Destroy",this._listener.onDestroy);
...
g);for(var b=0;b<g.children.length;b++)f.push(g.children[b])}}return h||this._tree},isDamaged:function(c,d,f){return c.start<=f&&c.end>d},parse:function(c,d,f,h,g,b){var a=this.textView.getModel(),e=a.getLineStart(a.getLineCount()-1),l=a.getCharCount(),k=this.getInitialExpected(c,f),m=-1;if(d)c.repaired=!0,c.endNeedsUpdate=!0,m=(m=c.children[c.children.length-1])?a.getLineEnd(a.getLineAtOffset(m.end+(g-b))):-1,h=a.getLineEnd(a.getLineAtOffset(h+b)),m=Math.max(m,h);for(var m=m===-1?l:m,h=k,o=c,n=!1,
p=f,v=-1;o&&(!d||p<m);){var s=this.getNextMatch(a,o,p);s||(p=p>=e?l:a.getLineStart(a.getLineAtOffset(p)+1));var u=s&&s.match,i=s&&s.rule,w=s&&s.isEnd;if(s&&s.isSub){if(p=this.afterMatch(u),i instanceof this.BeginEndRule)n=!0,d&&i===h.rule&&o===h.parent?(o=h,o.setStart(u),o.repaired=!0,o.endNeedsUpdate=!0,h=this.getNextExpected(h,"begin")):(d&&(this.prune(o,h),d=!1),u=new this.BeginEndNode(o,i,u),o.addChild(u),o=u)}else if(w||p===l){if(o instanceof this.BeginEndNode)u?(n=!0,v=Math.max(v,o.end),o.setEnd(u),
p=this.afterMatch(u),d&&o===h&&o.parent===h.parent?(o.repaired=!0,delete o.endNeedsUpdate,h=this.getNextExpected(h,"end")):d&&(this.prune(o,h),d=!1)):(o.setEnd(l),delete o.endNeedsUpdate);o=o.parent}d&&p>=m&&!n&&(this.prune(c,k),d=!1)}this.removeUnrepairedChildren(c,d,f);this.cleanup(d,c,f,m,l,g,b);return d?Math.max(v,p):p},removeUnrepairedChildren:function(c,d,f){if(d){for(var d=c.children,h=-1,g=0;g<d.length;g++){var b=d[g];if(!b.repaired&&this.isDamaged(b,f,Number.MAX_VALUE)){h=g;break}}if(h!==
...
b=c.getText(f,g),a=[],e=[],c=[],g=[];for(this.push(a,d.rule.subrules);a.length;){var l=a.length?a.pop():null,l=l&&l._resolvedRule._typedRule;if(l instanceof this.ContainerRule&&e.indexOf(l)===-1)e.push(l),this.push(a,l.subrules);else if(!l||!h||l.matchRegex){var k=l&&this.exec(l.matchRegex||l.beginRegex,b,f);k&&(c.push(k),g.push(l))}}a=Number.MAX_VALUE;e=-1;for(l=0;l<c.length;l++)if(k=c[l],k.index<a)a=k.index,e=l;if(!h&&(f=this.getEndMatch(d,b,f)))if(h=d.rule.applyEndPatternLast,e===-1||f.index<a||
...
g,d,h);c.ranges=this.toStyleRanges(d);c.ranges.sort(function(b,a){return b.start-a.start})},getLineScope:function(c,d,f,h){for(var g=f,b=this.getInitialExpected(d,f),a=[],e=[];d&&g<h;){var l=this.getNextMatch(c,d,g);if(!l)break;var k=l&&l.match,m=l&&l.rule,o=l&&l.isSub,l=l&&l.isEnd;k.index!==g&&e.push({start:g,end:k.index,node:d});if(o)g=this.afterMatch(k),m instanceof this.BeginEndRule?(this.addBeginScope(a,k,m),d=b,b=this.getNextExpected(b,"begin")):this.addMatchScope(a,k,m);else if(l)g=this.afterMatch(k),
...
new p({start:0,contentStart:0,end:d,contentEnd:d},null,this,c);this._computeFolding(this._rootBlock.getBlocks());b&&this.detectTasks&&(d=[],v(this._rootBlock,c,d),b.replaceAnnotations([],d));a.redrawLines()}var d={styleClass:"meta annotation currentLine"},f=/$/,j=/\\(\d)/g,g=/(.*)(?:[\r\n]|$)/g,b={regex:/ /g,style:{styleClass:"punctuation separator space",unmergeable:!0}},a={regex:/\t/g,style:{styleClass:"punctuation separator tab",unmergeable:!0}},e=function(a,b,c,d){var e=c,f=a.lastIndex;g.lastIndex=
c;var c=g.exec(b),h,j;a.lastIndex=0;if(c){for(j=c.index;0<=--j;)if(h=b.charAt(j),h==="\n"||h==="\r")break;h=b.substring(j+1,c.index+c[1].length);a.lastIndex=j=c.index-j-1}for(;c&&c.index<b.length;){var k;if(d){var l=a.lastIndex;if(a.test(h))a.lastIndex=l,k=a.exec(h)}else k=a.exec(h);if(k)return k.index+=e,k.index-=j,a.lastIndex=f,k;j=0;e+=c[0].length;if(c=g.exec(b))h=c[1],a.lastIndex=0}a.lastIndex=f;return null},l=function(a,b){var c=a.toString();j.lastIndex=0;if(!j.test(c))return a;j.lastIndex=0;
...
a)return d}return null},_getPatternManager:function(){return this.patternManager},_getStyles:function(a,b,c,d){b.getBaseModel&&(d=b.mapOffset(d));for(var f=d+c.length,g=[],h=d,j=a.getBlocks(),k=this._binarySearch(j,d,!0);k<j.length;k++){if(j[k].start>=f)break;var l=j[k].start,m=j[k].end;h<l&&n(c.substring(h-d,l-d),h,a,g);var o=Math.max(h,l);if(o===l&&j[k].pattern.regexBegin){var p=e(j[k].pattern.regexBegin,c.substring(o-d),0);if(p){var q=j[k].pattern.pattern.beginCaptures||j[k].pattern.pattern.captures;
q?r(p,q,o,g):g.push({start:o,end:o+p[0].length,style:j[k].pattern.pattern.name});o+=p[0].length}}var l=Math.min(f,m),t=[];if(l===m&&j[k].pattern.regexEnd&&(h=c.substring(l-h-(j[k].end-j[k].contentEnd)),p=e(j[k].pattern.regexEnd,h,0)))(q=j[k].pattern.pattern.endCaptures||j[k].pattern.pattern.captures)?r(p,q,l-p[0].length,t):j[k].pattern.pattern.name&&t.push({start:l-p[0].length,end:l,style:j[k].pattern.pattern.name}),l-=p[0].length;var h=this._getStyles(j[k],b,c.substring(o-d,l-d),o),v=j[k].pattern.pattern.contentName||
j[k].pattern.pattern.name;if(v){var H=o;h.forEach(function(a){a.start-H&&g.push({start:H,end:a.start,style:v});g.push(a);H=a.end});l-H&&g.push({start:H,end:l,style:v})}else g=g.concat(h);g=g.concat(t);h=m}h<f&&n(c.substring(h-d,f-d),h,a,g);if(b.getBaseModel)for(a=0;a<g.length;a++)c=g[a].end-g[a].start,g[a].start=b.mapOffset(g[a].start,!0),g[a].end=g[a].start+c;return g},_isRenderingWhitespace:function(){return this.whitespacesVisible&&(this.tabsVisible||this.spacesVisible)},_onDestroy:function(){this.destroy()},
...
(n=j,p=g),l=f.getText(o,p),l=t(f,l,this._rootBlock,o);while(l.length&&h.length&&n<j&&l[l.length-1].pattern.pattern.id!==h[n-1].pattern.pattern.id);for(g=m;g<h.length;g++)j=h[g],j.start>b&&j.adjustStart(a),j.start>b&&j.adjustEnd(a);var q=n-m!==l.length;if(!q)for(g=0;g<l.length;g++){var j=h[m+g],r=l[g];if(j.start!==r.start||j.end!==r.end||j.type!==r.type){q=!0;break}}g=[m,n-m].concat(l);Array.prototype.splice.apply(h,g);q&&(g=o,j=p,e!==f&&(g=e.mapOffset(g,!0),j=e.mapOffset(j,!0)),d.redrawRange(g,j));
...
define("orion/editor/stylers/text_html/syntax",["orion/editor/stylers/lib/syntax","orion/editor/stylers/application_javascript/syntax","orion/editor/stylers/text_css/syntax","orion/editor/stylers/text_x-php/syntax","orion/editor/stylers/application_xml/syntax"],function(k,m,p,h,c){k=k.grammars.concat(m.grammars).concat(p.grammars).concat(h.grammars).concat(c.grammars);k.push({id:"orion.html",contentTypes:["text/html"],patterns:[{include:"orion.xml"},{begin:"(?i)(<style)([^>]*)(>)",end:"(?i)(</style>)",
...
if(h){d=d.nodeValue;if(d==="true"||d==="false")d=d==="true";c[h]=d}}return c}function R(a,b){if(a.getElementsByClassName)return a.getElementsByClassName(b);b=b.replace(/ *$/,"");return a.querySelectorAll?a.querySelectorAll((" "+b).replace(/ +/g,".")):null}function A(a){var b=a.document||document,e=a.parent;e||(e="editor");typeof e==="string"&&(e=b.getElementById(e));if(!e&&a.className&&(b=R(b,a.className))){a.className=void 0;if(b.length>1&&a.noFocus===void 0)a.noFocus=!0;for(var f=[],g=b.length-
1;g>=0;g--)a.parent=b[g],f.push(A(a));return f}if(!e)throw"no parent";a=Q(e,a);if(typeof a.theme==="string"){var b=c.TextTheme.getTheme(a.theme),g=a.theme.lastIndexOf("/"),i=a.theme;g!==-1&&(i=i.substring(g+1));i.substring(i.length-4)===".css"&&(i=i.substring(0,i.length-4));b.setThemeClass(i,{href:a.theme});a.theme=b}var j;a.readonly||(f={createContentAssistMode:function(a){j=new o.ContentAssist(a.getTextView());a=new o.ContentAssistWidget(j);a=new o.ContentAssistMode(j,a);j.setMode(a);return a}});
var l=new q.Editor({textViewFactory:function(){return new p.TextView({parent:e,model:new d.ProjectionTextModel(a.model?a.model:new h.TextModel("")),tabSize:a.tabSize?a.tabSize:4,readonly:a.readonly,fullSelection:a.fullSelection,tabMode:a.tabMode,expandTab:a.expandTab,singleMode:a.singleMode,themeClass:a.themeClass,theme:a.theme,wrapMode:a.wrapMode,wrappable:a.wrappable})},undoStackFactory:new r.UndoFactory,annotationFactory:new r.AnnotationFactory,lineNumberRulerFactory:new r.LineNumberRulerFactory,
foldingRulerFactory:new r.FoldingRulerFactory,textDNDFactory:new r.TextDNDFactory,contentAssistFactory:f,keyBindingFactory:new r.KeyBindingsFactory,statusReporter:a.statusReporter,domNode:e});l.addEventListener("TextViewInstalled",function(){var b=l.getLineNumberRuler();b&&a.firstLineIndex!==void 0&&b.setFirstLine(a.firstLineIndex);if(b=l.getSourceCodeActions())b.setAutoPairParentheses(a.autoPairParentheses),b.setAutoPairBraces(a.autoPairBraces),b.setAutoPairSquareBrackets(a.autoPairSquareBrackets),
