...
d[m]+"animation-name: "+a+";\n";return b+(z+"}")}d="_"+d+"DOMReady";a.className=a.className?a.className+" "+d:d;a.__DOMReady=b;b=d+"Style";if(!q.getElementById(b)){var e=d+"Animation";q.addEventListener("animationstart",m,!1);q.addEventListener("MSAnimationStart",m,!1);q.addEventListener("webkitAnimationStart",m,!1);a=q.createElement("style");a.id=b;b=q.getElementsByTagName("head")[0]||q.documentElement;a.appendChild(q.createTextNode(l(d,e)));b.insertBefore(a,b.firstChild)}}function u(q,a,d){this.start=
q;this.end=a;this.caret=d}function v(q){this.left=q.left;this.top=q.top;this.right=q.right;this.bottom=q.bottom}function A(q,a,d){this.view=q;this.lineIndex=a;this._lineDiv=d}function w(q){this._init(q||{})}var y=h.addEventListener,x=h.removeEventListener,D=h.Animation;u.prototype={clone:function(){return new u(this.start,this.end,this.caret)},collapse:function(){this.caret?this.end=this.start:this.start=this.end},extend:function(q){this.caret?this.start=q:this.end=q;this.start>this.end&&(q=this.start,
this.start=this.end,this.end=q,this.caret=!this.caret)},setCaret:function(q){this.end=this.start=q;this.caret=!1},getCaret:function(){return this.caret?this.start:this.end},toString:function(){return"start\x3d"+this.start+" end\x3d"+this.end+(this.caret?" caret is at start":" caret is at end")},isEmpty:function(){return this.start===this.end},equals:function(q){return this.caret===q.caret&&this.start===q.start&&this.end===q.end}};v.prototype={toString:function(){return"{l\x3d"+this.left+", t\x3d"+
this.top+", r\x3d"+this.right+", b\x3d"+this.bottom+"}"}};A.prototype={create:function(q,a){if(!this._lineDiv){var d=this._lineDiv=this._createLine(q,a,this.lineIndex);d._line=this;return d}},_createLine:function(q,d,b){var m=this.view,l=m._model,e=l.getLine(b),t=l.getLineStart(b),f={type:"LineStyle",textView:m,lineIndex:b,lineText:e,lineStart:t};m.onLineStyle(f);var u=q.ownerDocument,l=d||g.createElement(u,"div");if(!d||!a(d.viewStyle,f.style))p(f.style,l,d),d&&(d._trim=null),l.viewStyle=f.style,
l.setAttribute("role","presentation");l.lineIndex=b;if(d&&l.viewLineText===e&&a(f.ranges,l.viewRanges))return l;l.viewRanges=f.ranges;l.viewLineText=e;b=[];this._createRanges(f.ranges,e,0,e.length,t,{tabOffset:0,ranges:b});f=" ";!m._fullSelection&&9>g.isIE&&(f="\ufeff");m={text:f,style:m._metrics.largestFontStyle,ignoreChars:1};0===b.length||!b[b.length-1].style||"div"!==b[b.length-1].style.tagName?b.push(m):b.splice(b.length-1,0,m);var h,v,k,A=f=0;if(g.isFirefox&&2E3<e.length){d&&(l.innerHTML="",
d.lineWidth=void 0);d=u.createDocumentFragment();for(e=0;e<b.length;e++)m=b[e],t=m.text,h=m.style,h=this._createSpan(l,t,h,m.ignoreChars),d.appendChild(h);l.appendChild(d)}else{var w,n;if(d){if(v=d.modelChangedEvent)0===v.removedLineCount&&0===v.addedLineCount?(n=v.start-t,w=v.addedCharCount-v.removedCharCount):n=-1,d.modelChangedEvent=void 0;v=d.firstChild}for(e=0;e<b.length;e++){m=b[e];t=m.text;f+=t.length;h=m.style;if(v)if(k=v.firstChild.data,u=v.viewStyle,k===t&&a(h,u)){A+=k.length;v._rectsCache=
void 0;h=v=v.nextSibling;continue}else for(;v;){if(-1!==n){u=f;u>=n&&(u-=w);k=(k=v.firstChild.data)?k.length:0;if(A+k>u)break;A+=k}u=v.nextSibling;l.removeChild(v);v=u}h=this._createSpan(l,t,h,m.ignoreChars);v?l.insertBefore(h,v):l.appendChild(h);d&&(d.lineWidth=void 0)}if(d)for(w=h?h.nextSibling:null;w;)u=w.nextSibling,d.removeChild(w),w=u}l.parentNode||q.appendChild(l);return l},_createRanges:function(q,d,b,m,l,e){if(!(b>m)){if(q)for(var t=0;t<q.length;t++){var g=q[t];if(!(g.end<l+b)){var f=Math.max(l+
b,g.start)-l;if(f>m)break;var u=Math.min(l+m,g.end)-l;if(f<=u){f=Math.max(b,f);u=Math.min(m,u);b<f&&this._createRange(d,b,f,null,e);if(!g.style||!g.style.unmergeable)for(;t+1<q.length&&q[t+1].start-l===u&&a(g.style,q[t+1].style);)g=q[t+1],u=Math.min(l+m,g.end)-l,t++;this._createRange(d,f,u,g.style,e);b=u}}}b<m&&this._createRange(d,b,m,null,e)}},_createRange:function(q,a,d,b,m){if(!(a>d)){var l=this.view._customTabSize;if(l&&8!==l)for(var e=q.indexOf("\t",a);-1!==e&&e<d;){a<e&&(a={text:q.substring(a,
e),style:b},m.ranges.push(a),m.tabOffset+=a.text.length);a=l-m.tabOffset%l;if(0<a){for(var t="\u00a0",g=1;g<a;g++)t+=" ";a={text:t,style:b,ignoreChars:a-1};m.ranges.push(a);m.tabOffset+=a.text.length}a=e+1;if(a===d)return;e=q.indexOf("\t",a)}a<=d&&(a={text:q.substring(a,d),style:b},m.ranges.push(a),m.tabOffset+=a.text.length)}},_createSpan:function(q,a,d,b){var m=this.view,l="span";d&&d.tagName&&(l=d.tagName.toLowerCase());var e="a"===l;e&&(this.hasLink=!0);e&&!m._linksVisible&&(l="span");e=q.ownerDocument;
q=g.createElement(q.ownerDocument,l);q.appendChild(e.createTextNode(d&&d.text?d.text:a));d&&d.html?(q.innerHTML=d.html,q.ignore=!0):d&&d.node&&(q.appendChild(d.node),q.ignore=!0);p(d,q);if("a"===l){var t=m._getWindow();y(q,"click",function(q){return m._handleLinkClick(q?q:t.event)},!1)}q.viewStyle=d;b&&(q.ignoreChars=b);return q},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(q,a){var d=this._ensureCreated(),
b=this.view;if(void 0===q)return this._getLineBoundingClientRect(d,!0);var m=b._model,l=d.ownerDocument,e=this.lineIndex,t=null;if(q<m.getLineEnd(e)){var f=m.getLineStart(e);this.forEach(function(a){var m=a.firstChild,z=this._nodeLength(a);if(f+z>q){var e=q-f;if(1===m.length)t=new v(a.getBoundingClientRect());else if(b._isRangeRects)z=l.createRange(),z.setStart(m,e),z.setEnd(m,e+1),t=new v(z.getBoundingClientRect());else if(g.isIE)z=l.body.createTextRange(),z.moveToElementText(a),z.collapse(),(m=
0===e&&8===g.isIE)&&(e=1),z.moveEnd("character",e+1),z.moveStart("character",e),t=new v(z.getBoundingClientRect()),m&&(t.left=a.getClientRects()[0].left);else{var u=m.data;a.removeChild(m);a.appendChild(l.createTextNode(u.substring(0,e)));var h=g.createElement(l,"span");h.appendChild(l.createTextNode(u.substring(e,e+1)));a.appendChild(h);a.appendChild(l.createTextNode(u.substring(e+1)));t=new v(h.getBoundingClientRect());a.innerHTML="";a.appendChild(m);this._createdDiv||(a=b._getSelection(),(f<=a.start&&
a.start<f+z||f<=a.end&&a.end<f+z)&&b._updateDOMSelection())}g.isIE&&(e=d.ownerDocument.defaultView||d.ownerDocument.parentWindow,a=e.screen.logicalXDPI/e.screen.deviceXDPI,e=e.screen.logicalYDPI/e.screen.deviceYDPI,t.left*=a,t.right*=a,t.top*=e,t.bottom*=e);return!1}f+=z;return!0})}m=this.getBoundingClientRect();t||(b._wrapMode?(e=this.getClientRects(),t=e[e.length-1],t.left=t.right,t.left+=m.left,t.top+=m.top,t.right+=m.left,t.bottom+=m.top):(t=new v(m),t.left=t.right));if(a||void 0===a)t.left-=
m.left,t.top-=m.top,t.right-=m.left,t.bottom-=m.top;return t},forEach:function(q){for(var a=this._ensureCreated().firstChild;a;){var d=a.nextSibling;if(!a.ignore&&!q.call(this,a))break;a=d}},_getClientRects:function(q,a){var d,b,m,l;if(!q._rectsCache){d=q.getClientRects();b=Array(d.length);for(l=0;l<d.length;l++)m=b[l]=new v(d[l]),m.left-=a.left,m.top-=a.top,m.right-=a.left,m.bottom-=a.top;q._rectsCache=b}d=q._rectsCache;b=[d.length];for(l=0;l<d.length;l++)b[l]=new v(d[l]);return b},getClientRects:function(q){if(!this.view._wrapMode)return[this.getBoundingClientRect()];
var a=[],d=this._ensureCreated().getBoundingClientRect();this.forEach(function(q){q=this._getClientRects(q,d);for(var b=0;b<q.length;b++){var m=q[b],l,e;if(m.top!==m.bottom){var t=m.top+(m.bottom-m.top)/2;for(l=0;l<a.length&&!(e=a[l],e.top<=t&&t<e.bottom);l++);l===a.length?a.push(m):(m.left<e.left&&(e.left=m.left),m.top<e.top&&(e.top=m.top),m.right>e.right&&(e.right=m.right),m.bottom>e.bottom&&(e.bottom=m.bottom))}}return!0});return void 0!==q?a[q]:a},_getLineBoundingClientRect:function(q,a){var d=
new v(q.getBoundingClientRect());if(!this.view._wrapMode){d.right=d.left;for(var b=q.lastChild;b&&b.ignoreChars===b.firstChild.length;)b=b.previousSibling;b&&(b=b.getBoundingClientRect(),d.right=b.right+t(q).right)}a&&(b=t(q),d.left+=b.left,d.right-=b.right);return d},getLineCount:function(){return!this.view._wrapMode?1:this.getClientRects().length},getLineIndex:function(q){if(!this.view._wrapMode)return 0;var a=this.getClientRects();q=this.getBoundingClientRect(q);q=q.top+(q.bottom-q.top)/2;for(var d=
0;d<a.length;d++)if(a[d].top<=q&&q<a[d].bottom)return d;return a.length-1},getLineStart:function(q){if(!this.view._wrapMode||0===q)return this.view._model.getLineStart(this.lineIndex);var a=this.getClientRects();return this.getOffset(a[q].left+1,a[q].top+1)},_nodeLength:function(q){if(!q||q.ignore)return 0;var a=q.firstChild.length;q.ignoreChars&&(a-=q.ignoreChars);return a},getModelOffset:function(q,a){if(!q)return 0;var d=0;this.forEach(function(b){var m=b.firstChild;if(m===q)return b.ignoreChars&&
(d-=b.ignoreChars),d+=a,!1;b.ignoreChars&&(d-=b.ignoreChars);d+=m.data.length;return!0});return Math.max(0,d)+this.view._model.getLineStart(this.lineIndex)},getNodeOffset:function(q){var a=0,d,b,m=this.view._model,l=m.getLineStart(this.lineIndex),e=q-l,t=m.getLineEnd(this.lineIndex)-l;this.forEach(function(q){var m=q.firstChild,l=this._nodeLength(q);if(l+a>e||a+l>=t)return d=m,b=e-a,q.ignoreChars&&(0<l&&b===l)&&(b+=q.ignoreChars),!1;a+=l;return!0});return{node:d,offset:b}},getText:function(q){var a=
"",d=0;this.forEach(function(b){var m;if(b.ignoreChars){m=b.lastChild;for(var l=0,e=[],t=-1;m;){var g=m.data;if(g)for(var f=g.length-1;0<=f;f--){var u=g.substring(f,f+1);l<b.ignoreChars&&(" "===u||"\ufeff"===u)?l++:e.push("\u00a0"===u?"\t":u)}q===m&&(t=e.length);m=m.previousSibling}e=e.reverse().join("");-1!==t&&(d=a.length+e.length-t);a+=e}else for(m=b.firstChild;m;)q===m&&(d=a.length),a+=m.data,m=m.nextSibling;return!0});return{text:a,offset:d}},getOffset:function(q,a){function d(b,f,C){var v=b.firstChild,
k=p._nodeLength(b),E=u.ownerDocument,A=E.defaultView||E.parentWindow,w=g.isIE?A.screen.logicalXDPI/A.screen.deviceXDPI:1,n=g.isIE?A.screen.logicalYDPI/A.screen.deviceYDPI:1,r,y,s,A=C.left+h.left,x,N;if(g.isIE||m._isRangeRects){for(var E=m._isRangeRects?E.createRange():E.body.createTextRange(),H=k,D=-1;1<H-D;){var P=Math.floor((H+D)/2);C=D+1;r=P===k-1&&b.ignoreChars?v.length:P+1;x=0===C&&8===g.isIE;m._isRangeRects?(E.setStart(v,C),E.setEnd(v,r)):(x&&(C=1),E.moveToElementText(b),E.move("character",
C),E.moveEnd("character",r-C));N=E.getClientRects();for(var M=!1,S=0;S<N.length;S++)if(C=N[S],r=(x?A:C.left)*w-h.left,s=C.right*w-h.left,y=C.top*n-h.top,C=C.bottom*n-h.top,r<=q&&q<s&&(!m._wrapMode||y<=a&&a<C)){M=!0;break}M?H=P:D=P}f+=H;C=H;r=H===k-1&&b.ignoreChars?v.length:Math.min(H+1,v.length);m._isRangeRects?(E.setStart(v,C),E.setEnd(v,r)):(E.moveToElementText(b),E.move("character",C),E.moveEnd("character",r-C));N=E.getClientRects();k=!1;0<N.length&&(C=N[0],r=(x?A:C.left)*w-h.left,s=C.right*w-
h.left,k=q>r+(s-r)/2);b=f-t;v=l.getLine(e);w=v.charCodeAt(b);55296<=w&&56319>=w&&k?b<v.length&&(w=v.charCodeAt(b+1),56320<=w&&57343>=w&&(f+=1)):56320<=w&&(57343>=w&&!k)&&0<b&&(w=v.charCodeAt(b-1),55296<=w&&56319>=w&&(f-=1));k&&f++}else{w=[];for(x=0;x<k;x++)w.push("\x3cspan\x3e"),x===k-1?w.push(v.data.substring(x)):w.push(v.data.substring(x,x+1)),w.push("\x3c/span\x3e");b.innerHTML=w.join("");for(w=b.firstChild;w;){C=w.getBoundingClientRect();r=C.left-h.left;s=C.right-h.left;if(r<=q&&q<s){q>r+(s-r)/
2&&f++;break}f++;w=w.nextSibling}p._createdDiv||(b.innerHTML="",b.appendChild(v),b=m._getSelection(),(f<=b.start&&b.start<f+k||f<=b.end&&b.end<f+k)&&m._updateDOMSelection())}return f}function b(d){if(d.ignore)return null;d=p._getClientRects(d,h);for(var l=0;l<d.length;l++){var e=d[l];if(e.left<=q&&q<e.right&&(!m._wrapMode||e.top<=a&&a<e.bottom))return e}return null}var m=this.view,l=m._model,e=this.lineIndex,t=l.getLineStart(e),f=l.getLineEnd(e);if(t===f)return t;var u=this._ensureCreated(),h=this.getBoundingClientRect(),
p=this,v,k;if(m._wrapMode){v=this.getClientRects();a<v[0].top&&(a=v[0].top);for(var A=0;A<v.length&&!(k=v[A],k.top<=a&&a<k.bottom);A++);q<k.left&&(q=k.left);q>k.right&&(q=k.right-1)}else 0>q&&(q=0),q>h.right-h.left&&(q=h.right-h.left);var w,n;if(this._lastHitChild&&this._lastHitChild.parentNode){if(w=this._lastHitOffset,n=this._lastHitChild,k=b(n),!k){v=w;for(var A=w+this._nodeLength(n),r=n.previousSibling,y=n.nextSibling;r||y;){if(r){v-=this._nodeLength(r);if(k=b(r)){n=r;w=v;break}r=r.previousSibling}if(y){if(k=
b(y)){n=y;w=A;break}A+=this._nodeLength(y);y=y.nextSibling}}}}else w=t,this.forEach(function(q){n=q;if(k=b(n))return!1;w+=this._nodeLength(n);return!0});n&&k&&(this._lastHitChild=n,this._lastHitOffset=w,w=d(n,w,k));return Math.min(f,Math.max(t,w))},getNextOffset:function(q,a){if("line"===a.unit){var d=this.view._model,b=d.getLineAtOffset(q);if(0<a.count)return a.count--,d.getLineEnd(b);a.count++;return d.getLineStart(b)}return"wordend"===a.unit||"wordWS"===a.unit||"wordendWS"===a.unit?this._getNextOffset_W3C(q,
a):g.isIE?this._getNextOffset_IE(q,a):this._getNextOffset_W3C(q,a)},_getNextOffset_W3C:function(q,a){function d(q){return 33<=q&&47>=q||58<=q&&64>=q||91<=q&&94>=q||96===q||123<=q&&126>=q}function b(q){return 32===q||9===q}var m=this.view._model,l=m.getLineAtOffset(q),e=m.getLine(l),t=m.getLineStart(l),m=m.getLineEnd(l),l=e.length,g=q-t,f,u=0>a.count?-1:1;if("word"===a.unit||"wordend"===a.unit||"wordWS"===a.unit||"wordendWS"===a.unit)for(var h,p,v;0!==a.count;){if(0<a.count){if(g===l)return m;f=e.charCodeAt(g);
h=d(f);p=!h&&!b(f);for(g++;g<l;){f=e.charCodeAt(g);if("wordWS"!==a.unit&&"wordendWS"!==a.unit){v=d(f);if("wordend"===a.unit){if(!v&&h)break}else if(v&&!h)break;f=!v&&!b(f)}else f=!b(f);if("wordend"===a.unit||"wordendWS"===a.unit){if(!f&&p)break}else if(f&&!p)break;p=f;h=v;g++}}else{if(0===g)return t;g--;f=e.charCodeAt(g);h=d(f);for(p=!h&&!b(f);0<g;){f=e.charCodeAt(g-1);if("wordWS"!==a.unit&&"wordendWS"!==a.unit){v=d(f);if("wordend"===a.unit){if(v&&!h)break}else if(!v&&h)break;f=!v&&!b(f)}else f=!b(f);
if("wordend"===a.unit||"wordendWS"===a.unit){if(f&&!p)break}else if(!f&&p)break;p=f;h=v;g--}}a.count-=u}else for(;0!==a.count&&0<=g+u&&g+u<=l;)g+=u,f=e.charCodeAt(g),56320<=f&&57343>=f&&0<g&&(f=e.charCodeAt(g-1),55296<=f&&56319>=f&&(g+=u)),a.count-=u;return t+g},_getNextOffset_IE:function(q,a){var d=this._ensureCreated(),b=this.view._model,m=this.lineIndex,l=0,e;e=b.getLineStart(m);var t=b.getLine(m),f=b.getLineStart(m),g=d.ownerDocument,u=0>a.count?-1:1;if(q===b.getLineEnd(m)){for(d=d.lastChild;d&&
d.ignoreChars===d.firstChild.length;)d=d.previousSibling;if(!d)return e;l=g.body.createTextRange();l.moveToElementText(d);e=l.text.length;l.moveEnd(a.unit,u);l=q+l.text.length-e}else if(q===e&&0>a.count)l=e;else for(d=d.firstChild;d;){b=this._nodeLength(d);if(e+b>q){l=g.body.createTextRange();if(q===e&&0>a.count){for(e=d.previousSibling;e&&(!e.firstChild||!e.firstChild.length);)e=e.previousSibling;l.moveToElementText(e?e:d.previousSibling)}else l.moveToElementText(d),l.collapse(),l.moveEnd("character",
q-e);e=l.text.length;l.moveEnd(a.unit,u);l=q+l.text.length-e;break}e=b+e;d=d.nextSibling}e=l-f;c=t.charCodeAt(e);56320<=c&&57343>=c&&0<e&&(c=t.charCodeAt(e-1),55296<=c&&56319>=c&&(e+=u));a.count-=u;return e+f},updateLinks:function(){var q=this._ensureCreated();if(this.hasLink){var a=this;this.forEach(function(d){var b=d.viewStyle;b&&(b.tagName&&"a"===b.tagName.toLowerCase())&&q.replaceChild(a._createSpan(q,d.firstChild.data,b),d);return!0})}},destroy:function(){var q=this._createdDiv;q&&(q.parentNode.removeChild(q),
this._createdDiv=null)}};w.prototype={addKeyMode:function(q,a){var d=this._keyModes;void 0!==a?d.splice(a,0,q):d.push(q);q._modeAdded&&q._modeAdded()},addRuler:function(q,a){q.setView(this);var d=this._rulers;if(void 0!==a){var b,m;for(m=b=0;b<d.length&&m<a;b++)q.getLocation()===d[b].getLocation()&&m++;d.splice(m,0,q);a=m}else d.push(q);this._createRuler(q,a);this._update()},computeSize:function(){var q=0,a=0,d=this._model,b=this._clientDiv;if(!b)return{width:q,height:a};var m=b.style.width;g.isWebkit&&
(b.style.width="0x7fffffffpx");for(var d=d.getLineCount(),l=0;l<d;l++){var e=this._getLine(l),t=e.getBoundingClientRect(),q=Math.max(q,t.right-t.left),a=a+(t.bottom-t.top);e.destroy()}g.isWebkit&&(b.style.width=m);b=this._getViewPadding();q+=b.right+b.left+this._metrics.scrollWidth;a+=b.bottom+b.top+this._metrics.scrollWidth;return{width:q,height:a}},convert:function(q,a,d){if(this._clientDiv){var b=this._getScroll(),m=this._getViewPadding(),l=this._viewDiv.getBoundingClientRect();"document"===a&&
(void 0!==q.x&&(q.x+=-b.x+l.left+m.left),void 0!==q.y&&(q.y+=-b.y+l.top+m.top));"document"===d&&(void 0!==q.x&&(q.x+=b.x-l.left-m.left),void 0!==q.y&&(q.y+=b.y-l.top-m.top));return q}},destroy:function(){for(var q=0;q<this._rulers.length;q++)this._rulers[q].setView(null);this.rulers=null;this._destroyView();this.onDestroy({type:"Destroy"});this._parent=null;this._model&&this._model.destroy&&this._model.destroy();this._actions=this._keyModes=this._doubleClickSelection=this._selection=this._theme=this._model=
...
(!g.isWindows||15<=g.isFirefox))(m=f.MutationObserver||f.MozMutationObserver)?(this._mutationObserver=new m(function(d){a._handleDataModified(d)}),this._mutationObserver.observe(b,{subtree:!0,characterData:!0})):d.push({target:this._clientDiv,type:"DOMCharacterDataModified",handler:function(d){return a._handleDataModified(d?d:f.event)}}),d.push({target:this._clientDiv,type:"compositionstart",handler:function(d){return a._handleCompositionStart(d?d:f.event)}}),d.push({target:this._clientDiv,type:"compositionend",
handler:function(d){return a._handleCompositionEnd(d?d:f.event)}});this._overlayDiv&&(d.push({target:this._overlayDiv,type:"mousedown",handler:function(d){return a._handleMouseDown(d?d:f.event)}}),d.push({target:this._overlayDiv,type:"mouseover",handler:function(d){return a._handleMouseOver(d?d:f.event)}}),d.push({target:this._overlayDiv,type:"mouseout",handler:function(d){return a._handleMouseOut(d?d:f.event)}}),d.push({target:this._overlayDiv,type:"contextmenu",handler:function(d){return a._handleContextMenu(d?
d:f.event)}}));this._isW3CEvents||d.push({target:this._clientDiv,type:"dblclick",handler:function(d){return a._handleDblclick(d?d:f.event)}})}this._hookRulerEvents(this._leftDiv,d);this._hookRulerEvents(this._rightDiv,d);this._hookRulerEvents(this._marginDiv,d);for(m=0;m<d.length;m++)l=d[m],y(l.target,l.type,l.handler,l.capture)},_hookRulerEvents:function(a,d){if(a){var b=this,m=this._getWindow();g.isIE&&d.push({target:a,type:"selectstart",handler:function(){return!1}});d.push({target:a,type:26<g.isFirefox?
"wheel":g.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(a){return b._handleMouseWheel(a?a:m.event)}});d.push({target:a,type:"click",handler:function(a){b._handleRulerEvent(a?a:m.event)}});d.push({target:a,type:"dblclick",handler:function(a){b._handleRulerEvent(a?a:m.event)}});d.push({target:a,type:"mousemove",handler:function(a){b._handleRulerEvent(a?a:m.event)}});d.push({target:a,type:"mouseover",handler:function(a){b._handleRulerEvent(a?a:m.event)}});d.push({target:a,type:"mouseout",
handler:function(a){b._handleRulerEvent(a?a:m.event)}})}},_getWindow:function(){return this._parent.ownerDocument.defaultView||this._parent.ownerDocument.parentWindow},_ignoreEvent:function(a){for(a=a.target;a&&a!==this._clientDiv;){if(a.ignore)return!0;a=a.parentNode}return!1},_init:function(a){var d=a.parent;"string"===typeof d&&(d=(a.document||document).getElementById(d));if(!d)throw"no parent";a.parent=d;a.model=a.model||new s.TextModel;var b=this._defaultOptions(),m;for(m in b)b.hasOwnProperty(m)&&
(this["_"+m]=void 0!==a[m]?a[m]:b[m].value);this._keyModes=[];this._rulers=[];this._selection=new u(0,0,!1);this._linksVisible=!1;this._maxLineWidth=this._redrawCount=0;this._maxLineIndex=-1;this._ignoreSelect=!0;this._hasFocus=this._ignoreFocus=!1;this._dragOffset=this._columnX=-1;this._isRangeRects=(!g.isIE||9<=g.isIE)&&"function"===typeof d.ownerDocument.createRange().getBoundingClientRect;this._isW3CEvents=d.addEventListener;this._autoScrollTimerID=this._autoScrollY=this._autoScrollX=null;this._AUTO_SCROLL_RATE=
50;this._mouseUpClosure=this._moseMoveClosure=this._grabControl=null;this._clickCount=this._lastMouseTime=this._lastMouseY=this._lastMouseX=0;this._clickTime=250;this._clickDist=5;this._isMouseDown=!1;this._doubleClickSelection=null;this._vScroll=this._hScroll=0;this._imeOffset=-1;this._createActions();this._createView()},_checkOverlayScroll:function(){if(g.isMac&&g.isWebkit&&!this._metrics.invalid&&0===this._metrics.scrollWidth){var a=this._viewDiv,d=this._isOverOverlayScroll();a.style.pointerEvents=
d.vertical||d.horizontal?"":"none"}},_isOverOverlayScroll:function(){if(!(200>(new Date).getTime()-this._lastScrollTime))return{};var a=this._viewDiv.getBoundingClientRect(),d=this._lastMouseMoveX,b=this._lastMouseMoveY;return{vertical:a.top<=b&&b<a.bottom&&a.right-15<=d&&d<a.right,horizontal:a.bottom-15<=b&&b<a.bottom&&a.left<=d&&d<a.right}},_modifyContent:function(a,d){if(this._readonly&&!a._code)return!1;a.type="Verify";this.onVerify(a);if(null===a.text||void 0===a.text)return!1;var b=this._model;
try{a._ignoreDOMSelection&&(this._ignoreDOMSelection=!0),b.setText(a.text,a.start,a.end)}finally{a._ignoreDOMSelection&&(this._ignoreDOMSelection=!1)}if(d){b=this._getSelection();b.setCaret(a.start+a.text.length);try{a._ignoreDOMSelection1&&(this._ignoreDOMSelection=!0),this._setSelection(b,!0)}finally{a._ignoreDOMSelection1&&(this._ignoreDOMSelection=!1)}}this.onModify({type:"Modify"});return!0},_onModelChanged:function(a){a.type="ModelChanged";this.onModelChanged(a);a.type="Changed";var d=a.start,
b=a.addedCharCount,m=a.removedCharCount,l=a.addedLineCount,e=a.removedLineCount,t=this._getSelection();t.end>d&&(t.end>d&&t.start<d+m?t.setCaret(d+b):(t.start+=b-m,t.end+=b-m),this._setSelection(t,!1,!1));d=this._model.getLineAtOffset(d);for(b=this._getLineNext();b;)m=b.lineIndex,d<=m&&m<=d+e&&(d===m&&!b.modelChangedEvent&&!b.lineRemoved?(b.modelChangedEvent=a,b.lineChanged=!0):(b.lineRemoved=!0,b.lineChanged=!1,b.modelChangedEvent=null)),m>d+e&&(b.lineIndex=m+l-e,b._line.lineIndex=b.lineIndex),b=
this._getLineNext(b);this._lineHeight&&(a=[d,e].concat(Array(l)),Array.prototype.splice.apply(this._lineHeight,a));!this._wrapMode&&(d<=this._maxLineIndex&&this._maxLineIndex<=d+e)&&(this._checkMaxLineIndex=this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0);this._update()},_onModelChanging:function(a){a.type="ModelChanging";this.onModelChanging(a);a.type="Changing"},_queueUpdate:function(){if(!this._updateTimer&&!this._ignoreQueueUpdate){var a=this;this._updateTimer=this._getWindow().setTimeout(function(){a._updateTimer=
null;a._update()},0)}},_resetLineHeight:function(a,d){if(this._wrapMode||this._variableLineHeight){if(void 0!==a&&void 0!==d)for(var b=a;b<d;b++)this._lineHeight[b]=void 0;else this._lineHeight=Array(this._model.getLineCount());this._calculateLineHeightTimer()}else this._lineHeight=null},_resetLineWidth:function(){var a=this._clientDiv;if(a)for(a=a.firstChild;a;)a.lineWidth=void 0,a=a.nextSibling},_reset:function(){this._maxLineIndex=-1;this._maxLineWidth=0;this._columnX=-1;this._bottomChild=this._topChild=
null;this._topIndexY=0;this._variableLineHeight=!1;this._resetLineHeight();this._setSelection(new u(0,0,!1),!1,!1);this._viewDiv&&(this._viewDiv.scrollLeft=0,this._viewDiv.scrollTop=0);var a=this._clientDiv;if(a){for(a=a.firstChild;a;)a.lineRemoved=!0,a=a.nextSibling;13>g.isFirefox&&this._fixCaret()}},_scrollViewAnimated:function(a,d,b){var m=this._getWindow();if(b&&this._scrollAnimation){var l=this;this._animation=new D({window:m,duration:this._scrollAnimation,curve:[d,0],onAnimate:function(a){a=
d-Math.floor(a);l._scrollView(0,a);d-=a},onEnd:function(){l._animation=null;l._scrollView(a,d);b&&m.setTimeout(b,0)}});this._animation.play()}else this._scrollView(a,d),b&&m.setTimeout(b,0)},_scrollView:function(a,d){this._ensureCaretVisible=!1;var b=this._viewDiv;a&&(b.scrollLeft+=a);d&&(b.scrollTop+=d)},_setClipboardText:function(a,b){var m,l=this._getWindow(),e=l.clipboardData;!e&&b&&(e=b.clipboardData);if(e&&(m=[],d(a,function(a){m.push(a)},function(){m.push(g.platformDelimiter)}),e.setData(g.isIE?
"Text":"text/plain",m.join(""))||21<g.isFirefox))return!0;var t=this._parent.ownerDocument,f=g.createElement(t,"pre");f.style.position="fixed";f.style.left="-1000px";d(a,function(a){f.appendChild(t.createTextNode(a))},function(){f.appendChild(g.createElement(t,"br"))});f.appendChild(t.createTextNode(" "));this._clientDiv.appendChild(f);e=t.createRange();e.setStart(f.firstChild,0);e.setEndBefore(f.lastChild);var u=l.getSelection();0<u.rangeCount&&u.removeAllRanges();u.addRange(e);var h=this,e=function(){f&&
f.parentNode===h._clientDiv&&h._clientDiv.removeChild(f);h._updateDOMSelection()},u=!1;this._ignoreCopy=!0;try{u=t.execCommand("copy",!1,null)}catch(p){}this._ignoreCopy=!1;if(!u&&b)return l.setTimeout(e,0),!1;e();return!0},_setDOMSelection:function(a,d,b,m,l){this._setDOMFullSelection(a,d,b,m);a=a._line.getNodeOffset(d);b=b._line.getNodeOffset(m);m=this._getWindow();d=this._parent.ownerDocument;if(m.getSelection){var e=m.getSelection();m=d.createRange();m.setStart(a.node,a.offset);m.setEnd(b.node,
b.offset);if(this._hasFocus&&(e.anchorNode!==a.node||e.anchorOffset!==a.offset||e.focusNode!==b.node||e.focusOffset!==b.offset||e.anchorNode!==b.node||e.anchorOffset!==b.offset||e.focusNode!==a.node||e.focusOffset!==a.offset))this._anchorNode=a.node,this._anchorOffset=a.offset,this._focusNode=b.node,this._focusOffset=b.offset,this._ignoreSelect=!1,0<e.rangeCount&&e.removeAllRanges(),e.addRange(m),this._ignoreSelect=!0;this._cursorDiv&&(m=d.createRange(),l?(m.setStart(a.node,a.offset),m.setEnd(a.node,
a.offset)):(m.setStart(b.node,b.offset),m.setEnd(b.node,b.offset)),l=m.getClientRects()[0],a=this._cursorDiv.parentNode,b=a.getBoundingClientRect(),l&&b&&(this._cursorDiv.style.top=l.top-b.top+a.scrollTop+"px",this._cursorDiv.style.left=l.left-b.left+a.scrollLeft+"px"))}else d.selection&&this._hasFocus&&(l=d.body,m=g.createElement(d,"div"),l.appendChild(m),l.removeChild(m),m=l.createTextRange(),m.moveToElementText(a.node.parentNode),m.moveStart("character",a.offset),l=l.createTextRange(),l.moveToElementText(b.node.parentNode),
l.moveStart("character",b.offset),m.setEndPoint("EndToStart",l),this._ignoreSelect=!1,m.select(),this._ignoreSelect=!0)},_setDOMFullSelection:function(a,d,b,m){if(this._selDiv1){var l=this._selDiv1;l.style.width="0px";l.style.height="0px";l=this._selDiv2;l.style.width="0px";l.style.height="0px";l=this._selDiv3;l.style.width="0px";l.style.height="0px";if(!(a===b&&d===m)){var e=this._getViewPadding(),t=this._clientDiv.getBoundingClientRect(),f=this._viewDiv.getBoundingClientRect(),l=f.left+e.left,g=
t.right,e=f.top+e.top,u=t.bottom,f=t=0;this._clipDiv?(f=this._clipDiv.getBoundingClientRect(),t=f.left-this._clipDiv.scrollLeft):(f=this._rootDiv.getBoundingClientRect(),t=f.left);f=f.top;this._ignoreDOMSelection=!0;var h=(new A(this,a.lineIndex,a)).getBoundingClientRect(d,!1),p=h.left;d=(new A(this,b.lineIndex,b)).getBoundingClientRect(m,!1);var v=d.left;this._ignoreDOMSelection=!1;var k=this._selDiv1,p=Math.min(g,Math.max(l,p)),w=Math.min(u,Math.max(e,h.top)),n=g;m=Math.min(u,Math.max(e,h.bottom));
k.style.left=p-t+"px";k.style.top=w-f+"px";k.style.width=Math.max(0,n-p)+"px";k.style.height=Math.max(0,m-w)+"px";a.lineIndex===b.lineIndex?(n=Math.min(v,g),k.style.width=Math.max(0,n-p)+"px"):(h=Math.min(u,Math.max(e,d.top)),v=Math.min(g,Math.max(l,v)),e=Math.min(u,Math.max(e,d.bottom)),u=this._selDiv3,u.style.left=l-t+"px",u.style.top=h-f+"px",u.style.width=Math.max(0,v-l)+"px",u.style.height=Math.max(0,e-h)+"px",1<Math.abs(a.lineIndex-b.lineIndex)&&(a=this._selDiv2,a.style.left=l-t+"px",a.style.top=
m-f+"px",a.style.width=Math.max(0,g-l)+"px",a.style.height=Math.max(0,h-m)+"px"))}}},_setGrab:function(a){a!==this._grabControl&&(a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null))},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=a;g.isIE&&a&&(this._hadFocus=this._hasFocus);var d=this._clientDiv;d.contentEditable=!a;this._hadFocus&&!a&&d.focus();this._overlayDiv&&(this._overlayDiv.style.zIndex=
a?"-1":"1");for(a=this._getLineNext();a;)a._line.updateLinks(),a=this._getLineNext(a);this._updateDOMSelection()}},_setSelection:function(a,d,b,m,l){if(a){this._columnX=-1;void 0===b&&(b=!0);var e=this._selection;this._selection=a;!1!==d&&this._showCaret(!1,m,d,l);b&&this._updateDOMSelection();if(!e.equals(a))this.onSelection({type:"Selection",oldValue:{start:e.start,end:e.end},newValue:{start:a.start,end:a.end}})}},_setSelectionTo:function(a,d,b,m){var l=this._model,e=this._getSelection();d=this.convert({x:a,
y:d},"page","document");a=this._getLineIndex(d.y);if(1===this._clickCount){l=this._getLine(a);a=l.getOffset(d.x,d.y-this._getLinePixel(a));l.destroy();if(m&&!b&&e.start<=a&&a<e.end)return this._dragOffset=a,!1;e.extend(a);b||e.collapse()}else 0===(this._clickCount&1)?(l=this._getLine(a),a=l.getOffset(d.x,d.y-this._getLinePixel(a)),this._doubleClickSelection?a>=this._doubleClickSelection.start?(b=this._doubleClickSelection.start,m=l.getNextOffset(a,{unit:"wordend",count:1})):(b=l.getNextOffset(a,{unit:"word",
count:-1}),m=this._doubleClickSelection.end):(b=l.getNextOffset(a,{unit:"word",count:-1}),m=l.getNextOffset(b,{unit:"wordend",count:1})),l.destroy()):this._doubleClickSelection?(m=l.getLineAtOffset(this._doubleClickSelection.start),a>=m?(b=l.getLineStart(m),m=l.getLineEnd(a)):(b=l.getLineStart(a),m=l.getLineEnd(m))):(b=l.getLineStart(a),m=l.getLineEnd(a)),e.setCaret(b),e.extend(m);this._setSelection(e,!0,!0);return!0},_setFullSelection:function(a,d){this._fullSelection=a;g.isWebkit&&(this._fullSelection=
!0);var b=this._clipDiv||this._rootDiv;if(b)if(this._fullSelection){if(!this._selDiv1&&this._fullSelection&&!g.isIOS){var m=b.ownerDocument;this._highlightRGB=g.isWebkit?"transparent":"Highlight";var l=g.createElement(m,"div");this._selDiv1=l;l.style.position="absolute";l.style.borderWidth="0px";l.style.margin="0px";l.style.padding="0px";l.style.outline="none";l.style.background=this._highlightRGB;l.style.width="0px";l.style.height="0px";l.style.zIndex="0";b.appendChild(l);var e=g.createElement(m,
"div");this._selDiv2=e;e.style.position="absolute";e.style.borderWidth="0px";e.style.margin="0px";e.style.padding="0px";e.style.outline="none";e.style.background=this._highlightRGB;e.style.width="0px";e.style.height="0px";e.style.zIndex="0";b.appendChild(e);this._selDiv3=m=g.createElement(m,"div");m.style.position="absolute";m.style.borderWidth="0px";m.style.margin="0px";m.style.padding="0px";m.style.outline="none";m.style.background=this._highlightRGB;m.style.width="0px";m.style.height="0px";m.style.zIndex=
"0";b.appendChild(m);if(g.isFirefox&&g.isMac){b=this._getWindow().getComputedStyle(m,null).getPropertyValue("background-color");switch(b){case "rgb(119, 141, 168)":b="rgb(199, 208, 218)";break;case "rgb(127, 127, 127)":b="rgb(198, 198, 198)";break;case "rgb(255, 193, 31)":b="rgb(250, 236, 115)";break;case "rgb(243, 70, 72)":b="rgb(255, 176, 139)";break;case "rgb(255, 138, 34)":b="rgb(255, 209, 129)";break;case "rgb(102, 197, 71)":b="rgb(194, 249, 144)";break;case "rgb(140, 78, 184)":b="rgb(232, 184, 255)";
break;default:b="rgb(180, 213, 255)"}this._highlightRGB=b;l.style.background=b;e.style.background=b;m.style.background=b}d||this._updateDOMSelection()}}else this._selDiv1&&(b.removeChild(this._selDiv1),this._selDiv1=null),this._selDiv2&&(b.removeChild(this._selDiv2),this._selDiv2=null),this._selDiv3&&(b.removeChild(this._selDiv3),this._selDiv3=null)},_setBlockCursor:function(a){this._blockCursorVisible=a;this._updateBlockCursorVisible()},_setOverwriteMode:function(a){this._overwriteMode=a;this._updateBlockCursorVisible()},
_updateBlockCursorVisible:function(){if(this._blockCursorVisible||this._overwriteMode){if(!this._cursorDiv){var a=this._viewDiv,d=g.createElement(a.ownerDocument,"div");d.className="textviewBlockCursor";this._cursorDiv=d;d.tabIndex=-1;d.style.zIndex="2";d.style.color="transparent";d.style.position="absolute";d.style.pointerEvents="none";d.innerHTML="\x26nbsp;";a.appendChild(d);this._updateDOMSelection()}}else this._cursorDiv&&(this._cursorDiv.parentNode.removeChild(this._cursorDiv),this._cursorDiv=
null)},_setMarginOffset:function(a,d){this._marginOffset=a;this._marginDiv.style.display=a?"block":"none";d||(this._metrics=this._calculateMetrics(),this._queueUpdate())},_setWrapOffset:function(a,d){this._wrapOffset=a;d||(this._metrics=this._calculateMetrics(),this._queueUpdate())},_setReadOnly:function(a){this._readonly=a;this._clientDiv.setAttribute("aria-readonly",a?"true":"false")},_setSingleMode:function(a,d){this._singleMode=a;this._updateOverflow();this._updateStyle(d)},_setTabSize:function(a,
d){this._tabSize=a;this._customTabSize=void 0;var b=this._clientDiv;g.isOpera?b&&(b.style.OTabSize=this._tabSize+""):537.1<=g.isWebkit?b&&(b.style.tabSize=this._tabSize+""):4<=g.isFirefox?b&&(b.style.MozTabSize=this._tabSize+""):8!==this._tabSize&&(this._customTabSize=this._tabSize);d||(this.redrawLines(),this._resetLineWidth())},_setTheme:function(a){this._theme&&this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);(this._theme=a)&&this._theme.addEventListener("ThemeChanged",
this._themeListener.onChanged);this._setThemeClass(this._themeClass)},_setThemeClass:function(a,d){this._themeClass=a;var b="textview",m=this._theme.getThemeClass();m&&(b+=" "+m);this._themeClass&&m!==this._themeClass&&(b+=" "+this._themeClass);this._rootDiv.className=b;this._updateStyle(d)},_setWrapMode:function(a,d){this._wrapMode=a&&this._wrappable;var b=this._clientDiv;this._wrapMode?(b.style.whiteSpace="pre-wrap",b.style.wordWrap="break-word"):(b.style.whiteSpace="pre",b.style.wordWrap="normal");
this._updateOverflow();d||(this.redraw(),this._resetLineWidth());this._resetLineHeight()},_showCaret:function(a,d,b,m){if(this._clientDiv&&!(0<this._redrawCount)&&!this._ignoreDOMSelection){var l=this._model,e=this._getSelection(),t=this._getScroll(),f=e.getCaret(),g=e.start,u=e.end,h=l.getLineAtOffset(g),p=l.getLineAtOffset(u),v=Math.max(Math.max(g,l.getLineStart(p)),u-1),l=this._getClientWidth(),k=this._getClientHeight(),A=l/4,w=this._getBoundsAtOffset(f===g?g:v),n=w.left,r=w.right,y=w.top,s=w.bottom,
x=0,D="object"===typeof b;if((a||D)&&!e.isEmpty())w=this._getBoundsAtOffset(f===u?g:v),x=(w.bottom>s?w.bottom:s)-(w.top<y?w.top:y),a&&(w.top===y?f===g?r=n+Math.min(w.right-n,l):n=r-Math.min(r-w.left,l):f===g?s=y+Math.min(w.bottom-y,k):y=s-Math.min(s-w.top,k));a=0;n<t.x&&(a=Math.min(n-t.x,-A));r>t.x+l&&(a=Math.max(r-t.x-l,A));e=0;y<t.y?e=y-t.y:s>t.y+k&&(e=s-t.y-k);m&&(0<m?0<e&&(e=Math.max(e,m)):0>e&&(e=Math.min(e,m)));m=D&&"always"===b.scrollPolicy;if(0!==a||0!==e||m)return D?(m=0<e,0===e&&(e=y-t.y),
t=b.viewAnchor,y=b.selectionAnchor,b=Math.min(Math.max(0,b.viewAnchorOffset||0)),e="top"===t?e+Math.floor(m?(1-b)*k:-b*k):"bottom"===t?e+Math.floor(m?b*k:-(1-b)*k):"center"===t?e+Math.floor(m?k/2+b*k:k/2-(1-b)*k):e+Math.floor(m?b*k:-b*k),h!==p&&("top"===y&&f!==g?e+=Math.floor(-x):"bottom"===y&&f!==u?e+=Math.floor(x):"center"===y&&(e+=Math.floor(x/2)))):0!==e&&"number"===typeof b&&(0>b&&(b=0),1<b&&(b=1),e+=Math.floor(0<e?b*k:-b*k)),this._scrollViewAnimated(a,e,d),k!==this._getClientHeight()||l!==this._getClientWidth()?
this._showCaret():this._ensureCaretVisible=!0,!0;d&&d();return!1}},_startIME:function(){if(-1===this._imeOffset){var a=this._getSelection();a.isEmpty()||this._modifyContent({text:"",start:a.start,end:a.end},!0);this._imeOffset=a.start}},_unhookEvents:function(){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);this._modelListener=
null;for(var a=0;a<this._handlers.length;a++){var d=this._handlers[a];x(d.target,d.type,d.handler)}this._handlers=null;this._mutationObserver&&(this._mutationObserver.disconnect(),this._mutationObserver=null)},_updateDOMSelection:function(){if(!(0<this._redrawCount)&&!this._ignoreDOMSelection&&this._clientDiv){var a=this._getSelection(),d=this._model,b=d.getLineAtOffset(a.start),m=d.getLineAtOffset(a.end),l=this._getLineNext();if(l){var e=this._getLinePrevious(),t;b<l.lineIndex?(b=l,t=d.getLineStart(l.lineIndex)):
b>e.lineIndex?(b=e,t=d.getLineStart(e.lineIndex)):(b=this._getLineNode(b),t=a.start);m<l.lineIndex?(m=l,d=d.getLineStart(l.lineIndex)):m>e.lineIndex?(m=e,d=d.getLineStart(e.lineIndex)):(m=this._getLineNode(m),d=a.end);this._setDOMSelection(b,t,m,d,a.caret)}}},_update:function(a){if(!(0<this._redrawCount)){this._updateTimer&&(this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,a=!1);var d=this._clientDiv,b=this._viewDiv;if(d){this._metrics.invalid&&(this._ignoreQueueUpdate=!0,
this._updateStyle(),this._ignoreQueueUpdate=!1);var m=this._model,l=this._getScroll(!1),e=this._getViewPadding(),t=m.getLineCount(),f=this._getLineHeight(),u=!1,h=!1,p=!1,v=this._metrics.scrollWidth;this._wrapMode&&(d.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px");var k,w,n,r,y=0,s=0,x;if(this._lineHeight){for(;s<t;){x=this._getLineHeight(s);if(y+x>l.y)break;y+=x;s++}k=s;w=Math.max(0,k-1);n=m=l.y-y;0<k&&(m+=this._getLineHeight(k-1))}else r=Math.max(0,l.y)/f,k=Math.floor(r),w=
Math.max(0,k-1),m=Math.round((r-w)*f),n=Math.round((r-k)*f);this._topIndexY=n;r=this._rootDiv;var D=r.clientWidth,K=r.clientHeight;if(a){f=0;this._leftDiv&&(k=this._leftDiv.getBoundingClientRect(),f=k.right-k.left);k=this._getClientWidth();r=this._getClientHeight();h=k;this._wrapMode?this._metrics.wrapWidth&&(h=this._metrics.wrapWidth):h=Math.max(this._maxLineWidth,h);for(;s<t;)x=this._getLineHeight(s,!1),y+=x,s++;t=y}else{r=this._getClientHeight();n=Math.min(k+Math.floor((r+n)/f),t-1);var l=Math.min(n+
1,t-1),F;for(x=d.firstChild;x;){F=x.lineIndex;var G=x.nextSibling;if(!(w<=F&&F<=l)||x.lineRemoved||-1===x.lineIndex)this._mouseWheelLine===x?(x.style.display="none",x.lineIndex=-1):d.removeChild(x);x=G}x=this._getLineNext();var G=b.ownerDocument,J=G.createDocumentFragment();for(F=w;F<=l;F++)!x||x.lineIndex>F?(new A(this,F)).create(J,null):(J.firstChild&&(d.insertBefore(J,x),J=G.createDocumentFragment()),x&&x.lineChanged&&(x=(new A(this,F)).create(J,x),x.lineChanged=!1),x=this._getLineNext(x));J.firstChild&&
d.insertBefore(J,x);g.isWebkit&&!this._wrapMode&&(d.style.width="0x7fffffffpx");x=this._getLineNext();F=r+m;for(J=!1;x;)w=x.lineWidth,void 0===w&&(G=x._line.getBoundingClientRect(),w=x.lineWidth=Math.ceil(G.right-G.left),G=G.bottom-G.top,this._lineHeight?this._lineHeight[x.lineIndex]=G:0!==f&&(0!==G&&Math.ceil(f)!==Math.ceil(G))&&(this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[x.lineIndex]=G)),this._lineHeight&&!J&&(F-=this._lineHeight[x.lineIndex],0>F&&(n=x.lineIndex,J=!0)),this._wrapMode||
(w>=this._maxLineWidth&&(this._maxLineWidth=w,this._maxLineIndex=x.lineIndex),this._checkMaxLineIndex===x.lineIndex&&(this._checkMaxLineIndex=-1)),x.lineIndex===k&&(this._topChild=x),x.lineIndex===n&&(this._bottomChild=x),x=this._getLineNext(x);-1!==this._checkMaxLineIndex&&(F=this._checkMaxLineIndex,this._checkMaxLineIndex=-1,0<=F&&F<t&&(f=new A(this,F),G=f.getBoundingClientRect(),w=G.right-G.left,w>=this._maxLineWidth&&(this._maxLineWidth=w,this._maxLineIndex=F),f.destroy()));for(;s<t;)x=this._getLineHeight(s,
s<=n),y+=x,s++;t=y;this._updateRuler(this._leftDiv,k,l,K);this._updateRuler(this._rightDiv,k,l,K);this._updateRuler(this._marginDiv,k,l,K);f=0;this._leftDiv&&(k=this._leftDiv.getBoundingClientRect(),f=k.right-k.left);l=0;this._rightDiv&&(l=this._rightDiv.getBoundingClientRect(),l=l.right-l.left);b.style.left=f+"px";b.style.right=l+"px";l=this._scrollDiv;l.style.height=t+"px";k=this._getClientWidth();!this._singleMode&&!this._wrapMode&&(y=u=r,(s="scroll"===b.style.overflowX)?u+=v:y-=v,x=n=k,(w="scroll"===
b.style.overflowY)?n+=v:x-=v,r=u,k=n,t>r&&(p=!0,k=x),this._maxLineWidth>k&&(h=!0,r=y,t>r&&(p=!0,k=x)),s!==h&&(b.style.overflowX=h?"scroll":"hidden"),w!==p&&(b.style.overflowY=p?"scroll":"hidden"),u=s!==h||w!==p);p=k;this._wrapMode?this._metrics.wrapWidth&&(p=this._metrics.wrapWidth):p=Math.max(this._maxLineWidth,p);h=p;if((!g.isIE||9<=g.isIE)&&this._maxLineWidth>k)p+=e.right+e.left;l.style.width=p+"px";this._clipScrollDiv&&(this._clipScrollDiv.style.width=p+"px");l=this._getScroll(!1)}this._vScrollDiv&&
(p=r-8,y=Math.max(15,Math.ceil(Math.min(1,p/(t+e.top+e.bottom))*p)),this._vScrollDiv.style.left=f+k-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,l.y*p/t))+"px",this._vScrollDiv.style.height=y+"px");!this._wrapMode&&this._hScrollDiv&&(p=k-8,y=Math.max(15,Math.ceil(Math.min(1,p/(this._maxLineWidth+e.left+e.right))*p)),this._hScrollDiv.style.left=f+Math.floor(Math.max(0,Math.floor(l.x*p/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=r-9+"px",this._hScrollDiv.style.width=y+"px");s=l.x;
y=this._clipDiv;p=this._overlayDiv;if(n=this._marginDiv)n.style.left=-s+f+this._metrics.marginWidth+e.left+"px",n.style.bottom=("scroll"===b.style.overflowX?v:0)+"px";y?(y.scrollLeft=s,y.scrollTop=0,b=f+e.left,v=e.top,a=k,f=r,s=0,n=-m,0===l.x&&(b-=e.left,a+=e.left,s=e.left),l.x+k===h&&(a+=e.right),0===l.y&&(v-=e.top,f+=e.top,n+=e.top),l.y+r===t&&(f+=e.bottom),y.style.left=b+"px",y.style.top=v+"px",y.style.right=D-a-b+"px",y.style.bottom=K-f-v+"px",d.style.left=s+"px",d.style.top=n+"px",d.style.width=
h+"px",d.style.height=r+m+"px",p&&(p.style.left=d.style.left,p.style.top=d.style.top,p.style.width=d.style.width,p.style.height=d.style.height)):(b=s,v=m,D=s+k,K=m+r,0===b&&(b-=e.left),0===v&&(v-=e.top),D===h&&(D+=e.right),l.y+r===t&&(K+=e.bottom),d.style.clip="rect("+v+"px,"+D+"px,"+K+"px,"+b+"px)",d.style.left=-s+f+e.left+"px",d.style.width=(this._wrapMode||g.isWebkit?h:k+s)+"px",a||(d.style.top=-m+e.top+"px",d.style.height=r+m+"px"),p&&(p.style.clip=d.style.clip,p.style.left=d.style.left,p.style.width=
d.style.width,a||(p.style.top=d.style.top,p.style.height=d.style.height)));this._updateDOMSelection();u&&(d=this._ensureCaretVisible,this._ensureCaretVisible=!1,d&&this._showCaret(),this._queueUpdate())}}},_updateOverflow:function(){var a=this._viewDiv;this._wrapMode?(a.style.overflowX="hidden",a.style.overflowY="scroll"):a.style.overflow="hidden"},_updateRuler:function(a,d,b,m){if(a){var l=this._parent.ownerDocument,e=this._getLineHeight(),t=this._getViewPadding();for(a=a.firstChild;a;){var f=a._ruler,
u=e,h=f.getOverview();"page"===h&&(u+=this._topIndexY);a.style.top=-u+"px";a.style.height=m+u+"px";a.rulerChanged&&p(f.getRulerStyle(),a);var v,k=a.firstChild;k?(v=k,k=k.nextSibling):(v=g.createElement(l,"div"),v.style.visibility="hidden",a.appendChild(v));var A;if(a.rulerChanged&&v){u=-1;if(A=f.getWidestAnnotation())p(A.style,v),A.html&&(v.innerHTML=A.html);v.lineIndex=u;v.style.height=e+t.top+"px"}var w;if("page"===h){for(f=f.getAnnotations(d,b+1);k;)u=k.lineIndex,A=k.nextSibling,(!(d<=u&&u<=b)||
k.lineChanged)&&a.removeChild(k),k=A;k=a.firstChild.nextSibling;w=l.createDocumentFragment();for(u=d;u<=b;u++)if(!k||k.lineIndex>u){v=g.createElement(l,"div");if(A=f[u])p(A.style,v),A.html&&(v.innerHTML=A.html),v.annotation=A;v.lineIndex=u;v.style.height=this._getLineHeight(u)+"px";w.appendChild(v)}else w.firstChild&&(a.insertBefore(w,k),w=l.createDocumentFragment()),k&&(k=k.nextSibling);w.firstChild&&a.insertBefore(w,k)}else{A=this._getClientHeight();u=this._model.getLineCount();k=A+t.top+t.bottom-
2*this._metrics.scrollWidth;h=e*u<k?e:k/u;if(a.rulerChanged){for(A=a.childNodes.length;1<A;)a.removeChild(a.lastChild),A--;f=f.getAnnotations(0,u);w=l.createDocumentFragment();for(var n in f)u=n>>>0,0>u||(v=g.createElement(l,"div"),A=f[n],p(A.style,v),v.style.position="absolute",v.style.top=this._metrics.scrollWidth+e+Math.floor(u*h)+"px",A.html&&(v.innerHTML=A.html),v.annotation=A,v.lineIndex=u,w.appendChild(v));a.appendChild(w)}else if(a._oldTrackHeight!==k)for(v=a.firstChild?a.firstChild.nextSibling:
null;v;)v.style.top=this._metrics.scrollWidth+e+Math.floor(v.lineIndex*h)+"px",v=v.nextSibling;a._oldTrackHeight=k}a.rulerChanged=!1;a=a.nextSibling}}},_updateStyleSheet:function(){var a="";g.isWebkit&&0<this._metrics.scrollWidth&&(a+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");g.isFirefox&&(g.isMac&&this._highlightRGB&&"Highlight"!==this._highlightRGB)&&(a+="\n.textview ::-moz-selection {background: "+this._highlightRGB+";}");if(a){var d=this._clientDiv.ownerDocument,b=d.getElementById("_textviewStyle");
if(b)b.removeChild(b.firstChild),b.appendChild(d.createTextNode(a));else{b=g.createElement(d,"style");b.id="_textviewStyle";var m=d.getElementsByTagName("head")[0]||d.documentElement;b.appendChild(d.createTextNode(a));m.insertBefore(b,m.firstChild)}}},_updateStyle:function(a){!a&&g.isIE&&(this._rootDiv.style.lineHeight="normal");var d=this._metrics=this._calculateMetrics();this._variableLineHeight&&(this._variableLineHeight=!1,this._resetLineHeight());this._rootDiv.style.lineHeight=g.isIE?d.lineHeight-
(d.lineTrim.top+d.lineTrim.bottom)+"px":"normal";this._updateStyleSheet();if(g.isMac&&g.isWebkit){var b=this._viewDiv;!d.invalid&&0===d.scrollWidth?(b.style.pointerEvents="none",b.style.zIndex="2"):(b.style.pointerEvents="",b.style.zIndex="")}a||(this.redraw(),this._resetLineWidth())}};k.EventTarget.addMixin(w.prototype);return{TextView:w}});
...
this._stylerAdapter.parse(b.getText(e.contentStart,e.end),e.contentStart,e,h,!0);for(var k=0;k<h.length;k++)"meta.annotation.task.todo"===h[k].style&&(d<=h[k].start&&h[k].end<=f)&&a.push(n.AnnotationType.createAnnotation(g,h[k].start,h[k].end,b.getText(h[k].start,h[k].end)))}e.getBlocks().forEach(function(e){this._computeTasks(e,b,a,d,f)}.bind(this))}},_createFoldingAnnotation:function(e,b,a,d){var f=b.getLineAtOffset(a);b=b.getLineAtOffset(d);return f===b?null:new (n.AnnotationType.getType(n.AnnotationType.ANNOTATION_FOLDING))(a,
d,e)},_findBlock:function(e,b){var a=e.getBlocks();if(!a.length)return e;var d=p(a,b,!0);return d<a.length&&a[d].start<=b&&b<a[d].end?this._findBlock(a[d],b):e},_findBrackets:function(e,b,a,d,f){for(var g=[],h=[],k=d,n=b.getBlocks(),r=p(n,d,!0);r<n.length&&!(n[r].start>=f);r++){var s=n[r].start,y=n[r].end;k<s&&(this._stylerAdapter.parse(a.substring(k-d,s-d),k,b,h),h.forEach(function(a){0===a.style.indexOf(e.beginName)?g.push(a.start+1):0===a.style.indexOf(e.endName)&&g.push(-(a.start+1))}),h=[]);
k=y}k<f&&(this._stylerAdapter.parse(a.substring(k-d,f-d),k,b,h),h.forEach(function(a){a.style&&(0===a.style.indexOf(e.beginName)?g.push(a.start+1):0===a.style.indexOf(e.endName)&&g.push(-(a.start+1)))}));return g},_findMatchingBracket:function(e,b,a){var d=e.getLineAtOffset(a),f=e.getLineEnd(d),g=e.getText(a,f),g=this._stylerAdapter.getBracketMatch(b,g);if(!g)return-1;for(var h=e.getLine(d),k=e.getLineStart(d),f=this._findBrackets(g,b,h,k,f),n=0;n<f.length;n++)if(h=0<=f[n]?1:-1,f[n]*h-1===a){a=1;
if(g.atStart){for(n++;n<f.length;n++)if(h=0<=f[n]?1:-1,a+=h,0===a)return f[n]*h-1;d+=1;for(n=e.getLineCount();d<n;){h=e.getLine(d);k=e.getLineStart(d);f=e.getLineEnd(d);f=this._findBrackets(g,b,h,k,f);for(k=0;k<f.length;k++)if(h=0<=f[k]?1:-1,a+=h,0===a)return f[k]*h-1;d++}}else{for(n--;0<=n;n--)if(h=0<=f[n]?1:-1,a+=h,0===a)return f[n]*h-1;for(d-=1;0<=d;){h=e.getLine(d);k=e.getLineStart(d);f=e.getLineEnd(d);f=this._findBrackets(g,b,h,k,f);for(n=f.length-1;0<=n;n--)if(h=0<=f[n]?1:-1,a+=h,0===a)return f[n]*
h-1;d--}}break}return-1},_getLineStyle:function(e){if(this._highlightCaretLine){var b=this._view.getModel(),a=this._view.getSelection();if(a.start===a.end&&b.getLineAtOffset(a.start)===e)return this._caretLineStyle}return null},_getStyles:function(e,b,a,d){b.getBaseModel&&(d=b.mapOffset(d));for(var f=d+a.length,g=[],h=d,k=e.getBlocks(),n=p(k,d,!0);n<k.length&&!(k[n].start>=f);n++){var r=k[n].start,s=k[n].end;h<r&&this._stylerAdapter.parse(a.substring(h-d,r-d),h,e,g);var y=Math.max(h,r);y===r&&(r=
this._stylerAdapter.getBlockStartStyle(k[n],a.substring(y-d),y,g))&&(y+=r.length);var r=Math.min(f,s),x=[];r===s&&(h=a.substring(r-h-(k[n].end-k[n].contentEnd)),(h=this._stylerAdapter.getBlockEndStyle(k[n],h,r,x))&&(r-=h.length));var h=this._getStyles(k[n],b,a.substring(y-d,r-d),y),D=this._stylerAdapter.getBlockContentStyleName(k[n]);if(D){var q=y;h.forEach(function(a){a.start-q&&g.push({start:q,end:a.start,style:D});a.mergeable&&(a.style+=","+D);g.push(a);q=a.end});r-q&&g.push({start:q,end:r,style:D})}else g=
g.concat(h);g=g.concat(x);h=s}h<f&&this._stylerAdapter.parse(a.substring(h-d,f-d),h,e,g);if(b.getBaseModel)for(e=0;e<g.length;e++)a=g[e].end-g[e].start,g[e].start=b.mapOffset(g[e].start,!0),g[e].end=g[e].start+a;return g},_isRenderingWhitespace:function(){return this._whitespacesVisible&&(this._tabsVisible||this._spacesVisible)},_onDestroy:function(){this.destroy()},_onLineStyle:function(e){e.textView===this._view&&(e.style=this._getLineStyle(e.lineIndex));e.ranges=this._getStyles(this._rootBlock,
e.textView.getModel(),e.lineText,e.lineStart);e.ranges.forEach(function(b){b.style&&(b.style={styleClass:b.style.replace(/\./g," ")})});this._isRenderingWhitespace()&&(this._spacesVisible&&this._spliceStyles(this._spacePattern,e.ranges,e.lineText,e.lineStart),this._tabsVisible&&this._spliceStyles(this._tabPattern,e.ranges,e.lineText,e.lineStart))},_onModelChanged:function(e){var b=e.start,a=e.removedCharCount;e=e.addedCharCount-a;var d=this._view.getModel(),f=d.getBaseModel?d.getBaseModel():d,a=b+
a,g=f.getCharCount(),h=f.getLineStart(f.getLineAtOffset(b)),k=this._findBlock(this._rootBlock,b),r,s,w,y,x,D,q;do{w=k.parent;if(!r&&w&&(x=f.getText(k.start,Math.min(g,k.end+e+1)),!this._stylerAdapter.verifyBlock(f,x,k,e))){k=w;continue}s=k.getBlocks();var z=s.length,C=p(s,h,!0),E=p(s,a,!1,C-1,z);r=!1;if(C&&s.length&&s[C-1].end===b){x=f.getText(s[C-1].start,Math.min(g,b+1));var B=this.computeBlocks(f,x,k,s[C-1].start,null,null,null);B.length&&B[0].end!==s[C-1].end&&(C--,r=!0)}C<z&&s[C].start<=h&&(h<
s[C].end||r)?(q=s[C].start,q>b&&(q+=e)):C===z&&0<z&&k.end-e===s[z-1].end?(q=s[z-1].start,q>b&&(q+=e)):q=h;D=E<z?s[E].end:k.contentEnd;b<=D&&(D+=e);D=Math.min(D,g-1);x=f.getText(q,D+1);B=this.computeBlocks(f,x,k,q,null,null,null);if(E<z){if(B.length&&B[B.length-1].end===D&&B[B.length-1].typeId===s[E].typeId)break;if(B.length&&this._stylerAdapter.blockSpansBeyondEnd(B[B.length-1])){E++;for(var I=B[B.length-1].getBlocks(),I=(I.length?I[I.length-1]:B[B.length-1]).typeId;E<z;){if(s[E].typeId===I){var L=
s[E].end+e,L=Math.min(L,g-1);x=f.getText(q,L+1);x=this.computeBlocks(f,x,k,q,null,null,null);if(x.length&&x[x.length-1].end===L){D=L;B=x;break}}E++}if(E<z)break}}else if(!B.length||B[B.length-1].end<=k.contentEnd+e)break;if(!w){D=g;E=z;x=f.getText(q,D);B=this.computeBlocks(f,x,k,q,null,null,null);break}k=w;y=!0}while(1);this._rootBlock.adjustBounds(b,e);E=Math.min(E+1,z);y||(y=E-C!==B.length);if(!y)for(z=0;z<B.length;z++)if(r=s[C+z],g=B[z],r.start!==g.start||r.end!==g.end||r.typeId!==g.typeId){y=
!0;break}!s.length&&!B.length?this.dispatchEvent({type:"BlocksChanged",old:[k],"new":[k]}):this.dispatchEvent({type:"BlocksChanged",old:s.slice(C,E),"new":B});C=[C,E-C].concat(B);Array.prototype.splice.apply(s,C);y&&(s=q,y=D,d!==f&&(s=d.mapOffset(s,!0),y=d.mapOffset(y,!0)),this._view.redrawRange(s,y));if(this._annotationModel){s=[];var O=[],H=[];y=this._annotationModel.getAnnotations(q,D);C=this._foldingEnabled&&f!==d;for(E=k.parent||k;y.hasNext();)B=y.next(),C&&B.type===n.AnnotationType.ANNOTATION_FOLDING?
(H.push(B),r=this._findBlock(E,B.start),!r||!(B.start===r.start&&B.end===r.end)?(s.push(B),B.expand()):(r=B.start,z=B.end,r>b&&(r-=e),z>b&&(z-=e),r<=b&&(b<z&&r<=a&&a<z)&&(r=f.getLineAtOffset(B.start),z=f.getLineAtOffset(B.end),r!==z?B.expanded||B.expand():s.push(B)))):B.type===n.AnnotationType.ANNOTATION_TASK&&k.start<=B.start&&B.end<=k.end&&s.push(B);C&&E.getBlocks().forEach(function(a){this._updateFolding(a,f,d,H,O,q,D)}.bind(this));this._detectTasks&&this._computeTasks(k,f,O,q,D);this._annotationModel.replaceAnnotations(s,
O)}},_onMouseDown:function(e){if(2===e.clickCount){var b=this._view.getModel(),a=this._view.getOffsetAtLocation(e.x,e.y);if(0<a){var d=a-1,f=b;b.getBaseModel&&(d=b.mapOffset(d),f=b.getBaseModel());var g=this._findBlock(this._rootBlock,d),d=this._findMatchingBracket(f,g,d);-1!==d&&(e.preventDefault(),e=d,b.getBaseModel&&(e=b.mapOffset(e,!0)),a>e&&(a--,e++),this._view.setSelection(e,a))}}},_onSelection:function(e){var b=e.oldValue,a=e.newValue;e=this._view.getModel();var d;if(this._highlightCaretLine){var f=
e.getLineAtOffset(b.start);d=e.getLineAtOffset(a.start);var g=a.start===a.end,b=b.start===b.end;f===d&&b&&g||(b&&this._view.redrawLines(f,f+1),(f!==d||!b)&&g&&this._view.redrawLines(d,d+1))}if(this._annotationModel){var b=this._bracketAnnotations,h,k;if(a.start===a.end&&0<(k=this._view.getCaretOffset()))k-=1,e.getBaseModel&&(k=e.mapOffset(k),e=e.getBaseModel()),a=this._findBlock(this._rootBlock,k),e=this._findMatchingBracket(e,a,k),-1!==e&&(h=[n.AnnotationType.createAnnotation(n.AnnotationType.ANNOTATION_MATCHING_BRACKET,
e,e+1),n.AnnotationType.createAnnotation(n.AnnotationType.ANNOTATION_CURRENT_BRACKET,k,k+1)]);this._bracketAnnotations=h;this._annotationModel.replaceAnnotations(b,h)}},_spliceStyles:function(e,b,a,d){for(var f=e.regex,g=f.lastIndex=0,h=f.exec(a);h;){for(h=d+h.index;g<b.length&&!(h<b[g].end);)g++;var k={start:h,end:h+1,style:e.style};if(g<b.length&&b[g].start<=h){var n={start:h+1,end:b[g].end,style:b[g].style};b[g].end=h;b.splice(g+1,0,n);b.splice(g+1,0,k);g+=2}else b.splice(g,0,k),g++;h=f.exec(a)}},
_updateFolding:function(e,b,a,d,f,g,h){g=g||e.start;h=h||e.end;if(e.start<=h&&g<=e.end){var k=p(d,e.start,!0);k<d.length&&d[k].start===e.start&&d[k].end===e.end||(k=this._createFoldingAnnotation(a,b,e.start,e.end))&&f.push(k);e.getBlocks().forEach(function(e){this._updateFolding(e,b,a,d,f,g,h)}.bind(this))}},_caretLineStyle:{styleClass:"meta annotation currentLine"},_spacePattern:{regex:/[ ]/g,style:{styleClass:"punctuation separator space",unmergeable:!0}},_tabPattern:{regex:/\t/g,style:{styleClass:"punctuation separator tab",
unmergeable:!0}}};s.EventTarget.addMixin(g.prototype);return{TextStyler:g,Block:f,createPatternBasedAdapter:function(e,b){return new r(e,b)}}});
