...
(function(k){function m(a,b){var e,j,w,x,l,f,c,d,o,h=b&&b.split("/"),g=q.map,n=g&&g["*"]||{};if(a&&a.charAt(0)===".")if(b){h=h.slice(0,h.length-1);a=h.concat(a.split("/"));for(d=0;d<a.length;d+=1)if(e=a[d],e===".")a.splice(d,1),d-=1;else if(e==="..")if(d===1&&(a[2]===".."||a[0]===".."))break;else d>0&&(a.splice(d-1,2),d-=2);a=a.join("/")}else a.indexOf("./")===0&&(a=a.substring(2));if((h||n)&&g){e=a.split("/");for(d=e.length;d>0;d-=1){j=e.slice(0,d).join("/");if(h)for(o=h.length;o>0;o-=1)if(w=g[h.slice(0,
o).join("/")])if(w=w[j]){x=w;l=d;break}if(x)break;!f&&n&&n[j]&&(f=n[j],c=d)}!x&&f&&(x=f,l=c);x&&(e.splice(0,l,x),a=e.join("/"))}return a}function p(a,e){return function(){return b.apply(k,s.call(arguments,0).concat([a,e]))}}function i(a){return function(b){return m(b,a)}}function c(a){return function(b){l[a]=b}}function d(a){if(n.call(o,a)){var b=o[a];delete o[a];r[a]=!0;g.apply(k,b)}if(!n.call(l,a)&&!n.call(r,a))throw Error("No "+a);return l[a]}function f(a){var b,e=a?a.indexOf("!"):-1;e>-1&&(b=
...
o;d.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(a){var b=this,e=this._model,c=this._getSelection(),l=c.getCaret(),d=e.getLineAtOffset(l),o=e.getLineCount(),g=this._getScroll(),e=this._getClientHeight(),h,n;if(this._lineHeight){h=this._columnX;g=this._getBoundsAtOffset(l);if(h===-1||a.select&&f.isIE)h=g.left;l=this._getLineIndex(g.top+e);n=this._getLine(l);d=this._getLinePixel(l);l=n.getOffset(h,g.top+e-d);e=n.getBoundingClientRect(l);n.destroy();c.extend(l);a.select||c.collapse();
this._setSelection(c,!0,!0,function(){b._columnX=h},e.top+d-g.top);return!0}if(d<o-1){var i=this._getLineHeight(),q=Math.min(o-d-1,Math.floor(e/i)),q=Math.max(1,q);h=this._columnX;if(h===-1||a.select&&f.isIE)n=this._getLine(d),h=n.getBoundingClientRect(l).left,n.destroy();n=this._getLine(d+q);c.extend(n.getOffset(h,0));n.destroy();a.select||c.collapse();a=o*i;l=g.y+q*i;l+e>a&&(l=a-e);this._setSelection(c,!0,!0,function(){b._columnX=h},l-g.y)}return!0},_doPageUp:function(a){var b=this,e=this._model,
...
r.left),e.innerHTML=Array(this._marginOffset+1).join(" "),g=e.getBoundingClientRect(),g=Math.ceil(g.right-g.left),a.removeChild(e);return{lineHeight:i,largestFontStyle:t,lineTrim:d,viewPadding:q,scrollWidth:n,wrapWidth:r,marginWidth:g,invalid:c}},_cancelAnimation:function(){if(this._animation)this._animation.stop(),this._animation=null},_clearSelection:function(a){var b=this._getSelection();if(b.isEmpty())return!1;a==="next"?b.start=b.end:b.end=b.start;this._setSelection(b,!0);return!0},_commitIME:function(){if(this._imeOffset!==
...
if(!h)this._clipboardDiv=h=f.createElement(g,"div"),h.style.position="fixed",h.style.whiteSpace="pre",h.style.left="-1000px",this._rootDiv.appendChild(h);h.innerHTML="<pre contenteditable=''></pre>";h.firstChild.focus();var n=this,i=function(){var a=n._getTextFromElement(h);h.innerHTML="";l=[];e(a,function(a){l.push(a)},function(){l.push(c)});return l.join("")},q=!1;this._ignorePaste=!0;if(!f.isLinux||this._lastMouseButton!==2)try{q=g.execCommand("paste",!1,null)}catch(r){q=h.childNodes.length>1||
h.firstChild&&h.firstChild.childNodes.length>0}this._ignorePaste=!1;if(!q)return a?(o.setTimeout(function(){n.focus();(d=i())&&b&&b(d);n._ignoreFocus=!1},0),null):(this.focus(),this._ignoreFocus=!1,"");this.focus();this._ignoreFocus=!1;(d=i())&&b&&b(d);return d}return""},_getDOMText:function(a,b){for(var e=a.firstChild,c="",l=0;e;){var f;if(!e.ignore)if(e.ignoreChars){f=e.lastChild;for(var d=0,o=[],g=-1;f;){var h=f.data;if(h)for(var n=h.length-1;n>=0;n--){var i=h.substring(n,n+1);d<e.ignoreChars&&
...
b[c],u(l.target,l.type,l.handler,l.capture)},_hookRulerEvents:function(a,b){if(a){var e=this,c=this._getWindow();f.isIE&&b.push({target:a,type:"selectstart",handler:function(){return!1}});b.push({target:a,type:f.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(a){return e._handleMouseWheel(a?a:c.event)}});b.push({target:a,type:"click",handler:function(a){e._handleRulerEvent(a?a:c.event)}});b.push({target:a,type:"dblclick",handler:function(a){e._handleRulerEvent(a?a:c.event)}});b.push({target:a,
...
this._getWindow();if(e&&this._scrollAnimation){var l=this;this._animation=new v({window:c,duration:this._scrollAnimation,curve:[b,0],onAnimate:function(a){a=b-Math.floor(a);l._scrollView(0,a);b-=a},onEnd:function(){l._animation=null;l._scrollView(a,b);e&&c.setTimeout(e,0)}});this._animation.play()}else this._scrollView(a,b),e&&c.setTimeout(e,0)},_scrollView:function(a,b){this._ensureCaretVisible=!1;var e=this._viewDiv;a&&(e.scrollLeft+=a);b&&(e.scrollTop+=b)},_setClipboardText:function(a,b){var c,
...
d.setStart(g.firstChild,0);d.setEndBefore(g.lastChild);var h=l.getSelection();h.rangeCount>0&&h.removeAllRanges();h.addRange(d);var n=this,d=function(){g&&g.parentNode===n._clientDiv&&n._clientDiv.removeChild(g);n._updateDOMSelection()},h=!1;this._ignoreCopy=!0;try{h=o.execCommand("copy",!1,null)}catch(i){}this._ignoreCopy=!1;if(!h&&b)return l.setTimeout(d,0),!1;d();return!0},_setDOMSelection:function(a,b,e,c,l){for(var d,o,g,h,n=0,i=a.firstChild,q,r,t=this._model.getLine(a.lineIndex).length;i;){if(!i.ignore){q=
i.firstChild;r=q.length;i.ignoreChars&&(r-=i.ignoreChars);if(n+r>b||n+r>=t){d=q;o=b-n;i.ignoreChars&&r>0&&o===r&&(o+=i.ignoreChars);break}n+=r}i=i.nextSibling}for(var n=0,i=e.firstChild,s=this._model.getLine(e.lineIndex).length;i;){if(!i.ignore){q=i.firstChild;r=q.length;i.ignoreChars&&(r-=i.ignoreChars);if(r+n>c||n+r>=s){g=q;h=c-n;i.ignoreChars&&r>0&&h===r&&(h+=i.ignoreChars);break}n+=r}i=i.nextSibling}this._setDOMFullSelection(a,b,t,e,c,s);a=this._getWindow();b=this._parent.ownerDocument;if(a.getSelection){e=
...
b){this._wrapMode=a&&this._wrappable;var e=this._clientDiv;this._wrapMode?(e.style.whiteSpace="pre-wrap",e.style.wordWrap="break-word"):(e.style.whiteSpace="pre",e.style.wordWrap="normal");this._updateOverflow();b||(this.redraw(),this._resetLineWidth());this._resetLineHeight()},_showCaret:function(a,b,e,c){if(this._clientDiv){var l=this._model,d=this._getSelection(),f=this._getScroll(),o=d.getCaret(),g=d.start,h=d.end,n=l.getLineAtOffset(h),i=Math.max(Math.max(g,l.getLineStart(n)),h-1),l=this._getClientWidth(),
n=this._getClientHeight(),q=l/4,r=this._getBoundsAtOffset(o===g?g:i),t=r.left,s=r.right,v=r.top,u=r.bottom;a&&!d.isEmpty()&&(r=this._getBoundsAtOffset(o===h?g:i),r.top===v?o===g?s=t+Math.min(r.right-t,l):t=s-Math.min(s-r.left,l):o===g?u=v+Math.min(r.bottom-v,n):v=u-Math.min(u-r.top,n));a=0;t<f.x&&(a=Math.min(t-f.x,-q));s>f.x+l&&(a=Math.max(s-f.x-l,q));d=0;v<f.y?d=v-f.y:u>f.y+n&&(d=u-f.y-n);c&&(c>0?d>0&&(d=Math.max(d,c)):d<0&&(d=Math.min(d,c)));if(a!==0||d!==0)return d!==0&&typeof e==="number"&&(e<
0&&(e=0),e>1&&(e=1),d+=Math.floor(d>0?e*n:-e*n)),this._scrollViewAnimated(a,d,b),n!==this._getClientHeight()||l!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0;else b&&b();return!1}},_startIME:function(){if(this._imeOffset===-1){var a=this._getSelection();a.isEmpty()||this._modifyContent({text:"",start:a.start,end:a.end},!0);this._imeOffset=a.start}},_unhookEvents:function(){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",
this._modelListener.onChanged);this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);this._modelListener=null;for(var a=0;a<this._handlers.length;a++){var b=this._handlers[a];t(b.target,b.type,b.handler)}this._handlers=null;if(this._mutationObserver)this._mutationObserver.disconnect(),this._mutationObserver=null},_updateDOMSelection:function(){if(!(this._redrawCount>0)&&!this._ignoreDOMSelection&&this._clientDiv){var a=this._getSelection(),b=this._model,e=b.getLineAtOffset(a.start),
c=b.getLineAtOffset(a.end),l=this._getLineNext();if(l){var d=this._getLinePrevious(),f;e<l.lineIndex?(f=l,e=0):e>d.lineIndex?(f=d,e=0):(f=this._getLineNode(e),e=a.start-b.getLineStart(e));c<l.lineIndex?b=0:c>d.lineIndex?(l=d,b=0):(l=this._getLineNode(c),b=a.end-b.getLineStart(c));this._setDOMSelection(f,e,l,b,a.caret)}}},_update:function(a){if(!(this._redrawCount>0)){if(this._updateTimer)this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,a=!1;var b=this._clientDiv,e=this._viewDiv;
if(b){if(this._metrics.invalid)this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1;var c=this._model,l=this._getScroll(!1),d=this._getViewPadding(),o=c.getLineCount(),g=this._getLineHeight(),h=!1,i=!1,q=!1,r=this._metrics.scrollWidth;if(this._wrapMode)b.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px";var t,s,v,u,k=0,p=0,m;if(this._lineHeight){for(;p<o;){m=this._getLineHeight(p);if(k+m>l.y)break;k+=m;p++}t=p;s=Math.max(0,t-1);v=c=l.y-k;t>0&&(c+=this._getLineHeight(t-
1))}else u=Math.max(0,l.y)/g,t=Math.floor(u),s=Math.max(0,t-1),c=Math.round((u-s)*g),v=Math.round((u-t)*g);this._topIndexY=v;u=this._rootDiv;var I=u.clientWidth,F=u.clientHeight;if(a){g=0;this._leftDiv&&(t=this._leftDiv.getBoundingClientRect(),g=t.right-t.left);t=this._getClientWidth();u=this._getClientHeight();i=t;if(this._wrapMode){if(this._metrics.wrapWidth)i=this._metrics.wrapWidth}else i=Math.max(this._maxLineWidth,i);for(;p<o;)m=this._getLineHeight(p,!1),k+=m,p++;o=k}else{u=this._getClientHeight();
v=Math.min(t+Math.floor((u+v)/g),o-1);var l=Math.min(v+1,o-1),A;for(m=b.firstChild;m;){A=m.lineIndex;var z=m.nextSibling;if(!(s<=A&&A<=l)||m.lineRemoved||m.lineIndex===-1)this._mouseWheelLine===m?(m.style.display="none",m.lineIndex=-1):b.removeChild(m);m=z}m=this._getLineNext();var z=e.ownerDocument,C=z.createDocumentFragment();for(A=s;A<=l;A++)if(!m||m.lineIndex>A)(new n(this,A)).create(C,null);else{C.firstChild&&(b.insertBefore(C,m),C=z.createDocumentFragment());if(m&&m.lineChanged)m=(new n(this,
...
!C&&(A-=this._lineHeight[m.lineIndex],A<0))v=m.lineIndex,C=!0;if(!this._wrapMode){if(s>=this._maxLineWidth)this._maxLineWidth=s,this._maxLineIndex=m.lineIndex;if(this._checkMaxLineIndex===m.lineIndex)this._checkMaxLineIndex=-1}if(m.lineIndex===t)this._topChild=m;if(m.lineIndex===v)this._bottomChild=m;m=this._getLineNext(m)}if(this._checkMaxLineIndex!==-1&&(A=this._checkMaxLineIndex,this._checkMaxLineIndex=-1,0<=A&&A<o)){g=new n(this,A);z=g.getBoundingClientRect();s=z.right-z.left;if(s>=this._maxLineWidth)this._maxLineWidth=
s,this._maxLineIndex=A;g.destroy()}for(;p<o;)m=this._getLineHeight(p,p<=v),k+=m,p++;o=k;this._updateRuler(this._leftDiv,t,l,F);this._updateRuler(this._rightDiv,t,l,F);this._updateRuler(this._marginDiv,t,l,F);g=0;this._leftDiv&&(t=this._leftDiv.getBoundingClientRect(),g=t.right-t.left);l=0;this._rightDiv&&(l=this._rightDiv.getBoundingClientRect(),l=l.right-l.left);e.style.left=g+"px";e.style.right=l+"px";l=this._scrollDiv;l.style.height=o+"px";t=this._getClientWidth();if(!this._singleMode&&!this._wrapMode){k=
h=u;(p=e.style.overflowX==="scroll")?h+=r:k-=r;m=v=t;(s=e.style.overflowY==="scroll")?v+=r:m-=r;u=h;t=v;o>u&&(q=!0,t=m);this._maxLineWidth>t&&(i=!0,u=k,o>u&&(q=!0,t=m));if(p!==i)e.style.overflowX=i?"scroll":"hidden";if(s!==q)e.style.overflowY=q?"scroll":"hidden";h=p!==i||s!==q}q=t;if(this._wrapMode){if(this._metrics.wrapWidth)q=this._metrics.wrapWidth}else q=Math.max(this._maxLineWidth,q);i=q;if((!f.isIE||f.isIE>=9)&&this._maxLineWidth>t)q+=d.right+d.left;l.style.width=q+"px";if(this._clipScrollDiv)this._clipScrollDiv.style.width=
q+"px";l=this._getScroll(!1)}if(this._vScrollDiv)q=u-8,k=Math.max(15,Math.ceil(Math.min(1,q/(o+d.top+d.bottom))*q)),this._vScrollDiv.style.left=g+t-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,l.y*q/o))+"px",this._vScrollDiv.style.height=k+"px";if(!this._wrapMode&&this._hScrollDiv)q=t-8,k=Math.max(15,Math.ceil(Math.min(1,q/(this._maxLineWidth+d.left+d.right))*q)),this._hScrollDiv.style.left=g+Math.floor(Math.max(0,Math.floor(l.x*q/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=u-
9+"px",this._hScrollDiv.style.width=k+"px";p=l.x;k=this._clipDiv;q=this._overlayDiv;if(v=this._marginDiv)v.style.left=-p+g+this._metrics.marginWidth+d.left+"px",v.style.bottom=(e.style.overflowX==="scroll"?r:0)+"px";if(k){k.scrollLeft=p;k.scrollTop=0;e=g+d.left;r=d.top;a=t;g=u;p=0;v=-c;if(l.x===0)e-=d.left,a+=d.left,p=d.left;l.x+t===i&&(a+=d.right);l.y===0&&(r-=d.top,g+=d.top,v+=d.top);l.y+u===o&&(g+=d.bottom);k.style.left=e+"px";k.style.top=r+"px";k.style.right=I-a-e+"px";k.style.bottom=F-g-r+"px";
...
o=this._getViewPadding(),a=a.firstChild;a;){var g=a._ruler,n=d,i=g.getOverview();i==="page"&&(n+=this._topIndexY);a.style.top=-n+"px";a.style.height=c+n+"px";a.rulerChanged&&h(g.getRulerStyle(),a);var q,r=a.firstChild;r?(q=r,r=r.nextSibling):(q=f.createElement(l,"div"),q.style.visibility="hidden",a.appendChild(q));var t;if(a.rulerChanged&&q){n=-1;if(t=g.getWidestAnnotation())if(h(t.style,q),t.html)q.innerHTML=t.html;q.lineIndex=n;q.style.height=d+o.top+"px"}var s;if(i==="page"){for(g=g.getAnnotations(b,
e+1);r;)n=r.lineIndex,t=r.nextSibling,(!(b<=n&&n<=e)||r.lineChanged)&&a.removeChild(r),r=t;r=a.firstChild.nextSibling;s=l.createDocumentFragment();for(n=b;n<=e;n++)if(!r||r.lineIndex>n){q=f.createElement(l,"div");if(t=g[n]){h(t.style,q);if(t.html)q.innerHTML=t.html;q.annotation=t}q.lineIndex=n;q.style.height=this._getLineHeight(n)+"px";s.appendChild(q)}else if(s.firstChild&&(a.insertBefore(s,r),s=l.createDocumentFragment()),r)r=r.nextSibling;s.firstChild&&a.insertBefore(s,r)}else{t=this._getClientHeight();
n=this._model.getLineCount();r=t+o.top+o.bottom-2*this._metrics.scrollWidth;i=d*n<r?d:r/n;if(a.rulerChanged){for(t=a.childNodes.length;t>1;)a.removeChild(a.lastChild),t--;g=g.getAnnotations(0,n);s=l.createDocumentFragment();for(var v in g)if(n=v>>>0,!(n<0)){q=f.createElement(l,"div");t=g[v];h(t.style,q);q.style.position="absolute";q.style.top=this._metrics.scrollWidth+d+Math.floor(n*i)+"px";if(t.html)q.innerHTML=t.html;q.annotation=t;q.lineIndex=n;s.appendChild(q)}a.appendChild(s)}else if(a._oldTrackHeight!==
...
(b.lineTrim.top+b.lineTrim.bottom)+"px":"normal";this._updateStyleSheet();a||(this.redraw(),this._resetLineWidth())}};i.EventTarget.addMixin(s.prototype);return{TextView:s}});
...
d.length+=a,c+=a):(d.offset+=c,f.ansestor&&h&&(d.length+=a));if(f.escape)f.model.escapePosition=d.offset}this._updateAnnotations(e)}}}.bind(this),onVerify:function(a){if(!this.ignoreVerify){for(var b=this.editor,c=b.mapOffset(a.start),d=this.editor.mapOffset(a.end),e=this.linkedModeModel,f,g;e;)if(f=this._getPositionChanged(e,c,d),g=f.position,g===void 0||g.model!==e)this.exitLinkedMode(!1),e=this.linkedModeModel;else break;if(e){var h=this._compoundChange;h?h.owner.model===e&&h.owner.group===g.group||
(this.endUndo(),this.startUndo()):this.startUndo();e.selectedGroupIndex=g.group;var h=0,i=a.text.length-(d-c);f=f.positions;var j;c-=g.position.offset;for(var k=d-g.position.offset,m=0;m<f.length;++m)if(j=f[m],d=j.position,j.oldOffset=d.offset,j.model===e&&j.group===g.group?(d.offset+=h,d.length+=i,h+=i):(d.offset+=h,j.ansestor&&(d.length+=g.count*i)),j.escape)j.model.escapePosition=d.offset;this.ignoreVerify=!0;for(m=f.length-1;m>=0;m--)j=f[m],j.model===e&&j.group===g.group&&b.setText(a.text,j.oldOffset+
...
e.getSelection();return b.start===b.end&&(b=e.getCaretOffset(),a.offset<=b&&b<=a.offset+a.length)?e.getText(a.offset,b):""},b.offset=a.offset,b.deactivate(),b.activate();else if(this._groupContentAssistProvider)this._groupContentAssistProvider=null,b.deactivate()}this._updateAnnotations()},_getModelPositions:function(c,b,a){for(var d=b.groups,f=0;f<d.length;f++)for(var h=d[f].positions,i=0;i<h.length;i++){var k=h[i];a&&(k={offset:k.offset+a,length:k.length});k={index:i,group:f,count:h.length,model:b,
position:k};c.push(k);if(b.nextModel&&b.nextModel.parentGroup===f)k.ansestor=!0,this._getModelPositions(c,b.nextModel,(a||0)+h[i].offset-h[0].offset)}},_getSortedPositions:function(c){var b=this._sortedPositions;if(!b){for(b=[];c.previousModel;)c=c.previousModel;for(this._getModelPositions(b,c);c;)c.escapePosition!==void 0&&b.push({escape:!0,model:c,position:{offset:c.escapePosition,length:0}}),c=c.nextModel;b.sort(function(a,b){return a.position.offset-b.position.offset});this._sortedPositions=b}return b},
_getPositionChanged:function(c,b,a){for(var d,c=this._getSortedPositions(c),f=c.length-1;f>=0;f--){var h=c[f].position;if(h.offset<=b&&a<=h.offset+h.length){d=c[f];break}}return{position:d,positions:c}},_updateAnnotations:function(c){var b=this.editor.getAnnotationModel();if(b){var a=[],d=[];b.getTextModel();for(var f=b.getAnnotations(),h;f.hasNext();)switch(h=f.next(),h.type){case i.AnnotationType.ANNOTATION_LINKED_GROUP:case i.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP:case i.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:a.push(h)}if(f=
this.linkedModeModel)for(var c=c||this._getSortedPositions(f),k=0;k<c.length;k++)if(h=c[k],h.model===f){var m=i.AnnotationType.ANNOTATION_LINKED_GROUP;h.group===f.selectedGroupIndex&&(m=h.index===0?i.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:i.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP);h=h.position;h=i.AnnotationType.createAnnotation(m,h.offset,h.offset+h.length,"");d.push(h)}b.replaceAnnotations(a,d)}}});h.LinkedMode=f;return h});
